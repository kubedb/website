...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Storage Autoscaling Overview](/docs/v2025.4.30/guides/mssqlserver/autoscaler/storage/overview)
...
> If you want to autoscale MSSQLServer `Standalone`, Just deploy a [standalone](/docs/v2025.4.30/guides/mssqlserver/clustering/standalone) sql server instance using KubeDB.
