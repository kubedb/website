...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  ...
  - [MySQLDatabase](/docs/v2025.4.30/guides/mysql/concepts/mysqldatabase/)
  - [Schema Manager Overview](/docs/v2025.4.30/guides/mysql/schema-manager/overview/)
...
- Detail concepts of [MySQLDatabase object](/docs/v2025.4.30/guides/mysql/concepts/mysqldatabase/).
