...
- Read [mongodb hidden-node concept](/docs/v2025.4.30/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Replica Set Hidden-node.
...
- [Backup and Restore](/docs/v2025.4.30/guides/mongodb/backup/stash/overview/) process of MongoDB databases using Stash.
