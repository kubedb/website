...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2025.4.30/guides/elasticsearch/plugins/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2025.4.30/guides/elasticsearch/plugins/x-pack/configuration).
