...
- `spec:`
    ...
    - `tls:`
        ...
        - `certificates`
    - `cientAuthMode`
      Read about the fields in details from [ferretdb concept](/docs/v2025.4.30/guides/ferretdb/concepts/ferretdb),
...
<figure align="center">
<img alt="Deploy FerretDB with TLS/SSL" src="/docs/v2025.4.30/images/ferretdb/fr-tls.svg">
