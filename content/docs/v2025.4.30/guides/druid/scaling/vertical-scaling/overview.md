...
- You should be familiar with the following `KubeDB` concepts:
    - [Druid](/docs/v2025.4.30/guides/kafka/concepts/kafka)
    - [DruidOpsRequest](/docs/v2025.4.30/guides/kafka/concepts/kafkaopsrequest)
...
<figure align="center">
  <img alt="Vertical scaling process of Druid" src="/docs/v2025.4.30/guides/druid/scaling/horizontal-scaling/images/dr-horizontal-scaling.png">
