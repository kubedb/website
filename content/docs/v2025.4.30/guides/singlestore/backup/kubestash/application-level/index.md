...
- If you are not familiar with how KubeStash backup and restore SingleStore databases, please check the following guide [here](/docs/v2025.4.30/guides/singlestore/backup/kubestash/overview/).
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/singlestore/backup/kubestash/application-level/examples](/docs/v2025.4.30/guides/singlestore/backup/kubestash/application-level/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
Here, we have to use service `sample-singlestore` and secret `sample-singlestore-root-cred` to connect with the database. `KubeDB` creates an [AppBinding](/docs/v2025.4.30/guides/singlestore/concepts/appbinding) CR that holds the necessary information to connect with the database.
