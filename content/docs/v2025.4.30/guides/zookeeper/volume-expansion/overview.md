...
<figure align="center">
  <img alt="Volume Expansion process of ZooKeeper" src="/docs/v2025.4.30/images/day-2-operation/zookeeper/zk-volume-expansion.svg">
...
In the [next](/docs/v2025.4.30/guides/zookeeper/volume-expansion/volume-expansion) docs, we are going to show a step-by-step guide on Volume Expansion of various ZooKeeper database components using `ZooKeeperOpsRequest` CRD.
