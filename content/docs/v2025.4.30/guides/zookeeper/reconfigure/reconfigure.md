...
> **Note:** YAML files used in this tutorial are stored in [examples](/docs/v2025.4.30/examples/zookeeper) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
