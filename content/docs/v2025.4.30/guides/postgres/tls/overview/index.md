...
Read about the fields in details from [postgres concept](/docs/v2025.4.30/guides/postgres/concepts/postgres#),
...
<figure align="center">
  <img alt="Postgres with TLS/SSL Flow" src="/docs/v2025.4.30/guides/postgres/tls/overview/images/pg-tls-ssl.png">
