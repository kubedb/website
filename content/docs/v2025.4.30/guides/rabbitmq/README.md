...
url: /docs/v2025.4.30/guides/rabbitmq/
aliases:
- /docs/v2025.4.30/guides/rabbitmq/README/
info:
  autoscaler: v0.39.0
  cli: v0.54.0
  dashboard: v0.30.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.4.30/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
