...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2025.4.30/guides/kafka/concepts/kafkaversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- [Monitor Apache Kafka with Prometheus operator](/docs/v2025.4.30/guides/kafka/monitoring/using-prometheus-operator)
- [Monitor Apache Kafka with Built-in Prometheus](/docs/v2025.4.30/guides/kafka/monitoring/using-builtin-prometheus)
...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2025.4.30/guides/kafka/README).
