...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2025.4.30/guides/kafka/clustering/topology-cluster/)
    - [KafkaOpsRequest](/docs/v2025.4.30/guides/kafka/concepts/kafkaopsrequest)
    - [Horizontal Scaling Overview](/docs/v2025.4.30/guides/kafka/scaling/horizontal-scaling/overview)
...
- Monitor your Kafka with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.4.30/guides/kafka/monitoring/using-prometheus-operator).
