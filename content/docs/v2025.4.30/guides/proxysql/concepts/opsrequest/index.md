...
`spec.proxyRef` is a required field that point to the [ProxySQL](/docs/v2025.4.30/guides/proxysql/concepts/proxysql) object for which the administrative operations will be performed. This field consists of the following sub-field:
...
- `spec.updateVersion.targetVersion` refers to a [ProxySQLVersion](/docs/v2025.4.30/guides/proxysql/concepts/proxysql-version/) CR that contains the ProxySQL version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.4.30/guides/proxysql/concepts/proxysql/index.md/#spectls).
