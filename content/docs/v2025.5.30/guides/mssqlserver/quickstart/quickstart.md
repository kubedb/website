...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2025.5.30/setup/README)  and make sure install with helm command including `--set global.featureGates.MSSQLServer=true` to ensure MSSQLServer CRD installation.
...
- Want to set up SQL Server Availability Group clusters? Check how to [Configure SQL Server Availability Gruop Cluster](/docs/v2025.5.30/guides/mssqlserver/clustering/ag_cluster)
