...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.5.30/guides/mssqlserver/monitoring/using-prometheus-operator).
