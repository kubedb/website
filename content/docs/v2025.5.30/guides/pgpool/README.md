...
url: /docs/v2025.5.30/guides/pgpool/
aliases:
- /docs/v2025.5.30/guides/pgpool/README/
info:
  autoscaler: v0.40.0
  cli: v0.55.0
  dashboard: v0.31.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2025.5.30/guides/pgpool/concepts/catalog) object with your custom pgpool image.
...
- [Quickstart Pgpool](/docs/v2025.5.30/guides/pgpool/quickstart/quickstart) with KubeDB Operator.
