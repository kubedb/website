...
- Read [concept of MongoDB Version Catalog](/docs/v2025.5.30/guides/mongodb/concepts/catalog) to learn detail concepts of `MongoDBVersion` object.
...
Follow the steps [install KubeDB operator](/docs/v2025.5.30/setup/README) properly. The list configuration arguments of the helm installation command will be found [here](https://github.com/kubedb/installer/tree/v2022.10.18/charts/kubedb#configuration).
