...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Reconfigure Overview](/docs/v2025.5.30/guides/druid/reconfigure/overview)
...
> **Note:** YAML files used in this tutorial are stored in [/docs/guides/druid/reconfigure/yamls](/docs/v2025.5.30/guides/druid/reconfigure/yamls) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.5.30/guides/druid/reconfigure/images/druid-ui.png">
</p>
...
You can access the UI similarly by doing port-forward as mentioned in [Check Configuration from Druid UI](/docs/v2025.5.30/guides/druid/reconfigure/#CheckConfigurationfromDruidUI)

You should be able to see the following changes in the UI:

<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.5.30/guides/druid/configuration/config-file/images/druid-updated-ui.png">
</p>
