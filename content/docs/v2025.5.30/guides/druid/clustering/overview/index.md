...
![Druid Architecture](/docs/v2025.5.30/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2025.5.30/guides/druid/clustering/overview/) using KubeDB.
