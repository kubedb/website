...
url: /docs/v2025.5.30/guides/pgbouncer/
aliases:
- /docs/v2025.5.30/guides/pgbouncer/README/
info:
  autoscaler: v0.40.0
  cli: v0.55.0
  dashboard: v0.31.0
...
- [Quickstart PgBouncer](/docs/v2025.5.30/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2025.5.30/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.5.30/guides/pgbouncer/monitoring/using-prometheus-operator).
