...
- `spec:`
  ...
  - `connectionPool`
    - `authType`
Read about the fields in details from [pgbouncer concept](/docs/v2025.5.30/guides/pgbouncer/concepts/pgbouncer),
...
<figure align="center">
<img alt="Deploy PgBouncer with TLS/SSL" src="/docs/v2025.5.30/images/day-2-operation/pgbouncer/pb-tls.svg">
