...
- `spec.tls.sslMode` is the ssl mode of the server. You can see the details [here](/docs/v2025.5.30/guides/ferretdb/concepts/ferretdb#specsslmode).
- The meaning of `spec.timeout` & `spec.apply` fields will be found [here](/docs/v2025.5.30/guides/ferretdb/concepts/opsrequest#spectimeout)
