...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/Solr](/docs/v2025.5.30/examples/solr) directory of [kubedb/docs](https://github.com/kube/docs) repository.
