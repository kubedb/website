...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Storage Autoscaling Overview](/docs/v2025.5.30/guides/solr/autoscaler/storage/overview)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.5.30/examples/solr/autoscaler/storage) of [kubedb/docs](https://github.com/kubedb/docs) repository.
