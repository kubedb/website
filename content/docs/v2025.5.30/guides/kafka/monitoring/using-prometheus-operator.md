...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.5.30/images/kafka/kafka-promethues.png" style="padding:10px">
</p>
...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2025.5.30/guides/kafka/README).
