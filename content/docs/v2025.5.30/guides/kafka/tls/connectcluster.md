...
> **Note:** Before creating Kafka ConnectCluster, make sure you have a Kafka cluster with/without TLS/SSL enabled. If you don't have a Kafka cluster, you can follow the steps [here](/docs/v2025.5.30/guides/kafka/tls/topology).
...
- `spec.kafkaRef` refers to the Kafka cluster that we have created from [here](/docs/v2025.5.30/guides/kafka/tls/topology).
