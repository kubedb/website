...
The steps below apply regardless of which [installation method](/docs/v2026.7.10/setup/install/kubedb/) you used.
...
KubeDB can run fully disconnected from the internet, as long as every required image is cached in a registry the cluster can reach (users commonly use Harbor or JFrog Artifactory for this, see the [offline installation guide](/docs/v2026.7.10/setup/install/kubedb/helm)).
...
Now, you are ready to [create your first database](/docs/v2026.7.10/guides/README) using KubeDB.
