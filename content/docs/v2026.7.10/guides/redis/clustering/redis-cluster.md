...
- Read [redis clustering concept](/docs/v2026.7.10/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2026.7.10/guides/redis/sentinel/overview)
