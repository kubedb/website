...
url: /docs/v2026.7.10/guides/zookeeper/
aliases:
- /docs/v2026.7.10/guides/zookeeper/README/
info:
  autoscaler: v0.51.0
  cli: v0.66.0
  dashboard: v0.42.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.7.10/images/zookeeper/zookeeper-lifecycle.png">
</p>

## User Guide

- [Quickstart ZooKeeper](/docs/v2026.7.10/guides/zookeeper/quickstart/quickstart) with KubeDB Operator.
- Detail Concept of [ZooKeeper Object](/docs/v2026.7.10/guides/zookeeper/concepts/zookeeper).
