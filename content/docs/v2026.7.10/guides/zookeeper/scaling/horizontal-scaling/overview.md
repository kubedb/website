...
<figure align="center">
  <img alt="Horizontal scaling process of ZooKeeper" src="/docs/v2026.7.10/images/day-2-operation/zookeeper/zk-horizontal-scaling.svg">
...
In the [next](/docs/v2026.7.10/guides/zookeeper/scaling/horizontal-scaling/horizontal-scaling) docs, we are going to show a step by step guide on horizontal scaling of ZooKeeper database using `ZooKeeperOpsRequest` CRD.