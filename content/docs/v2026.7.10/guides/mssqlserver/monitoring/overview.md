...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.7.10/guides/mssqlserver/monitoring/using-prometheus-operator).
