...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.7.10/guides/mssqlserver/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.7.10/images/mssqlserver/monitoring/mssql-monitoring-targets.png" style="padding:10px">
</p>
