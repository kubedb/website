...
- You should be familiar with the following `KubeDB` concepts:
    - [AppBinding](/docs/v2026.7.10/guides/mssqlserver/concepts/appbinding)
    - [MSSQLServer](/docs/v2026.7.10/guides/mssqlserver/concepts/mssqlserver)
    - [MSSQLServerMigration](/docs/v2026.7.10/guides/mssqlserver/concepts/migrator)
...
For a full description of every field, see the [MSSQLServerMigration CRD reference](/docs/v2026.7.10/guides/mssqlserver/concepts/migrator).
