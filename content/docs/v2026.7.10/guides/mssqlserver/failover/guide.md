...
For more details, please check the full section [here](/docs/v2026.7.10/guides/mssqlserver/volume-expansion/overview).
...
- Learn about [PITR](/docs/v2026.7.10/guides/mssqlserver/pitr/archiver)
- Learn about [backup and restore](/docs/v2026.7.10/guides/mssqlserver/backup/overview/) MSSQLServer database using Stash.
- Want to setup MSSQLServer cluster? Check how to [configure Highly Available MSSQLServer Cluster](/docs/v2026.7.10/guides/mssqlserver/clustering/ag_cluster)
- Monitor your MSSQLServer database with KubeDB using [Prometheus operator](/docs/v2026.7.10/guides/mssqlserver/monitoring/using-prometheus-operator).
