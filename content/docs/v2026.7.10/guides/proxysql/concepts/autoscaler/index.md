...
`spec.proxyRef` is a required field that point to the [ProxySQL](/docs/v2026.7.10/guides/proxysql/concepts/proxysql) object for which the autoscaling will be performed. This field consists of the following sub-field:
