...
- Read [concept of Memcached Version Catalog](/docs/v2026.7.10/guides/memcached/concepts/memcached-version) to learn detail concepts of `MemcachedVersion` object.
