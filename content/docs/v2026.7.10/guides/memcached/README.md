...
url: /docs/v2026.7.10/guides/memcached/
aliases:
- /docs/v2026.7.10/guides/memcached/README/
info:
  autoscaler: v0.51.0
  cli: v0.66.0
  dashboard: v0.42.0
...
- Use [kubedb cli](/docs/v2026.7.10/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
