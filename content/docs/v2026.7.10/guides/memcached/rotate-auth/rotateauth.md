...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/memcached/rotate-auth](/docs/v2026.7.10/examples/memcached/rotate-auth) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
