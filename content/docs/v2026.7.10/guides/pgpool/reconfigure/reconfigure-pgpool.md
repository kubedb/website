...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.7.10/guides/pgpool/reconfigure/overview)
...
- Have a look at the [Pgpool OpsRequest concept](/docs/v2026.7.10/guides/pgpool/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
