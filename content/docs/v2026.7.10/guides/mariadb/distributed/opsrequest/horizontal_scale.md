...
- Install `KubeDB` Community and Enterprise operator in your hub cluster following the steps [here](/docs/v2026.7.10/setup/README). Make sure to enable OCM support:
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Distributed MariaDB Overview](/docs/v2026.7.10/guides/mariadb/distributed/overview/)
  - [MariaDBOpsRequest](/docs/v2026.7.10/guides/mariadb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2026.7.10/guides/mariadb/scaling/horizontal-scaling/overview/)
