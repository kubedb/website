...
`spec.version` is a required field specifying the name of the [HanaDBVersion](/docs/v2026.7.10/guides/hanadb/concepts/catalog)
...
> The HANA username must remain `SYSTEM`. See [Rotate Authentication](/docs/v2026.7.10/guides/hanadb/rotate-authentication/rotate-authentication)
...
See [Custom Configuration](/docs/v2026.7.10/guides/hanadb/configuration/using-config-file). At runtime, custom
...
certificates with the aliases `server`, `client`, and `metrics-exporter`. See [TLS/SSL Encryption](/docs/v2026.7.10/guides/hanadb/tls/overview).
...
[Monitoring](/docs/v2026.7.10/guides/hanadb/monitoring/using-builtin-prometheus).
...
- Deploy a [Standalone HanaDB](/docs/v2026.7.10/guides/hanadb/quickstart/quickstart).
- Deploy a [System Replication cluster](/docs/v2026.7.10/guides/hanadb/clustering/system-replication).
- Learn about [HanaDBVersion](/docs/v2026.7.10/guides/hanadb/concepts/catalog) and [HanaDBOpsRequest](/docs/v2026.7.10/guides/hanadb/concepts/opsrequest).
