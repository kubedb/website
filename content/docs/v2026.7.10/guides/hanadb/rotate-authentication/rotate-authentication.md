...
- Create a namespace `demo` and deploy a standalone `hanadb-standalone` (see
  [Reconfigure](/docs/v2026.7.10/guides/hanadb/reconfigure/reconfigure#deploy-a-hanadb)).
...
- Encrypt connections with [TLS/SSL](/docs/v2026.7.10/guides/hanadb/tls/overview).
