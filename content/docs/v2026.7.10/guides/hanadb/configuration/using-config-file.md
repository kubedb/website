...
see [Reconfigure](/docs/v2026.7.10/guides/hanadb/reconfigure/reconfigure).
...
- Change configuration on a running database with [Reconfigure](/docs/v2026.7.10/guides/hanadb/reconfigure/reconfigure).
