...
- Install the KubeDB Provisioner and Ops-manager operators following the steps [here](/docs/v2026.7.10/setup/README).
...
- [Restart](/docs/v2026.7.10/guides/hanadb/restart/restart) it (primary restarted last),
- [Vertically scale](/docs/v2026.7.10/guides/hanadb/scaling/vertical-scaling/vertical-scaling) the nodes,
- Enable [TLS](/docs/v2026.7.10/guides/hanadb/tls/overview), and
- [Migrate storage](/docs/v2026.7.10/guides/hanadb/storage-migration/storage-migration).
...
- Detailed concepts of the [HanaDB object](/docs/v2026.7.10/guides/hanadb/concepts/hanadb).
- Review the [HanaDBOpsRequest CRD](/docs/v2026.7.10/guides/hanadb/concepts/opsrequest).
