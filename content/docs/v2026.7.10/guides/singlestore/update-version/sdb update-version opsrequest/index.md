...
- Install `KubeDB` Community and Ops-manager operator in your cluster following the steps [here](/docs/v2026.7.10/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2026.7.10/guides/singlestore/concepts/singlestore)
  - [Cluster](/docs/v2026.7.10/guides/singlestore/clustering/overview/)
  - [SingleStoreOpsRequest](/docs/v2026.7.10/guides/singlestore/concepts/opsrequest)
  - [Updating Overview](/docs/v2026.7.10/guides/singlestore/update-version/overview/)
