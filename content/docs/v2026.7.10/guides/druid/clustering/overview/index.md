...
![Druid Architecture](/docs/v2026.7.10/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2026.7.10/guides/druid/clustering/overview/) using KubeDB.
