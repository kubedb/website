...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2026.7.10/guides/druid/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/druid](/docs/v2026.7.10/examples/druid) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.7.10/guides/druid/update-version/images/druid-ui-28.png">
</p>
...
You can also see the version of druid cluster from the druid ui by following the steps described previously in this tutorial. [Check Druid Version from UI](/docs/v2026.7.10/guides/druid/update-version/guide.md/#Check-Druid-Version-from-UI)
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.7.10/guides/druid/update-version/images/druid-ui-30.png">
</p>
