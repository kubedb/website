...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure TLS Overview](/docs/v2026.7.10/guides/milvus/reconfigure-tls/overview)
...
- Deploy a [TLS-secured Milvus](/docs/v2026.7.10/guides/milvus/tls/guide) from the start.
