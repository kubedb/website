...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Rotate Authentication Overview](/docs/v2026.7.10/guides/milvus/rotate-auth/overview)
...
See the [Recommendation Engine guide](/docs/v2026.7.10/guides/milvus/recommendation/guide) for an end-to-end walkthrough.
...
- Learn more about the [Recommendation Engine](/docs/v2026.7.10/guides/milvus/recommendation/guide).
