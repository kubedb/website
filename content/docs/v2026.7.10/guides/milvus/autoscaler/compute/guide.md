...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Autoscaling Overview](/docs/v2026.7.10/guides/milvus/autoscaler/compute/overview)
...
The Ops-manager then applies the vertical scaling exactly as in the [vertical scaling guide](/docs/v2026.7.10/guides/milvus/scaling/vertical-scaling/guide), right-sizing the pod to the recommended resources.
