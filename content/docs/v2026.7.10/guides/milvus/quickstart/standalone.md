...
- Complete the dependency setup from [Prepare Dependencies](/docs/v2026.7.10/guides/milvus/quickstart/prerequisites). That guide installs MinIO, creates the `my-release-minio` secret, and installs the etcd operator required by Milvus.
...
If you later enable [Prometheus Operator monitoring](/docs/v2026.7.10/guides/milvus/monitoring/using-prometheus-operator), KubeDB also creates a dedicated `milvus-standalone-stats` service on port `9091` for scraping.
...
3. Add `spec.metaStorage.externallyManaged: true` and the external endpoints to your `Milvus` manifest as shown in [Prepare Dependencies](/docs/v2026.7.10/guides/milvus/quickstart/prerequisites#optional-path-use-external-etcd).
...
If you want to remove the dependencies too, either delete the whole `demo` namespace or follow the cleanup steps in [Prepare Dependencies](/docs/v2026.7.10/guides/milvus/quickstart/prerequisites#cleanup).

## Next Steps

- [Prepare Dependencies](/docs/v2026.7.10/guides/milvus/quickstart/prerequisites) for another cluster.
- [Deploy a Distributed Milvus](/docs/v2026.7.10/guides/milvus/quickstart/distributed).
- [Enable Prometheus Operator monitoring](/docs/v2026.7.10/guides/milvus/monitoring/using-prometheus-operator).
- [Enable TLS](/docs/v2026.7.10/guides/milvus/tls/guide).
