...
If you later enable [Prometheus Operator monitoring](/docs/v2026.7.10/guides/milvus/monitoring/using-prometheus-operator), KubeDB also creates a dedicated `milvus-cluster-stats` service and a `ServiceMonitor`.
...
- [Monitor](/docs/v2026.7.10/guides/milvus/monitoring/using-prometheus-operator) your Milvus cluster.
- [Horizontally scale](/docs/v2026.7.10/guides/milvus/scaling/horizontal-scaling/guide) the distributed roles.
