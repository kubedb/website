...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [TLS Overview](/docs/v2026.7.10/guides/milvus/tls/overview)
...
- Add, rotate or remove TLS on a running database with [Reconfigure TLS](/docs/v2026.7.10/guides/milvus/reconfigure-tls/guide).
