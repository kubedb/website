...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Update Version Overview](/docs/v2026.7.10/guides/milvus/update-version/overview)
...
- Learn how the [Recommendation Engine](/docs/v2026.7.10/guides/milvus/recommendation/guide) suggests version updates automatically.
