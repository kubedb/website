...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2026.7.10/guides/ignite/update-version/overview)
...
- Have a look [here](/docs/v2026.7.10/guides/ignite/concepts/opsrequest#spectimeout) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
