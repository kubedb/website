...
<figure align="center">
  <img alt="updating Process of Ignite" src="/docs/v2026.7.10/images/day-2-operation/ignite/ig-version-update.svg">
...
In the [next](/docs/v2026.7.10/guides/ignite/update-version/update-version) doc, we are going to show a step-by-step guide on updating of an Ignite database using updateVersion operation.
