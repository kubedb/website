...
- Install KubeDB following [the setup guide](/docs/v2026.7.10/setup/README).
...
- Learn Neo4j CR fields from [Neo4j concept doc](/docs/v2026.7.10/guides/neo4j/concepts/neo4j).
