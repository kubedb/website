...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.7.10/images/neo4j/prometheus.png" style="padding:10px">
</p>
...
- Monitor your Neo4j database with KubeDB using [built-in Prometheus](/docs/v2026.7.10/guides/neo4j/monitoring/using-builtin-prometheus).
