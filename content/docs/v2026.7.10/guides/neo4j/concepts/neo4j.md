...
`spec.version` is a required field that specifies the name of the [Neo4jVersion](/docs/v2026.7.10/guides/neo4j/concepts/catalog) CRD where database image and version metadata are defined.
...
KubeDB merges the provided settings into Neo4j configuration and reconciles the cluster accordingly. See the [configuration guide](/docs/v2026.7.10/guides/neo4j/configuration/using-config-file).
...
See [monitoring overview](/docs/v2026.7.10/guides/neo4j/monitoring/overview) for setup and verification.
...
See [TLS overview](/docs/v2026.7.10/guides/neo4j/tls/overview/) and [Reconfigure TLS](/docs/v2026.7.10/guides/neo4j/reconfigure-tls/overview).
...
- [Custom RBAC for Neo4j](/docs/v2026.7.10/guides/neo4j/custom-rbac/using-custom-rbac)
- [Private Registry for Neo4j](/docs/v2026.7.10/guides/neo4j/private-registry/using-private-registry)
...
- Learn about [Neo4jVersion CRD](/docs/v2026.7.10/guides/neo4j/concepts/catalog).
- Learn about [AppBinding CRD](/docs/v2026.7.10/guides/neo4j/concepts/appbinding).
- Explore [Neo4j OpsRequest](/docs/v2026.7.10/guides/neo4j/concepts/opsrequest).
- Follow the [Neo4j quickstart](/docs/v2026.7.10/guides/neo4j/quickstart/quickstart)
