...
If the `DEPRECATED` column shows `true` for a version you are currently using, upgrade to a supported version via [UpdateVersion](/docs/v2026.7.10/guides/neo4j/update-version/versionupgrading/).

## Next Steps

- Read the [Neo4j CRD concept](/docs/v2026.7.10/guides/neo4j/concepts/neo4j).
- Run the [Neo4j quickstart](/docs/v2026.7.10/guides/neo4j/quickstart/quickstart).