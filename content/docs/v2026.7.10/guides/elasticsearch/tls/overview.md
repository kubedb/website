...
Read about the fields in details from [elasticsearch concept](/docs/v2026.7.10/guides/elasticsearch/concepts/elasticsearch/).
...
<figure align="center">
<img alt="Deploy Elasticsearch with TLS/SSL" src="/docs/v2026.7.10/images/elasticsearch/es-tls.svg">
