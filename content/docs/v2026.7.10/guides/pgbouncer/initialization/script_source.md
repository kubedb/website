...
PgBouncer is a connection pooler for PostgreSQL and requires a running PostgreSQL instance as its backend. Prepare a KubeDB Postgres cluster using this [tutorial](/docs/v2026.7.10/guides/postgres/clustering/streaming_replication).
...
- Learn about [backup and restore](/docs/v2026.7.10/guides/pgbouncer/backup/overview/) PgBouncer using Stash.
