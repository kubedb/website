...
Now, create a secret with structure defined [here](/docs/v2026.7.10/guides/pgbouncer/concepts/pgbouncer#specsyncusers). Below is the YAML of the `secret` that we are going to create,
...
- Monitor your PgBouncer database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.7.10/guides/pgbouncer/monitoring/using-prometheus-operator).
