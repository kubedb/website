...
- Now, install KubeDB operator in your cluster following the steps in the [KubeDB setup guide](/docs/v2026.7.10/setup/README) and make sure the Helm command includes `--set global.featureGates.Qdrant=true` to ensure Qdrant CRD installation.
...
In this tutorial, we will use `1.17.0` QdrantVersion CR to create a Qdrant cluster. To know more about what `QdrantVersion` CR is and why there may be variation in version names, please visit [here](/docs/v2026.7.10/guides/qdrant/concepts/catalog).
...
- Want to set up distributed Qdrant deployment? Check [Distributed Deployment](/docs/v2026.7.10/guides/qdrant/distributed-deployment/overview).
