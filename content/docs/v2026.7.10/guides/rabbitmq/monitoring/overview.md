...
- Learn how to monitor RabbitMQ database with KubeDB using [builtin-Prometheus](/docs/v2026.7.10/guides/rabbitmq/monitoring/using-builtin-prometheus)
- Learn how to monitor RabbitMQ database with KubeDB using [Prometheus operator](/docs/v2026.7.10/guides/rabbitmq/monitoring/using-prometheus-operator).
