...
url: /docs/v2026.7.10/guides/rabbitmq/
aliases:
- /docs/v2026.7.10/guides/rabbitmq/README/
info:
  autoscaler: v0.51.0
  cli: v0.66.0
  dashboard: v0.42.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.7.10/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
