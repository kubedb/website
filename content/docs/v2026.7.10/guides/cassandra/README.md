...
url: /docs/v2026.7.10/guides/cassandra/
aliases:
- /docs/v2026.7.10/guides/cassandra/README/
info:
  autoscaler: v0.51.0
  cli: v0.66.0
  dashboard: v0.42.0
...
- [Quickstart Cassandra](/docs/v2026.7.10/guides/cassandra/quickstart/guide/quickstart) with KubeDB Operator.
