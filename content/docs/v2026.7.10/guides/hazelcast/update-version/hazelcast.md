...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [updating Overview](/docs/v2026.7.10/guides/hazelcast/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/hazelcast](/docs/v2026.7.10/examples/hazelcast) directory of [kubedb/docs](https://github.com/kube/docs) repository.
