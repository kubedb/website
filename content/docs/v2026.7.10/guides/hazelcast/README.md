...
url: /docs/v2026.7.10/guides/hazelcast/
aliases:
- /docs/v2026.7.10/guides/hazelcast/README/
info:
  autoscaler: v0.51.0
  cli: v0.66.0
  dashboard: v0.42.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.7.10/guides/hazelcast/quickstart/overview/images/Lifecycle-of-a-hazelcast-instance.png">
</p>

## User Guide

- [Quickstart Hazelcast](/docs/v2026.7.10/guides/hazelcast/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Hazelcast Object](/docs/v2026.7.10/guides/hazelcast/concepts/hazelcast).
