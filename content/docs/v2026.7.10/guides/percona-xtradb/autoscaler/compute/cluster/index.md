...
- Install `KubeDB` Community, Ops-Manager and Autoscaler operator in your cluster following the steps [here](/docs/v2026.7.10/setup/README).

- Install `Metrics Server` from [here](https://github.com/kubernetes-sigs/metrics-server#installation)

- You should be familiar with the following `KubeDB` concepts:
  - [PerconaXtraDB](/docs/v2026.7.10/guides/percona-xtradb/concepts/perconaxtradb)
  - [PerconaXtraDBAutoscaler](/docs/v2026.7.10/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2026.7.10/guides/percona-xtradb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.7.10/guides/percona-xtradb/autoscaler/compute/overview)
