...
- Detail concepts of [Oracle object](/docs/v2026.7.10/guides/oracle/concepts/oracle).
- Monitor your Oracle database with KubeDB using [Prometheus operator](/docs/v2026.7.10/guides/oracle/monitoring/using-prometheus-operator).
- Learn how to [reconfigure](/docs/v2026.7.10/guides/oracle/reconfigure/reconfigure) an Oracle database.
