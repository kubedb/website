...
- Learn how to provision a database with a [custom configuration file](/docs/v2026.7.10/guides/oracle/configuration/using-config-file) at creation time.
