...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure TLS Overview](/docs/v2026.7.10/guides/weaviate/reconfigure-tls/overview)
...
- Provision a cluster with TLS from the start: [Weaviate TLS](/docs/v2026.7.10/guides/weaviate/tls/overview).
