...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2026.7.10/setup/README) and make sure to include the Weaviate feature gate during installation.
...
- Use [custom configuration](/docs/v2026.7.10/guides/weaviate/configuration/using-config-file) for your Weaviate cluster.
- Encrypt traffic with [TLS](/docs/v2026.7.10/guides/weaviate/tls/overview).
- Run day-2 operations: [Restart](/docs/v2026.7.10/guides/weaviate/restart/restart.md), [Reconfigure](/docs/v2026.7.10/guides/weaviate/reconfigure/reconfigure.md), [Volume Expansion](/docs/v2026.7.10/guides/weaviate/volume-expansion/volume-expansion), [Vertical Scaling](/docs/v2026.7.10/guides/weaviate/scaling/vertical-scaling/vertical-scaling), [Horizontal Scaling](/docs/v2026.7.10/guides/weaviate/scaling/horizontal-scaling/horizontal-scaling), [Rotate Authentication](/docs/v2026.7.10/guides/weaviate/rotate-auth/rotate-auth), and [Storage Migration](/docs/v2026.7.10/guides/weaviate/storage-migration/storage-migration).
- Automatically scale your cluster with the [Compute Autoscaler](/docs/v2026.7.10/guides/weaviate/autoscaler/compute/compute-autoscale) and [Storage Autoscaler](/docs/v2026.7.10/guides/weaviate/autoscaler/storage/storage-autoscale).
