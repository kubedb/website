...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Weaviate TLS Overview](/docs/v2026.7.10/guides/weaviate/tls/overview)
...
- Add, rotate, or remove TLS on a running cluster: [Reconfigure TLS](/docs/v2026.7.10/guides/weaviate/reconfigure-tls/reconfigure-tls).
