...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.7.10/guides/clickhouse/scaling/vertical-scaling/overview)
...
- Detail concepts of [ClickHouse object](/docs/v2026.7.10/guides/clickhouse/concepts/clickhouse).
