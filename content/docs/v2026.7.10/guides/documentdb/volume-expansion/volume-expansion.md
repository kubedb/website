...
instances did not finish bootstrapping (see the [Restart](/docs/v2026.7.10/guides/documentdb/restart/)
...
- [Storage migration](/docs/v2026.7.10/guides/documentdb/storage-migration/) to a different StorageClass.
- [Storage autoscaling](/docs/v2026.7.10/guides/documentdb/autoscaler/storage/) of a DocumentDB cluster.
