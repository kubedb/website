...
[here](/docs/v2026.7.10/setup/README).
...
- Learn about the [synchronous replication overview](/docs/v2026.7.10/guides/postgres/synchronous/).
- Run PostgreSQL with a [custom configuration file](/docs/v2026.7.10/guides/postgres/configuration/using-config-file).
