...
- Install `KubeDB` Community and Enterprise operator in your cluster following the steps [here](/docs/v2026.7.10/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [Postgres](/docs/v2026.7.10/guides/postgres/concepts/postgres)
  - [PostgresOpsRequest](/docs/v2026.7.10/guides/postgres/concepts/opsrequest)
  - [Reconfigure Overview](/docs/v2026.7.10/guides/postgres/reconfigure/overview)
...
To know more about this configuration file, check [here](/docs/v2026.7.10/guides/postgres/configuration/using-config-file)
```ini
$ cat user.conf
max_connections=200
...
- Monitor your Postgres database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.7.10/guides/postgres/monitoring/using-prometheus-operator).
- Monitor your Postgres database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.7.10/guides/postgres/monitoring/using-builtin-prometheus).
- Use [private Docker registry](/docs/v2026.7.10/guides/postgres/private-registry/using-private-registry) to deploy Postgres with KubeDB.
- Use [kubedb cli](/docs/v2026.7.10/guides/postgres/cli/cli) to manage databases like kubectl for Kubernetes.
- Detail concepts of [Postgres object](/docs/v2026.7.10/guides/postgres/concepts/postgres).
