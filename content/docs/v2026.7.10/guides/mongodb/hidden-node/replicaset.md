...
- Read [mongodb hidden-node concept](/docs/v2026.7.10/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Hidden node.
...
- Deploy MongoDB shard [with Hidden-node](/docs/v2026.7.10/guides/mongodb/hidden-node/sharding).
