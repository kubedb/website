...
- Install `KubeDB` operator with the kubedb-courier operator enabled in your cluster following the steps [here](/docs/v2026.7.10/operatormanual/migration/).
...
- You should be familiar with the following `KubeDB` concepts:
    - [AppBinding](/docs/v2026.7.10/guides/mongodb/concepts/appbinding)
    - [MongoDB](/docs/v2026.7.10/guides/mongodb/concepts/mongodb)
    - [MongoDBMigration](/docs/v2026.7.10/guides/mongodb/concepts/migrator)
    - [Migration](/docs/v2026.7.10/operatormanual/migration/)
...
For a full description of every field, see the [MongoDBMigration CRD reference](/docs/v2026.7.10/guides/mongodb/concepts/migrator).
