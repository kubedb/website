...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.7.10/setup/README).
...
- [Backup and Restore](/docs/v2026.7.10/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
