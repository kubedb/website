...
url: /docs/v2020.11.12/guides/pgbouncer/
aliases:
- /docs/v2020.11.12/guides/pgbouncer/README/
info:
  cli: v0.15.1
  community: v0.15.1
  enterprise: v0.2.1
...
- [Quickstart PgBouncer](/docs/v2020.11.12/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2020.11.12/guides/pgbouncer/monitoring/using-builtin-prometheus).
