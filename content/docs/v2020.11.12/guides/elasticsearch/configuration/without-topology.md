...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2020.11.12/guides/elasticsearch/configuration/overview).
