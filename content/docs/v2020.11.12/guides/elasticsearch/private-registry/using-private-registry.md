...
When installing KubeDB operator, set the flags `--docker-registry` and `--image-pull-secret` to appropriate value. Follow the guide for customizing installer to see how to pass those flags from [here](/docs/v2020.11.12/setup/README#customizing-installer).
...
- Learn about [backup & restore](/docs/v2020.11.12/guides/elasticsearch/backup/stash) of Elasticsearch database using Stash.
