...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/v2020.11.12/images/elasticsearch/sg-flow.png">
  </kbd>
</p>
...
- Learn how to [use TLS certificates](/docs/v2020.11.12/guides/elasticsearch/search-guard/use-tls) to connect Elasticsearch.
