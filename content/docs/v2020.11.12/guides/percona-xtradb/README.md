...
url: /docs/v2020.11.12/guides/percona-xtradb/
aliases:
- /docs/v2020.11.12/guides/percona-xtradb/README/
info:
  cli: v0.15.1
  community: v0.15.1
  enterprise: v0.2.1
...
- [Overview](/docs/v2020.11.12/guides/percona-xtradb/overview/overview) of PerconaXtraDB.
- [Quickstart PerconaXtraDB](/docs/v2020.11.12/guides/percona-xtradb/quickstart/quickstart) with KubeDB Operator.
