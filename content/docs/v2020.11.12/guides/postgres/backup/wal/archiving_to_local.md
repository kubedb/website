...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/v2020.11.12/guides/postgres/backup/wal/continuous_archiving) to learn more.
