...
[MinIO](https://docs.min.io/) is an open source object storage server compatible with Amazon S3 APIs. **WAL-G** is used to continuously archive PostgreSQL WAL files to MinIO. Please refer to [continuous archiving in KubeDB](/docs/v2020.11.12/guides/postgres/backup/wal/continuous_archiving) to learn more.
...
- Learn about initializing [PostgreSQL from WAL](/docs/v2020.11.12/guides/postgres/initialization/wal/wal_source) files stored in backup servers.
