...
- Monitor your MySQL instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2020.11.12/guides/mysql/monitoring/using-prometheus-operator).
- Monitor your MySQL instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2020.11.12/guides/mysql/monitoring/using-builtin-prometheus).
