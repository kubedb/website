...
![MySQL Replication](/docs/v2020.11.12/images/mysql/clustering/replicationarchitecturexample.png)
...
![Primary-Secondary Replication](/docs/v2020.11.12/images/mysql/clustering/async-replication-diagram.png)
...
![MySQL Semisynchronous Replication](/docs/v2020.11.12/images/mysql/clustering/semisync-replication-diagram.png)
...
![MySQL Group Replication Protocol](/docs/v2020.11.12/images/mysql/clustering/gr-replication-diagram.png)
...
![3 Server Group](/docs/v2020.11.12/images/mysql/clustering/gr-3-server-group.png)
...
- [Deploy MySQL Group Replication](/docs/v2020.11.12/guides/mysql/clustering/group_replication_single_primary) using KubeDB.
