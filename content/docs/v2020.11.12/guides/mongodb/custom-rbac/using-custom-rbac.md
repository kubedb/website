...
- [Backup and Restore](/docs/v2020.11.12/guides/mongodb/backup/stash) MongoDB instances using Stash.
- Initialize [MongoDB with Script](/docs/v2020.11.12/guides/mongodb/initialization/using-script).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2020.11.12/guides/mongodb/monitoring/using-prometheus-operator).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2020.11.12/guides/mongodb/monitoring/using-builtin-prometheus).
