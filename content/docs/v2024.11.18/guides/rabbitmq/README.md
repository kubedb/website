...
url: /docs/v2024.11.18/guides/rabbitmq/
aliases:
- /docs/v2024.11.18/guides/rabbitmq/README/
info:
  autoscaler: v0.34.0
  cli: v0.49.0
  dashboard: v0.25.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2024.11.18/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
