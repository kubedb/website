...
url: /docs/v2024.11.18/guides/pgpool/
aliases:
- /docs/v2024.11.18/guides/pgpool/README/
info:
  autoscaler: v0.34.0
  cli: v0.49.0
  dashboard: v0.25.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2024.11.18/guides/pgpool/concepts/catalog) object with your custom pgpool image.
