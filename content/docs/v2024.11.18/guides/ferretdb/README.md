...
url: /docs/v2024.11.18/guides/ferretdb/
aliases:
- /docs/v2024.11.18/guides/ferretdb/README/
info:
  autoscaler: v0.34.0
  cli: v0.49.0
  dashboard: v0.25.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2024.11.18/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2024.11.18/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
