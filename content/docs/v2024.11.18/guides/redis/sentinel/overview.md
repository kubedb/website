...
![redis-sentinel](/docs/v2024.11.18/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.11.18/guides/redis/sentinel/redis-sentinel) using KubeDB.
