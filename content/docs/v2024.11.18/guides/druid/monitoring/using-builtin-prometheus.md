...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2024.11.18/guides/druid/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.11.18/guides/druid/monitoring/images/druid-prometheus.png" style="padding:10px">
</p>
...
- Learn how to configure [Druid Topology](/docs/v2024.11.18/guides/druid/clustering/overview/).
