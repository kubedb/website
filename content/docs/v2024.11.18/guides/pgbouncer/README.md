...
url: /docs/v2024.11.18/guides/pgbouncer/
aliases:
- /docs/v2024.11.18/guides/pgbouncer/README/
info:
  autoscaler: v0.34.0
  cli: v0.49.0
  dashboard: v0.25.0
...
- [Quickstart PgBouncer](/docs/v2024.11.18/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.11.18/guides/pgbouncer/monitoring/using-builtin-prometheus).
