...
`spec.databaseRef` is a `required` field that points to the [Elasticsearch](/docs/v2024.11.18/guides/elasticsearch/concepts/elasticsearch/) object for which the administrative operations will be performed. This field consists of the following sub-field:

- `databaseRef.name` - specifies the name of the [Elasticsearch](/docs/v2024.11.18/guides/elasticsearch/concepts/elasticsearch/) object.
...
- `updateVersion.targetVersion` refers to an [ElasticsearchVersion](/docs/v2024.11.18/guides/elasticsearch/concepts/catalog/) CR name that contains the Elasticsearch version information required to perform the update.
