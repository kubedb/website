...
- Learn about ConnectCluster CRD [here](/docs/v2024.11.18/guides/kafka/concepts/connectcluster).
- Deploy your first ConnectCluster with KubeDB by following the guide [here](/docs/v2024.11.18/guides/kafka/connectcluster/quickstart).
