...
For this tutorial, we are going to use ConnectCluster version `3.6.1` with three worker nodes. To learn more about ConnectCluster CR, please visit [here](/docs/v2024.11.18/guides/kafka/concepts/connectcluster) and visit [here](/docs/v2024.11.18/guides/kafka/concepts/kafkaconnectorversion) to learn about KafkaConnectorVersion CR.
...
Before creating ConnectCluster, you must need a Kafka cluster. If you don't have a Kafka cluster, you can create one by following this [tutorial](/docs/v2024.11.18/guides/kafka/clustering/topology-cluster/).
...
To do that, we need to create a Postgres database. You can create a Postgres database by following this [tutorial](/docs/v2024.11.18/guides/postgres/quickstart/quickstart).
We also need a MySQL database. You can create a MySQL database by following this [tutorial](/docs/v2024.11.18/guides/mysql/quickstart/).
