...
- If you are not familiar with how Stash backup and restore PostgreSQL databases, please check the following guide [here](/docs/v2024.11.18/guides/postgres/backup/stash/overview/):

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2024.11.18/guides/postgres/concepts/appbinding)
...
Here, we have to use the service `sample-postgres` and secret `sample-postgres-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2024.11.18/guides/postgres/concepts/appbinding) crd that holds the necessary information to connect with the database.
...
<figure align="center">
 <img alt="Backup data in GCS Bucket" src="/docs/v2024.11.18/guides/postgres/backup/stash/standalone/images/sample-postgres-backup.png">
