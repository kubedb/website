...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2024.11.18/images/zookeeper/zookeeper-prometheus.png" style="padding:10px">
</p>
...
- Monitor your ZooKeeper database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.11.18/guides/zookeeper/monitoring/using-builtin-prometheus).
- Detail concepts of [ZooKeeper object](/docs/v2024.11.18/guides/zookeeper/concepts/zookeeper).
- Detail concepts of [ZooKeeperVersion object](/docs/v2024.11.18/guides/zookeeper/concepts/catalog).
