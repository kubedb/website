...
- Read [concept of Memcached Version Catalog](/docs/v2024.11.18/guides/memcached/concepts/memcached-version) to learn detail concepts of `MemcachedVersion` object.
