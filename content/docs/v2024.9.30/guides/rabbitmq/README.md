...
url: /docs/v2024.9.30/guides/rabbitmq/
aliases:
- /docs/v2024.9.30/guides/rabbitmq/README/
info:
  autoscaler: v0.33.0
  cli: v0.48.0
  dashboard: v0.24.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2024.9.30/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
