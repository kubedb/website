...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/rabbitmq](/docs/v2024.9.30/examples/rabbitmq) directory of [kubedb/docs](https://github.com/kube/docs) repository.
