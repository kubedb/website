...
url: /docs/v2024.9.30/guides/ferretdb/
aliases:
- /docs/v2024.9.30/guides/ferretdb/README/
info:
  autoscaler: v0.33.0
  cli: v0.48.0
  dashboard: v0.24.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2024.9.30/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2024.9.30/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
