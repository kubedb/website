...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2024.9.30/guides/kafka/clustering/combined-cluster/)
    - [KafkaOpsRequest](/docs/v2024.9.30/guides/kafka/concepts/kafkaopsrequest)
    - [Horizontal Scaling Overview](/docs/v2024.9.30/guides/kafka/scaling/horizontal-scaling/overview)
...
- Monitor your Kafka with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.9.30/guides/kafka/monitoring/using-prometheus-operator).
