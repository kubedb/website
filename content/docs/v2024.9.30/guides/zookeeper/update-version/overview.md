...
<figure align="center">
  <img alt="updating Process of ZooKeeper" src="/docs/v2024.9.30/images/day-2-operation/zookeeper/zk-version-update.svg">
...
In the [next](/docs/v2024.9.30/guides/zookeeper/update-version/update-version) doc, we are going to show a step-by-step guide on updating of a ZooKeeper database using updateVersion operation.