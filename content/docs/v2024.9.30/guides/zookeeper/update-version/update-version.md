...
- You should be familiar with the following `KubeDB` concepts:
    - [ZooKeeper](/docs/v2024.9.30/guides/zookeeper/concepts/zookeeper)
    - [ZooKeeperOpsRequest](/docs/v2024.9.30/guides/zookeeper/concepts/opsrequest)
    - [Updating Overview](/docs/v2024.9.30/guides/zookeeper/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/zookeeper](/docs/v2024.9.30/examples/zookeeper) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
- Have a look [here](/docs/v2024.9.30/guides/zookeeper/concepts/opsrequest#spectimeout) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
