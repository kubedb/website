...
url: /docs/v2024.9.30/guides/zookeeper/
aliases:
- /docs/v2024.9.30/guides/zookeeper/README/
info:
  autoscaler: v0.33.0
  cli: v0.48.0
  dashboard: v0.24.0
...
- [Quickstart ZooKeeper](/docs/v2024.9.30/guides/zookeeper/quickstart/quickstart) with KubeDB Operator.
- Detail Concept of [ZooKeeper Object](/docs/v2024.9.30/guides/zookeeper/concepts/zookeeper).
