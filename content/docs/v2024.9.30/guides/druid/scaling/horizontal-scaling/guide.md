...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Horizontal Scaling Overview](/docs/v2024.9.30/guides/druid/scaling/horizontal-scaling/overview)
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.9.30/guides/druid/scaling/horizontal-scaling/images/druid-ui.png">
</p>
...
Verify the scaled replica count of nodes from the druid ui. To access the UI follow the steps described in the first part of this guide. [(Check Replica Count from Druid UI)](/docs/v2024.9.30/guides/druid/scaling/horizontal-scaling/#Check-Replica-Count-from-Druid-UI)
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.9.30/guides/druid/scaling/horizontal-scaling/images/druid-ui-scaled-up.png">
</p>
...
- Monitor your Druid with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.9.30/guides/druid/monitoring/using-prometheus-operator).
