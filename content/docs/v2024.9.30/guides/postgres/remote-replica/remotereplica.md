...
We wil use the [kubedb_plugin](/docs/v2024.9.30/setup/README) for generating configuration for remote replica. It will create the appbinding and necessary secrets to connect with source server
```bash
