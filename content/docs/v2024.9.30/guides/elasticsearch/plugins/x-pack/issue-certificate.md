...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2024.9.30/guides/elasticsearch/plugins/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2024.9.30/guides/elasticsearch/plugins/x-pack/configuration).
