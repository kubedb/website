...
url: /docs/v2021.01.14/guides/percona-xtradb/
aliases:
- /docs/v2021.01.14/guides/percona-xtradb/README/
info:
  autocaler: v0.1.0
  cli: v0.16.0
  community: v0.16.0
...
- [Overview](/docs/v2021.01.14/guides/percona-xtradb/overview/overview) of PerconaXtraDB.
- [Quickstart PerconaXtraDB](/docs/v2021.01.14/guides/percona-xtradb/quickstart/quickstart) with KubeDB Operator.
