...
Also cleanup the resources created for `wal-postgres` following the guide [here](/docs/v2021.01.14/guides/postgres/backup/wal/archiving_to_local#cleaning-up).
