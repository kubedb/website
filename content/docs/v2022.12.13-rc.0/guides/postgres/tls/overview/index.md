...
Read about the fields in details from [postgres concept](/docs/v2022.12.13-rc.0/guides/postgres/concepts/postgres#),
...
<figure align="center">
  <img alt="Postgres with TLS/SSL Flow" src="/docs/v2022.12.13-rc.0/guides/postgres/tls/overview/images/pg-tls-ssl.png">
