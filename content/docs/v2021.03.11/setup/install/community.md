...
<figure align="center">
  <img alt="KubeDB Backend Overview" src="/docs/v2021.03.11/images/setup/community_license_form.png">
  <figcaption align="center">Fig: KubeDB License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing KubeDB by following the upgrading guide from [here](/docs/v2021.03.11/setup/upgrade#upgrading-license).
...
kube-system   kubedb-community-569cd4c686-7jx95   1/1     Running   0          23s
```
...
Now, you are ready to [create your first database](/docs/v2021.03.11/guides/README) using KubeDB.
