...
url: /docs/v2021.03.11/guides/mongodb/
aliases:
- /docs/v2021.03.11/guides/mongodb/README/
info:
  autoscaler: v0.2.0
  cli: v0.17.0
  community: v0.17.0
...
- [MongoDB Replicaset](/docs/v2021.03.11/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2021.03.11/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2021.03.11/guides/mongodb/backup/stash) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2021.03.11/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2021.03.11/guides/mongodb/configuration/using-config-file).
