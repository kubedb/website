...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2021.03.11/guides/elasticsearch/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2021.03.11/guides/elasticsearch/x-pack/configuration).
