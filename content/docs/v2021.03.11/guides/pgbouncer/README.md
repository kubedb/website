...
url: /docs/v2021.03.11/guides/pgbouncer/
aliases:
- /docs/v2021.03.11/guides/pgbouncer/README/
info:
  autoscaler: v0.2.0
  cli: v0.17.0
  community: v0.17.0
...
- [Quickstart PgBouncer](/docs/v2021.03.11/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.03.11/guides/pgbouncer/monitoring/using-builtin-prometheus).
