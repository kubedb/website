...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2021.03.11/guides/proxysql/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2021.03.11/images/proxysql/proxysql-builtin-prom-target.png" style="padding:10px">
</p>
...
- Monitor your ProxySQL database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2021.03.11/guides/proxysql/monitoring/using-prometheus-operator).
