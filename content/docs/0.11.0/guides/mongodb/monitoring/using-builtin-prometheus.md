...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/0.11.0/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [taking instant backup and restore from snapshot](/docs/0.11.0/guides/mongodb/snapshot/backup-and-restore) of MongoDB database using KubeDB.
- Learn how to [schedule backup](/docs/0.11.0/guides/mongodb/snapshot/scheduled-backup)  of MongoDB database.
- Learn about initializing [MongoDB with Snapshot](/docs/0.11.0/guides/mongodb/initialization/using-snapshot).
- Learn how to configure [MongoDB Topology](/docs/0.11.0/guides/mongodb/clustering/topology).
