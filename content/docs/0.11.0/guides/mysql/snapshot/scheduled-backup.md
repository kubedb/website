...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/0.11.0/concepts/snapshot).  Now, create the `MySQL` object with scheduled snapshot.
...
![snapshot-console](/docs/0.11.0/images/mysql/mysql-scheduled.png)
