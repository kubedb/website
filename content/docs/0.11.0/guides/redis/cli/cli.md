...
Lets edit an existing running Redis object to setup [Monitoring](/docs/0.11.0/guides/redis/monitoring/using-builtin-prometheus). The following command will open Redis `redis-demo` in editor.
...
- Learn how to use custom configuration in Redis with KubeDB [here](/docs/0.11.0/guides/redis/custom-config/using-custom-config)
