...
Lets edit an existing running Elasticsearch object to setup [Scheduled Backup](/docs/0.11.0/guides/elasticsearch/snapshot/scheduled_backup). The following command will open Elasticsearch `elasticsearch-demo` in editor.
...
- Learn how to use KubeDB to run a Elasticsearch database [here](/docs/0.11.0/guides/elasticsearch/README).
