...
url: /docs/v2023.12.11/guides/pgbouncer/
aliases:
- /docs/v2023.12.11/guides/pgbouncer/README/
info:
  autoscaler: v0.23.0
  cli: v0.38.0
  dashboard: v0.14.0
...
- [Quickstart PgBouncer](/docs/v2023.12.11/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.12.11/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2023.12.11/guides/pgbouncer/monitoring/using-prometheus-operator).
