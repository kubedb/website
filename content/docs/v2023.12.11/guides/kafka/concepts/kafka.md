...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2023.12.11/guides/kafka/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- [Monitor Apache with Prometheus operator](/docs/v2023.12.11/guides/kafka/monitoring/using-prometheus-operator)
