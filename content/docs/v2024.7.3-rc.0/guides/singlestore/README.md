...
url: /docs/v2024.7.3-rc.0/guides/singlestore/
aliases:
- /docs/v2024.7.3-rc.0/guides/singlestore/README/
info:
  cli: v0.47.0-rc.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.7.3-rc.0/guides/singlestore/images/singlestore-lifecycle.png" >
</p>

## User Guide

- [Quickstart SingleStore](/docs/v2024.7.3-rc.0/guides/singlestore/quickstart/quickstart) with KubeDB Operator.
