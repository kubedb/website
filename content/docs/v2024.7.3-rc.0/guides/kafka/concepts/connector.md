...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2024.7.3-rc.0/guides/kafka/quickstart/overview/kafka/).
- Learn how to use KubeDB to run a Apache Kafka Connect cluster [here](/docs/v2024.7.3-rc.0/guides/kafka/quickstart/overview/connectcluster/).
