...
- Learn about ConnectCluster CRD [here](/docs/v2024.7.3-rc.0/guides/kafka/concepts/connectcluster).
- Deploy your first ConnectCluster with KubeDB by following the guide [here](/docs/v2024.7.3-rc.0/guides/kafka/quickstart/overview/connectcluster/).
