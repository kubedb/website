...
```
## Next Steps
- Learn about [backup and restore](/docs/v2024.7.3-rc.0/guides/mongodb/backup/overview/) MongoDB database using Stash.
- Learn about initializing [MongoDB with Script](/docs/v2024.7.3-rc.0/guides/mongodb/initialization/using-script).
- Learn about [custom mongoVersions](/docs/v2024.7.3-rc.0/guides/mongodb/concepts/catalog).
- Want to setup MongoDB cluster? Check how to [configure Highly Available MongoDB Cluster](/docs/v2024.7.3-rc.0/guides/mongodb/clustering/replicaset)
- Monitor your MongoDB database with KubeDB using [built-in Prometheus](/docs/v2024.7.3-rc.0/guides/mongodb/monitoring/using-builtin-prometheus).
- Monitor your MongoDB database with KubeDB using [Prometheus operator](/docs/v2024.7.3-rc.0/guides/mongodb/monitoring/using-prometheus-operator).
- Detail concepts of [mongo object](/docs/v2024.7.3-rc.0/guides/mongodb/concepts/mongodb).
