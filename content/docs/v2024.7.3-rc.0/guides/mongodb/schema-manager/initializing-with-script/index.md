...
- You should be familiar with the following concepts:
  ...
  - [Schema Manager Overview](/docs/v2024.7.3-rc.0/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2024.7.3-rc.0/guides/mongodb/concepts/mongodbdatabase).
