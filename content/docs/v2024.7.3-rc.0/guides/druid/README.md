...
url: /docs/v2024.7.3-rc.0/guides/druid/
aliases:
- /docs/v2024.7.3-rc.0/guides/druid/README/
info:
  cli: v0.47.0-rc.0
...
> The listed DruidVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [DruidVersion](/docs/v2024.7.3-rc.0/guides/druid/concepts/catalog) object with your custom Druid image.
...
## User Guide 
- [Quickstart Druid](/docs/v2024.7.3-rc.0/guides/druid/quickstart/overview/) with KubeDB Operator.
...
- Detail concepts of [Druid object](/docs/v2024.7.3-rc.0/guides/druid/concepts/druid).
