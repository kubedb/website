...
url: /docs/v2024.7.3-rc.0/guides/pgpool/
aliases:
- /docs/v2024.7.3-rc.0/guides/pgpool/README/
info:
  cli: v0.47.0-rc.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2024.7.3-rc.0/guides/pgpool/concepts/catalog) object with your custom pgpool image.
...
- [Quickstart Pgpool](/docs/v2024.7.3-rc.0/guides/pgpool/quickstart/quickstart) with KubeDB Operator.
