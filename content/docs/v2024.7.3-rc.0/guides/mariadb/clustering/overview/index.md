...
![MariaDB Cluster](/docs/v2024.7.3-rc.0/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2024.7.3-rc.0/guides/mariadb/clustering/galera-cluster) using KubeDB.
