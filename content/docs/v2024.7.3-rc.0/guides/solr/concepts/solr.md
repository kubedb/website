...
`spec.version` is a required field specifying the name of the [SolrVersion](/docs/v2024.7.3-rc.0/guides/solr/concepts/solrversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `SolrVersion` crds,
...
- Learn how to use KubeDB to run a Solr server [here](/docs/v2024.7.3-rc.0/guides/solr/README).
