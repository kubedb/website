...
url: /docs/v2024.7.3-rc.0/guides/mssqlserver/
aliases:
- /docs/v2024.7.3-rc.0/guides/mssqlserver/README/
info:
  cli: v0.47.0-rc.0
...
- [Quickstart MSSQLServer](/docs/v2024.7.3-rc.0/guides/mssqlserver/quickstart/quickstart) with KubeDB Operator.
