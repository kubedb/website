...
`spec.databaseRef` is a required field that point to the [PerconaXtraDB](/docs/v2024.7.3-rc.0/guides/percona-xtradb/concepts/perconaxtradb) object for which the autoscaling will be performed. This field consists of the following sub-field:
