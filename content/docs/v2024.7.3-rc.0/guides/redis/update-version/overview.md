...
<figure align="center">
  <img alt="Update Version Process of Redis" src="/docs/v2024.7.3-rc.0/images/day-2-operation/redis/rd-updating.svg">
...
- Learn how to Update Version of [Redis Standalone](/docs/v2024.7.3-rc.0/guides/redis/update-version/standalone)
- Learn how to Update Version of [Redis Cluster](/docs/v2024.7.3-rc.0/guides/redis/update-version/cluster)
- Learn how to Update Version of [Redis Sentinel](/docs/v2024.7.3-rc.0/guides/redis/update-version/sentinel)