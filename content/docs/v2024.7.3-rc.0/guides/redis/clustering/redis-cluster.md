...
- Read [redis clustering concept](/docs/v2024.7.3-rc.0/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2024.7.3-rc.0/guides/redis/sentinel/overview)
