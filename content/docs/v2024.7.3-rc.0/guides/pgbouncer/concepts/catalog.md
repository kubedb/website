...
`metadata.name` is a required field that specifies the name of the `PgBouncerVersion` crd. You have to specify this name in `spec.version` field of [PgBouncer](/docs/v2024.7.3-rc.0/guides/pgbouncer/concepts/pgbouncer) crd.
...
- Learn about PgBouncer crd [here](/docs/v2024.7.3-rc.0/guides/pgbouncer/concepts/catalog).
- Deploy your first PgBouncer server with KubeDB by following the guide [here](/docs/v2024.7.3-rc.0/guides/pgbouncer/quickstart/quickstart).