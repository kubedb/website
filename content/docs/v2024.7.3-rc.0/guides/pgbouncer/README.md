...
url: /docs/v2024.7.3-rc.0/guides/pgbouncer/
aliases:
- /docs/v2024.7.3-rc.0/guides/pgbouncer/README/
info:
  cli: v0.47.0-rc.0
...
- [Quickstart PgBouncer](/docs/v2024.7.3-rc.0/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.7.3-rc.0/guides/pgbouncer/monitoring/using-builtin-prometheus).
