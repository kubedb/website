...
* [kubectl-dba monitor check-connection](/docs/v2025.3.24/reference/cli/kubectl-dba_monitor_check-connection)	 - Check connection status of prometheus targets with server
* [kubectl-dba monitor dashboard](/docs/v2025.3.24/reference/cli/kubectl-dba_monitor_dashboard)	 - Check availability of a grafana dashboard
* [kubectl-dba monitor get-alerts](/docs/v2025.3.24/reference/cli/kubectl-dba_monitor_get-alerts)	 - Alerts associated with a database
