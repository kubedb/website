...
`spec.databaseRef` is a `required` field that points to the [Solr](/docs/v2025.3.24/guides/solr/concepts/solr) object for which the administrative operations will be performed. This field consists of the following sub-field:

- `databaseRef.name` - specifies the name of the [Solr](/docs/v2025.3.24/guides/solr/concepts/solr) object.
...
- `updateVersion.targetVersion` refers to an [SolrVersion](/docs/v2025.3.24/guides/solr/concepts/solrversion) CR name that contains the Solr version information required to perform the update.
