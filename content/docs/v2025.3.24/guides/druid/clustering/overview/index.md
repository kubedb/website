...
![Druid Architecture](/docs/v2025.3.24/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2025.3.24/guides/druid/clustering/overview/) using KubeDB.
