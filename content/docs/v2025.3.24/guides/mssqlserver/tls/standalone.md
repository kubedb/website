...
Read about the fields in details in [mssqlserver concept](/docs/v2025.3.24/guides/mssqlserver/concepts/mssqlserver).
...
- [Backup and Restore](/docs/v2025.3.24/guides/mssqlserver/backup/overview/) MSSQLServer databases using KubeStash.