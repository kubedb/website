...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Availability Group Cluster](/docs/v2025.3.24/guides/mssqlserver/clustering/ag_cluster)
  - [MSSQLServerOpsRequest](/docs/v2025.3.24/guides/mssqlserver/concepts/opsrequest)
  - [Updating Overview](/docs/v2025.3.24/guides/mssqlserver/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mssqlserver](/docs/v2025.3.24/examples/mssqlserver/update-version) directory of [kubedb/docs](https://github.com/kube/docs) repository.
