...
url: /docs/v2025.3.24/guides/pgpool/
aliases:
- /docs/v2025.3.24/guides/pgpool/README/
info:
  autoscaler: v0.38.0
  cli: v0.53.0
  dashboard: v0.29.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2025.3.24/guides/pgpool/concepts/catalog) object with your custom pgpool image.
