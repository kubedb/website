...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [ConnectCluster](/docs/v2025.3.24/guides/kafka/concepts/connectcluster)
    - [Connector](/docs/v2025.3.24/guides/kafka/concepts/connector)
...
<figure align="center">
  <img alt="Kafka Migration Process" src="/docs/v2025.3.24/images/kafka/migration/migration.png">
...
<figure align="center">
  <img alt="List of connector for migration" src="/docs/v2025.3.24/images/kafka/migration/connectors.png">
...
<figure align="center">
  <img alt="Messages from target cluster" src="/docs/v2025.3.24/images/kafka/migration/replicated-messages.png">
...
<figure align="center">
  <img alt="Translated consumer-group to target cluster" src="/docs/v2025.3.24/images/kafka/migration/translated-cg.png">
...
<figure align="center">
  <img alt="Mirror-source connector replication latency(ms)" src="/docs/v2025.3.24/images/kafka/migration/latency-ms-max.png">
...
<figure align="center">
  <img alt="Mirror-source connector replication latency(ms)" src="/docs/v2025.3.24/images/kafka/migration/record-count.png">
<figcaption align="center">Fig: Mirror-source connector replication latency(ms)</figcaption>
</figure>
...
Also, you can monitor the whole cluster using [prometheus](/docs/v2025.3.24/guides/kafka/monitoring/using-prometheus-operator) and grafana.
...
<figure align="center">
  <img alt="All messages synced to target cluster" src="/docs/v2025.3.24/images/kafka/migration/messages-synced.png">
...
<figure align="center">
  <img alt="Consumer-group synced with source cluster" src="/docs/v2025.3.24/images/kafka/migration/cg-synced.png">
...
- Learn how to configure [Kafka Topology](/docs/v2025.3.24/guides/kafka/clustering/topology-cluster/).
- Learn [ConnectCluster](/docs/v2025.3.24/guides/kafka/connectcluster/connectcluster)
