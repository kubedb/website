...
url: /docs/v2025.3.24/guides/rabbitmq/
aliases:
- /docs/v2025.3.24/guides/rabbitmq/README/
info:
  autoscaler: v0.38.0
  cli: v0.53.0
  dashboard: v0.29.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.3.24/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
