...
- You should be familiar with the following `KubeDB` concepts:
  - [Elasticsearch](/docs/v2025.3.24/guides/elasticsearch/concepts/elasticsearch/)
  - [ElasticsearchAutoscaler](/docs/v2025.3.24/guides/elasticsearch/concepts/autoscaler/)
  - [ElasticsearchOpsRequest](/docs/v2025.3.24/guides/elasticsearch/concepts/elasticsearch-ops-request/)
  - [Compute Resource Autoscaling Overview](/docs/v2025.3.24/guides/elasticsearch/autoscaler/compute/overview/)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.3.24/guides/elasticsearch/autoscaler/compute/combined/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2025.3.24/guides/elasticsearch/concepts/elasticsearch-ops-request/#spectimeout), [apply](/docs/v2025.3.24/guides/elasticsearch/concepts/elasticsearch-ops-request/#specapply).
