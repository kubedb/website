...
Read about the fields in details from [redis concept](/docs/v2025.3.24/guides/redis/concepts/redis),
...
<figure align="center">
<img alt="Deploy Redis with TLS/SSL" src="/docs/v2025.3.24/images/day-2-operation/redis/rd-tls.svg">
