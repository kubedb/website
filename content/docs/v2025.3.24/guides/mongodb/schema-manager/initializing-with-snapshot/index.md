...
- You should be familiar with the following concepts:
  ...
  - [MongoDBDatabase](/docs/v2025.3.24/guides/mongodb/concepts/mongodbdatabase)
  - [Schema Manager Overview](/docs/v2025.3.24/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2025.3.24/guides/mongodb/concepts/mongodbdatabase).
