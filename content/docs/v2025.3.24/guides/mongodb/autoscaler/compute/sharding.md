...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2025.3.24/guides/mongodb/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mongodb](/docs/v2025.3.24/examples/mongodb) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2025.3.24/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2025.3.24/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2025.3.24/guides/mongodb/concepts/opsrequest#specapply).
