...
url: /docs/v2025.3.24/guides/mongodb/
aliases:
- /docs/v2025.3.24/guides/mongodb/README/
info:
  autoscaler: v0.38.0
  cli: v0.53.0
  dashboard: v0.29.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.3.24/images/mongodb/quick-start.png">
</p>

## User Guide

- [Quickstart MongoDB](/docs/v2025.3.24/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
- [MongoDB Replicaset](/docs/v2025.3.24/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2025.3.24/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2025.3.24/guides/mongodb/backup/stash/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2025.3.24/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2025.3.24/guides/mongodb/configuration/using-config-file).
