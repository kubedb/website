...
Lets edit an existing running MongoDB object to setup [Scheduled Backup](/docs/0.9.0-rc.1/guides/mongodb/snapshot/scheduled-backup). The following command will open MongoDB `mongodb-demo` in editor.
