...
- [Quickstart Redis](/docs/0.9.0-rc.1/guides/redis/quickstart/quickstart) with KubeDB Operator.
...
- Use [kubedb cli](/docs/0.9.0-rc.1/guides/redis/cli/cli) to manage databases like kubectl for Kubernetes.
