...
KubeDB comes with its own cli. It is called `kubedb` cli. `kubedb` can be used to manage any KubeDB object. `kubedb` cli also performs various validations to improve ux. To install KubeDB cli on your workstation, follow the steps [here](/docs/0.9.0-rc.1/setup/install).
...
To learn about various options of `create` command, please visit [here](/docs/0.9.0-rc.1/reference/kubedb_create).
...
To learn about various options of `get` command, please visit [here](/docs/0.9.0-rc.1/reference/kubedb_get).
...
To learn about various options of `describe` command, please visit [here](/docs/0.9.0-rc.1/reference/kubedb_describe).
...
Lets edit an existing running Elasticsearch object to setup [Scheduled Backup](/docs/0.9.0-rc.1/guides/elasticsearch/snapshot/scheduled_backup). The following command will open Elasticsearch `elasticsearch-demo` in editor.
...
To learn about various options of `edit` command, please visit [here](/docs/0.9.0-rc.1/reference/kubedb_edit).
...
To learn about various options of `delete` command, please visit [here](/docs/0.9.0-rc.1/reference/kubedb_delete).
...
- Learn how to use KubeDB to run a Elasticsearch database [here](/docs/0.9.0-rc.1/guides/elasticsearch/README).
