...
Lets edit an existing running Postgres object to setup [Scheduled Backup](/docs/0.8.0-rc.0/backup). The following command will open Postgres `postgres-demo` in editor.
...
`kubed compare` command compares two summary reports for the same type of database. By default it dumps a git diff-like output on terminal. To learn about various options of `compare` command, please visit [here](/docs/0.8.0-rc.0/reference/kubedb_compare).
...
- Learn how to use KubeDB to run a PostgreSQL database [here](/docs/0.8.0-rc.0/guides/postgres/overview).
- Learn how to use KubeDB to run an Elasticsearch database [here](/docs/0.8.0-rc.0/guides/elasticsearch/overview).
