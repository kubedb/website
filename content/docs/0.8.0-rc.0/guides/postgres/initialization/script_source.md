...
Now lets connect to our Postgres `script-postgres`  using pgAdmin we have installed in [quickstart](/docs/0.8.0-rc.0/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
