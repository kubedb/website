...
`KubeDB` provides the flexibility of deploying MongoDB database from a private Docker registry. To learn how to deploym MongoDB from a private registry, please visit [here](/docs/0.8.0-rc.0/guides/mongodb/private-registry/using-private-registry).
...
- [Monitor MongoDB with builtin Prometheus](/docs/0.8.0-rc.0/guides/mongodb/monitoring/using-builtin-prometheus)
- [Monitor MongoDB with CoreOS Prometheus operator](/docs/0.8.0-rc.0/guides/mongodb/monitoring/using-coreos-prometheus-operator)
...
- Learn how to use KubeDB to run a MongoDB database [here](/docs/0.8.0-rc.0/guides/mongodb/README).
