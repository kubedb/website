...
menu:
  docs_v2022.10.12-rc.0:
    ...
    weight: 10
menu_name: docs_v2022.10.12-rc.0s
...
PgBouncerVersions are KubeDB crds that define the docker images KubeDB will use when deploying a pgbouncer server. For more details about PgBouncerVersion crd, please visit [here](/docs/v2022.10.12-rc.0/guides/pgbouncer/concepts/catalog).
