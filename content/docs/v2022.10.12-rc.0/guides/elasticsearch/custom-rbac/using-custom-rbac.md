...
If you would like to uninstall the KubeDB operator, please follow the steps [here](/docs/v2022.10.12-rc.0/setup/README).

## Next Steps

- [Quickstart Elasticsearch](/docs/v2022.10.12-rc.0/guides/elasticsearch/quickstart/overview/) with KubeDB Operator.
- [Backup & Restore](/docs/v2022.10.12-rc.0/guides/elasticsearch/backup/overview/) Elasticsearch instances using Stash.
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2022.10.12-rc.0/guides/elasticsearch/monitoring/using-prometheus-operator).
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2022.10.12-rc.0/guides/elasticsearch/monitoring/using-builtin-prometheus).
