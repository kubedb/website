...
`spec.version` is a `required` field that specifies the name of the [ElasticsearchVersion](/docs/v2022.10.12-rc.0/guides/elasticsearch/concepts/catalog/) CRD where the docker images are specified.
...
`spec.init` is an `optional` section that can be used to initialize a newly created Elasticsearch cluster from prior snapshots, taken by [Stash](/docs/v2022.10.12-rc.0/guides/elasticsearch/backup/overview/).
...
For detailed tutorial on how to initialize Elasticsearch from Stash backup, please visit [here](/docs/v2022.10.12-rc.0/guides/elasticsearch/backup/overview/).
...
- [Monitor Elasticsearch with builtin Prometheus](/docs/v2022.10.12-rc.0/guides/elasticsearch/monitoring/using-builtin-prometheus)
- [Monitor Elasticsearch with Prometheus operator](/docs/v2022.10.12-rc.0/guides/elasticsearch/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to run an Elasticsearch database [here](/docs/v2022.10.12-rc.0/guides/elasticsearch/README).
