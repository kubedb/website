...
- [AppBinding](/docs/v2022.10.12-rc.0/guides/redis/concepts/appbinding)
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.10.12-rc.0/guides/redis/backup/standalone/images/sample-redis-backup.png">
