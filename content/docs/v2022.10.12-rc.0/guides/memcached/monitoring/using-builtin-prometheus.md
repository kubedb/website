...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2022.10.12-rc.0/guides/memcached/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2022.10.12-rc.0/images/memcached/monitoring/mc-builtin-prom-target.png" style="padding:10px">
</p>
