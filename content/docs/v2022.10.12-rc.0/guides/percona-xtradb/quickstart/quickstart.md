...
- Initialize [PerconaXtraDB with Script](/docs/v2022.10.12-rc.0/guides/percona-xtradb/initialization/using-script).
...
- How to use [custom rbac resource](/docs/v2022.10.12-rc.0/guides/percona-xtradb/custom-rbac/using-custom-rbac) for PerconaXtraDB.
