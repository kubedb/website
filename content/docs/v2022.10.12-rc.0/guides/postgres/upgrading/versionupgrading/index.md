...
- Install `KubeDB` provisioner and enterprise operator in your cluster following the steps [here](/docs/v2022.10.12-rc.0/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [Postgres](/docs/v2022.10.12-rc.0/guides/postgres/concepts/postgres)
  - [PostgresOpsRequest](/docs/v2022.10.12-rc.0/guides/postgres/concepts/opsrequest)
  - [Upgrading Overview](/docs/v2022.10.12-rc.0/guides/postgres/upgrading/overview/)
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/postgres/upgrading/versionupgrading/yamls](/docs/v2022.10.12-rc.0/guides/postgres/upgrading/versionupgrading/yamls) directory of [kubedb/docs](https://github.com/kube/docs) repository.
