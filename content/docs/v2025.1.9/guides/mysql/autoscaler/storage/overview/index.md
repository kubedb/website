...
- You should be familiar with the following `KubeDB` concepts:
  - [MySQL](/docs/v2025.1.9/guides/mysql/concepts/mysqldatabase)
  - [MySQLAutoscaler](/docs/v2025.1.9/guides/mysql/concepts/autoscaler)
...
<figure align="center">
  <img alt="Storage Autoscaling process of MySQL" src="/docs/v2025.1.9/guides/mysql/autoscaler/storage/overview/images/storage-autoscaling.jpg">
