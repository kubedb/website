...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2025.1.9/guides/kafka/clustering/topology-cluster/)
    - [KafkaOpsRequest](/docs/v2025.1.9/guides/kafka/concepts/kafkaopsrequest)
    - [Vertical Scaling Overview](/docs/v2025.1.9/guides/kafka/scaling/vertical-scaling/overview)
