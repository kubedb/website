...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Compute Resource Autoscaling Overview](/docs/v2025.1.9/guides/solr/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.1.9/examples/solr/autoscaler) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2025.1.9/guides/solr/concepts/solropsrequests#spectimeout), [apply](/docs/v2025.1.9/guides/solr/concepts/solropsrequests#specapply).
