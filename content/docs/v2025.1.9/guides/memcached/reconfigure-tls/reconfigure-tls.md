...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.1.9/guides/memcached/concepts/memcached#spectls).
...
- Detail concepts of [Memcached](/docs/v2025.1.9/guides/memcached/concepts/memcached).
