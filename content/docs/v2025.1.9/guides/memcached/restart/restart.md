...
- The meaning of `spec.timeout` & `spec.apply` fields can be found [here](/docs/v2025.1.9/guides/memcached/concepts/memcached-opsrequest)
...
- Monitor your Memcached database with KubeDB using [Built-in Prometheus](/docs/v2025.1.9/guides/memcached/monitoring/using-builtin-prometheus).
- Monitor your Memcached database with KubeDB using [Prometheus Operator](/docs/v2025.1.9/guides/memcached/monitoring/using-prometheus-operator).
