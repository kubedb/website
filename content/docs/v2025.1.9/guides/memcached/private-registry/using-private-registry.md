...
- Read [concept of Memcached Version Catalog](/docs/v2025.1.9/guides/memcached/concepts/memcached-version) to learn detail concepts of `MemcachedVersion` object.
