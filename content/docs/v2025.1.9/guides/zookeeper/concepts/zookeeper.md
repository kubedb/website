...
`spec.version` is a required field specifying the name of the [ZooKeeperVersion](/docs/v2025.1.9/guides/zookeeper/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `ZooKeeperVersion` crds,
...
- Learn how to use KubeDB to run a ZooKeeper server [here](/docs/v2025.1.9/guides/zookeeper/README).
