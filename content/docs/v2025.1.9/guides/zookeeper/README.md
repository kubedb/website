...
url: /docs/v2025.1.9/guides/zookeeper/
aliases:
- /docs/v2025.1.9/guides/zookeeper/README/
info:
  autoscaler: v0.36.0
  cli: v0.51.0
  dashboard: v0.27.0
...
- [Quickstart ZooKeeper](/docs/v2025.1.9/guides/zookeeper/quickstart/quickstart) with KubeDB Operator.
- Detail Concept of [ZooKeeper Object](/docs/v2025.1.9/guides/zookeeper/concepts/zookeeper).
