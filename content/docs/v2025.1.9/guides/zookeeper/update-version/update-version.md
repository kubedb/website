...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2025.1.9/guides/zookeeper/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/zookeeper](/docs/v2025.1.9/examples/zookeeper) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
- Have a look [here](/docs/v2025.1.9/guides/zookeeper/concepts/opsrequest#spectimeout) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
