...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.1.9/guides/mssqlserver/monitoring/using-prometheus-operator).
