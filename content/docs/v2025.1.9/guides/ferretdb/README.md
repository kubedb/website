...
url: /docs/v2025.1.9/guides/ferretdb/
aliases:
- /docs/v2025.1.9/guides/ferretdb/README/
info:
  autoscaler: v0.36.0
  cli: v0.51.0
  dashboard: v0.27.0
...
- [Quickstart FerretDB](/docs/v2025.1.9/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
