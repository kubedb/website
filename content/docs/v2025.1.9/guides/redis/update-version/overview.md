...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [RedisSentinel](/docs/v2025.1.9/guides/redis/concepts/redissentinel)
...
<figure align="center">
  <img alt="Update Version Process of Redis" src="/docs/v2025.1.9/images/day-2-operation/redis/rd-updating.svg">
...
- Learn how to Update Version of [Redis Standalone](/docs/v2025.1.9/guides/redis/update-version/standalone)
- Learn how to Update Version of [Redis Cluster](/docs/v2025.1.9/guides/redis/update-version/cluster)
- Learn how to Update Version of [Redis Sentinel](/docs/v2025.1.9/guides/redis/update-version/sentinel)