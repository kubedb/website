...
- Read [mongodb hidden-node concept](/docs/v2025.1.9/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Hidden node.
...
- Deploy MongoDB shard [with Hidden-node](/docs/v2025.1.9/guides/mongodb/hidden-node/sharding).
