...
url: /docs/v2025.1.9/guides/pgbouncer/
aliases:
- /docs/v2025.1.9/guides/pgbouncer/README/
info:
  autoscaler: v0.36.0
  cli: v0.51.0
  dashboard: v0.27.0
...
- [Quickstart PgBouncer](/docs/v2025.1.9/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2025.1.9/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.1.9/guides/pgbouncer/monitoring/using-prometheus-operator).
