...
Read about the fields in details in [mongodb concept](/docs/v2023.01.17/guides/mongodb/concepts/mongodb),
...
Below is the YAML for MongoDB Sharding. Here, [`spec.sslMode`](/docs/v2023.01.17/guides/mongodb/concepts/mongodb#specsslMode) specifies `sslMode` for `sharding` and [`spec.clusterAuthMode`](/docs/v2023.01.17/guides/mongodb/concepts/mongodb#specclusterAuthMode) provides `clusterAuthMode` for sharding servers.
