...
- Install `KubeDB` Provisioner, Ops-manager and Autoscaler operator in your cluster following the steps [here](/docs/v2023.01.17/setup/README).

- Install `Metrics Server` from [here](https://github.com/kubernetes-sigs/metrics-server#installation)

- You should be familiar with the following `KubeDB` concepts:
  - [MongoDB](/docs/v2023.01.17/guides/mongodb/concepts/mongodb)
  - [MongoDBAutoscaler](/docs/v2023.01.17/guides/mongodb/concepts/autoscaler)
  - [MongoDBOpsRequest](/docs/v2023.01.17/guides/mongodb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2023.01.17/guides/mongodb/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2023.01.17/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2023.01.17/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2023.01.17/guides/mongodb/concepts/opsrequest#specapply).
