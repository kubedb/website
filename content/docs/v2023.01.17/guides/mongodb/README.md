...
url: /docs/v2023.01.17/guides/mongodb/
aliases:
- /docs/v2023.01.17/guides/mongodb/README/
info:
  autoscaler: v0.15.1
  cli: v0.30.1
  dashboard: v0.6.1
...
- [MongoDB Replicaset](/docs/v2023.01.17/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2023.01.17/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.01.17/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2023.01.17/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2023.01.17/guides/mongodb/configuration/using-config-file).
