...
- You should be familiar with the following concepts:
  ...
  - [MongoDBDatabase](/docs/v2023.01.17/guides/mongodb/concepts/mongodbdatabase)
  - [Schema Manager Overview](/docs/v2023.01.17/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2023.01.17/guides/mongodb/concepts/mongodbdatabase).
