...
When you install the KubeDB operator, it registers a CRD named [ElasticsearchVersion](/docs/v2023.01.17/guides/elasticsearch/concepts/catalog/). The installation process comes with a set of tested ElasticsearchVersion objects. Let's check available ElasticsearchVersions by following command,
