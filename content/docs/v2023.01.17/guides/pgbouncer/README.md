...
url: /docs/v2023.01.17/guides/pgbouncer/
aliases:
- /docs/v2023.01.17/guides/pgbouncer/README/
info:
  autoscaler: v0.15.1
  cli: v0.30.1
  dashboard: v0.6.1
...
- [Quickstart PgBouncer](/docs/v2023.01.17/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.01.17/guides/pgbouncer/monitoring/using-builtin-prometheus).
