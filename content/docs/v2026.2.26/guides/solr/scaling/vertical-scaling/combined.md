...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.2.26/guides/solr/scaling/vertical-scaling/overview)
...
- Different Solr Combined clustering modes [here](/docs/v2026.2.26/guides/solr/clustering/combined_cluster).
