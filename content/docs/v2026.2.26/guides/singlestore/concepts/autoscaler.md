...
`spec.databaseRef` is a required field that point to the [SingleStore](/docs/v2026.2.26/guides/singlestore/concepts/singlestore) object for which the autoscaling will be performed. This field consists of the following sub-field:
...
These are the options to pass in the internally created opsRequest CRO. `opsRequestOptions` has three fields. They have been described in details [here](/docs/v2026.2.26/guides/singlestore/concepts/opsrequest#specreadinesscriteria).
