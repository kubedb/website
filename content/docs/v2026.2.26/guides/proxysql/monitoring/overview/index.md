...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2026.2.26/guides/proxysql/monitoring/overview/images/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor `ProxySQL` server with KubeDB using [builtin-Prometheus](/docs/v2026.2.26/guides/proxysql/monitoring/builtin-prometheus) and using [Prometheus operator](/docs/v2026.2.26/guides/proxysql/monitoring/prometheus-operator).
- Learn how to monitor `ElasticSearch` database with KubeDB using [builtin-Prometheus](/docs/v2026.2.26/guides/elasticsearch/monitoring/using-builtin-prometheus) and using [Prometheus operator](/docs/v2026.2.26/guides/elasticsearch/monitoring/using-prometheus-operator).
