...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.2.26/setup/README).
...
- [Backup and Restore](/docs/v2026.2.26/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
