...
- Learn how to monitor ZooKeeper database with KubeDB using [builtin-Prometheus](/docs/v2026.2.26/guides/zookeeper/monitoring/using-builtin-prometheus)
- Learn how to monitor ZooKeeper database with KubeDB using [Prometheus operator](/docs/v2026.2.26/guides/zookeeper/monitoring/using-prometheus-operator).
