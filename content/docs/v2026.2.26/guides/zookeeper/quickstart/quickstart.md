...
- Now, install KubeDB cli on your workstation and KubeDB operator in your cluster following the steps [here](/docs/v2026.2.26/setup/README). Please set `global.featureGates.ZooKeeper=true`
