...
`spec.databaseRef` is a required field that point to the [Hazelcast](/docs/v2026.2.26/guides/hazelcast/concepts/hazelcast) object for which the autoscaling will be performed. This field consists of the following sub-field:
