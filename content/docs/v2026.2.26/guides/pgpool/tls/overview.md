...
- `spec:`
  ...
  - `tls:`
    ...
    - `certificates`
  - `cientAuthMode`
Read about the fields in details from [pgpool concept](/docs/v2026.2.26/guides/pgpool/concepts/pgpool),
...
<figure align="center">
<img alt="Deploy Pgpool with TLS/SSL" src="/docs/v2026.2.26/images/day-2-operation/pgpool/pp-tls.svg">
