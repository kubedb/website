...
- Monitor your Pgpool instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.26/guides/pgpool/monitoring/using-prometheus-operator).
- Monitor your Pgpool instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.2.26/guides/pgpool/monitoring/using-builtin-prometheus).
