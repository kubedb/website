...
url: /docs/v2026.2.26/guides/ferretdb/
aliases:
- /docs/v2026.2.26/guides/ferretdb/README/
info:
  autoscaler: v0.48.0
  cli: v0.63.0
  dashboard: v0.39.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.2.26/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2026.2.26/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
