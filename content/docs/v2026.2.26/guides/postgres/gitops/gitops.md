...
- Install `KubeDB` operator in your cluster following the steps [here](/docs/v2026.2.26/setup/README).  Pass `--set kubedb-crd-manager.installGitOpsCRDs=true` in the kubedb installation process to enable `GitOps` operator. 
...
To know more about this configuration file, check [here](/docs/v2026.2.26/guides/postgres/configuration/using-config-file)
```yaml
apiVersion: v1
stringData:
  user.conf: |
...
List postgres versions using `kubectl get postgresversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.2.26/guides/postgres/update-version/versionupgrading/).
...
- Learn Postgres [GitOps](/docs/v2026.2.26/guides/postgres/concepts/postgres-gitops)
- Learn Postgres Scaling 
  - [Horizontal Scaling](/docs/v2026.2.26/guides/postgres/scaling/horizontal-scaling/overview/)
  - [Vertical Scaling](/docs/v2026.2.26/guides/postgres/scaling/vertical-scaling/overview/)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.2.26/guides/postgres/update-version/versionupgrading/)
