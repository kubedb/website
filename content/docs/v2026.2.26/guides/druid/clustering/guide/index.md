...
- Read [druid topology cluster overview](/docs/v2026.2.26/guides/druid/clustering/overview/) to get a basic idea about the design and architecture of Druid.
...
- Detail concepts of [DruidDBVersion object](/docs/v2026.2.26/guides/druid/concepts/druidversion).
