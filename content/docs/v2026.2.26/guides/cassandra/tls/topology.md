...
Read about the fields in details in [cassandra concept](/docs/v2026.2.26/guides/cassandra/concepts/cassandra),
...
- Monitor your Cassandra cluster with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.2.26/guides/cassandra/monitoring/using-builtin-prometheus).
- Detail concepts of [Cassandra object](/docs/v2026.2.26/guides/cassandra/concepts/cassandra).
