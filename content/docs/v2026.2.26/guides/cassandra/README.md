...
url: /docs/v2026.2.26/guides/cassandra/
aliases:
- /docs/v2026.2.26/guides/cassandra/README/
info:
  autoscaler: v0.48.0
  cli: v0.63.0
  dashboard: v0.39.0
...
- [Quickstart Cassandra](/docs/v2026.2.26/guides/cassandra/quickstart/guide/quickstart) with KubeDB Operator.
