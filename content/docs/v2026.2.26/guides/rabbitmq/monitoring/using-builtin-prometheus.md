...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.2.26/guides/rabbitmq/monitoring/overview).
...
- Monitor your RabbitMQ database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.2.26/guides/rabbitmq/monitoring/using-prometheus-operator).
