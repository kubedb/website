...
url: /docs/v2026.2.26/guides/rabbitmq/
aliases:
- /docs/v2026.2.26/guides/rabbitmq/README/
info:
  autoscaler: v0.48.0
  cli: v0.63.0
  dashboard: v0.39.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.2.26/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
