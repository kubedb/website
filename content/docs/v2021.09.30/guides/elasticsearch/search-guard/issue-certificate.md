...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2021.09.30/guides/elasticsearch/search-guard/use-tls).
- Learn how to generate [search-guard configuration](/docs/v2021.09.30/guides/elasticsearch/search-guard/configuration).
