...
- Install `KubeDB` Community, Enterprise and Autoscaler operator in your cluster following the steps [here](/docs/v2021.09.30/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2021.09.30/guides/elasticsearch/autoscaler/compute/overview/)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2021.09.30/guides/elasticsearch/autoscaler/compute/topology/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
