...
KubeDB supports providing custom configuration for MySQL via [PodTemplate](/docs/v2021.09.30/guides/mysql/concepts/database/#specpodtemplate). This tutorial will show you how to use KubeDB to run a MySQL database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2021.09.30/guides/mysql/concepts/database/#specpodtemplate),

## CRD Configuration

Below is the YAML for the MySQL created in this example. Here, [`spec.podTemplate.spec.env`](/docs/v2021.09.30/guides/mysql/concepts/database/#specpodtemplatespecenv) specifies environment variables and [`spec.podTemplate.spec.args`](/docs/v2021.09.30/guides/mysql/concepts/database/#specpodtemplatespecargs) provides extra arguments for [MySQL Docker Image](https://hub.docker.com/_/mysql/).
...
![mysql_all_databases](/docs/v2021.09.30/guides/mysql/configuration/podtemplating/images/mysql-all-databases.png)

![mysql_charset](/docs/v2021.09.30/guides/mysql/configuration/podtemplating/images/mysql-charset.png)
