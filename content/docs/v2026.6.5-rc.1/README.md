...
url: /docs/v2026.6.5-rc.1/welcome/
aliases:
- /docs/v2026.6.5-rc.1/
- /docs/v2026.6.5-rc.1/README/
info:
...
- [Overview](/docs/v2026.6.5-rc.1/overview/). Overview explains what KubeDB does and how it does it.

- [Setup](/docs/v2026.6.5-rc.1/setup/). Setup contains instructions for installing the KubeDB in various cloud providers.
...
We're always looking for help improving our documentation, so please don't hesitate to [file an issue](https://github.com/kubedb/project/issues/new) if you see some problem. Or better yet, submit your own [contributions](/docs/v2026.6.5-rc.1/CONTRIBUTING) to help make our docs better.
