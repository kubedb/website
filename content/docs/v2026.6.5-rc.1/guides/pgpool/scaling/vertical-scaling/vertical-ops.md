...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.6.5-rc.1/guides/pgpool/scaling/vertical-scaling/overview)
...
- Have a look [here](/docs/v2026.6.5-rc.1/guides/pgpool/concepts/opsrequest) on the respective sections to understand the `timeout` & `apply` fields.
