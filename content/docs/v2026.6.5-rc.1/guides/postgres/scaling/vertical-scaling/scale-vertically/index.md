...
- Install `KubeDB-Provisioner` and `kubeDB-Ops-Manager` in your cluster following the steps [here](/docs/v2026.6.5-rc.1/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.6.5-rc.1/guides/postgres/scaling/vertical-scaling/overview/)
