...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2026.6.5-rc.1/guides/percona-xtradb/clustering/overview)
  - [PerconaXtraDBOpsRequest](/docs/v2026.6.5-rc.1/guides/percona-xtradb/concepts/opsrequest)
  - [updating Overview](/docs/v2026.6.5-rc.1/guides/percona-xtradb/update-version/overview)
