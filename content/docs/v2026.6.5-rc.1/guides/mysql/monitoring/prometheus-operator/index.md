...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.6.5-rc.1/guides/mysql/monitoring/overview/).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.6.5-rc.1/images/mysql/monitoring/mysql-coreos-prom-target.png" style="padding:10px">
</p>
