...
- Now, install `KubeDB` in your cluster following the steps [here](/docs/v2026.6.5-rc.1/setup/README).
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/qdrant/reconfigure-tls](/docs/v2026.6.5-rc.1/examples/qdrant/reconfigure-tls) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.timeout` specifies the timeout for the operation (learn more [here](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/opsrequest#spectimeout)).
- `spec.apply` specifies when to apply the operation (learn more [here](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/opsrequest#specapply)).
...
- Learn about [backup and restore](/docs/v2026.6.5-rc.1/guides/qdrant/backup/overview/) Qdrant using KubeStash.
- Detail concepts of [Qdrant object](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/qdrant).
