...
Read about the fields in detail from the [Qdrant Concepts](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/qdrant#spectls) page.
...
<figure align="center">
<img alt="Deploy Qdrant with TLS" src="/docs/v2026.6.5-rc.1/guides/qdrant/images/qdrant-tls.png">
