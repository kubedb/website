...
`spec.version` (required) specifies the name of the [QdrantVersion](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/catalog) CRD where the docker images are specified.
...
- `secretName` — the name of a Secret containing the custom `production.yaml` configuration file for Qdrant. See [Custom Configuration](/docs/v2026.6.5-rc.1/guides/qdrant/configuration/using-config-file) for details.
...
- Learn about [QdrantVersion CRD](/docs/v2026.6.5-rc.1/guides/qdrant/concepts/catalog).
