...
- If you are not familiar with how KubeStash backup and restore `Microsoft SQL Server` databases, please check the following guide [here](/docs/v2026.6.5-rc.1/guides/mssqlserver/backup/overview/).
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/mssqlserver/backup/application-level/examples](/docs/v2026.6.5-rc.1/guides/mssqlserver/backup/application-level/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
