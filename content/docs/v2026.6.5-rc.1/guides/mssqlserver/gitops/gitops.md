...
List Mssqlserver versions using `kubectl get msversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.6.5-rc.1/guides/mssqlserver/update-version/overview).
...
- Learn Mssqlserver Scaling
    - [Horizontal Scaling](/docs/v2026.6.5-rc.1/guides/mssqlserver/scaling/horizontal-scaling/overview)
    - [Vertical Scaling](/docs/v2026.6.5-rc.1/guides/mssqlserver/scaling/vertical-scaling/overview)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.6.5-rc.1/guides/mssqlserver/update-version/overview)
- Monitor your MSSQLServer database with KubeDB using [built-in Prometheus](/docs/v2026.6.5-rc.1/guides/mssqlserver/monitoring/using-prometheus-operator).
