...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.6.5-rc.1/setup/README).
...
- [Backup and Restore](/docs/v2026.6.5-rc.1/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
