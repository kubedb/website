...
url: /docs/v2026.6.5-rc.1/guides/rabbitmq/
aliases:
- /docs/v2026.6.5-rc.1/guides/rabbitmq/README/
info:
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.6.5-rc.1/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
