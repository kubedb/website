...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.6.5-rc.1/guides/rabbitmq/monitoring/overview).
...
- Monitor your RabbitMQ database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.6.5-rc.1/guides/rabbitmq/monitoring/using-prometheus-operator).
