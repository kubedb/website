...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/v2026.6.5-rc.1/guides/redis/backup/kubestash/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="Redis Backup Overview" src="/docs/v2026.6.5-rc.1/guides/redis/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.6.5-rc.1/guides/redis/backup/kubestash/overview/images/restore_overview.svg">
...
- Backup a `Redis` database using KubeStash by the following guides from [here](/docs/v2026.6.5-rc.1/guides/redis/backup/kubestash/logical/).