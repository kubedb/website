...
- Read [redis sentinel concept](/docs/v2026.6.5-rc.1/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2026.6.5-rc.1/guides/redis/sentinel/replacesentinel/overview)
