...
- Install the KubeDB CLI on your workstation and the KubeDB operator in your cluster by following the steps [here](/docs/v2026.6.5-rc.1/setup/README).
...
- Learn about [backup and restore](/docs/v2026.6.5-rc.1/guides/redis/backup/kubestash/overview/) Redis databases using KubeStash.
- Explore initializing a [Redis database with scripts](/docs/v2026.6.5-rc.1/guides/redis/initialization/using-script).
- Understand the detailed concepts of the [Redis object](/docs/v2026.6.5-rc.1/guides/redis/concepts/redis).
- Want to contribute to KubeDB? Check our [contribution guidelines](/docs/v2026.6.5-rc.1/CONTRIBUTING).