...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2026.6.5-rc.1/guides/solr/clustering/topology_cluster)
    - [SolrOpsRequest](/docs/v2026.6.5-rc.1/guides/solr/concepts/solropsrequests)
    - [Horizontal Scaling Overview](/docs/v2026.6.5-rc.1/guides/solr/scaling/horizontal-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/solr](/docs/v2026.6.5-rc.1/examples/solr) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
