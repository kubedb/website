...
`metadata.name` is a required field that specifies the name of the `SolrVersion` crd. You have to specify this name in `spec.version` field of [Solr](/docs/v2026.6.5-rc.1/guides/solr/concepts/solr) crd.
...
- Learn about Solr crd [here](/docs/v2026.6.5-rc.1/guides/solr/concepts/solr).
- Deploy your first Solr server with KubeDB by following the guide [here](/docs/v2026.6.5-rc.1/guides/solr/quickstart/overview/).
