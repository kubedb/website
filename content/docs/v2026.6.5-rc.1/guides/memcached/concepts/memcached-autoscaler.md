...
These are the options to pass in the internally created opsRequest CRO. opsRequestOptions has three fields. They have been described in details [here](/docs/v2026.6.5-rc.1/guides/memcached/concepts/memcached-opsrequest).
...
- Deploy your first Memcached database with Memcached by following the guide [here](/docs/v2026.6.5-rc.1/guides/memcached/quickstart/quickstart).