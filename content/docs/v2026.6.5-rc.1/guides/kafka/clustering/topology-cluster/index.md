...
For this demo, we are going to provision kafka version `3.9.0` with 3 controllers and 3 brokers. To learn more about Kafka CR, visit [here](/docs/v2026.6.5-rc.1/guides/kafka/concepts/kafka). visit [here](/docs/v2026.6.5-rc.1/guides/kafka/concepts/kafkaversion) to learn more about KafkaVersion CR.
