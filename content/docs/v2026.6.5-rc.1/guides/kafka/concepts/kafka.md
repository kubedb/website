...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2026.6.5-rc.1/guides/kafka/concepts/kafkaversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- [Monitor Apache Kafka with Prometheus operator](/docs/v2026.6.5-rc.1/guides/kafka/monitoring/using-prometheus-operator)
- [Monitor Apache Kafka with Built-in Prometheus](/docs/v2026.6.5-rc.1/guides/kafka/monitoring/using-builtin-prometheus)
...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2026.6.5-rc.1/guides/kafka/README).
- Deploy [dedicated topology cluster](/docs/v2026.6.5-rc.1/guides/kafka/clustering/topology-cluster/) for Apache Kafka
- Deploy [combined cluster](/docs/v2026.6.5-rc.1/guides/kafka/clustering/combined-cluster/) for Apache Kafka
- Monitor your Kafka cluster with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.6.5-rc.1/guides/kafka/monitoring/using-prometheus-operator).
- Detail concepts of [KafkaVersion object](/docs/v2026.6.5-rc.1/guides/kafka/concepts/kafkaversion).
- Learn to use KubeDB managed Kafka objects using [CLIs](/docs/v2026.6.5-rc.1/guides/kafka/cli/cli).
