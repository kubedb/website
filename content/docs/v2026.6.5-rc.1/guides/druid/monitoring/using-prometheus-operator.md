...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.6.5-rc.1/guides/druid/monitoring/images/druid-prometheus.png" style="padding:10px">
</p>
...
- Deploy [dedicated  cluster](/docs/v2026.6.5-rc.1/guides/druid/clustering/overview/) for Apache Druid
