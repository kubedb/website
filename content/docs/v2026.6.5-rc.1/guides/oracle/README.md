...
url: /docs/v2026.6.5-rc.1/guides/oracle/
aliases:
- /docs/v2026.6.5-rc.1/guides/oracle/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.5-rc.1/images/oracle/oracle_lifecycle.png">
</p>

## User Guide

- [Quickstart Oracle](/docs/v2026.6.5-rc.1/guides/oracle/quickstart/guide) with KubeDB Operator.
