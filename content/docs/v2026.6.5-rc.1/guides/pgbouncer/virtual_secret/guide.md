...
Luckily PostgreSQL is readily available in KubeDB as crd and can easily be deployed using this guide [here](/docs/v2026.6.5-rc.1/guides/postgres/virtual_secret/guide).
