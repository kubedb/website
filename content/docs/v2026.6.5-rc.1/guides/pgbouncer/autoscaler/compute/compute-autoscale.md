...
- You should be familiar with the following `KubeDB` concepts:
  - [PgBouncer](/docs/v2026.6.5-rc.1/guides/pgbouncer/concepts/pgbouncer)
  - [PgBouncerAutoscaler](/docs/v2026.6.5-rc.1/guides/pgbouncer/concepts/autoscaler)
  - [PgBouncerOpsRequest](/docs/v2026.6.5-rc.1/guides/pgbouncer/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.6.5-rc.1/guides/pgbouncer/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/pgbouncer](/docs/v2026.6.5-rc.1/examples/pgbouncer) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.6.5-rc.1/guides/pgbouncer/concepts/opsrequest#spectimeout), [apply](/docs/v2026.6.5-rc.1/guides/pgbouncer/concepts/opsrequest#specapply).
