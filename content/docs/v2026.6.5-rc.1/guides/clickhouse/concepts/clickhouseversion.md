...
`metadata.name` is a required field that specifies the name of the `ClickHouseVersion` CR. You have to specify this name in `spec.version` field of [ClickHouse](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouse) CR.
...
- Learn about ClickHouse CRD [here](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouse).
