...
- You should be familiar with the following `KubeDB` concepts:
    - [ClickHouse](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouse)
    - [ClickHouseAutoscaler](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouseautoscaler)
    - [ClickHouseOpsRequest](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouseopsrequest)
    - [Compute Resource Autoscaling Overview](/docs/v2026.6.5-rc.1/guides/clickhouse/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/clickhouse](/docs/v2026.6.5-rc.1/examples/clickhouse) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouseopsrequest#spectimeout), [apply](/docs/v2026.6.5-rc.1/guides/clickhouse/concepts/clickhouseopsrequest#specapply).
