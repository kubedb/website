...
Read about the fields in details from [proxysql concept](/docs/v2026.6.5-rc.1/guides/proxysql/concepts/proxysql/index.md/#spectls),
...
<figure align="center">
  <img alt="ProxySQL TLS" src="/docs/v2026.6.5-rc.1/guides/proxysql/tls/overview/images/proxy-tls-ssl.png">
