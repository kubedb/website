...
> 🆕 New to KubeDB? Start with the [quickstart guide](/docs/v2026.6.5-rc.1/README) before continuing here.
...
See also: [Neo4j](/docs/v2026.6.5-rc.1/guides/neo4j/concepts/neo4j) · [Neo4jOpsRequest](/docs/v2026.6.5-rc.1/guides/neo4j/concepts/opsrequest) · [Vertical Scaling Overview](/docs/v2026.6.5-rc.1/guides/neo4j/scaling/vertical-scaling/overview)
...
If this OpsRequest does not finish, first inspect the affected pod and then check the `kubedb-ops-manager` operator logs for the exact error. For a shared checklist, see the [Neo4j Ops Request Overview](/docs/v2026.6.5-rc.1/guides/neo4j/concepts/opsrequest#troubleshooting).
...
- [Neo4j Horizontal Scaling](/docs/v2026.6.5-rc.1/guides/neo4j/scaling/horizontal-scaling/) — add or remove cluster members
- [Neo4j Version Upgrade](/docs/v2026.6.5-rc.1/guides/neo4j/update-version/) — roll to a newer Neo4j release
- [Neo4j Volume Expansion](/docs/v2026.6.5-rc.1/guides/neo4j/volume-expansion/) — increase persistent storage