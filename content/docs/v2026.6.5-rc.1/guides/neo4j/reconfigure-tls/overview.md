...
<figure align="center">
  <img alt="Reconfiguring TLS process of Neo4j" src="/docs/v2026.6.5-rc.1/images/neo4j/reconfigureTLS.png">
...
- Follow: [Reconfigure TLS in Neo4j](/docs/v2026.6.5-rc.1/guides/neo4j/reconfigure-tls/reconfigure-tls).
