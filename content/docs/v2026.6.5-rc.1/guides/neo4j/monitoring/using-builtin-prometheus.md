...
> Prerequisites: A running Kubernetes cluster with KubeDB installed. See the [quickstart guide](/docs/v2026.6.5-rc.1/guides/neo4j/quickstart/quickstart) if you need to set up your environment.

- If you are not familiar with how to configure Prometheus to scrape metrics from various Kubernetes resources, please read the tutorial from [here](https://github.com/appscode/third-party-tools/tree/master/monitoring/prometheus/builtin).

- To learn how Prometheus monitoring works with KubeDB in general, please visit the [monitoring overview](/docs/v2026.6.5-rc.1/guides/neo4j/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.6.5-rc.1/images/neo4j/prometheus-builtin.png" style="padding:10px">
</p>
...
## Next Steps
- Monitor your Neo4j database with KubeDB using [`Prometheus operator`](/docs/v2026.6.5-rc.1/guides/neo4j/monitoring/using-prometheus-operator).
- Use [private Docker registry](/docs/v2026.6.5-rc.1/guides/neo4j/private-registry/using-private-registry) to deploy Neo4j with KubeDB.
