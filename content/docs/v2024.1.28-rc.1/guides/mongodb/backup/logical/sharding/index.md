...
KubeDB creates an [AppBinding](/docs/v2024.1.28-rc.1/guides/mongodb/concepts/appbinding) crd that holds the necessary information to connect with the database.
