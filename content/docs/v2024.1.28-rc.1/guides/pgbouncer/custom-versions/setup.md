...
menu:
  docs_v2024.1.28-rc.1:
    ...
    weight: 10
menu_name: docs_v2024.1.28-rc.1s
...
PgBouncerVersions are KubeDB crds that define the docker images KubeDB will use when deploying a pgbouncer server. For more details about PgBouncerVersion crd, please visit [here](/docs/v2024.1.28-rc.1/guides/pgbouncer/concepts/catalog).
