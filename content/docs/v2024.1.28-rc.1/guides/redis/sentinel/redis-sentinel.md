...
- Read [redis sentinel concept](/docs/v2024.1.28-rc.1/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2024.1.28-rc.1/guides/redis/sentinel/replacesentinel/overview)
- Monitor your Redis database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.1.28-rc.1/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.1.28-rc.1/guides/redis/monitoring/using-builtin-prometheus).
