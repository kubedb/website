...
![redis-sentinel](/docs/v2024.1.28-rc.1/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.1.28-rc.1/guides/redis/sentinel/redis-sentinel) using KubeDB.
