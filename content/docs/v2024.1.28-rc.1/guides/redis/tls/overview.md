...
Read about the fields in details from [redis concept](/docs/v2024.1.28-rc.1/guides/redis/concepts/redis),
...
<figure align="center">
<img alt="Deploy Redis with TLS/SSL" src="/docs/v2024.1.28-rc.1/images/day-2-operation/redis/rd-tls.svg">
