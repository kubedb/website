...
![MariaDB Cluster](/docs/v2024.1.28-rc.1/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2024.1.28-rc.1/guides/mariadb/clustering/galera-cluster) using KubeDB.
