...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2024.1.28-rc.1/guides/mysql/concepts/database/#spectls).
