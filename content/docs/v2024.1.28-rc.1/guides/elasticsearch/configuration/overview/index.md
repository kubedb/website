...
- Learn how to use custom configuration in combined cluster from [here](/docs/v2024.1.28-rc.1/guides/elasticsearch/configuration/combined-cluster/).
- Learn how to use custom configuration in topology cluster from [here](/docs/v2024.1.28-rc.1/guides/elasticsearch/configuration/topology-cluster/).
