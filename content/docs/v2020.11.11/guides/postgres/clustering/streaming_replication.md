...
Now connect to this *primary* server Pod `ha-postgres-0` using pgAdmin installed in [quickstart](/docs/v2020.11.11/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
...
<p align="center">
  <kbd>
    <img alt="recovered-postgres"  src="/docs/v2020.11.11/images/postgres/ha-postgres.gif">
  </kbd>
</p>
...
Now connect to one of our *hot standby* servers Pod `hot-postgres-2` using pgAdmin installed in [quickstart](/docs/v2020.11.11/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
...
- Setup [Continuous Archiving](/docs/v2020.11.11/guides/postgres/backup/wal/continuous_archiving) in PostgreSQL using `wal-g`
