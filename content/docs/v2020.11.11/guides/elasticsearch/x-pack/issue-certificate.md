...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2020.11.11/guides/elasticsearch/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2020.11.11/guides/elasticsearch/x-pack/configuration).
