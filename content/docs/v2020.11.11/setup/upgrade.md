...
If you are upgrading KubeDB to a patch release, please reapply the [installation instructions](/docs/v2020.11.11/setup/README). That will upgrade the operator pod to the new version and fix any RBAC issues.
