...
- Read [redis clustering concept](/docs/v2024.8.2-rc.2/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2024.8.2-rc.2/guides/redis/sentinel/overview)
