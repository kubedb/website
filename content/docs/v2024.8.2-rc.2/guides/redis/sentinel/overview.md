...
![redis-sentinel](/docs/v2024.8.2-rc.2/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.8.2-rc.2/guides/redis/sentinel/redis-sentinel) using KubeDB.
