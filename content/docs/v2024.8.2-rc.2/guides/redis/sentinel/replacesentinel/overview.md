...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2024.8.2-rc.2/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2024.8.2-rc.2/guides/redis/sentinel/replacesentinel/replace-sentinel)