...
- [AppBinding](/docs/v2024.8.2-rc.2/guides/redis/concepts/appbinding)
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2024.8.2-rc.2/guides/redis/backup/standalone/images/sample-redis-backup.png">
