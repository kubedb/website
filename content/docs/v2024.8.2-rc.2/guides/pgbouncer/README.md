...
url: /docs/v2024.8.2-rc.2/guides/pgbouncer/
aliases:
- /docs/v2024.8.2-rc.2/guides/pgbouncer/README/
info:
...
- [Quickstart PgBouncer](/docs/v2024.8.2-rc.2/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.8.2-rc.2/guides/pgbouncer/monitoring/using-builtin-prometheus).
