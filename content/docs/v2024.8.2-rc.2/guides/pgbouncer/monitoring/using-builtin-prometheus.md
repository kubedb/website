...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.8.2-rc.2/images/pgbouncer/monitoring/pb-builtin-prom-target.png" style="padding:10px">
</p>
...
## Next Steps
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2024.8.2-rc.2/guides/pgbouncer/monitoring/using-prometheus-operator).
