...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2024.8.2-rc.2/guides/percona-xtradb/clustering/overview)
  - [PerconaXtraDBOpsRequest](/docs/v2024.8.2-rc.2/guides/percona-xtradb/concepts/opsrequest)
  - [updating Overview](/docs/v2024.8.2-rc.2/guides/percona-xtradb/update-version/overview)
