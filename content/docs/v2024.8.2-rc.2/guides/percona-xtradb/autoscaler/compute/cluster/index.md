...
- You should be familiar with the following `KubeDB` concepts:
  - [PerconaXtraDB](/docs/v2024.8.2-rc.2/guides/percona-xtradb/concepts/perconaxtradb)
  - [PerconaXtraDBAutoscaler](/docs/v2024.8.2-rc.2/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2024.8.2-rc.2/guides/percona-xtradb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2024.8.2-rc.2/guides/percona-xtradb/autoscaler/compute/overview)
