...
`spec.databaseRef` is a required field that point to the [PerconaXtraDB](/docs/v2024.8.2-rc.2/guides/percona-xtradb/concepts/perconaxtradb) object for which the autoscaling will be performed. This field consists of the following sub-field:
