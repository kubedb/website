...
![MariaDB Cluster](/docs/v2024.8.2-rc.2/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2024.8.2-rc.2/guides/mariadb/clustering/galera-cluster) using KubeDB.
