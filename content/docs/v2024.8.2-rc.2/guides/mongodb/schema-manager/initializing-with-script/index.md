...
- You should be familiar with the following concepts:
  ...
  - [MongoDBDatabase](/docs/v2024.8.2-rc.2/guides/mongodb/concepts/mongodbdatabase)
  - [Schema Manager Overview](/docs/v2024.8.2-rc.2/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2024.8.2-rc.2/guides/mongodb/concepts/mongodbdatabase).
