...
<figure align="center">
  <img alt="MySQL Backup Overview" src="/docs/v2023.11.2/guides/mysql/backup/overview/images/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2023.11.2/guides/mysql/concepts/appbinding/) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2023.11.2/guides/mysql/backup/overview/images/restore_overview.svg">
...
- Backup a standalone MySQL server using Stash by following the guides from [here](/docs/v2023.11.2/guides/mysql/backup/standalone/).
