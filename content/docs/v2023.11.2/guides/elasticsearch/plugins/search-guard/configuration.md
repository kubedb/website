...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/v2023.11.2/images/elasticsearch/sg-flow.png">
  </kbd>
</p>
...
- Learn how to [use TLS certificates](/docs/v2023.11.2/guides/elasticsearch/plugins/search-guard/use-tls) to connect Elasticsearch.
