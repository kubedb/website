...
url: /docs/v2023.11.2/guides/pgbouncer/
aliases:
- /docs/v2023.11.2/guides/pgbouncer/README/
info:
  autoscaler: v0.22.0
  cli: v0.37.0
  dashboard: v0.13.0
...
- [Quickstart PgBouncer](/docs/v2023.11.2/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.11.2/guides/pgbouncer/monitoring/using-builtin-prometheus).
