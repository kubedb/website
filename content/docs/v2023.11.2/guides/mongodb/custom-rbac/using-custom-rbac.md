...
If you would like to uninstall the KubeDB operator, please follow the steps [here](/docs/v2023.11.2/setup/README).

## Next Steps

- [Quickstart MongoDB](/docs/v2023.11.2/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
- [Backup and Restore](/docs/v2023.11.2/guides/mongodb/backup/overview/) MongoDB instances using Stash.
- Initialize [MongoDB with Script](/docs/v2023.11.2/guides/mongodb/initialization/using-script).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2023.11.2/guides/mongodb/monitoring/using-prometheus-operator).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2023.11.2/guides/mongodb/monitoring/using-builtin-prometheus).
