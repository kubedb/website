...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Sharding](/docs/v2023.11.2/guides/mongodb/clustering/sharding)
  - [MongoDBOpsRequest](/docs/v2023.11.2/guides/mongodb/concepts/opsrequest)
  - [Updating Overview](/docs/v2023.11.2/guides/mongodb/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mongodb](/docs/v2023.11.2/examples/mongodb) directory of [kubedb/docs](https://github.com/kube/docs) repository.
