...
- You should be familiar with the following `KubeDB` concepts:
    - [ProxySQL](/docs/v2023.11.2/guides/proxysql/concepts/proxysql/)
    - [ProxySQL Cluster](/docs/v2023.11.2/guides/proxysql/clustering/proxysql-cluster/)
    - [ProxySQLOpsRequest](/docs/v2023.11.2/guides/proxysql/concepts/opsrequest/)`
    - [Horizontal Scaling Overview](/docs/v2023.11.2/guides/proxysql/scaling/horizontal-scaling/overview/)
