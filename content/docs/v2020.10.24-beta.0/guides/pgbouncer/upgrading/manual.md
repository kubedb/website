...
- Get started with PgBouncer using  [quickstart](/docs/v2020.10.24-beta.0/guides/pgbouncer/quickstart/quickstart).
- Learn about [custom PgBouncerVersions](/docs/v2020.10.24-beta.0/guides/pgbouncer/custom-versions/setup).
- Learn about [private registry](/docs/v2020.10.24-beta.0/guides/pgbouncer/private-registry/using-private-registry).
