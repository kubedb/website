...
- Read [mysql group replication concept](/docs/v2020.10.24-beta.0/guides/mysql/clustering/overview) to learn about MySQL Group Replication.
...
- You have to be familiar with the [ProxySQL](/docs/v2020.10.24-beta.0/guides/proxysql/concepts/proxysql) CRD.
