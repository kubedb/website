...
Read about the fields in details from [mysql concept](/docs/v2020.10.24-beta.0/guides/mysql/concepts/mysql#),
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2020.10.24-beta.0/images/day-2-operation/mysql/my-tls-ssl.png">
