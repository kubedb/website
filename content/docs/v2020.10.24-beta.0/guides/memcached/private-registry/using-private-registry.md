...
- Read [concept of Memcached Version Catalog](/docs/v2020.10.24-beta.0/guides/memcached/concepts/catalog) to learn detail concepts of `MemcachedVersion` object.
