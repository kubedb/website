...
`metadata.name` is a required field that specifies the name of the `ZooKeeperVersion` crd. You have to specify this name in `spec.version` field of [ZooKeeper](/docs/v2024.8.14-rc.3/guides/zookeeper/concepts/zookeeper) crd.
...
- Learn about ZooKeeper crd [here](/docs/v2024.8.14-rc.3/guides/zookeeper/concepts/zookeeper).
- Deploy your first ZooKeeper server with KubeDB by following the guide [here](/docs/v2024.8.14-rc.3/guides/zookeeper/quickstart/quickstart).
