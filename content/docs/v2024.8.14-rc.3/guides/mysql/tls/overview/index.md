...
Read about the fields in details from [mysql concept](/docs/v2024.8.14-rc.3/guides/mysql/concepts/database/#),
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2024.8.14-rc.3/guides/mysql/tls/overview/images/my-tls-ssl.png">
