...
If you would like to uninstall the KubeDB operator, please follow the steps [here](/docs/v2024.8.14-rc.3/setup/README).
...
- [Backup & Restore](/docs/v2024.8.14-rc.3/guides/elasticsearch/backup/overview/) Elasticsearch instances using Stash.
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.8.14-rc.3/guides/elasticsearch/monitoring/using-prometheus-operator).
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.8.14-rc.3/guides/elasticsearch/monitoring/using-builtin-prometheus).
