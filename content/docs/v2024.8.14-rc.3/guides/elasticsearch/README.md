...
url: /docs/v2024.8.14-rc.3/guides/elasticsearch/
aliases:
- /docs/v2024.8.14-rc.3/guides/elasticsearch/README/
info:
...
--->
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.8.14-rc.3/guides/elasticsearch/images/Lifecycle-of-an-Elasticsearch-CRD-complete.png">
</p>
...
> The listed ElasticsearchVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [ElasticsearchVersion](/docs/v2024.8.14-rc.3/guides/elasticsearch/concepts/catalog/) object with your custom Elasticsearch image.

## User Guide

- [Quickstart Elasticsearch](/docs/v2024.8.14-rc.3/guides/elasticsearch/quickstart/overview/elasticsearch/) with KubeDB Operator.
- [Quickstart OpenSearch](/docs/v2024.8.14-rc.3/guides/elasticsearch/quickstart/overview/opensearch/) with KubeDB Operator.
- [Quickstart Kibana](/docs/v2024.8.14-rc.3/guides/elasticsearch/elasticsearch-dashboard/kibana/) with KubeDB Operator.
- [Quickstart OpenSearch-Dashboards](/docs/v2024.8.14-rc.3/guides/elasticsearch/elasticsearch-dashboard/opensearch-dashboards/) with KubeDB Operator.
- [Elasticsearch Clustering](/docs/v2024.8.14-rc.3/guides/elasticsearch/clustering/combined-cluster/) supported by KubeDB
- [Backup & Restore Elasticsearch](/docs/v2024.8.14-rc.3/guides/elasticsearch/backup/overview/) database using Stash.
...
- Use [kubedb cli](/docs/v2024.8.14-rc.3/guides/elasticsearch/cli/cli) to manage databases like kubectl for Kubernetes.
