...
url: /docs/v2024.8.14-rc.3/guides/mongodb/
aliases:
- /docs/v2024.8.14-rc.3/guides/mongodb/README/
info:
...
- [MongoDB Replicaset](/docs/v2024.8.14-rc.3/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2024.8.14-rc.3/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.8.14-rc.3/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2024.8.14-rc.3/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2024.8.14-rc.3/guides/mongodb/configuration/using-config-file).
