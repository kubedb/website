...
![MariaDB Cluster](/docs/v2024.8.14-rc.3/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2024.8.14-rc.3/guides/mariadb/clustering/galera-cluster) using KubeDB.
