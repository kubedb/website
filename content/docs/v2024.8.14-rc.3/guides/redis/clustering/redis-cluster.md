...
- Read [redis clustering concept](/docs/v2024.8.14-rc.3/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2024.8.14-rc.3/guides/redis/sentinel/overview)
