...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2024.8.14-rc.3/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2024.8.14-rc.3/guides/redis/sentinel/replacesentinel/replace-sentinel)