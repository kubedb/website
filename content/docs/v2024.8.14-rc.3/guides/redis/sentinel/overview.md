...
![redis-sentinel](/docs/v2024.8.14-rc.3/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.8.14-rc.3/guides/redis/sentinel/redis-sentinel) using KubeDB.
