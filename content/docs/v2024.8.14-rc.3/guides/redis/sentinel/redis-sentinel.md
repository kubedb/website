...
- Read [redis sentinel concept](/docs/v2024.8.14-rc.3/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2024.8.14-rc.3/guides/redis/sentinel/replacesentinel/overview)
