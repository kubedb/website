...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2024.8.14-rc.3/guides/kafka/quickstart/overview/kafka/).
- Learn how to use KubeDB to run a Apache Kafka Connect cluster [here](/docs/v2024.8.14-rc.3/guides/kafka/quickstart/overview/connectcluster/).
