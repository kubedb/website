...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2024.8.14-rc.3/guides/kafka/concepts/kafkaversion) CR where the docker images are specified. Currently, when you install KubeDB, it creates the following `KafkaVersion` resources,
...
- Learn how to use KubeDB to run a Apache Kafka Connect cluster [here](/docs/v2024.8.14-rc.3/guides/kafka/README).
- Monitor your ConnectCluster with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2024.8.14-rc.3/guides/kafka/monitoring/using-prometheus-operator).
