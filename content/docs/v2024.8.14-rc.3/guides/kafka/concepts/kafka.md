...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2024.8.14-rc.3/guides/kafka/concepts/kafkaversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- [Monitor Apache with Prometheus operator](/docs/v2024.8.14-rc.3/guides/kafka/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2024.8.14-rc.3/guides/kafka/README).
- Deploy [dedicated topology cluster](/docs/v2024.8.14-rc.3/guides/kafka/clustering/topology-cluster/) for Apache Kafka
- Deploy [combined cluster](/docs/v2024.8.14-rc.3/guides/kafka/clustering/combined-cluster/) for Apache Kafka
- Monitor your Kafka cluster with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2024.8.14-rc.3/guides/kafka/monitoring/using-prometheus-operator).
- Detail concepts of [KafkaVersion object](/docs/v2024.8.14-rc.3/guides/kafka/concepts/kafkaversion).
- Learn to use KubeDB managed Kafka objects using [CLIs](/docs/v2024.8.14-rc.3/guides/kafka/cli/cli).
