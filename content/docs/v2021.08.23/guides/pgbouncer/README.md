...
url: /docs/v2021.08.23/guides/pgbouncer/
aliases:
- /docs/v2021.08.23/guides/pgbouncer/README/
info:
  autoscaler: v0.5.0
  cli: v0.20.0
  community: v0.20.0
...
- [Quickstart PgBouncer](/docs/v2021.08.23/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.08.23/guides/pgbouncer/monitoring/using-builtin-prometheus).
