...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2021.08.23/setup/README).
- You have to be familiar with the [ProxySQL](/docs/v2021.08.23/guides/proxysql/concepts/proxysql) CRD.
