...
`.spec.version` is a required field specifying the name of the [ProxySQLVersion](/docs/v2021.08.23/guides/proxysql/concepts/catalog) CRD where the docker images are specified. Currently, when you install KubeDB, it creates the following `ProxySQLVersion` resources,
...
- [Monitor ProxySQL with builtin Prometheus](/docs/v2021.08.23/guides/proxysql/monitoring/using-builtin-prometheus)
- [Monitor ProxySQL with Prometheus operator](/docs/v2021.08.23/guides/proxysql/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to load balance MySQL Group Replication [here](/docs/v2021.08.23/guides/proxysql/quickstart/load-balance-mysql-group-replication).
