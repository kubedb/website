...
- Initialize [PerconaXtraDB with Script](/docs/v2021.08.23/guides/percona-xtradb/initialization/using-script).
...
- How to use [custom rbac resource](/docs/v2021.08.23/guides/percona-xtradb/custom-rbac/using-custom-rbac) for PerconaXtraDB.
