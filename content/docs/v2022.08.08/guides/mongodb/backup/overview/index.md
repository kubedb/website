...
<figure align="center">
  <img alt="KubeDB + Stash" src="/docs/v2022.08.08/images/kubedb_plus_stash.svg">
...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2022.08.08/guides/mongodb/concepts/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/docs/v2022.08.08/guides/mongodb/backup/overview/images/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Backup a standalone MongoDB databases using Stash following the guide from [here](/docs/v2022.08.08/guides/mongodb/backup/logical/standalone/).
- Backup a MongoDB Replicaset cluster using Stash following the guide from [here](/docs/v2022.08.08/guides/mongodb/backup/logical/replicaset/).
- Backup a sharded MongoDB cluster using Stash following the guide from [here](/docs/v2022.08.08/guides/mongodb/backup/logical/sharding/).
