...
- Read [mongodb arbiter concept](/docs/v2022.08.08/guides/mongodb/arbiter/concept) to get the concept about MongoDB Replica Set Arbiter.
...
- Deploy MongoDB shard [with Arbiter](/docs/v2022.08.08/guides/mongodb/arbiter/sharding).
