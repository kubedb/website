...
`spec.databaseRef` is a required field that point to the [MongoDB](/docs/v2022.08.08/guides/mongodb/concepts/mongodb) object for which the autoscaling will be performed. This field consists of the following sub-field:
