...
url: /docs/v2022.08.08/guides/percona-xtradb/
aliases:
- /docs/v2022.08.08/guides/percona-xtradb/README/
info:
  autoscaler: v0.13.0
  cli: v0.28.0
  dashboard: v0.4.0
...
- [Overview](/docs/v2022.08.08/guides/percona-xtradb/overview/overview) of PerconaXtraDB.
- [Quickstart PerconaXtraDB](/docs/v2022.08.08/guides/percona-xtradb/quickstart/quickstart) with KubeDB Operator.
