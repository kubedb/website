...
`spec.proxyRef` is a required field that point to the [ProxySQL](/docs/v2022.12.28/guides/proxysql/concepts/proxysql) object for which the autoscaling will be performed. This field consists of the following sub-field:
