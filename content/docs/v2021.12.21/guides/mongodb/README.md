...
url: /docs/v2021.12.21/guides/mongodb/
aliases:
- /docs/v2021.12.21/guides/mongodb/README/
info:
  autoscaler: v0.9.2
  cli: v0.24.0
  community: v0.24.2
...
- [MongoDB Replicaset](/docs/v2021.12.21/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2021.12.21/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2021.12.21/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2021.12.21/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2021.12.21/guides/mongodb/configuration/using-config-file).
