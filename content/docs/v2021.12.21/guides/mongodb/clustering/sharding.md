...
- Read [mongodb sharding concept](/docs/v2021.12.21/guides/mongodb/clustering/sharding_concept) to learn about MongoDB Sharding clustering.
...
When [TerminationPolicy](/docs/v2021.12.21/guides/mongodb/concepts/mongodb#specterminationpolicy) is set to halt, and you delete the mongodb object, the KubeDB operator will delete the StatefulSet and its pods but leaves the PVCs, secrets and database backup (snapshots) intact. Learn details of all `TerminationPolicy` [here](/docs/v2021.12.21/guides/mongodb/concepts/mongodb#specterminationpolicy).
...
- [Backup and Restore](/docs/v2021.12.21/guides/mongodb/backup/overview/) process of MongoDB databases using Stash.
...
- Detail concepts of [MongoDBVersion object](/docs/v2021.12.21/guides/mongodb/concepts/catalog).
