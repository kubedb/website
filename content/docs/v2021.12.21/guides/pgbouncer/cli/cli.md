...
Let's edit an existing running PgBouncer object to setup [Monitoring](/docs/v2021.12.21/guides/pgbouncer/monitoring/using-prometheus-operator). The following command will open PgBouncer `pgbouncer-demo` in editor.
...
- Learn how to use KubeDB to run a PgBouncer [here](/docs/v2021.12.21/guides/pgbouncer/README).
