...
- Install `KubeDB-Provisioner` and `kubeDP-Ops-Manager` in your cluster following the steps [here](/docs/v2021.12.21/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2021.12.21/guides/postgres/scaling/vertical-scaling/overview/)
