...
{{< notice type="warning" message="This is an KubeDB-ops-manager only feature. Please install [KubeDB ops manager](/docs/v2021.12.21/setup/install/enterprise) to try this feature." >}}
...
<figure align="center">
  <img alt="Postgres Upgrade Flow" src="/docs/v2021.12.21/guides/postgres/upgrading/overview/images/pg-upgrading.png">
