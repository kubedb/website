...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.2.6-rc.0/guides/mongodb/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2025.2.6-rc.0/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn how to configure [MongoDB Topology](/docs/v2025.2.6-rc.0/guides/mongodb/clustering/sharding).
