...
- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2025.2.6-rc.0/guides/singlestore/concepts/)
...
<figure align="center">
  <img alt="Reconfiguring process of SingleStore" src="/docs/v2025.2.6-rc.0/guides/singlestore/reconfigure/overview/images/sdb-reconfigure.svg">
