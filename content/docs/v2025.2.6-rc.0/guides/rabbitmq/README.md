...
url: /docs/v2025.2.6-rc.0/guides/rabbitmq/
aliases:
- /docs/v2025.2.6-rc.0/guides/rabbitmq/README/
info:
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.2.6-rc.0/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
