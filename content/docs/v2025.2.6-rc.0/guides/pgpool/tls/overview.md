...
- `spec:`
  ...
  - `tls:`
    ...
    - `certificates`
  - `cientAuthMode`
Read about the fields in details from [pgpool concept](/docs/v2025.2.6-rc.0/guides/pgpool/concepts/pgpool),
...
<figure align="center">
<img alt="Deploy Pgpool with TLS/SSL" src="/docs/v2025.2.6-rc.0/images/day-2-operation/pgpool/pp-tls.svg">
