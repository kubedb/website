...
![Druid Architecture](/docs/v2025.2.6-rc.0/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2025.2.6-rc.0/guides/druid/clustering/overview/) using KubeDB.
