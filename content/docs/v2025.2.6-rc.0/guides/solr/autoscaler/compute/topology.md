...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.2.6-rc.0/examples/solr/autoscaler/compute) of [kubedb/docs](https://github.com/kubedb/docs) repository.
