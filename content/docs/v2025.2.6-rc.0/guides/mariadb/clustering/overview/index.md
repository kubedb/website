...
![MariaDB Cluster](/docs/v2025.2.6-rc.0/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2025.2.6-rc.0/guides/mariadb/clustering/galera-cluster) using KubeDB.
