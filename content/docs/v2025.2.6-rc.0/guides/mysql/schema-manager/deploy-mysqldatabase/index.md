...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  ...
  - [Schema Manager Overview](/docs/v2025.2.6-rc.0/guides/mysql/schema-manager/overview/)
...
- Detail concepts of [MySQLDatabase object](/docs/v2025.2.6-rc.0/guides/mysql/concepts/mysqldatabase/).
