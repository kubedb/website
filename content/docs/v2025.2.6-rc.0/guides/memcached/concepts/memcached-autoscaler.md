...
These are the options to pass in the internally created opsRequest CRO. opsRequestOptions has three fields. They have been described in details [here](/docs/v2025.2.6-rc.0/guides/memcached/concepts/memcached-opsrequest).
...
- Deploy your first Memcached database with Memcached by following the guide [here](/docs/v2025.2.6-rc.0/guides/memcached/quickstart/quickstart).