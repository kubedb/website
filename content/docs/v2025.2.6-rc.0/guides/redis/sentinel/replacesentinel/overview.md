...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2025.2.6-rc.0/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2025.2.6-rc.0/guides/redis/sentinel/replacesentinel/replace-sentinel)