...
![redis-sentinel](/docs/v2025.2.6-rc.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2025.2.6-rc.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
