...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.2.6-rc.0/guides/elasticsearch/autoscaler/compute/combined/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#spectimeout), [apply](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#specapply).
