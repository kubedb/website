...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Storage Autoscaling Overview](/docs/v2025.2.6-rc.0/guides/elasticsearch/autoscaler/storage/overview/)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.2.6-rc.0/guides/elasticsearch/autoscaler/storage/combined/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
