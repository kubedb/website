...
`spec.databaseRef` is a `required` field that point to the [Elasticsearch](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/elasticsearch/) object for which the autoscaling will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Elasticsearch](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/elasticsearch/) object.
