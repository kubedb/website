...
### spec.version
`spec.version` is a `required` field that specifies the name of the [ElasticsearchVersion](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/catalog/) CRD where the docker images are specified.
...
`spec.init` is an `optional` section that can be used to initialize a newly created Elasticsearch cluster from prior snapshots, taken by [Stash](/docs/v2025.2.6-rc.0/guides/elasticsearch/backup/stash/overview/).
...
For detailed tutorial on how to initialize Elasticsearch from Stash backup, please visit [here](/docs/v2025.2.6-rc.0/guides/elasticsearch/backup/stash/overview/).
...
- [Monitor Elasticsearch with builtin Prometheus](/docs/v2025.2.6-rc.0/guides/elasticsearch/monitoring/using-builtin-prometheus)
- [Monitor Elasticsearch with Prometheus operator](/docs/v2025.2.6-rc.0/guides/elasticsearch/monitoring/using-prometheus-operator)
...
If a service account name is given, and there's an existing service account by that name, the KubeDB operator will use that existing service account. Since this service account is not managed by KubeDB, users are responsible for providing necessary access permissions manually. Follow the guide [here](/docs/v2025.2.6-rc.0/guides/elasticsearch/custom-rbac/using-custom-rbac) to grant necessary permissions in this scenario.
...
- Learn how to use KubeDB to run an Elasticsearch database [here](/docs/v2025.2.6-rc.0/guides/elasticsearch/README).
- Learn how to use ElasticsearchOpsRequest [here](/docs/v2025.2.6-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/).
