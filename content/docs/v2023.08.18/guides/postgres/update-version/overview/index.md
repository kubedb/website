...
{{< notice type="warning" message="This is an KubeDB-ops-manager only feature. Please install [KubeDB ops manager](/docs/v2023.08.18/setup/install/enterprise) to try this feature." >}}
...
<figure align="center">
  <img alt="Postgres update Flow" src="/docs/v2023.08.18/guides/postgres/update-version/overview/images/pg-updating.png">
