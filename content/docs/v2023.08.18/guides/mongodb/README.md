...
url: /docs/v2023.08.18/guides/mongodb/
aliases:
- /docs/v2023.08.18/guides/mongodb/README/
info:
  autoscaler: v0.20.0
  cli: v0.35.0
  dashboard: v0.11.0
...
- [MongoDB Replicaset](/docs/v2023.08.18/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2023.08.18/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.08.18/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2023.08.18/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2023.08.18/guides/mongodb/configuration/using-config-file).
