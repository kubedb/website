...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2023.08.18/guides/mongodb/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2023.08.18/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2023.08.18/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2023.08.18/guides/mongodb/concepts/opsrequest#specapply).
