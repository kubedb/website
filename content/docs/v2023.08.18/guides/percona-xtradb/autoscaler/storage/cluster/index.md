...
- You should be familiar with the following `KubeDB` concepts:
  - [PerconaXtraDB](/docs/v2023.08.18/guides/percona-xtradb/concepts/perconaxtradb)
  - [PerconaXtraDBAutoscaler](/docs/v2023.08.18/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2023.08.18/guides/percona-xtradb/concepts/opsrequest)
  - [Storage Autoscaling Overview](/docs/v2023.08.18/guides/percona-xtradb/autoscaler/storage/overview)
