...
url: /docs/v2024.12.18/guides/mysql/
aliases:
- /docs/v2024.12.18/guides/mysql/README/
info:
  autoscaler: v0.35.0
  cli: v0.50.0
  dashboard: v0.26.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.12.18/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2024.12.18/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.12.18/guides/mysql/backup/stash/overview/) MySQL databases using Stash.
