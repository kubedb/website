...
url: /docs/v2024.12.18/guides/memcached/
aliases:
- /docs/v2024.12.18/guides/memcached/README/
info:
  autoscaler: v0.35.0
  cli: v0.50.0
  dashboard: v0.26.0
...
- [Quickstart Memcached](/docs/v2024.12.18/guides/memcached/quickstart/quickstart) with KubeDB Operator.
...
- Use [kubedb cli](/docs/v2024.12.18/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
