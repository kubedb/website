...
![Druid Architecture](/docs/v2024.12.18/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2024.12.18/guides/druid/clustering/overview/) using KubeDB.
