...
url: /docs/v2024.12.18/guides/druid/
aliases:
- /docs/v2024.12.18/guides/druid/README/
info:
  autoscaler: v0.35.0
  cli: v0.50.0
  dashboard: v0.26.0
...
> The listed DruidVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [DruidVersion](/docs/v2024.12.18/guides/druid/concepts/druidversion) object with your custom Druid image.
...
- [Druid Clustering](/docs/v2024.12.18/guides/druid/clustering/overview/) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.12.18/guides/druid/backup/overview/) Druid databases using KubeStash.
- Start [Druid with Custom Config](/docs/v2024.12.18/guides/druid/configuration/_index).
...
- Monitor your Druid database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.12.18/guides/druid/monitoring/using-builtin-prometheus).
