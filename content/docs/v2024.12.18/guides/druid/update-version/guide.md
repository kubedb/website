...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/druid](/docs/v2024.12.18/examples/druid) directory of [kubedb/docs](https://github.com/kube/docs) repository.
