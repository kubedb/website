...
- Learn how to monitor FerretDB database with KubeDB using [builtin-Prometheus](/docs/v2024.12.18/guides/ferretdb/monitoring/using-builtin-prometheus)
- Learn how to monitor FerretDB database with KubeDB using [Prometheus operator](/docs/v2024.12.18/guides/ferretdb/monitoring/using-prometheus-operator).
