...
url: /docs/v2024.12.18/guides/ferretdb/
aliases:
- /docs/v2024.12.18/guides/ferretdb/README/
info:
  autoscaler: v0.35.0
  cli: v0.50.0
  dashboard: v0.26.0
...
- [Quickstart FerretDB](/docs/v2024.12.18/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
