...
`spec.databaseRef` is a `required` field that point to the [Solr](/docs/v2024.12.18/guides/solr/concepts/solr) object for which the autoscaling will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Solr](/docs/v2024.12.18/guides/solr/concepts/solr) object.
