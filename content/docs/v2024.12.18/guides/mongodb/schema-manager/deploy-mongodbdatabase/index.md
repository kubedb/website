...
- You should be familiar with the following concepts:
  ...
  - [MongoDBDatabase](/docs/v2024.12.18/guides/mongodb/concepts/mongodbdatabase)
  - [Schema Manager Overview](/docs/v2024.12.18/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2024.12.18/guides/mongodb/concepts/mongodbdatabase).
