...
`spec.databaseRef` is a required field that point to the [Kafka](/docs/v2024.12.18/guides/kafka/concepts/kafka) object for which the autoscaling will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Kafka](/docs/v2024.12.18/guides/kafka/concepts/kafka) object.
