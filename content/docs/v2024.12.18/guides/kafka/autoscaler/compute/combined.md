...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [KafkaAutoscaler](/docs/v2024.12.18/guides/kafka/concepts/kafkaautoscaler)
  - [KafkaOpsRequest](/docs/v2024.12.18/guides/kafka/concepts/kafkaopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2024.12.18/guides/kafka/autoscaler/compute/overview)
