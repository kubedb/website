...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2024.12.18/guides/kafka/clustering/topology-cluster/)
    - [KafkaOpsRequest](/docs/v2024.12.18/guides/kafka/concepts/kafkaopsrequest)
    - [Vertical Scaling Overview](/docs/v2024.12.18/guides/kafka/scaling/vertical-scaling/overview)
