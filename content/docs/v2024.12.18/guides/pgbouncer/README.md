...
url: /docs/v2024.12.18/guides/pgbouncer/
aliases:
- /docs/v2024.12.18/guides/pgbouncer/README/
info:
  autoscaler: v0.35.0
  cli: v0.50.0
  dashboard: v0.26.0
...
- [Quickstart PgBouncer](/docs/v2024.12.18/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.12.18/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2024.12.18/guides/pgbouncer/monitoring/using-prometheus-operator).
