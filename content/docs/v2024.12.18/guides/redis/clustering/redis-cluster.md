...
- Read [redis clustering concept](/docs/v2024.12.18/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2024.12.18/guides/redis/sentinel/overview)
