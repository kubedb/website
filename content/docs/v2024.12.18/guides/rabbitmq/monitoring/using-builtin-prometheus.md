...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2024.12.18/guides/rabbitmq/monitoring/overview).
...
- Monitor your RabbitMQ database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2024.12.18/guides/rabbitmq/monitoring/using-prometheus-operator).
