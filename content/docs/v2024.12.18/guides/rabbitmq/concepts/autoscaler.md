...
`spec.databaseRef` is a required field that point to the [RabbitMQ](/docs/v2024.12.18/guides/rabbitmq/concepts/rabbitmq) object for which the autoscaling will be performed. This field consists of the following sub-field:
