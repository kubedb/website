...
`metadata.name` is a required field that specifies the name of the `DruidVersion` CR. You have to specify this name in `spec.version` field of [Druid](/docs/v2025.2.19/guides/druid/concepts/druid) CR.
...
- Learn about Druid CRD [here](/docs/v2025.2.19/guides/druid/concepts/druid).
- Deploy your first Druid database with KubeDB by following the guide [here](/docs/v2025.2.19/guides/druid/quickstart/guide/).
