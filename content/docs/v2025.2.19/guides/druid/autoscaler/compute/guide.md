...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [DruidAutoscaler](/docs/v2025.2.19/guides/druid/concepts/druidautoscaler)
    - [DruidOpsRequest](/docs/v2025.2.19/guides/druid/concepts/druidopsrequest)
    - [Compute Resource Autoscaling Overview](/docs/v2025.2.19/guides/druid/autoscaler/compute/overview)
