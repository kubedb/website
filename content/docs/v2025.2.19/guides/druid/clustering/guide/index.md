...
- Read [druid topology cluster overview](/docs/v2025.2.19/guides/druid/clustering/overview/) to get a basic idea about the design and architecture of Druid.
...
- Detail concepts of [DruidDBVersion object](/docs/v2025.2.19/guides/druid/concepts/druidversion).
