...
<figure align="center">
  <img alt="Vertical scaling process of ZooKeeper" src="/docs/v2025.2.19/images/day-2-operation/zookeeper/zk-vertical-scaling.svg">
...
In the [next](/docs/v2025.2.19/guides/zookeeper/scaling/vertical-scaling/vertical-scaling) docs, we are going to show a step by step guide on updating resources of ZooKeeper database using `ZooKeeperOpsRequest` CRD.