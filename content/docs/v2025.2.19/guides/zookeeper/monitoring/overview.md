...
- Learn how to monitor ZooKeeper database with KubeDB using [builtin-Prometheus](/docs/v2025.2.19/guides/zookeeper/monitoring/using-builtin-prometheus)
- Learn how to monitor ZooKeeper database with KubeDB using [Prometheus operator](/docs/v2025.2.19/guides/zookeeper/monitoring/using-prometheus-operator).
