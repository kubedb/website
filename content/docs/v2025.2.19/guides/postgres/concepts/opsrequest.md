...
`spec.databaseRef` is a required field that point to the [Postgres](/docs/v2025.2.19/guides/postgres/concepts/postgres) object where the administrative operations will be applied. This field consists of the following sub-field:

- **spec.databaseRef.name :**  specifies the name of the [Postgres](/docs/v2025.2.19/guides/postgres/concepts/postgres) object.
...
- `spec.updateVersion.targetVersion` refers to a [PostgresVersion](/docs/v2025.2.19/guides/postgres/concepts/catalog) CR that contains the Postgres version information where you want to update.
