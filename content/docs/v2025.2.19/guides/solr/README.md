...
url: /docs/v2025.2.19/guides/solr/
aliases:
- /docs/v2025.2.19/guides/solr/README/
info:
  autoscaler: v0.37.0
  cli: v0.52.0
  dashboard: v0.28.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.2.19/guides/solr/quickstart/overview/images/Lifecycle-of-a-solr-instance.png">
</p>

## User Guide

- [Quickstart Solr](/docs/v2025.2.19/guides/solr/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Solr Object](/docs/v2025.2.19/guides/solr/concepts/solr).
