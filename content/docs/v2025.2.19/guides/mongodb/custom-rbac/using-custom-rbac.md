...
- [Backup and Restore](/docs/v2025.2.19/guides/mongodb/backup/stash/overview/) MongoDB instances using Stash.
- Initialize [MongoDB with Script](/docs/v2025.2.19/guides/mongodb/initialization/using-script).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.2.19/guides/mongodb/monitoring/using-prometheus-operator).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.2.19/guides/mongodb/monitoring/using-builtin-prometheus).
