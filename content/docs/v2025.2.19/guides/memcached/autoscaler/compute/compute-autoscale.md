...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MemcachedAutoscaler](/docs/v2025.2.19/guides/memcached/concepts/memcached-autoscaler)
  - [MemcachedOpsRequest](/docs/v2025.2.19/guides/memcached/concepts/memcached-opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2025.2.19/guides/memcached/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2025.2.19/guides/memcached/concepts/memcached-opsrequest#spectimeout), [apply](/docs/v2025.2.19/guides/memcached/concepts/memcached-opsrequest#specapply).
