...
url: /docs/v2025.2.19/guides/memcached/
aliases:
- /docs/v2025.2.19/guides/memcached/README/
info:
  autoscaler: v0.37.0
  cli: v0.52.0
  dashboard: v0.28.0
...
- Use [kubedb cli](/docs/v2025.2.19/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
