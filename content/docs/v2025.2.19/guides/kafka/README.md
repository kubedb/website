...
url: /docs/v2025.2.19/guides/kafka/
aliases:
- /docs/v2025.2.19/guides/kafka/README/
info:
  autoscaler: v0.37.0
  cli: v0.52.0
  dashboard: v0.28.0
...
> The listed KafkaVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [KafkaVersion](/docs/v2025.2.19/guides/kafka/concepts/kafkaversion) object with your custom Kafka image.
...
- Monitor your Kafka database with KubeDB using [out-of-the-box Prometheus and Grafana](/docs/v2025.2.19/guides/kafka/monitoring/using-prometheus-operator).
...
- Detail concepts of [Connector object](/docs/v2025.2.19/guides/kafka/concepts/connector).
- Detail concepts of [KafkaVersion object](/docs/v2025.2.19/guides/kafka/concepts/kafkaversion).
