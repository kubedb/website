...
`spec.proxyRef` is a required field that point to the [ProxySQL](/docs/v2025.2.19/guides/proxysql/concepts/proxysql) object for which the autoscaling will be performed. This field consists of the following sub-field:
