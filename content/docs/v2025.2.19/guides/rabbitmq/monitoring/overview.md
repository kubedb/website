...
- Learn how to monitor RabbitMQ database with KubeDB using [builtin-Prometheus](/docs/v2025.2.19/guides/rabbitmq/monitoring/using-builtin-prometheus)
- Learn how to monitor RabbitMQ database with KubeDB using [Prometheus operator](/docs/v2025.2.19/guides/rabbitmq/monitoring/using-prometheus-operator).
