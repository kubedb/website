...
- Monitor your RabbitMQ database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.2.19/guides/rabbitmq/monitoring/using-prometheus-operator).
