...
url: /docs/v2025.2.19/guides/rabbitmq/
aliases:
- /docs/v2025.2.19/guides/rabbitmq/README/
info:
  autoscaler: v0.37.0
  cli: v0.52.0
  dashboard: v0.28.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.2.19/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
