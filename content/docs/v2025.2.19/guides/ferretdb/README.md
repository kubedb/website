...
url: /docs/v2025.2.19/guides/ferretdb/
aliases:
- /docs/v2025.2.19/guides/ferretdb/README/
info:
  autoscaler: v0.37.0
  cli: v0.52.0
  dashboard: v0.28.0
...
- [Quickstart FerretDB](/docs/v2025.2.19/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
