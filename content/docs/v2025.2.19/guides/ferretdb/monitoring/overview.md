...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2025.2.19/images/concepts/monitoring/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor FerretDB database with KubeDB using [builtin-Prometheus](/docs/v2025.2.19/guides/ferretdb/monitoring/using-builtin-prometheus)
- Learn how to monitor FerretDB database with KubeDB using [Prometheus operator](/docs/v2025.2.19/guides/ferretdb/monitoring/using-prometheus-operator).
