...
- Read [redis sentinel concept](/docs/v2025.2.19/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2025.2.19/guides/redis/sentinel/replacesentinel/overview)
