...
- Learn how to use custom configuration in combined cluster from [here](/docs/v2023.11.29-rc.0/guides/elasticsearch/configuration/combined-cluster/).
- Learn how to use custom configuration in topology cluster from [here](/docs/v2023.11.29-rc.0/guides/elasticsearch/configuration/topology-cluster/).
