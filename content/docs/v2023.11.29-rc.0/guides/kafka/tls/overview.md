...
Read about the fields in details from [kafka concept](/docs/v2023.11.29-rc.0/guides/kafka/concepts/kafka),
...
<figure align="center">
<img alt="Deploy Kafka with TLS/SSL" src="/docs/v2023.11.29-rc.0/images/kafka/kf-tls.svg">
