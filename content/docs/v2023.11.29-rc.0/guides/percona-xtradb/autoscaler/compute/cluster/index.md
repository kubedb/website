...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDBAutoscaler](/docs/v2023.11.29-rc.0/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2023.11.29-rc.0/guides/percona-xtradb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2023.11.29-rc.0/guides/percona-xtradb/autoscaler/compute/overview)
