...
Let's edit an existing running Memcached object to setup [Monitoring](/docs/v2023.11.29-rc.0/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
