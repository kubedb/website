...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Redis Clustering](/docs/v2023.11.29-rc.0/guides/redis/clustering/redis-cluster)
  - [RedisOpsRequest](/docs/v2023.11.29-rc.0/guides/redis/concepts/redisopsrequest)
  - [updating Overview](/docs/v2023.11.29-rc.0/guides/redis/update-version/overview)
