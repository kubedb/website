...
- Read [redis clustering concept](/docs/v2023.11.29-rc.0/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2023.11.29-rc.0/guides/redis/sentinel/overview)
