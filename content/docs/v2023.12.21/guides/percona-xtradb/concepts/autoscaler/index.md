...
`spec.databaseRef` is a required field that point to the [PerconaXtraDB](/docs/v2023.12.21/guides/percona-xtradb/concepts/perconaxtradb) object for which the autoscaling will be performed. This field consists of the following sub-field:
