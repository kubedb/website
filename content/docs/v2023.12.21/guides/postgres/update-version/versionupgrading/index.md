...
- You should be familiar with the following `KubeDB` concepts:
  - [Postgres](/docs/v2023.12.21/guides/postgres/concepts/postgres)
  - [PostgresOpsRequest](/docs/v2023.12.21/guides/postgres/concepts/opsrequest)
  - [updating Overview](/docs/v2023.12.21/guides/postgres/update-version/overview/)
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/postgres/updating/versionupdating/yamls](/docs/v2023.12.21/guides/postgres/update-version/versionupgrading/yamls) directory of [kubedb/docs](https://github.com/kube/docs) repository.
