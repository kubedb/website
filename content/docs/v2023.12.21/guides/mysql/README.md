...
url: /docs/v2023.12.21/guides/mysql/
aliases:
- /docs/v2023.12.21/guides/mysql/README/
info:
  autoscaler: v0.24.0
  cli: v0.39.0
  dashboard: v0.15.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2023.12.21/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2023.12.21/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.12.21/guides/mysql/backup/overview/) MySQL databases using Stash.
