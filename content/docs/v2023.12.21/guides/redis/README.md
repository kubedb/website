...
url: /docs/v2023.12.21/guides/redis/
aliases:
- /docs/v2023.12.21/guides/redis/README/
info:
  autoscaler: v0.24.0
  cli: v0.39.0
  dashboard: v0.15.0
...
- [Deploy Redis Cluster](/docs/v2023.12.21/guides/redis/clustering/redis-cluster) using KubeDB.
