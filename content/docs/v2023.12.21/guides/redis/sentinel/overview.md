...
![redis-sentinel](/docs/v2023.12.21/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.12.21/guides/redis/sentinel/redis-sentinel) using KubeDB.
