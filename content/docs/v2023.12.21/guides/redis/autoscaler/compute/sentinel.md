...
- You should be familiar with the following `KubeDB` concepts:
  - [RedisSentinel](/docs/v2023.12.21/guides/redis/concepts/redissentinel)
  - [RedisAutoscaler](/docs/v2023.12.21/guides/redis/concepts/autoscaler)
  - [RedisOpsRequest](/docs/v2023.12.21/guides/redis/concepts/redisopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2023.12.21/guides/redis/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2023.12.21/guides/redis/concepts/redisopsrequest#spectimeout), [apply](/docs/v2023.12.21/guides/redis/concepts/redisopsrequest#specapply).
