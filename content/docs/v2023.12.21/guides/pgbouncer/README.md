...
url: /docs/v2023.12.21/guides/pgbouncer/
aliases:
- /docs/v2023.12.21/guides/pgbouncer/README/
info:
  autoscaler: v0.24.0
  cli: v0.39.0
  dashboard: v0.15.0
...
- [Quickstart PgBouncer](/docs/v2023.12.21/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.12.21/guides/pgbouncer/monitoring/using-builtin-prometheus).
