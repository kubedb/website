...
`spec.databaseRef` is a required field that point to the [ClickHouse](/docs/v2026.2.16-rc.0/guides/clickhouse/concepts/clickhouse) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [ClickHouse](/docs/v2026.2.16-rc.0/guides/clickhouse/concepts/clickhouse) object.
...
- `spec.updateVersion.targetVersion` refers to a [ClickHouseVersion](/docs/v2026.2.16-rc.0/guides/clickhouse/concepts/clickhouseversion) CR that contains the ClickHouse version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.2.16-rc.0/guides/clickhouse/concepts/clickhouse#spectls).
