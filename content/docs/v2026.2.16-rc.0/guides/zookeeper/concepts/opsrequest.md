...
`spec.databaseRef` is a required field that point to the [ZooKeeper](/docs/v2026.2.16-rc.0/guides/zookeeper/concepts/zookeeper) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [ZooKeeper](/docs/v2026.2.16-rc.0/guides/zookeeper/concepts/zookeeper) object.
...
- `spec.updateVersion.targetVersion` refers to a [ZooKeeperVersion](/docs/v2026.2.16-rc.0/guides/zookeeper/concepts/catalog) CR that contains the ZooKeeper version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.2.16-rc.0/guides/zookeeper/concepts/zookeeper#spectls).
