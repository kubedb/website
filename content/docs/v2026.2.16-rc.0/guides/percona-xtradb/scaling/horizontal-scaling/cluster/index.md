...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDB Cluster](/docs/v2026.2.16-rc.0/guides/percona-xtradb/clustering/galera-cluster/)
  - [PerconaXtraDBOpsRequest](/docs/v2026.2.16-rc.0/guides/percona-xtradb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2026.2.16-rc.0/guides/percona-xtradb/scaling/horizontal-scaling/overview/)
