...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2026.2.16-rc.0/guides/solr/clustering/combined_cluster)
    - [SolrOpsRequest](/docs/v2026.2.16-rc.0/guides/solr/concepts/solropsrequests)
    - [Horizontal Scaling Overview](/docs/v2026.2.16-rc.0/guides/solr/scaling/horizontal-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/solr](/docs/v2026.2.16-rc.0/examples/solr) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
