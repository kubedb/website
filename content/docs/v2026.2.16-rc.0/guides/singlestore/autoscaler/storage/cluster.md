...
- Install `KubeDB` Provisioner, Ops-manager and Autoscaler operator in your cluster following the steps [here](/docs/v2026.2.16-rc.0/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
    - [SingleStore](/docs/v2026.2.16-rc.0/guides/singlestore/concepts/singlestore)
    - [SingleStoreAutoscaler](/docs/v2026.2.16-rc.0/guides/singlestore/concepts/autoscaler)
    - [SingleStoreOpsRequest](/docs/v2026.2.16-rc.0/guides/singlestore/concepts/opsrequest)
    - [Storage Autoscaling Overview](/docs/v2026.2.16-rc.0/guides/singlestore/autoscaler/storage/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/singlestore](/docs/v2026.2.16-rc.0/examples/singlestore) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Detail concepts of [SingleStore object](/docs/v2026.2.16-rc.0/guides/singlestore/concepts/singlestore).
- Different SingleStore clustering modes [here](/docs/v2026.2.16-rc.0/guides/singlestore/clustering/_index).
- Monitor your SingleStore database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.16-rc.0/guides/singlestore/monitoring/prometheus-operator/).
- Monitor your SingleStore database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.2.16-rc.0/guides/singlestore/monitoring/builtin-prometheus/)
