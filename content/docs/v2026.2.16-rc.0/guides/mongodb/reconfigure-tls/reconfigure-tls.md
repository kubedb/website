...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.2.16-rc.0/guides/mongodb/concepts/mongodb#spectls).
