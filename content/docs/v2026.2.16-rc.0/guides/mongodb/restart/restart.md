...
- The meaning of`spec.readinessCriteria`, `spec.timeout` & `spec.apply` fields will be found [here](/docs/v2026.2.16-rc.0/guides/mongodb/concepts/opsrequest#specreadinessCriteria)
