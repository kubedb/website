...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2026.2.16-rc.0/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
