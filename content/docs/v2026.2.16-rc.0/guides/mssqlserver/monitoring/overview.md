...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.2.16-rc.0/guides/mssqlserver/monitoring/using-prometheus-operator).
