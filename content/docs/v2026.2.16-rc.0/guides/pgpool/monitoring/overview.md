...
- Learn how to monitor Pgpool database with KubeDB using [builtin-Prometheus](/docs/v2026.2.16-rc.0/guides/pgpool/monitoring/using-builtin-prometheus)
- Learn how to monitor Pgpool database with KubeDB using [Prometheus operator](/docs/v2026.2.16-rc.0/guides/pgpool/monitoring/using-prometheus-operator).
