...
KubeDB supports providing custom configuration for Ignite via [PodTemplate](/docs/v2026.2.16-rc.0/guides/ignite/concepts/ignite#specpodtemplate). This tutorial will show you how to use KubeDB to run a Ignite database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2026.2.16-rc.0/guides/ignite/concepts/ignite#specpodtemplate),
...
- [Quickstart Ignite](/docs/v2026.2.16-rc.0/guides/ignite/quickstart/quickstart) with KubeDB Operator.
- Monitor your Ignite database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.16-rc.0/guides/ignite/monitoring/using-prometheus-operator).
- Monitor your Ignite database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.2.16-rc.0/guides/ignite/monitoring/using-builtin-prometheus).
