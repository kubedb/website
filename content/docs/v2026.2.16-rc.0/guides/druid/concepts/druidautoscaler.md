...
`spec.databaseRef` is a required field that point to the [Druid](/docs/v2026.2.16-rc.0/guides/druid/concepts/druid) object for which the autoscaling will be performed. This field consists of the following sub-field:
