...
![Druid Architecture](/docs/v2026.2.16-rc.0/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2026.2.16-rc.0/guides/druid/clustering/overview/) using KubeDB.
