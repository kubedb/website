...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2026.2.16-rc.0/guides/kafka/concepts/kafkaversion) CR where the docker images are specified. Currently, when you install KubeDB, it creates the following `KafkaVersion` resources,
...
- [Monitor Apache with Prometheus operator](/docs/v2026.2.16-rc.0/guides/kafka/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to run a Apache Kafka Connect cluster [here](/docs/v2026.2.16-rc.0/guides/kafka/README).
- Monitor your ConnectCluster with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.2.16-rc.0/guides/kafka/monitoring/using-prometheus-operator).
