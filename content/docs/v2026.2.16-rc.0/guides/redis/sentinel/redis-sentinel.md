...
- Read [redis sentinel concept](/docs/v2026.2.16-rc.0/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2026.2.16-rc.0/guides/redis/sentinel/replacesentinel/overview)
