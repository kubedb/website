...
![redis-sentinel](/docs/v2026.2.16-rc.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2026.2.16-rc.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
