...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [External Client Connection](/docs/v2026.2.16-rc.0/guides/redis/external-connections/exposure)
...
Deploy `Redis/Valkey` cluster as shown in [External Connection Exposer](/docs/v2026.2.16-rc.0/guides/redis/external-connections/exposure).
