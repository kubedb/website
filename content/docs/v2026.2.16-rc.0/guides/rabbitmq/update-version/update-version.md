...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2026.2.16-rc.0/guides/rabbitmq/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/rabbitmq](/docs/v2026.2.16-rc.0/examples/rabbitmq) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
- Have a look [here](/docs/v2026.2.16-rc.0/guides/rabbitmq/concepts/opsrequest#spectimeout) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
