...
- You should be familiar with the following `KubeDB` concepts:
    - [Elasticsearch](/docs/v2026.2.16-rc.0/guides/elasticsearch/concepts/elasticsearch/)
    - [ElasticsearchOpsRequest](/docs/v2026.2.16-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Updating Overview](/docs/v2026.2.16-rc.0/guides/elasticsearch/update-version/elasticsearch)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/elasticsearch](/docs/v2026.2.16-rc.0/examples/elasticsearch) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
> **Note:** If you want to update combined Elasticsearch, you just refer to the `Elasticsearch` combined object name in `spec.databaseRef.name`. To create a combined Elasticsearch, you can refer to the [Elasticsearch Combined](/docs/v2026.2.16-rc.0/guides/elasticsearch/clustering/combined-cluster/) guide.
...
> **NOTE:** If you want to update Opensearch, you can follow the same steps as above but using `ElasticsearchOpsRequest` CRD. You can visit [OpenSearch ](/docs/v2026.2.16-rc.0/guides/elasticsearch/quickstart/overview/opensearch) guide for more details.
...
- Detail concepts of [ElasticsearchOpsRequest object](/docs/v2026.2.16-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/).
- Detailed concept of [Elasticesearch Version](/docs/v2026.2.16-rc.0/guides/elasticsearch/concepts/catalog/).
