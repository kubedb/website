...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [ProxySQL Cluster](/docs/v2026.2.16-rc.0/guides/proxysql/clustering/proxysql-cluster/)
    - [ProxySQLOpsRequest](/docs/v2026.2.16-rc.0/guides/proxysql/concepts/opsrequest/)`
    - [Horizontal Scaling Overview](/docs/v2026.2.16-rc.0/guides/proxysql/scaling/horizontal-scaling/overview/)
