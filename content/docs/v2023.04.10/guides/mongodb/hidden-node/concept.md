...
<p align="center">
  <img alt="hidden-node"  src="/docs/v2023.04.10/images/mongodb/hidden.png" width="500" height="408">
</p>
...
- [Deploy MongoDB ReplicaSet with Hidden-node](/docs/v2023.04.10/guides/mongodb/hidden-node/replicaset) using KubeDB.
