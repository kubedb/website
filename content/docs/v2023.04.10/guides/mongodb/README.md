...
url: /docs/v2023.04.10/guides/mongodb/
aliases:
- /docs/v2023.04.10/guides/mongodb/README/
info:
  autoscaler: v0.18.0
  cli: v0.33.0
  dashboard: v0.9.0
...
- [MongoDB Replicaset](/docs/v2023.04.10/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2023.04.10/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.04.10/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2023.04.10/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2023.04.10/guides/mongodb/configuration/using-config-file).
