...
- Read [mongodb arbiter concept](/docs/v2023.04.10/guides/mongodb/arbiter/concept) to get the concept about MongoDB Replica Set Arbiter.
...
- Deploy MongoDB shard [with Arbiter](/docs/v2023.04.10/guides/mongodb/arbiter/sharding).
