...
url: /docs/v2023.04.10/guides/pgbouncer/
aliases:
- /docs/v2023.04.10/guides/pgbouncer/README/
info:
  autoscaler: v0.18.0
  cli: v0.33.0
  dashboard: v0.9.0
...
- [Quickstart PgBouncer](/docs/v2023.04.10/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.04.10/guides/pgbouncer/monitoring/using-builtin-prometheus).
