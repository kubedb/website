...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2023.04.10/guides/memcached/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2023.04.10/images/memcached/monitoring/mc-builtin-prom-target.png" style="padding:10px">
</p>
