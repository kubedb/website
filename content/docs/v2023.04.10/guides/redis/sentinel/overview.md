...
![redis-sentinel](/docs/v2023.04.10/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.04.10/guides/redis/sentinel/redis-sentinel) using KubeDB.
