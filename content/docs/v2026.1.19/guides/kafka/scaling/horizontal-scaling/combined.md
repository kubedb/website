...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Horizontal Scaling Overview](/docs/v2026.1.19/guides/kafka/scaling/horizontal-scaling/overview)
...
- Monitor your Kafka with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.1.19/guides/kafka/monitoring/using-prometheus-operator).
