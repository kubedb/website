...
url: /docs/v2026.1.19/guides/ferretdb/
aliases:
- /docs/v2026.1.19/guides/ferretdb/README/
info:
  autoscaler: v0.45.0
  cli: v0.60.0
  dashboard: v0.36.0
...
- [Quickstart FerretDB](/docs/v2026.1.19/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
