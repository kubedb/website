...
url: /docs/v2026.1.19/guides/oracle/
aliases:
- /docs/v2026.1.19/guides/oracle/README/
info:
  autoscaler: v0.45.0
  cli: v0.60.0
  dashboard: v0.36.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.1.19/images/oracle/oracle_lifecycle.png">
</p>

## User Guide

- [Quickstart Oracle](/docs/v2026.1.19/guides/oracle/quickstart/guide) with KubeDB Operator.
