...
Read about the fields in details from [Memcached concept](/docs/v2026.1.19/guides/memcached/concepts/memcached),
...
<figure align="center">
<img alt="Deploy Memcached with TLS/SSL" src="/docs/v2026.1.19/images/memcached/memcached-tls.png">
