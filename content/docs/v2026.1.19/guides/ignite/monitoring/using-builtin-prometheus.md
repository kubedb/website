...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.1.19/guides/ignite/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.1.19/images/ignite/monitoring/ig-builtin-prom-target.png" style="padding:10px">
</p>
