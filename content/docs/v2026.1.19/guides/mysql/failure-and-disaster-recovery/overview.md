...
For more details, please check the full section [here](/docs/v2026.1.19/guides/mysql/volume-expansion/overview/).
...
- You can configure [Backup and Restore](/docs/v2026.1.19/guides/mysql/backup/kubestash/overview/)
- Learn about [PITR](/docs/v2026.1.19/guides/mysql/pitr/volumesnapshot/archiver)
