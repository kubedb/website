...
Read about the fields in details in [RabbitMQ concept](/docs/v2026.1.19/guides/rabbitmq/concepts/rabbitmq),
...
Below is the YAML for RabbitMQ Standalone. Here, [`spec.sslMode`](/docs/v2026.1.19/guides/rabbitmq/concepts/rabbitmq#spectls) specifies tls configurations required for operator to create corresponding resources.
...
(/docs/v2026.1.19/guides/RabbitMQ/monitoring/using-prometheus-operator).
