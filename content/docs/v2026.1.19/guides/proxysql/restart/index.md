...
- Install KubeDB CLI on your workstation and the KubeDB operator in your cluster by following the steps [here](/docs/v2026.1.19/setup/README).
...
> For details on the fields of ProxySQLOpsRequest, please visit to the [ProxySQLOpsRequest API reference](/docs/v2026.1.19/guides/proxysql/concepts/opsrequest/)
...
- Detail concepts of [ProxySQL object](/docs/v2026.1.19/guides/proxysql/concepts/proxysql/).
- Detail concepts of [ProxySQLOpsRequest object](/docs/v2026.1.19/guides/proxysql/concepts/opsrequest/).
