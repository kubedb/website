...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.1.19/guides/postgres/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.1.19/images/postgres/monitoring/pg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [backup and restore](/docs/v2026.1.19/guides/postgres/backup/stash/overview/) PostgreSQL databases using Stash.
