...
`spec.databaseRef` is a required field that point to the [PgBouncer](/docs/v2026.1.19/guides/pgbouncer/concepts/pgbouncer) object for which the autoscaling will be performed. This field consists of the following sub-field:
