...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [External Client Connection](/docs/v2026.1.19/guides/redis/external-connections/exposure)
...
Deploy `Redis/Valkey` cluster as shown in [External Connection Exposer](/docs/v2026.1.19/guides/redis/external-connections/exposure).
