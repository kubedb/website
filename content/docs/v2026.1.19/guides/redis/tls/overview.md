...
Read about the fields in details from [redis concept](/docs/v2026.1.19/guides/redis/concepts/redis),
...
<figure align="center">
<img alt="Deploy Redis with TLS/SSL" src="/docs/v2026.1.19/images/day-2-operation/redis/rd-tls.svg">
