...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2026.1.19/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
