...
`spec.databaseRef` is a required field that point to the [ClickHouse](/docs/v2026.1.19/guides/clickhouse/concepts/clickhouse) object for which the autoscaling will be performed. This field consists of the following sub-field:
