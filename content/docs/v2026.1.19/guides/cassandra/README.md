...
url: /docs/v2026.1.19/guides/cassandra/
aliases:
- /docs/v2026.1.19/guides/cassandra/README/
info:
  autoscaler: v0.45.0
  cli: v0.60.0
  dashboard: v0.36.0
...
- [Quickstart Cassandra](/docs/v2026.1.19/guides/cassandra/quickstart/guide/quickstart) with KubeDB Operator.
