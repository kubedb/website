...
- Monitor your Solr cluster with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.1.19/guides/solr/monitoring/prometheus-operator).
- Monitor your Solr cluster with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.1.19/guides/solr/monitoring/prometheus-builtin).
