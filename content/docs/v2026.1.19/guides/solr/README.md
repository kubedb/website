...
url: /docs/v2026.1.19/guides/solr/
aliases:
- /docs/v2026.1.19/guides/solr/README/
info:
  autoscaler: v0.45.0
  cli: v0.60.0
  dashboard: v0.36.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.1.19/guides/solr/quickstart/overview/images/Lifecycle-of-a-Solr-instance.png">
</p>

## User Guide

- [Quickstart Solr](/docs/v2026.1.19/guides/solr/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Solr Object](/docs/v2026.1.19/guides/solr/concepts/solr).
