...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.1.19/guides/pgpool/concepts/pgpool#spectls).
- `spec.tls.sslMode` is the ssl mode of the server. You can see the details [here](/docs/v2026.1.19/guides/pgpool/concepts/pgpool#specsslmode).
- `spec.tls.clientAuthMode` is the authentication mode of the server. You can see the details [here](/docs/v2026.1.19/guides/pgpool/concepts/pgpool#specclientauthmode).
- The meaning of `spec.timeout` & `spec.apply` fields will be found [here](/docs/v2026.1.19/guides/pgpool/concepts/opsrequest#spectimeout)
