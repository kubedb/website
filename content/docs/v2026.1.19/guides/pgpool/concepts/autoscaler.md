...
`spec.databaseRef` is a required field that point to the [Pgpool](/docs/v2026.1.19/guides/pgpool/concepts/pgpool) object for which the autoscaling will be performed. This field consists of the following sub-field:
