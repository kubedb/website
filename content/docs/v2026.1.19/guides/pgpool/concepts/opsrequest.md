...
`spec.databaseRef` is a required field that point to the [Pgpool](/docs/v2026.1.19/guides/pgpool/concepts/pgpool) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Pgpool](/docs/v2026.1.19/guides/pgpool/concepts/pgpool) object.
...
- `spec.updateVersion.targetVersion` refers to a [PgpoolVersion](/docs/v2026.1.19/guides/pgpool/concepts/catalog) CR that contains the Pgpool version information where you want to update.
