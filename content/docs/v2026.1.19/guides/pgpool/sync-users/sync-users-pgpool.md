...
Now, create a secret with structure defined [here](/docs/v2026.1.19/guides/pgpool/concepts/pgpool#specsyncusers). Below is the YAML of the `secret` that we are going to create,
