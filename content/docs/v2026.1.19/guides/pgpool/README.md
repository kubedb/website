...
url: /docs/v2026.1.19/guides/pgpool/
aliases:
- /docs/v2026.1.19/guides/pgpool/README/
info:
  autoscaler: v0.45.0
  cli: v0.60.0
  dashboard: v0.36.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2026.1.19/guides/pgpool/concepts/catalog) object with your custom pgpool image.
