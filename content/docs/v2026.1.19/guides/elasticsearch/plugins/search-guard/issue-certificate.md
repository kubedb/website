...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2026.1.19/guides/elasticsearch/plugins/search-guard/use-tls).
- Learn how to generate [search-guard configuration](/docs/v2026.1.19/guides/elasticsearch/plugins/search-guard/configuration).
