...
### spec.monitor
To learn how to monitor MongoDB databases, please visit [here](/docs/0.8.0-beta.0/concepts/monitoring).
...
## Next Steps
- Learn how to use KubeDB to run a MongoDB database [here](/docs/0.8.0-beta.0/guides/mongodb/overview).
