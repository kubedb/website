...
Let's edit an existing running Memcached object to setup [Monitoring](/docs/v2024.1.31/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
