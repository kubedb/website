...
To learn about various options of `describe` command, please visit [here](/docs/v2024.1.31/reference/cli/kubectl-dba_describe).
...
Let's edit an existing running Redis object to setup [Monitoring](/docs/v2024.1.31/guides/redis/monitoring/using-builtin-prometheus). The following command will open Redis `redis-demo` in editor.
...
- Learn how to use custom configuration in Redis with KubeDB [here](/docs/v2024.1.31/guides/redis/configuration/using-config-file)
