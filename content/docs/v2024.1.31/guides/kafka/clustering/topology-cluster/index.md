...
For this demo, we are going to provision kafka version `3.3.2` with 3 controllers and 3 brokers. To learn more about Kafka CR, visit [here](/docs/v2024.1.31/guides/kafka/concepts/kafka). visit [here](/docs/v2024.1.31/guides/kafka/concepts/catalog) to learn more about KafkaVersion CR.
