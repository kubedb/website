...
KubeDB supports providing custom configuration for MySQL via [PodTemplate](/docs/v2024.1.31/guides/mysql/concepts/database/#specpodtemplate). This tutorial will show you how to use KubeDB to run a MySQL database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2024.1.31/guides/mysql/concepts/database/#specpodtemplate),
...
![mysql_all_databases](/docs/v2024.1.31/guides/mysql/configuration/podtemplating/images/mysql-all-databases.png)

![mysql_charset](/docs/v2024.1.31/guides/mysql/configuration/podtemplating/images/mysql-charset.png)
