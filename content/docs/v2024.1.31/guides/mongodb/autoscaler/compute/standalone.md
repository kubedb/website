...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MongoDBAutoscaler](/docs/v2024.1.31/guides/mongodb/concepts/autoscaler)
  - [MongoDBOpsRequest](/docs/v2024.1.31/guides/mongodb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2024.1.31/guides/mongodb/autoscaler/compute/overview)
