...
Read about the fields in details in [redis concept](/docs/v2024.6.4/guides/redis/concepts/redis) and [redissentinel concept](/docs/v2024.6.4/guides/redis/concepts/redissentinel)
...
- [Backup and Restore](/docs/v2024.6.4/guides/redis/backup/overview/) Redis databases using Stash. .
- Monitor your Redis database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.6.4/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.6.4/guides/redis/monitoring/using-builtin-prometheus).
