...
<p text-align="center">
  <img alt="lifecycle"  src="/docs/v2024.6.4/guides/rabbitmq/quickstart/images/rabbitmq-lifecycle.png">
</p>
...
- Now, install KubeDB in your cluster following the steps [here](/docs/v2024.6.4/setup/README) and make sure install with helm command including `--set global.featureGates.RabbitMQ=true` to ensure RabbitMQ CRDs.
...
<p text-align="center">
  <img alt="management-ui"  src="/docs/v2024.6.4/guides/rabbitmq/quickstart/images/management-ui.png">
</p>
