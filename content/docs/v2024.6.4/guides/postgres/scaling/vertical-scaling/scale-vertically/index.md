...
- Install `KubeDB-Provisioner` and `kubeDB-Ops-Manager` in your cluster following the steps [here](/docs/v2024.6.4/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2024.6.4/guides/postgres/scaling/vertical-scaling/overview/)
