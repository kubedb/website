...
url: /docs/v2024.6.4/guides/mssqlserver/
aliases:
- /docs/v2024.6.4/guides/mssqlserver/README/
info:
  autoscaler: v0.31.0
  cli: v0.46.0
  dashboard: v0.22.0
...
- [Quickstart MSSQLServer](/docs/v2024.6.4/guides/mssqlserver/quickstart/quickstart) with KubeDB Operator.
