...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2022.05.24/guides/mysql/monitoring/overview/images/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor Elasticsearch database with KubeDB using [builtin-Prometheus](/docs/v2022.05.24/guides/elasticsearch/monitoring/using-builtin-prometheus) and using [Prometheus operator](/docs/v2022.05.24/guides/elasticsearch/monitoring/using-prometheus-operator).
