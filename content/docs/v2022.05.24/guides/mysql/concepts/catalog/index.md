...
`metadata.name` is a required field that specifies the name of the `MySQLVersion` crd. You have to specify this name in `spec.version` field of [MySQL](/docs/v2022.05.24/guides/mysql/concepts/database/) crd.
...
- Learn about MySQL crd [here](/docs/v2022.05.24/guides/mysql/concepts/database/).
- Deploy your first MySQL database with KubeDB by following the guide [here](/docs/v2022.05.24/guides/mysql/quickstart/).
