...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/memcached](/docs/v2026.4.27/examples/memcached/update-version) directory of [kubedb/docs](https://github.com/kube/docs) repository.
