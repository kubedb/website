...
- Read [concept of Memcached Version Catalog](/docs/v2026.4.27/guides/memcached/concepts/memcached-version) to learn detail concepts of `MemcachedVersion` object.
