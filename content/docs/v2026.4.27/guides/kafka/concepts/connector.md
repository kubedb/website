...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2026.4.27/guides/kafka/quickstart/kafka/).
- Learn how to use KubeDB to run Apache Kafka Connect cluster [here](/docs/v2026.4.27/guides/kafka/connectcluster/quickstart).
