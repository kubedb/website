...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.4.27/guides/cassandra/monitoring/overview).
...
- Monitor your Cassandra database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.4.27/guides/cassandra/monitoring/using-prometheus-operator).
