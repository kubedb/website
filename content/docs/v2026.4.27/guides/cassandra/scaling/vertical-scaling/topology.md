...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.4.27/guides/cassandra/scaling/vertical-scaling/overview)
...
- Detail concepts of [Cassandra object](/docs/v2026.4.27/guides/cassandra/concepts/cassandra).
