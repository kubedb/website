...
url: /docs/v2026.4.27/guides/ferretdb/
aliases:
- /docs/v2026.4.27/guides/ferretdb/README/
info:
  autoscaler: v0.49.0
  cli: v0.64.0
  dashboard: v0.40.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.4.27/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2026.4.27/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
