...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Distributed MariaDB Overview](/docs/v2026.4.27/guides/mariadb/distributed/overview)
...
<figure align="center">
  <img alt="Storage Autoscaling process of MariaDB" src="/docs/v2026.4.27/guides/mariadb/autoscaler/storage/overview/images/mdas-storage.jpeg">
