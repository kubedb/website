...
`spec.databaseRef` is a required field that point to the [Ignite](/docs/v2026.4.27/guides/ignite/concepts/ignite) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Ignite](/docs/v2026.4.27/guides/ignite/concepts/ignite) object.
