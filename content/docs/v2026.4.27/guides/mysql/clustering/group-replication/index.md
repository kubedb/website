...
- Read [mysql group replication concept](/docs/v2026.4.27/guides/mysql/clustering/overview/) to learn about MySQL Group Replication.
...
- Detail concepts of [MySQLDBVersion object](/docs/v2026.4.27/guides/mysql/concepts/catalog/).
