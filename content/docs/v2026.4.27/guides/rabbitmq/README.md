...
url: /docs/v2026.4.27/guides/rabbitmq/
aliases:
- /docs/v2026.4.27/guides/rabbitmq/README/
info:
  autoscaler: v0.49.0
  cli: v0.64.0
  dashboard: v0.40.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.4.27/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
