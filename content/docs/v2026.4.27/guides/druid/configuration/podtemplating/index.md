...
KubeDB supports providing custom configuration for Druid via [PodTemplate](/docs/v2026.4.27/guides/druid/concepts/druid#spec.topology). This tutorial will show you how to use KubeDB to run a Druid database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2026.4.27/guides/druid/concepts/druid#spectopology),
...
Below is the YAML for the Druid created in this example. Here, [`spec.topology.aggregator/leaf.podTemplate.spec.args`](/docs/v2026.4.27/guides/mysql/concepts/database/#specpodtemplatespecargs) provides extra arguments.
