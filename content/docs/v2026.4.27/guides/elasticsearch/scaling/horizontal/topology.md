...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2026.4.27/guides/elasticsearch/clustering/topology-cluster/simple-dedicated-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.4.27/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Horizontal Scaling Overview](/docs/v2026.4.27/guides/elasticsearch/scaling/horizontal/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/Elasticsearch](/docs/v2026.4.27/examples/elasticsearch) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Different Elasticsearch topology clustering modes [here](/docs/v2026.4.27/guides/elasticsearch/clustering/_index).
- Monitor your Elasticsearch with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.4.27/guides/elasticsearch/monitoring/using-prometheus-operator).
