...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.4.27/guides/mssqlserver/monitoring/using-prometheus-operator).
