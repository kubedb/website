...
When you install KubeDB, a `HazelcastVersion` custom resource will be created automatically for every supported Hazelcast versions. You have to specify the name of `HazelcastVersion` crd in `spec.version` field of [Hazelcast](/docs/v2026.4.27/guides/hazelcast/concepts/hazelcast) crd. Then, KubeDB will use the docker images specified in the `HazelcastVersion` crd to create your expected database.
...
`metadata.name` is a required field that specifies the name of the `HazelcastVersion` crd. You have to specify this name in `spec.version` field of [Hazelcast](/docs/v2026.4.27/guides/hazelcast/concepts/hazelcast) crd.
...
- Learn about Hazelcast crd [here](/docs/v2026.4.27/guides/hazelcast/concepts/hazelcast).
- Deploy your first Hazelcast server with KubeDB by following the guide [here](/docs/v2026.4.27/guides/hazelcast/quickstart/overview/).
