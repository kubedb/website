...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Horizontal Scaling Overview](/docs/v2026.4.27/guides/clickhouse/scaling/horizontal-scaling/overview)
...
- Detail concepts of [ClickHouse object](/docs/v2026.4.27/guides/clickhouse/concepts/clickhouse).
