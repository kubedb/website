...
`metadata.name` is a required field that specifies the name of the `ClickHouseVersion` CR. You have to specify this name in `spec.version` field of [ClickHouse](/docs/v2026.4.27/guides/clickhouse/concepts/clickhouse) CR.
...
- Learn about ClickHouse CRD [here](/docs/v2026.4.27/guides/clickhouse/concepts/clickhouse).
