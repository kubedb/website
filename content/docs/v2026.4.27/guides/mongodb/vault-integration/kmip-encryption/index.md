...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.4.27/setup/README).
...
- [Backup and Restore](/docs/v2026.4.27/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
