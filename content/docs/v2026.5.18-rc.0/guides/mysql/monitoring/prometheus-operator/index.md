...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.5.18-rc.0/guides/mysql/monitoring/overview/).
...
coreos-prom-mysql   8.4.8    Running   2m53s
```
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.5.18-rc.0/images/mysql/monitoring/mysql-coreos-prom-target.png" style="padding:10px">
</p>
