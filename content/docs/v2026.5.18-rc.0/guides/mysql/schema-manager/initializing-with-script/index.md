...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  - [MySQL](/docs/v2026.5.18-rc.0/guides/mysql/concepts/database/)
  - [MySQLDatabase](/docs/v2026.5.18-rc.0/guides/mysql/concepts/mysqldatabase/)
  - [Schema Manager Overview](/docs/v2026.5.18-rc.0/guides/mysql/schema-manager/overview/)
...
- `spec.version` is the name of the MySQLVersion CR. Here, we are using MySQL version `8.4.8`.
...
- Detail concepts of [MySQLDatabase object](/docs/v2026.5.18-rc.0/guides/mysql/concepts/mysqldatabase/).
