...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.5.18-rc.0/setup/README).
...
- [Backup and Restore](/docs/v2026.5.18-rc.0/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
