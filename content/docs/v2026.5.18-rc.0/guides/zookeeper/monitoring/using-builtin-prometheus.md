...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.5.18-rc.0/images/zookeeper/zk-builtin-prom-target.png" style="padding:10px">
</p>
...
- Monitor your ZooKeeper database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.5.18-rc.0/guides/zookeeper/monitoring/using-prometheus-operator).
