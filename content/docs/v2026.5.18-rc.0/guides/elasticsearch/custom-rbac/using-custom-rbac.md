...
- [Backup & Restore](/docs/v2026.5.18-rc.0/guides/elasticsearch/backup/stash/overview/) Elasticsearch instances using Stash.
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.5.18-rc.0/guides/elasticsearch/monitoring/using-prometheus-operator).
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.5.18-rc.0/guides/elasticsearch/monitoring/using-builtin-prometheus).
