...
`spec.databaseRef` is a required field that point to the [Cassandra](/docs/v2026.5.18-rc.0/guides/cassandra/concepts/cassandra) object for which the autoscaling will be performed. This field consists of the following sub-field:
