...
url: /docs/v2026.5.18-rc.0/guides/pgpool/
aliases:
- /docs/v2026.5.18-rc.0/guides/pgpool/README/
info:
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2026.5.18-rc.0/guides/pgpool/concepts/catalog) object with your custom pgpool image.
