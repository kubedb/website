...
- Read [druid topology cluster overview](/docs/v2026.5.18-rc.0/guides/druid/clustering/overview/) to get a basic idea about the design and architecture of Druid.
...
- Detail concepts of [DruidDBVersion object](/docs/v2026.5.18-rc.0/guides/druid/concepts/druidversion).
