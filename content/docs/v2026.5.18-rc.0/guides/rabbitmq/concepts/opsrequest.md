...
`spec.databaseRef` is a required field that point to the [RabbitMQ](/docs/v2026.5.18-rc.0/guides/rabbitmq/concepts/rabbitmq) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [RabbitMQ](/docs/v2026.5.18-rc.0/guides/rabbitmq/concepts/rabbitmq) object.
...
- `spec.updateVersion.targetVersion` refers to a [RabbitMQVersion](/docs/v2026.5.18-rc.0/guides/rabbitmq/concepts/catalog) CR that contains the RabbitMQ version information where you want to update.
