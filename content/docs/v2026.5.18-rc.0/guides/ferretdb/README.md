...
url: /docs/v2026.5.18-rc.0/guides/ferretdb/
aliases:
- /docs/v2026.5.18-rc.0/guides/ferretdb/README/
info:
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2026.5.18-rc.0/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2026.5.18-rc.0/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
