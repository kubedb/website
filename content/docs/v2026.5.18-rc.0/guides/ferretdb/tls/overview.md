...
- `spec:`
    ...
    - `tls:`
        ...
        - `certificates`
    - `cientAuthMode`
      Read about the fields in details from [ferretdb concept](/docs/v2026.5.18-rc.0/guides/ferretdb/concepts/ferretdb),
...
<figure align="center">
<img alt="Deploy FerretDB with TLS/SSL" src="/docs/v2026.5.18-rc.0/images/ferretdb/fr-tls.svg">
