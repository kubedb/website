...
`metadata.name` is a required field that specifies the name of the `ClickHouseVersion` CR. You have to specify this name in `spec.version` field of [ClickHouse](/docs/v2026.5.18-rc.0/guides/clickhouse/concepts/clickhouse) CR.
...
- Learn about ClickHouse CRD [here](/docs/v2026.5.18-rc.0/guides/clickhouse/concepts/clickhouse).
