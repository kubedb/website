...
Now, install the KubeDB operator in your cluster following the steps [here](/docs/v2026.5.18-rc.0/setup/README).
...
For this tutorial, we are going to use ConnectCluster version `3.9.0` with three worker nodes. To learn more about ConnectCluster CR, please visit [here](/docs/v2026.5.18-rc.0/guides/kafka/concepts/connectcluster) and visit [here](/docs/v2026.5.18-rc.0/guides/kafka/concepts/kafkaconnectorversion) to learn about KafkaConnectorVersion CR.
...
Before creating ConnectCluster, you must need a Kafka cluster. If you don't have a Kafka cluster, you can create one by following this [tutorial](/docs/v2026.5.18-rc.0/guides/kafka/clustering/topology-cluster/).
...
To do that, we need to create a Postgres database. You can create a Postgres database by following this [tutorial](/docs/v2026.5.18-rc.0/guides/postgres/quickstart/quickstart).
We also need a MySQL database. You can create a MySQL database by following this [tutorial](/docs/v2026.5.18-rc.0/guides/mysql/quickstart/).
...
1 **Use `deletionPolicy: Delete`**. It is nice to be able to resume the cluster from the previous one. So, we preserve auth `Secrets`. If you don't want to resume the cluster, you can just use `spec.deletionPolicy: WipeOut`. It will clean up every resource that was created with the ConnectCluster CR. For more details, please visit [here](/docs/v2026.5.18-rc.0/guides/kafka/concepts/connectcluster#specdeletionpolicy).

## Next Steps

- [Quickstart Kafka](/docs/v2026.5.18-rc.0/guides/kafka/quickstart/kafka/) with KubeDB Operator.
- [Quickstart ConnectCluster](/docs/v2026.5.18-rc.0/guides/kafka/connectcluster/quickstart) with KubeDB Operator.
- Use [kubedb cli](/docs/v2026.5.18-rc.0/guides/kafka/cli/cli) to manage databases like kubectl for Kubernetes.
- Detail concepts of [ConnectCluster object](/docs/v2026.5.18-rc.0/guides/kafka/concepts/connectcluster).
