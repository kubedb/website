...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.5.18-rc.0/guides/kafka/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2026.5.18-rc.0/images/kafka/kafka-promethues.png" style="padding:10px">
</p>
...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2026.5.18-rc.0/guides/kafka/README).
