...
- Learn about ConnectCluster CRD [here](/docs/v2026.5.18-rc.0/guides/kafka/concepts/connectcluster).
- Deploy your first ConnectCluster with KubeDB by following the guide [here](/docs/v2026.5.18-rc.0/guides/kafka/connectcluster/quickstart).
