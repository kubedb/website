...
If you deploy a database using [KubeDB](https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/concepts/), `AppBinding` object will be created automatically for it. Otherwise, you have to create an `AppBinding` object manually pointing to your desired database.
