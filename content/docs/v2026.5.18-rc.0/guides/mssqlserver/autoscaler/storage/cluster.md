...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MSSQLServerAutoscaler](/docs/v2026.5.18-rc.0/guides/mssqlserver/concepts/autoscaler)
  - [Storage Autoscaling Overview](/docs/v2026.5.18-rc.0/guides/mssqlserver/autoscaler/storage/overview)
...
> If you want to autoscale MSSQLServer `Standalone`, Just deploy a [standalone](/docs/v2026.5.18-rc.0/guides/mssqlserver/clustering/standalone) sql server instance using KubeDB.
