...
![Druid Architecture](/docs/v2025.3.20-rc.1/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2025.3.20-rc.1/guides/druid/clustering/overview/) using KubeDB.
