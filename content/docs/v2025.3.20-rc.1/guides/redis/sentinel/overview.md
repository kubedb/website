...
![redis-sentinel](/docs/v2025.3.20-rc.1/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2025.3.20-rc.1/guides/redis/sentinel/redis-sentinel) using KubeDB.
