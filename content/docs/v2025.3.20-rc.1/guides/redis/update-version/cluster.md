...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Redis Clustering](/docs/v2025.3.20-rc.1/guides/redis/clustering/redis-cluster)
  - [RedisOpsRequest](/docs/v2025.3.20-rc.1/guides/redis/concepts/redisopsrequest)
  - [updating Overview](/docs/v2025.3.20-rc.1/guides/redis/update-version/overview)
