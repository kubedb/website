...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.3.20-rc.1/guides/mssqlserver/monitoring/using-prometheus-operator).
