...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2025.3.20-rc.1/guides/postgres/reconfigure/overview)
...
To know more about this configuration file, check [here](/docs/v2025.3.20-rc.1/guides/postgres/configuration/using-config-file)
```ini
$ cat user.conf
max_connections=200
