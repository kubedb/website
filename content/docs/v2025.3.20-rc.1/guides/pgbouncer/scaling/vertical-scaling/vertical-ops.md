...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2025.3.20-rc.1/guides/pgbouncer/scaling/vertical-scaling/overview)
...
- Have a look [here](/docs/v2025.3.20-rc.1/guides/pgbouncer/concepts/opsrequest) on the respective sections to understand the `timeout` & `apply` fields.
