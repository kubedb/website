...
<figure align="center">
  <img alt="Monitoring process of PgBouncer using Prometheus Operator" src="/docs/v2025.3.20-rc.1/images/day-2-operation/pgbouncer/prometheus-operator.png">
...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.3.20-rc.1/guides/pgbouncer/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.3.20-rc.1/images/pgbouncer/monitoring/pb-coreos-prom-target.png" style="padding:10px">
</p>
...
- Monitor your PgBouncer database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.3.20-rc.1/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Detail concepts of [PgBouncer object](/docs/v2025.3.20-rc.1/guides/pgbouncer/concepts/pgbouncer).
- Detail concepts of [PgBouncerVersion object](/docs/v2025.3.20-rc.1/guides/pgbouncer/concepts/catalog).
