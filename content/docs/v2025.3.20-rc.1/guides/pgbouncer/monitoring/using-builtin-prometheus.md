...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.3.20-rc.1/images/pgbouncer/monitoring/pb-builtin-prom-target.png" style="padding:10px">
</p>
...
- Monitor your PgBouncer database with KubeDB using [out-of-the-box prometheus-Operator](/docs/v2025.3.20-rc.1/guides/pgbouncer/monitoring/using-prometheus-operator).
