...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2025.3.20-rc.1/guides/singlestore/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/singlestore](/docs/v2025.3.20-rc.1/examples/singlestore) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Different SingleStore clustering modes [here](/docs/v2025.3.20-rc.1/guides/singlestore/clustering/_index).
