...
- Install `KubeDB` Community and Ops-manager operator in your cluster following the steps [here](/docs/v2025.3.20-rc.1/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2025.3.20-rc.1/guides/singlestore/concepts/singlestore)
  - [Cluster](/docs/v2025.3.20-rc.1/guides/singlestore/clustering/overview/)
  - [SingleStoreOpsRequest](/docs/v2025.3.20-rc.1/guides/singlestore/concepts/opsrequest)
  - [Updating Overview](/docs/v2025.3.20-rc.1/guides/singlestore/update-version/overview/)
