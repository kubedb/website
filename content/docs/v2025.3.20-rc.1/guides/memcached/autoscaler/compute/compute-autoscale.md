...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2025.3.20-rc.1/guides/memcached/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2025.3.20-rc.1/guides/memcached/concepts/memcached-opsrequest#spectimeout), [apply](/docs/v2025.3.20-rc.1/guides/memcached/concepts/memcached-opsrequest#specapply).
