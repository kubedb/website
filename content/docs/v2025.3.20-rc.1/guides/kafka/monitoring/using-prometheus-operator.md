...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.3.20-rc.1/guides/kafka/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.3.20-rc.1/images/kafka/kafka-promethues.png" style="padding:10px">
</p>
...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2025.3.20-rc.1/guides/kafka/README).
