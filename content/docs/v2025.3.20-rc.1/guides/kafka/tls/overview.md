...
Read about the fields in details from [kafka concept](/docs/v2025.3.20-rc.1/guides/kafka/concepts/kafka),
...
<figure align="center">
<img alt="Deploy Kafka with TLS/SSL" src="/docs/v2025.3.20-rc.1/images/kafka/kf-tls.svg">
