...
- Learn how to monitor Pgpool database with KubeDB using [builtin-Prometheus](/docs/v2025.3.20-rc.1/guides/pgpool/monitoring/using-builtin-prometheus)
- Learn how to monitor Pgpool database with KubeDB using [Prometheus operator](/docs/v2025.3.20-rc.1/guides/pgpool/monitoring/using-prometheus-operator).
