...
url: /docs/v2025.3.20-rc.1/guides/mongodb/
aliases:
- /docs/v2025.3.20-rc.1/guides/mongodb/README/
info:
...
- [MongoDB Replicaset](/docs/v2025.3.20-rc.1/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2025.3.20-rc.1/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2025.3.20-rc.1/guides/mongodb/backup/stash/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2025.3.20-rc.1/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2025.3.20-rc.1/guides/mongodb/configuration/using-config-file).
