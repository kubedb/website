...
* [kubectl-dba remote-config mysql](/docs/v2025.3.20-rc.1/reference/cli/kubectl-dba_remote-config_mysql)	 - generate appbinding , secrets for remote replica
* [kubectl-dba remote-config postgres](/docs/v2025.3.20-rc.1/reference/cli/kubectl-dba_remote-config_postgres)	 - generate appbinding , secrets for remote replica
