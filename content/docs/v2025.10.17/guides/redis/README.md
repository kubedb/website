...
url: /docs/v2025.10.17/guides/redis/
aliases:
- /docs/v2025.10.17/guides/redis/README/
info:
  autoscaler: v0.44.0
  cli: v0.59.0
  dashboard: v0.35.0
...
- [Deploy Redis Cluster](/docs/v2025.10.17/guides/redis/clustering/redis-cluster) using KubeDB.
