...
![redis-sentinel](/docs/v2025.10.17/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2025.10.17/guides/redis/sentinel/redis-sentinel) using KubeDB.
