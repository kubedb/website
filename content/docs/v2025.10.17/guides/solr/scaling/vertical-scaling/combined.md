...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2025.10.17/guides/solr/scaling/vertical-scaling/overview)
...
- Different Solr Combined clustering modes [here](/docs/v2025.10.17/guides/solr/clustering/combined_cluster).
