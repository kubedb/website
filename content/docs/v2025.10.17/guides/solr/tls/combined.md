...
- Now, install KubeDB cli on your workstation and KubeDB operator in your combined following the steps [here](/docs/v2025.10.17/setup/README).
...
- Monitor your Solr combined with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.10.17/guides/solr/monitoring/prometheus-operator).
- Monitor your Solr combined with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.10.17/guides/solr/monitoring/prometheus-builtin).
