...
Now, create a secret with structure defined [here](/docs/v2025.10.17/guides/pgbouncer/concepts/pgbouncer#specsyncusers). Below is the YAML of the `secret` that we are going to create,
