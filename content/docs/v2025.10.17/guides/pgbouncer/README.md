...
url: /docs/v2025.10.17/guides/pgbouncer/
aliases:
- /docs/v2025.10.17/guides/pgbouncer/README/
info:
  autoscaler: v0.44.0
  cli: v0.59.0
  dashboard: v0.35.0
...
- [Quickstart PgBouncer](/docs/v2025.10.17/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2025.10.17/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.10.17/guides/pgbouncer/monitoring/using-prometheus-operator).
