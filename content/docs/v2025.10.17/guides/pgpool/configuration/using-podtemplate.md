...
KubeDB supports providing custom configuration for Pgpool via [PodTemplate](/docs/v2025.10.17/guides/pgpool/concepts/pgpool#specpodtemplate). This tutorial will show you how to use KubeDB to run a Pgpool database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2025.10.17/guides/pgpool/concepts/pgpool#specpodtemplate),
