...
![Kibana Monitoring Home](/docs/v2025.10.17/images/elasticsearch/x-pack/monitoring-home.png)

![Kibana Monitoring Node](/docs/v2025.10.17/images/elasticsearch/x-pack/monitoring-node.png)

![Kibana Monitoring Overview](/docs/v2025.10.17/images/elasticsearch/x-pack/monitoring-overview.png)
...
To uninstall KubeDB follow this [guide](/docs/v2025.10.17/setup/README).
