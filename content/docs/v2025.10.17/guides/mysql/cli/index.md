...
Lets edit an existing running MySQL object to setup database [Halted](/docs/v2025.10.17/guides/mysql/concepts/database/#spechalted). The following command will open MySQL `mysql-demo` in editor.
