...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2025.10.17/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
