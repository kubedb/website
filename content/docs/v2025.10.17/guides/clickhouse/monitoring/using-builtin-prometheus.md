...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.10.17/guides/clickhouse/monitoring/overview).
...
- Monitor your ClickHouse database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.10.17/guides/clickhouse/monitoring/using-prometheus-operator).
