...
`spec.databaseRef` is a required field that point to the [ClickHouse](/docs/v2025.10.17/guides/clickhouse/concepts/clickhouse) object for which the autoscaling will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [ClickHouse](/docs/v2025.10.17/guides/clickhouse/concepts/clickhouse) object.
