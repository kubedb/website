...
url: /docs/v2025.10.17/guides/rabbitmq/
aliases:
- /docs/v2025.10.17/guides/rabbitmq/README/
info:
  autoscaler: v0.44.0
  cli: v0.59.0
  dashboard: v0.35.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.10.17/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
