...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDBAutoscaler](/docs/v2025.10.17/guides/percona-xtradb/concepts/autoscaler)
...
<figure align="center">
  <img alt="Storage Autoscaling process of PerconaXtraDB" src="/docs/v2025.10.17/guides/percona-xtradb/autoscaler/storage/overview/images/pxas-storage.jpeg">
