...
`spec.databaseRef` is a required field that point to the [ZooKeeper](/docs/v2025.10.17/guides/zookeeper/concepts/zookeeper) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [ZooKeeper](/docs/v2025.10.17/guides/zookeeper/concepts/zookeeper) object.
...
- `spec.updateVersion.targetVersion` refers to a [ZooKeeperVersion](/docs/v2025.10.17/guides/zookeeper/concepts/catalog) CR that contains the ZooKeeper version information where you want to update.
