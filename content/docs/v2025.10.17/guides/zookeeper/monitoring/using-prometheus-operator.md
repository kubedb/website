...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.10.17/guides/zookeeper/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.10.17/images/zookeeper/zookeeper-prometheus.png" style="padding:10px">
</p>
...
- Monitor your ZooKeeper database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.10.17/guides/zookeeper/monitoring/using-builtin-prometheus).
- Detail concepts of [ZooKeeper object](/docs/v2025.10.17/guides/zookeeper/concepts/zookeeper).
- Detail concepts of [ZooKeeperVersion object](/docs/v2025.10.17/guides/zookeeper/concepts/catalog).
