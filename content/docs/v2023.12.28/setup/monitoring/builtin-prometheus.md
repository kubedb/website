...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while installing KubeDB. To know details about how to enable monitoring see [here](/docs/v2023.12.28/setup/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2023.12.28/images/monitoring/operator/builtin-prom-target.png" style="padding:10px">
</p>
...
To uninstall KubeDB follow this [guide](/docs/v2023.12.28/setup/README).

## Next Steps

- Learn what metrics KubeDB operator exports from [here](/docs/v2023.12.28/setup/monitoring/overview).
- Learn how to monitor KubeDB operator using Prometheus operator from [here](/docs/v2023.12.28/setup/monitoring/prometheus-operator).
