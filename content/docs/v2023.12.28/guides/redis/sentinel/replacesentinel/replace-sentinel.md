...
- Install `KubeDB` Community and Enterprise operator in your cluster following the steps [here](/docs/v2023.12.28/setup/README).
...
- Detail concepts of [RedisSentinel object](/docs/v2023.12.28/guides/redis/concepts/redissentinel).
