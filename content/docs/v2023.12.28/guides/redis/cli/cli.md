...
Let's edit an existing running Redis object to setup [Monitoring](/docs/v2023.12.28/guides/redis/monitoring/using-builtin-prometheus). The following command will open Redis `redis-demo` in editor.
...
- Learn how to use custom configuration in Redis with KubeDB [here](/docs/v2023.12.28/guides/redis/configuration/using-config-file)
