...
layout: docs
menu:
  docsplatform_v2026.9.11:
    identifier: api-readme
    name: API Reference
    parent: api
    weight: -1
menu_name: docsplatform_v2026.9.11
section_menu_id: api
url: /docs/platform/v2026.9.11/api/
aliases:
- /docs/platform/v2026.9.11/api/README/
- /docs/platform/v2026.9.11/api/overview/
info:
  kubedb-installer: v2026.9.11
  kubeops-installer: v2026.9.11
