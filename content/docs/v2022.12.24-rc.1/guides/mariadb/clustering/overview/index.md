...
![MariaDB Cluster](/docs/v2022.12.24-rc.1/guides/mariadb/clustering/overview/images/galera_small.png)
...
- [Deploy MariaDB Galera Cluster](/docs/v2022.12.24-rc.1/guides/mariadb/clustering/galera-cluster) using KubeDB.
