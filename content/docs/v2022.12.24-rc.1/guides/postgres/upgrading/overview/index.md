...
{{< notice type="warning" message="This is an KubeDB-ops-manager only feature. Please install [KubeDB ops manager](/docs/v2022.12.24-rc.1/setup/install/enterprise) to try this feature." >}}
...
<figure align="center">
  <img alt="Postgres Upgrade Flow" src="/docs/v2022.12.24-rc.1/guides/postgres/upgrading/overview/images/pg-upgrading.png">
