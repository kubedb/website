...
- [AppBinding](/docs/v2022.12.24-rc.1/guides/redis/concepts/appbinding)
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.12.24-rc.1/guides/redis/backup/standalone/images/sample-redis-backup.png">
