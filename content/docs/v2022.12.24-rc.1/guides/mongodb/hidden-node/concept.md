...
<p align="center">
  <img alt="hidden-node"  src="/docs/v2022.12.24-rc.1/images/mongodb/hidden.png" width="500" height="408">
</p>
...
- [Deploy MongoDB ReplicaSet with Hidden-node](/docs/v2022.12.24-rc.1/guides/mongodb/hidden-node/replicaset) using KubeDB.
