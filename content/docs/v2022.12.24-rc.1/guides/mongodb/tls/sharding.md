...
Read about the fields in details in [mongodb concept](/docs/v2022.12.24-rc.1/guides/mongodb/concepts/mongodb),
...
Below is the YAML for MongoDB Sharding. Here, [`spec.sslMode`](/docs/v2022.12.24-rc.1/guides/mongodb/concepts/mongodb#specsslMode) specifies `sslMode` for `sharding` and [`spec.clusterAuthMode`](/docs/v2022.12.24-rc.1/guides/mongodb/concepts/mongodb#specclusterAuthMode) provides `clusterAuthMode` for sharding servers.
