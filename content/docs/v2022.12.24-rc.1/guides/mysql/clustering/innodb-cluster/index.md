...
- Read [mysql group replication concept](/docs/v2022.12.24-rc.1/guides/mysql/clustering/overview/) to learn about MySQL Group Replication.
...
- Detail concepts of [MySQLDBVersion object](/docs/v2022.12.24-rc.1/guides/mysql/concepts/catalog/).
