...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  ...
  - [MySQLDatabase](/docs/v2022.12.24-rc.1/guides/mysql/concepts/mysqldatabase/)
  - [Schema Manager Overview](/docs/v2022.12.24-rc.1/guides/mysql/schema-manager/overview/)
...
- Detail concepts of [MySQLDatabase object](/docs/v2022.12.24-rc.1/guides/mysql/concepts/mysqldatabase/).
