...
<figure align="center">
  <img alt="Percona XtraDB Backup Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2022.12.24-rc.1/guides/percona-xtradb/concepts/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Backup Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/standalone_backup.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Backup Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/cluster_backup.png">
...
<figure align="center">
  <img alt="Percona XtraDB Restore Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Restore Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/standalone_restore.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Restore Overview" src="/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/overview/images/cluster_restore.png">
  <figcaption align="center">Fig: Percona XtraDB Cluster Restore</figcaption>
</figure>

## Next Steps

- Backup a Precona XtraDB cluster using Stash by following the guides from [here](/docs/v2022.12.24-rc.1/guides/percona-xtradb/backup/cluster/).
