...
Below is the YAML for MongoDB Sharding. Here, [`spec.sslMode`](/docs/v2020.12.10/guides/mongodb/concepts/mongodb#specsslMode) specifies `sslMode` for `sharding` and [`spec.clusterAuthMode`](/docs/v2020.12.10/guides/mongodb/concepts/mongodb#specclusterAuthMode) provides `clusterAuthMode` for sharding servers.
