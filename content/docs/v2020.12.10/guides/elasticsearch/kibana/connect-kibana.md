...
![Search Guard Login UI](/docs/v2020.12.10/images/elasticsearch/kibana/search-guard-login-ui.png)
...
![Kibana Home](/docs/v2020.12.10/images/elasticsearch/kibana/kibana-home.png)
...
![Create Index_Pattern](/docs/v2020.12.10/images/elasticsearch/kibana/kibana-create-index.png)

Once we have created an index_pattern, we can use the Discovery UI.

![](/docs/v2020.12.10/images/elasticsearch/kibana/kibana-discovery-ui.png)
