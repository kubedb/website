...
>We have designed this tutorial to demonstrate a production setup of KubeDB managed Elasticsearch. If you just want to try out KubeDB, you can bypass some of the safety features following the tips [here](/docs/v2020.12.10/guides/elasticsearch/quickstart/quickstart#tips-for-testing).
...
In this tutorial, we will use `7.3.2` ElasticsearchVersion crd to create Elasticsearch database. To know more about what is `ElasticsearchVersion` crd and why there is `6.3` and `7.3.2` variation, please visit [here](/docs/v2020.12.10/guides/elasticsearch/concepts/catalog). You can also see supported ElasticsearchVersion in KubeDB 0.11.0 from [here](/docs/v2020.12.10/guides/elasticsearch/README#supported-elasticsearchversion-crd).
...
To learn about how to configure an Elasticsearch cluster, please visit [here](/docs/v2020.12.10/guides/elasticsearch/clustering/topology).
...
To know more about x-pack configuration, please visit [here](/docs/v2020.12.10/guides/elasticsearch/x-pack/configuration).
...
To learn more about how to create TLS secure Elasticsearch database with KubeDB, please visit [here](/docs/v2020.12.10/guides/elasticsearch/x-pack/use-tls).
