...
- Learn about archiving to [Amazon S3](/docs/0.12.0/guides/postgres/snapshot/archiving_to_s3).
- Learn about archiving to [S3 MinIO](/docs/0.12.0/guides/postgres/snapshot/archiving_to_minio).
- Learn about archiving to [Google Cloud Storage](/docs/0.12.0/guides/postgres/snapshot/archiving_to_gcs).
- Learn about archiving to [Azure Storage](/docs/0.12.0/guides/postgres/snapshot/archiving_to_azure).
- Learn about archiving to [OpenStack Object Storage (Swift)](/docs/0.12.0/guides/postgres/snapshot/archiving_to_swift).
- Learn about archiving to [Local Storage](/docs/0.12.0/guides/postgres/snapshot/archiving_to_local).
