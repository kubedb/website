...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/0.12.0/guides/postgres/snapshot/continuous_archiving) to learn more.
