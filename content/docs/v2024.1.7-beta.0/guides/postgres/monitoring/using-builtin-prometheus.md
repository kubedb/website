...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.1.7-beta.0/images/postgres/monitoring/pg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [backup and restore](/docs/v2024.1.7-beta.0/guides/postgres/backup/overview/) PostgreSQL databases using Stash.
