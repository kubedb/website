...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2024.1.7-beta.0/guides/postgres/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2024.1.7-beta.0/images/postgres/monitoring/pg-coreos-prom-target.png" style="padding:10px">
</p>
