...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2024.1.7-beta.0/guides/mongodb/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2024.1.7-beta.0/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2024.1.7-beta.0/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2024.1.7-beta.0/guides/mongodb/concepts/opsrequest#specapply).
