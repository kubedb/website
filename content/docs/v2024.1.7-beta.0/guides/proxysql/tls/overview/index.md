...
Read about the fields in details from [proxysql concept](/docs/v2024.1.7-beta.0/guides/proxysql/concepts/proxysql/index.md/#spectls),
...
<figure align="center">
  <img alt="ProxySQL TLS" src="/docs/v2024.1.7-beta.0/guides/proxysql/tls/overview/images/proxy-tls-ssl.png">
