...
![redis-sentinel](/docs/v2024.1.7-beta.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.1.7-beta.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
