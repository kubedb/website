...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2024.1.7-beta.0/guides/elasticsearch/autoscaler/compute/combined/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2024.1.7-beta.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#spectimeout), [apply](/docs/v2024.1.7-beta.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#specapply).
