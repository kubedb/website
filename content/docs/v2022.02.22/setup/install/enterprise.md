...
A full features comparison between KubeDB Enterprise Edition and community version can be found [here](/docs/v2022.02.22/overview/README).
...
<figure align="center">
  <img alt="KubeDB Backend Overview" src="/docs/v2022.02.22/images/setup/enterprise_license_form.png">
  <figcaption align="center">Fig: KubeDB License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing KubeDB by following the upgrading guide from [here](/docs/v2022.02.22/setup/upgrade/#updating-license).
...
Now, you are ready to [create your first database](/docs/v2022.02.22/guides/README) using KubeDB.
