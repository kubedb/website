...
url: /docs/v2022.02.22/guides/elasticsearch/
aliases:
- /docs/v2022.02.22/guides/elasticsearch/README/
info:
  autoscaler: v0.10.0
  cli: v0.25.0
  community: v0.25.0
...
> The listed ElasticsearchVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [ElasticsearchVersion](/docs/v2022.02.22/guides/elasticsearch/concepts/catalog/) object with your custom Elasticsearch image.

## User Guide

- [Quickstart Elasticsearch](/docs/v2022.02.22/guides/elasticsearch/quickstart/overview/) with KubeDB Operator.
- [Elasticsearch Clustering](/docs/v2022.02.22/guides/elasticsearch/clustering/combined-cluster/) supported by KubeDB
- [Backup & Restore Elasticsearch](/docs/v2022.02.22/guides/elasticsearch/backup/overview/) database using Stash.
