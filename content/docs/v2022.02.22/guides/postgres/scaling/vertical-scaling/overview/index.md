...
{{< notice type="warning" message="This is an Enterprise-only feature. Please install [KubeDB Ops Manager](/docs/v2022.02.22/setup/install/enterprise) to try this feature." >}}
...
<figure align="center">
  <img alt="Vertical scaling Flow" src="/docs/v2022.02.22/guides/postgres/scaling/vertical-scaling/overview/images/pg-vertical-scaling.png">
