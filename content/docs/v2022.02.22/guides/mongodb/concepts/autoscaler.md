...
`spec.databaseRef` is a required field that point to the [MongoDB](/docs/v2022.02.22/guides/mongodb/concepts/mongodb) object for which the autoscaling will be performed. This field consists of the following sub-field:
