...
url: /docs/v2025.8.31/guides/ferretdb/
aliases:
- /docs/v2025.8.31/guides/ferretdb/README/
info:
  autoscaler: v0.43.0
  cli: v0.58.0
  dashboard: v0.34.0
...
- [Quickstart FerretDB](/docs/v2025.8.31/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
