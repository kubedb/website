...
KubeDB supports providing custom configuration for Ignite via [PodTemplate](/docs/v2025.8.31/guides/ignite/concepts/ignite#specpodtemplate). This tutorial will show you how to use KubeDB to run a Ignite database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2025.8.31/guides/ignite/concepts/ignite#specpodtemplate),
