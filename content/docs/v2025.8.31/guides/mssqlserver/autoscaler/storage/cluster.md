...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MSSQLServerAutoscaler](/docs/v2025.8.31/guides/mssqlserver/concepts/autoscaler)
  - [Storage Autoscaling Overview](/docs/v2025.8.31/guides/mssqlserver/autoscaler/storage/overview)
...
> If you want to autoscale MSSQLServer `Standalone`, Just deploy a [standalone](/docs/v2025.8.31/guides/mssqlserver/clustering/standalone) sql server instance using KubeDB.
