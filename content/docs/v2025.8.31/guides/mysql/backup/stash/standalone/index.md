...
- If you are not familiar with how Stash backup and restore MySQL databases, please check the following guide [here](/docs/v2025.8.31/guides/mysql/backup/stash/overview/).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2025.8.31/guides/mysql/concepts/appbinding/)
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2025.8.31/guides/mysql/concepts/appbinding/) CRD that holds the necessary information to connect with the database.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2025.8.31/guides/mysql/backup/stash/standalone/images/sample-mysql-backup.png">
