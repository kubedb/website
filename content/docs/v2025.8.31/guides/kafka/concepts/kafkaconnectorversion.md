...
- Learn about ConnectCluster CRD [here](/docs/v2025.8.31/guides/kafka/concepts/connectcluster).
- Deploy your first ConnectCluster with KubeDB by following the guide [here](/docs/v2025.8.31/guides/kafka/connectcluster/quickstart).
