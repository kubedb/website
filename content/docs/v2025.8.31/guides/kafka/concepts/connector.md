...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2025.8.31/guides/kafka/quickstart/kafka/).
- Learn how to use KubeDB to run Apache Kafka Connect cluster [here](/docs/v2025.8.31/guides/kafka/connectcluster/quickstart).
