...
`spec.version` is a required field specifying the name of the [CassandraVersion](/docs/v2025.8.31/guides/cassandra/concepts/cassandraversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Cassandra` resources,
...
- [Monitor Apache Cassandra with Prometheus operator](/docs/v2025.8.31/guides/cassandra/monitoring/using-prometheus-operator)
- [Monitor Apache Cassandra with Built-in Prometheus](/docs/v2025.8.31/guides/cassandra/monitoring/using-builtin-prometheus)
...
- Learn how to use KubeDB to run Apache Cassandra cluster [here](/docs/v2025.8.31/guides/cassandra/README).
