...
url: /docs/v2025.8.31/guides/redis/
aliases:
- /docs/v2025.8.31/guides/redis/README/
info:
  autoscaler: v0.43.0
  cli: v0.58.0
  dashboard: v0.34.0
...
- [Deploy Redis Cluster](/docs/v2025.8.31/guides/redis/clustering/redis-cluster) using KubeDB.
