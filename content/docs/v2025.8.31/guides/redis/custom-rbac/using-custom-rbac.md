...
- [Quickstart Redis](/docs/v2025.8.31/guides/redis/quickstart/overview/redis) with KubeDB Operator.
- Monitor your Redis instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.8.31/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.8.31/guides/redis/monitoring/using-builtin-prometheus).
...
- Use [kubedb cli](/docs/v2025.8.31/guides/redis/cli/cli) to manage databases like kubectl for Kubernetes.
