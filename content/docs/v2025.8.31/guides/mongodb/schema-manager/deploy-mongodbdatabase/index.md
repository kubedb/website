...
- You should be familiar with the following concepts:
  ...
  - [Schema Manager Overview](/docs/v2025.8.31/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2025.8.31/guides/mongodb/concepts/mongodbdatabase).
