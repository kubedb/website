...
Below is the YAML for MongoDB Replicaset Horizons. Here, [`spec.replicaSet.horizons`](/docs/v2025.8.31/guides/mongodb/concepts/mongodb#specreplicaset) specifies `horizons` for `replicaset`.
