...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/v2025.8.31/guides/elasticsearch/backup/kubestash/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="Elasticsearch Backup Overview" src="/docs/v2025.8.31/guides/elasticsearch/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2025.8.31/guides/elasticsearch/backup/kubestash/overview/images/restore_overview.svg">
...
- Backup a `Elasticsearch` database using KubeStash by the following guides from [here](/docs/v2025.8.31/guides/elasticsearch/backup/kubestash/logical/).