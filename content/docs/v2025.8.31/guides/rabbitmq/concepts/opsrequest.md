...
`spec.databaseRef` is a required field that point to the [RabbitMQ](/docs/v2025.8.31/guides/rabbitmq/concepts/rabbitmq) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [RabbitMQ](/docs/v2025.8.31/guides/rabbitmq/concepts/rabbitmq) object.
...
- `spec.updateVersion.targetVersion` refers to a [RabbitMQVersion](/docs/v2025.8.31/guides/rabbitmq/concepts/catalog) CR that contains the RabbitMQ version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.8.31/guides/rabbitmq/concepts/rabbitmq#spectls).
