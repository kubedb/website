...
url: /docs/v2025.8.31/guides/rabbitmq/
aliases:
- /docs/v2025.8.31/guides/rabbitmq/README/
info:
  autoscaler: v0.43.0
  cli: v0.58.0
  dashboard: v0.34.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.8.31/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
