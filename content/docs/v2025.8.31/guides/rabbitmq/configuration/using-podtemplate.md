...
KubeDB supports providing custom configuration for RabbitMQ via [PodTemplate](/docs/v2025.8.31/guides/rabbitmq/concepts/rabbitmq#specpodtemplate). This tutorial will show you how to use KubeDB to run a RabbitMQ database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2025.8.31/guides/rabbitmq/concepts/rabbitmq#specpodtemplate),
...
- [Quickstart rabbitmq](/docs/v2025.8.31/guides/rabbitmq/quickstart/quickstart) with KubeDB Operator.
...
- Monitor your rabbitmq database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.8.31/guides/rabbitmq/monitoring/using-builtin-prometheus).
