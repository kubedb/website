...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2025.8.31/guides/rabbitmq/scaling/vertical-scaling/overview)
...
- Have a look [here](/docs/v2025.8.31/guides/rabbitmq/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
