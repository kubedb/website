...
url: /docs/v2025.8.31/guides/memcached/
aliases:
- /docs/v2025.8.31/guides/memcached/README/
info:
  autoscaler: v0.43.0
  cli: v0.58.0
  dashboard: v0.34.0
...
- Use [kubedb cli](/docs/v2025.8.31/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
