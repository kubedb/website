...
Let's edit an existing running Memcached object to setup [Monitoring](/docs/v2025.8.31/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
...
- Learn how to use custom configuration in Memcached with KubeDB [here](/docs/v2025.8.31/guides/memcached/custom-configuration/using-config-file)
