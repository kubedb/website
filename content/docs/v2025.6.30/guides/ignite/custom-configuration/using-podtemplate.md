...
KubeDB supports providing custom configuration for Ignite via [PodTemplate](/docs/v2025.6.30/guides/ignite/concepts/ignite#specpodtemplate). This tutorial will show you how to use KubeDB to run a Ignite database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2025.6.30/guides/ignite/concepts/ignite#specpodtemplate),
...
- Monitor your Ignite database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.6.30/guides/ignite/monitoring/using-prometheus-operator).
- Monitor your Ignite database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.6.30/guides/ignite/monitoring/using-builtin-prometheus).
