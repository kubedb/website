...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2025.6.30/guides/solr/clustering/combined_cluster)
    - [SolrOpsRequest](/docs/v2025.6.30/guides/solr/concepts/solropsrequests)
    - [Vertical Scaling Overview](/docs/v2025.6.30/guides/solr/scaling/vertical-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/solr](/docs/v2025.6.30/examples/solr) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Different Solr Combined clustering modes [here](/docs/v2025.6.30/guides/solr/clustering/combined_cluster).
