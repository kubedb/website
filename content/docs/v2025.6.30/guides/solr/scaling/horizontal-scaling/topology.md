...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2025.6.30/guides/solr/clustering/topology_cluster)
    - [SolrOpsRequest](/docs/v2025.6.30/guides/solr/concepts/solropsrequests)
    - [Horizontal Scaling Overview](/docs/v2025.6.30/guides/solr/scaling/horizontal-scaling/overview)
