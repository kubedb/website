...
`spec.version` is a required field specifying the name of the [SolrVersion](/docs/v2025.6.30/guides/solr/concepts/solrversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `SolrVersion` crds,
...
- Learn how to use KubeDB to run a Solr server [here](/docs/v2025.6.30/guides/solr/README).
