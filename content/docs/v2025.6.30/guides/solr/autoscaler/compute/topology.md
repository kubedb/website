...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.6.30/examples/solr/autoscaler/compute) of [kubedb/docs](https://github.com/kubedb/docs) repository.
