...
url: /docs/v2025.6.30/guides/ferretdb/
aliases:
- /docs/v2025.6.30/guides/ferretdb/README/
info:
  autoscaler: v0.41.0
  cli: v0.56.0
  dashboard: v0.32.0
...
- [Quickstart FerretDB](/docs/v2025.6.30/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
