...
`spec.databaseRef` is a required field that point to the [FerretDB](/docs/v2025.6.30/guides/ferretdb/concepts/ferretdb) object for which the autoscaling will be performed. This field consists of the following sub-field:
