...
url: /docs/v2025.6.30/guides/mongodb/
aliases:
- /docs/v2025.6.30/guides/mongodb/README/
info:
  autoscaler: v0.41.0
  cli: v0.56.0
  dashboard: v0.32.0
...
- [MongoDB Replicaset](/docs/v2025.6.30/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2025.6.30/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2025.6.30/guides/mongodb/backup/stash/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2025.6.30/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2025.6.30/guides/mongodb/configuration/using-config-file).
