...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Replicaset](/docs/v2025.6.30/guides/mongodb/clustering/replicaset)
  - [MongoDBOpsRequest](/docs/v2025.6.30/guides/mongodb/concepts/opsrequest)
  - [Updating Overview](/docs/v2025.6.30/guides/mongodb/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mongodb](/docs/v2025.6.30/examples/mongodb) directory of [kubedb/docs](https://github.com/kube/docs) repository.
