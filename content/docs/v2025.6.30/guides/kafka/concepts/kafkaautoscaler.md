...
`spec.databaseRef` is a required field that point to the [Kafka](/docs/v2025.6.30/guides/kafka/concepts/kafka) object for which the autoscaling will be performed. This field consists of the following sub-field:
