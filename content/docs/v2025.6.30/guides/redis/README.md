...
url: /docs/v2025.6.30/guides/redis/
aliases:
- /docs/v2025.6.30/guides/redis/README/
info:
  autoscaler: v0.41.0
  cli: v0.56.0
  dashboard: v0.32.0
...
- [Deploy Redis Cluster](/docs/v2025.6.30/guides/redis/clustering/redis-cluster) using KubeDB.
