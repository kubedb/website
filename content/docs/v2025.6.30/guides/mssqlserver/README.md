...
url: /docs/v2025.6.30/guides/mssqlserver/
aliases:
- /docs/v2025.6.30/guides/mssqlserver/README/
info:
  autoscaler: v0.41.0
  cli: v0.56.0
  dashboard: v0.32.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.6.30/guides/mssqlserver/images/mssqlserver-lifecycle.png" >
</p>

## User Guide

- [Quickstart Microsoft SQL Server](/docs/v2025.6.30/guides/mssqlserver/quickstart/quickstart) with KubeDB Operator.
- Detail concepts of [MSSQLServer object](/docs/v2025.6.30/guides/mssqlserver/concepts/mssqlserver).
- [SQL Server Availability Group Clustering](/docs/v2025.6.30/guides/mssqlserver/clustering/ag_cluster) supported by KubeDB.
- How to [Backup & Restore](/docs/v2025.6.30/guides/mssqlserver/backup/overview/) SQL Server using [KubeStash](https://kubestash.com/).
