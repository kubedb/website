...
Read about the fields in details in [mssqlserver concept](/docs/v2025.6.30/guides/mssqlserver/concepts/mssqlserver).
...
- [Backup and Restore](/docs/v2025.6.30/guides/mssqlserver/backup/overview/) MSSQLServer databases using KubeStash. .
