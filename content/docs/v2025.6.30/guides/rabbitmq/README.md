...
url: /docs/v2025.6.30/guides/rabbitmq/
aliases:
- /docs/v2025.6.30/guides/rabbitmq/README/
info:
  autoscaler: v0.41.0
  cli: v0.56.0
  dashboard: v0.32.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.6.30/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>
