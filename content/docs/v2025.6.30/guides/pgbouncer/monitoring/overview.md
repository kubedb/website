...
- Learn how to monitor PgBouncer database with KubeDB using [builtin-Prometheus](/docs/v2025.6.30/guides/pgbouncer/monitoring/using-builtin-prometheus)
- Learn how to monitor PgBouncer database with KubeDB using [Prometheus operator](/docs/v2025.6.30/guides/pgbouncer/monitoring/using-prometheus-operator).
