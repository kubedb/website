...
<figure align="center">
  <img alt="Monitoring process of PgBouncer using Prometheus Operator" src="/docs/v2025.6.30/images/day-2-operation/pgbouncer/prometheus-operator.png">
...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.6.30/guides/pgbouncer/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.6.30/images/pgbouncer/monitoring/pb-coreos-prom-target.png" style="padding:10px">
</p>
...
- Detail concepts of [PgBouncerVersion object](/docs/v2025.6.30/guides/pgbouncer/concepts/catalog).
