...
url: /docs/v2024.1.26-rc.0/guides/mysql/
aliases:
- /docs/v2024.1.26-rc.0/guides/mysql/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.1.26-rc.0/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2024.1.26-rc.0/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.1.26-rc.0/guides/mysql/backup/overview/) MySQL databases using Stash.
