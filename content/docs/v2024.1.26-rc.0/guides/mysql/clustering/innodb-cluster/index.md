...
- Read [mysql group replication concept](/docs/v2024.1.26-rc.0/guides/mysql/clustering/overview/) to learn about MySQL Group Replication.
...
- Detail concepts of [MySQLDBVersion object](/docs/v2024.1.26-rc.0/guides/mysql/concepts/catalog/).
