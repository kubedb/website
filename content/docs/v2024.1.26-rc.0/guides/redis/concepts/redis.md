...
`spec.version` is a required field specifying the name of the [RedisVersion](/docs/v2024.1.26-rc.0/guides/redis/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `RedisVersion` crds,
