...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [RedisAutoscaler](/docs/v2024.1.26-rc.0/guides/redis/concepts/autoscaler)
  - [RedisOpsRequest](/docs/v2024.1.26-rc.0/guides/redis/concepts/redisopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2024.1.26-rc.0/guides/redis/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2024.1.26-rc.0/guides/redis/concepts/redisopsrequest#spectimeout), [apply](/docs/v2024.1.26-rc.0/guides/redis/concepts/redisopsrequest#specapply).
