...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Redis Clustering](/docs/v2024.1.26-rc.0/guides/redis/clustering/redis-cluster)
  - [RedisOpsRequest](/docs/v2024.1.26-rc.0/guides/redis/concepts/redisopsrequest)
  - [updating Overview](/docs/v2024.1.26-rc.0/guides/redis/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/redis](/docs/v2024.1.26-rc.0/examples/redis) directory of [kubedb/docs](https://github.com/kube/docs) repository.
