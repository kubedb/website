...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDBAutoscaler](/docs/v2024.1.26-rc.0/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2024.1.26-rc.0/guides/percona-xtradb/concepts/opsrequest)
  - [Storage Autoscaling Overview](/docs/v2024.1.26-rc.0/guides/percona-xtradb/autoscaler/storage/overview)
