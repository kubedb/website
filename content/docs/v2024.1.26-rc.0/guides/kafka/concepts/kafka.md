...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2024.1.26-rc.0/guides/kafka/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- [Monitor Apache with Prometheus operator](/docs/v2024.1.26-rc.0/guides/kafka/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to run a Apache Kafka cluster [here](/docs/v2024.1.26-rc.0/guides/kafka/README).
- Deploy [dedicated topology cluster](/docs/v2024.1.26-rc.0/guides/kafka/clustering/topology-cluster/) for Apache Kafka
- Deploy [combined cluster](/docs/v2024.1.26-rc.0/guides/kafka/clustering/combined-cluster/) for Apache Kafka
