...
- Read [mongodb arbiter concept](/docs/v2024.1.26-rc.0/guides/mongodb/arbiter/concept) to get the concept about MongoDB Replica Set Arbiter.
...
- Deploy MongoDB shard [with Arbiter](/docs/v2024.1.26-rc.0/guides/mongodb/arbiter/sharding).
