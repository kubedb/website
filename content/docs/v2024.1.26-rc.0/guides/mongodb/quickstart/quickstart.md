...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.1.26-rc.0/images/mongodb/quick-start.png">
</p>
...
When [TerminationPolicy](/docs/v2024.1.26-rc.0/guides/mongodb/concepts/mongodb#specterminationpolicy) is set to halt, and you delete the mongodb object, the KubeDB operator will delete the StatefulSet and its pods but leaves the PVCs, secrets and database backup (snapshots) intact. Learn details of all `TerminationPolicy` [here](/docs/v2024.1.26-rc.0/guides/mongodb/concepts/mongodb#specterminationpolicy).
