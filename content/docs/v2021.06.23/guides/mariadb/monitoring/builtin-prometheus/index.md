...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2021.06.23/guides/mariadb/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2021.06.23/guides/mariadb/monitoring/builtin-prometheus/images/built-prom.png" style="padding:10px">
</p>
