...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2021.06.23/guides/pgbouncer/monitoring/overview).

- You need to have monitoring enabled using either [Builtin Prometheus](/docs/v2021.06.23/guides/pgbouncer/monitoring/using-builtin-prometheus) or [Prometheus operator](/docs/v2021.06.23/guides/pgbouncer/monitoring/using-builtin-prometheus).
...
<p align="center">
  <img alt="Data Target" src="/docs/v2021.06.23/images/pgbouncer/monitoring/pb-grafana-datasource.png" style="padding:10px">
</p>
...
<p align="center">
  <img alt="Data Target" src="/docs/v2021.06.23/images/pgbouncer/monitoring/pb-grafana-importdashboard.png" style="padding:10px">
</p>
