...
`metadata.name` is a required field that specifies the name of the `RedisVersion` crd. You have to specify this name in `spec.version` field of [Redis](/docs/v2021.06.23/guides/redis/concepts/redis) crd.
...
- Learn about Redis crd [here](/docs/v2021.06.23/guides/redis/concepts/redis).
- Deploy your first Redis server with KubeDB by following the guide [here](/docs/v2021.06.23/guides/redis/quickstart/quickstart).
