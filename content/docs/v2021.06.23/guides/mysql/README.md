...
url: /docs/v2021.06.23/guides/mysql/
aliases:
- /docs/v2021.06.23/guides/mysql/README/
info:
  autoscaler: v0.4.0
  cli: v0.19.0
  community: v0.19.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2021.06.23/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2021.06.23/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2021.06.23/guides/mysql/backup/overview/) MySQL databases using Stash.
