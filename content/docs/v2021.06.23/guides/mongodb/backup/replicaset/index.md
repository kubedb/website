...
KubeDB creates an [AppBinding](/docs/v2021.06.23/guides/mongodb/concepts/appbinding) crd that holds the necessary information to connect with the database.
