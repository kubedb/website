...
`spec.databaseRef` is a required field that point to the [MongoDB](/docs/v2021.06.23/guides/mongodb/concepts/mongodb) object for which the autoscaling will be performed. This field consists of the following sub-field:
