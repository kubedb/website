...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while installing KubeDB. To know details about how to enable monitoring see [here](/docs/v2021.01.26/setup/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2021.01.26/images/monitoring/operator/builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn how to monitor KubeDB operator using Prometheus operator from [here](/docs/v2021.01.26/setup/monitoring/prometheus-operator).
