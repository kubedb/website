...
- Monitor your MySQL instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2021.01.26/guides/mysql/monitoring/using-prometheus-operator).
- Monitor your MySQL instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2021.01.26/guides/mysql/monitoring/using-builtin-prometheus).
