...
url: /docs/v2021.01.26/guides/percona-xtradb/
aliases:
- /docs/v2021.01.26/guides/percona-xtradb/README/
info:
  autoscaler: v0.1.2
  cli: v0.16.2
  community: v0.16.2
...
- [Overview](/docs/v2021.01.26/guides/percona-xtradb/overview/overview) of PerconaXtraDB.
- [Quickstart PerconaXtraDB](/docs/v2021.01.26/guides/percona-xtradb/quickstart/quickstart) with KubeDB Operator.
