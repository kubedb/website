...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2021.01.26/images/percona-xtradb/Lifecycle_of_a_PerconaXtraDB.svg">
</p>
...
- How to use [custom rbac resource](/docs/v2021.01.26/guides/percona-xtradb/custom-rbac/using-custom-rbac) for PerconaXtraDB.
