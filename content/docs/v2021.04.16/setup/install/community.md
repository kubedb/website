...
<figure align="center">
  <img alt="KubeDB Backend Overview" src="/docs/v2021.04.16/images/setup/community_license_form.png">
  <figcaption align="center">Fig: KubeDB License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing KubeDB by following the upgrading guide from [here](/docs/v2021.04.16/setup/upgrade/#updating-license).
...
Now, you are ready to [create your first database](/docs/v2021.04.16/guides/README) using KubeDB.
