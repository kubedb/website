...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Replicaset](/docs/v2021.04.16/guides/mongodb/clustering/replicaset)
  - [MongoDBOpsRequest](/docs/v2021.04.16/guides/mongodb/concepts/opsrequest)
  - [Upgrading Overview](/docs/v2021.04.16/guides/mongodb/upgrading/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mongodb](/docs/v2021.04.16/examples/mongodb) directory of [kubedb/docs](https://github.com/kube/docs) repository.
