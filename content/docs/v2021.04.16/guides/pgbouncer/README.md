...
url: /docs/v2021.04.16/guides/pgbouncer/
aliases:
- /docs/v2021.04.16/guides/pgbouncer/README/
info:
  autoscaler: v0.3.0
  cli: v0.18.0
  community: v0.18.0
...
- [Quickstart PgBouncer](/docs/v2021.04.16/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.04.16/guides/pgbouncer/monitoring/using-builtin-prometheus).
