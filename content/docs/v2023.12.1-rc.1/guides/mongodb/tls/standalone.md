...
Below is the YAML for MongoDB Standalone. Here, [`spec.sslMode`](/docs/v2023.12.1-rc.1/guides/mongodb/concepts/mongodb#specsslMode) specifies `sslMode` for `standalone` (which is `requireSSL`).
