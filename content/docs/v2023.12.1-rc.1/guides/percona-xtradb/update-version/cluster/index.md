...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2023.12.1-rc.1/guides/percona-xtradb/clustering/overview)
  - [PerconaXtraDBOpsRequest](/docs/v2023.12.1-rc.1/guides/percona-xtradb/concepts/opsrequest)
  - [updating Overview](/docs/v2023.12.1-rc.1/guides/percona-xtradb/update-version/overview)
