...
- You should be familiar with the following `KubeDB` concepts:
  - [MySQL](/docs/v2023.12.1-rc.1/guides/mysql/concepts/)
...
<figure align="center">
  <img alt="Reconfiguring process of MySQL" src="/docs/v2023.12.1-rc.1/guides/mysql/reconfigure/overview/reconfigure.jpg">
