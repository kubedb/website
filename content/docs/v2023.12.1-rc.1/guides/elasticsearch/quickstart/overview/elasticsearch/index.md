...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2023.12.1-rc.1/guides/elasticsearch/quickstart/overview/elasticsearch/images/Lifecycle-of-an-Elasticsearch-CRD.png">
</p>
...
Now, install the KubeDB operator in your cluster following the steps [here](/docs/v2023.12.1-rc.1/setup/install/_index).
...
> We have designed this tutorial to demonstrate a production setup of KubeDB managed Elasticsearch. If you just want to try out KubeDB, you can bypass some safety features following the tips [here](/docs/v2023.12.1-rc.1/guides/elasticsearch/quickstart/overview/elasticsearch/#tips-for-testing).
...
When you install the KubeDB operator, it registers a CRD named [ElasticsearchVersion](/docs/v2023.12.1-rc.1/guides/elasticsearch/concepts/catalog/). The installation process comes with a set of tested ElasticsearchVersion objects. Let's check available ElasticsearchVersions by,
...
kubedb-xpack-7.14.0         7.14.0    KubeDB         kubedb/elasticsearch:7.14.0-xpack-v2021.08.23                      4h24m
kubedb-xpack-7.16.2         7.16.2    KubeDB         kubedb/elasticsearch:7.16.2-xpack-v2021.12.24                      4h24m
kubedb-xpack-7.9.1          7.9.1     KubeDB         kubedb/elasticsearch:7.9.1-xpack-v2021.08.23                       4h24m
kubedb-xpack-8.2.0          8.2.0     KubeDB         kubedb/elasticsearch:8.2.0-xpack-v2022.05.24                       4h24m
...
opendistro-1.11.0           7.9.1     OpenDistro     amazon/opendistro-for-elasticsearch:1.10.1                         4h24m
opendistro-1.12.0           7.10.0    OpenDistro     amazon/opendistro-for-elasticsearch:1.12.0                         4h24m
...
opensearch-1.2.2            1.2.2     OpenSearch     opensearchproject/opensearch:1.2.2                                 4h24m
opensearch-1.3.2            1.3.2     OpenSearch     opensearchproject/opensearch:1.3.2                                 4h24m
...
searchguard-7.14.2          7.14.2    SearchGuard    floragunncom/sg-elasticsearch:7.14.2-52.3.0                        4h24m
...
searchguard-7.5.2-v1        7.5.2     SearchGuard    floragunncom/sg-elasticsearch:7.5.2-oss-40.0.0                     4h24m
searchguard-7.8.1           7.8.1     SearchGuard    floragunncom/sg-elasticsearch:7.8.1-oss-43.0.0                     4h24m
searchguard-7.9.3           7.9.3     SearchGuard    floragunncom/sg-elasticsearch:7.9.3-oss-47.1.0                     4h24m
...
xpack-7.14.0                7.14.0    ElasticStack   elasticsearch:7.14.0                                               4h24m
xpack-7.16.2                7.16.2    ElasticStack   elasticsearch:7.16.2                                               4h24m
...
xpack-7.9.1-v1              7.9.1     ElasticStack   elasticsearch:7.9.1                                                4h24m
xpack-7.9.1-v2              7.9.1     ElasticStack   elasticsearch:7.9.1                                                4h24m
xpack-8.2.0                 8.2.0     ElasticStack   elasticsearch:8.2.0                                                4h24m
...
- `AppBinding` - an [AppBinding](/docs/v2023.12.1-rc.1/guides/elasticsearch/concepts/appbinding/) which hold to connect information for the database. It is also named after the Elastics
...
2. **Use `terminationPolicy: WipeOut`**. It is nice to be able to resume the database from the previous one. So, we preserve all your `PVCs` and auth `Secrets`. If you don't want to resume the database, you can just use `spec.terminationPolicy: WipeOut`. It will clean up every resouce that was created with the Elasticsearch CR. For more details, please visit [here](/docs/v2023.12.1-rc.1/guides/elasticsearch/concepts/elasticsearch/#specterminationpolicy).

## Next Steps

- [Quickstart Kibana](/docs/v2023.12.1-rc.1/guides/elasticsearch/elasticsearch-dashboard/kibana/) with KubeDB Operator.
- Learn how to configure [Elasticsearch Topology Cluster](/docs/v2023.12.1-rc.1/guides/elasticsearch/clustering/topology-cluster/simple-dedicated-cluster/).
- Learn about [backup & restore](/docs/v2023.12.1-rc.1/guides/elasticsearch/backup/overview/) Elasticsearch database using Stash.
- Monitor your Elasticsearch database with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.12.1-rc.1/guides/elasticsearch/monitoring/using-builtin-prometheus).
- Monitor your Elasticsearch database with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2023.12.1-rc.1/guides/elasticsearch/monitoring/using-prometheus-operator).
- Detail concepts of [Elasticsearch object](/docs/v2023.12.1-rc.1/guides/elasticsearch/concepts/elasticsearch/).
- Use [private Docker registry](/docs/v2023.12.1-rc.1/guides/elasticsearch/private-registry/using-private-registry) to deploy Elasticsearch with KubeDB.
