...
- Read [concept of MariaDB Version Catalog](/docs/v2023.12.1-rc.1/guides/mariadb/concepts/mariadb-version) to learn detail concepts of `MariaDBVersion` object.
