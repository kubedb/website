...
- Read [redis clustering concept](/docs/v2023.12.1-rc.1/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2023.12.1-rc.1/guides/redis/sentinel/overview)
