...
`spec.databaseRef` is a required field that point to the [Redis](/docs/v2023.12.1-rc.1/guides/redis/concepts/redis) object where the administrative operations will be applied. This field consists of the following sub-field:
...
- `spec.updateVersion.targetVersion` refers to a [RedisVersion](/docs/v2023.12.1-rc.1/guides/redis/concepts/catalog) CR that contains the Redis version information where you want to update.
