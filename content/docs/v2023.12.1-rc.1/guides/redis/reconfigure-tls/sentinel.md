...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2023.12.1-rc.1/guides/redis/concepts/redis#spectls).
