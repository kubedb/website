...
- If you are not familiar with how Stash backup and restore Redis databases, please check the following guide [here](/docs/v2023.12.1-rc.1/guides/redis/backup/overview/).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.12.1-rc.1/guides/redis/backup/auto-backup/images/sample-redis-1.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.12.1-rc.1/guides/redis/backup/auto-backup/images/sample-redis-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.12.1-rc.1/guides/redis/backup/auto-backup/images/sample-redis-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
