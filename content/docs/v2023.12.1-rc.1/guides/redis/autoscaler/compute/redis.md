...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Resource Autoscaling Overview](/docs/v2023.12.1-rc.1/guides/redis/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2023.12.1-rc.1/guides/redis/concepts/redisopsrequest#spectimeout), [apply](/docs/v2023.12.1-rc.1/guides/redis/concepts/redisopsrequest#specapply).
