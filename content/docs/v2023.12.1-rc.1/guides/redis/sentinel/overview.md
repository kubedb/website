...
![redis-sentinel](/docs/v2023.12.1-rc.1/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.12.1-rc.1/guides/redis/sentinel/redis-sentinel) using KubeDB.
