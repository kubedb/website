...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MongoDBAutoscaler](/docs/v2023.06.19/guides/mongodb/concepts/autoscaler)
  - [MongoDBOpsRequest](/docs/v2023.06.19/guides/mongodb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2023.06.19/guides/mongodb/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2023.06.19/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2023.06.19/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2023.06.19/guides/mongodb/concepts/opsrequest#specapply).
