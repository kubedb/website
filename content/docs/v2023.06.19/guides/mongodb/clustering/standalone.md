...
- `spec.podTemplate` specifies the resources and other specifications of the pod. Have a look [here](/docs/v2023.06.19/guides/mongodb/concepts/mongodb#specpodtemplate) to know the other subfields of the podTemplate.
...
When [TerminationPolicy](/docs/v2023.06.19/guides/mongodb/concepts/mongodb#specterminationpolicy) is set to halt, and you delete the mongodb object, the KubeDB operator will delete the StatefulSet and its pods but leaves the PVCs, secrets and database backup (snapshots) intact. Learn details of all `TerminationPolicy` [here](/docs/v2023.06.19/guides/mongodb/concepts/mongodb#specterminationpolicy).
...
- Deploy MongoDB [ReplicaSet](/docs/v2023.06.19/guides/mongodb/clustering/replication_concept)
- [Backup and Restore](/docs/v2023.06.19/guides/mongodb/backup/overview/) process of MongoDB databases using Stash.
...
- Detail concepts of [MongoDBVersion object](/docs/v2023.06.19/guides/mongodb/concepts/catalog).
