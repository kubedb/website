...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2023.06.19/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [backup and restore](/docs/v2023.06.19/guides/mongodb/backup/overview/) MongoDB database using Stash.
- Learn how to configure [MongoDB Topology](/docs/v2023.06.19/guides/mongodb/clustering/sharding).
