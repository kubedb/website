...
![redis-sentinel](/docs/v2023.06.19/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.06.19/guides/redis/sentinel/redis-sentinel) using KubeDB.
