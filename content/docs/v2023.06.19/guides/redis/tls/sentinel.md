...
Read about the fields in details in [redis concept](/docs/v2023.06.19/guides/redis/concepts/redis) and [redissentinel concept](/docs/v2023.06.19/guides/redis/concepts/redissentinel)
...
- [Backup and Restore](/docs/v2023.06.19/guides/redis/backup/overview/) Redis databases using Stash. .
- Monitor your Redis database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2023.06.19/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2023.06.19/guides/redis/monitoring/using-builtin-prometheus).
