...
Now, create a secret with structure defined [here](/docs/v2025.7.30-rc.0/guides/pgpool/concepts/pgpool#specsyncusers). Below is the YAML of the `secret` that we are going to create,
