...
Read about the fields in details in [mssqlserver concept](/docs/v2025.7.30-rc.0/guides/mssqlserver/concepts/mssqlserver).
...
- [Backup and Restore](/docs/v2025.7.30-rc.0/guides/mssqlserver/backup/overview/) MSSQLServer databases using KubeStash.