...
url: /docs/v2025.7.30-rc.0/guides/mysql/
aliases:
- /docs/v2025.7.30-rc.0/guides/mysql/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.7.30-rc.0/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2025.7.30-rc.0/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2025.7.30-rc.0/guides/mysql/backup/stash/overview/) MySQL databases using Stash.
