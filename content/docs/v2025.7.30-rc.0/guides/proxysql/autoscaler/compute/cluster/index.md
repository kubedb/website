...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [ProxySQLAutoscaler](/docs/v2025.7.30-rc.0/guides/proxysql/concepts/autoscaler)
  - [ProxySQLOpsRequest](/docs/v2025.7.30-rc.0/guides/proxysql/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2025.7.30-rc.0/guides/proxysql/autoscaler/compute/overview)
