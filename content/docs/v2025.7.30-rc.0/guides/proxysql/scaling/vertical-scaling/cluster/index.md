...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Clustering](/docs/v2025.7.30-rc.0/guides/proxysql/clustering/proxysql-cluster)
    - [ProxySQLOpsRequest](/docs/v2025.7.30-rc.0/guides/proxysql/concepts/opsrequest)
    - [Vertical Scaling Overview](/docs/v2025.7.30-rc.0/guides/proxysql/scaling/vertical-scaling/overview)
