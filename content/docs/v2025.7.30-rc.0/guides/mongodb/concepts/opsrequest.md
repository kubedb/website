...
`spec.databaseRef` is a required field that point to the [MongoDB](/docs/v2025.7.30-rc.0/guides/mongodb/concepts/mongodb) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [MongoDB](/docs/v2025.7.30-rc.0/guides/mongodb/concepts/mongodb) object.
...
- `spec.updateVersion.targetVersion` refers to a [MongoDBVersion](/docs/v2025.7.30-rc.0/guides/mongodb/concepts/catalog) CR that contains the MongoDB version information where you want to update.

Have a look on the [`updateConstraints`](/docs/v2025.7.30-rc.0/guides/mongodb/concepts/catalog#specupdateconstraints) of the mongodbVersion spec to know which versions are supported for updating from the current version.
```yaml
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.7.30-rc.0/guides/mongodb/concepts/mongodb#spectls).
