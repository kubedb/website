...
url: /docs/v2025.7.30-rc.0/guides/ferretdb/
aliases:
- /docs/v2025.7.30-rc.0/guides/ferretdb/README/
info:
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2025.7.30-rc.0/images/ferretdb/quick-start.png" >
</p>

## User Guide

- [Quickstart FerretDB](/docs/v2025.7.30-rc.0/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
