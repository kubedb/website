...
- Read [redis clustering concept](/docs/v2025.7.30-rc.0/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2025.7.30-rc.0/guides/redis/sentinel/overview)
