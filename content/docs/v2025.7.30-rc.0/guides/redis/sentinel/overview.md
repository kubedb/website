...
![redis-sentinel](/docs/v2025.7.30-rc.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2025.7.30-rc.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
