...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2021.01.02-rc.0/guides/elasticsearch/configuration/overview).
