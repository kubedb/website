...
url: /docs/v2026.6.19/operatormanual/migration/
aliases:
- /docs/v2026.6.19/operatormanual/migration/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
Add `--set kubedb-courier.enabled=true` to the standard [KubeDB helm install](/docs/v2026.6.19/setup/install/kubedb/helm) guide.
...
Add `--set kubedb-courier.enabled=true` to the [Kubedb helm upgrade](/docs/v2026.6.19/setup/upgrade/) 
...
[PostgreSQL](/docs/v2026.6.19/guides/postgres/migration/databaseMigration)

[MySQL](/docs/v2026.6.19/guides/mysql/migration/databaseMigration)

[MariaDB](/docs/v2026.6.19/guides/mariadb/migration/databaseMigration)

[MongoDB](/docs/v2026.6.19/guides/mongodb/migration/databaseMigration)
