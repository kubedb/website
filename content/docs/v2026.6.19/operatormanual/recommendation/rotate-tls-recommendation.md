...
> **Note:** Recommendations work across most KubeDB-managed databases. The walkthrough below uses [Elasticsearch](/docs/v2026.6.19/guides/elasticsearch) as a concrete example.
...
See [Maintenance Window](/docs/v2026.6.19/operatormanual/recommendation/maintenance-window) for the complete reference.
...
See [Approval Policy](/docs/v2026.6.19/operatormanual/recommendation/approval-policy) for the complete reference.

### 3. Or use a cluster-wide default

If you would rather set one default for the whole cluster, replace the namespace-scoped `MaintenanceWindow` with a `ClusterMaintenanceWindow` and point `maintenanceWindowRef.kind` at it. See [Cluster Maintenance Window](/docs/v2026.6.19/operatormanual/recommendation/cluster-maintenance-window).
