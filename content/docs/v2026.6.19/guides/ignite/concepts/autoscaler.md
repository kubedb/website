...
`spec.databaseRef` is a required field that point to the [Ignite](/docs/v2026.6.19/guides/ignite/concepts/ignite) object for which the autoscaling will be performed. This field consists of the following sub-field:
