...
url: /docs/v2026.6.19/guides/hazelcast/
aliases:
- /docs/v2026.6.19/guides/hazelcast/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.19/guides/hazelcast/quickstart/overview/images/Lifecycle-of-a-hazelcast-instance.png">
</p>

## User Guide

- [Quickstart Hazelcast](/docs/v2026.6.19/guides/hazelcast/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Hazelcast Object](/docs/v2026.6.19/guides/hazelcast/concepts/hazelcast).
