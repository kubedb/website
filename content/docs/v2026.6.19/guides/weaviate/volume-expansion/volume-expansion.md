...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.6.19/guides/weaviate/volume-expansion/overview)
...
- Detail concepts of [Weaviate object](/docs/v2026.6.19/guides/weaviate/concepts/weaviate).
- Automatically scale the storage with the [Storage Autoscaler](/docs/v2026.6.19/guides/weaviate/autoscaler/storage/storage-autoscale).
