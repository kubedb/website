...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.6.19/guides/weaviate/reconfigure/overview)
...
- Learn how to supply a [custom configuration](/docs/v2026.6.19/guides/weaviate/configuration/using-config-file) at provisioning time.
