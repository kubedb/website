...
url: /docs/v2026.6.19/guides/weaviate/
aliases:
- /docs/v2026.6.19/guides/weaviate/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
- [Quickstart Weaviate](/docs/v2026.6.19/guides/weaviate/quickstart/quickstart) with KubeDB operator.
- Use [custom configuration](/docs/v2026.6.19/guides/weaviate/configuration/using-config-file) for Weaviate.
- Secure your cluster with [TLS](/docs/v2026.6.19/guides/weaviate/tls/overview).
- Run day-2 operations with [Ops Requests](/docs/v2026.6.19/guides/weaviate/restart/restart) and [Autoscaler](/docs/v2026.6.19/guides/weaviate/autoscaler/compute/compute-autoscale).
