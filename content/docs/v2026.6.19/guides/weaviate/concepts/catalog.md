...
- Learn about the [Weaviate CRD](/docs/v2026.6.19/guides/weaviate/concepts/weaviate).
- Deploy your first Weaviate database with the [Quickstart](/docs/v2026.6.19/guides/weaviate/quickstart/quickstart).
