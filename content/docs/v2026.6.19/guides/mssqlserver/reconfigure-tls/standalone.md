...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.6.19/guides/mssqlserver/concepts/mssqlserver#spectls).
...
- Monitor your MSSQLServer database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.6.19/guides/mssqlserver/monitoring/using-prometheus-operator).
