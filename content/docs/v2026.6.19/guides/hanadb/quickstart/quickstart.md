...
- Install the KubeDB **Provisioner** and **Ops-manager** operators in your cluster following the steps
  [here](/docs/v2026.6.19/setup/README), with the HanaDB feature and catalog enabled.
...
- Apply [custom configuration](/docs/v2026.6.19/guides/hanadb/configuration/using-config-file).
- Set up [monitoring](/docs/v2026.6.19/guides/hanadb/monitoring/using-builtin-prometheus) and [TLS](/docs/v2026.6.19/guides/hanadb/tls/overview).
