...
- [Restart](/docs/v2026.6.19/guides/hanadb/restart/restart) it (primary restarted last),
- [Vertically scale](/docs/v2026.6.19/guides/hanadb/scaling/vertical-scaling/vertical-scaling) the nodes,
- Enable [TLS](/docs/v2026.6.19/guides/hanadb/tls/overview), and
- [Migrate storage](/docs/v2026.6.19/guides/hanadb/storage-migration/storage-migration).
...
- Detailed concepts of the [HanaDB object](/docs/v2026.6.19/guides/hanadb/concepts/hanadb).
- Review the [HanaDBOpsRequest CRD](/docs/v2026.6.19/guides/hanadb/concepts/opsrequest).
