...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [KafkaAutoscaler](/docs/v2026.6.19/guides/kafka/concepts/kafkaautoscaler)
    - [KafkaOpsRequest](/docs/v2026.6.19/guides/kafka/concepts/kafkaopsrequest)
    - [Storage Autoscaling Overview](/docs/v2026.6.19/guides/kafka/autoscaler/storage/overview)
...
- Different Kafka topology clustering modes [here](/docs/v2026.6.19/guides/kafka/clustering/_index).
