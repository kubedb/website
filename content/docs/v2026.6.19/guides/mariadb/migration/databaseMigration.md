...
- You should be familiar with the following `KubeDB` concepts:
    - [AppBinding](/docs/v2026.6.19/guides/mariadb/concepts/appbinding/)
    - [MariaDB](/docs/v2026.6.19/guides/mariadb/concepts/mariadb)
    - [Migration](/docs/v2026.6.19/guides/mariadb/concepts/migrator/)
...
Here we scope the migration to the `shop` database (`schema.database: [shop]`), enable both the bulk snapshot and CDC streaming phases, and cap connections at 100 on each side. For a full description of every field, see the [Migration CRD reference](/docs/v2026.6.19/guides/mariadb/concepts/migrator/).
