...
builtin-prom-md   11.8.5    Ready    76s
```
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.6.19/guides/mariadb/monitoring/builtin-prometheus/images/built-prom.png" style="padding:10px">
</p>
