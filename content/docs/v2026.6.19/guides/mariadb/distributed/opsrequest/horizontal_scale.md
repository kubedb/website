...
- Install `KubeDB` Community and Enterprise operator in your hub cluster following the steps [here](/docs/v2026.6.19/setup/README). Make sure to enable OCM support:
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Horizontal Scaling Overview](/docs/v2026.6.19/guides/mariadb/scaling/horizontal-scaling/overview/)
