...
- At first, you need to have a multi-cluster Kubernetes setup with OCM and KubeSlice configured. Follow the [Distributed MariaDB Overview](/docs/v2026.6.19/guides/mariadb/distributed/overview) guide to set up the required infrastructure.

- Install `KubeDB` Community, Ops-Manager and Autoscaler operator in your hub cluster following the steps [here](/docs/v2026.6.19/setup/README). Make sure to enable OCM support:
  ```bash
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Distributed MariaDB Compute Autoscaling Overview](/docs/v2026.6.19/guides/mariadb/distributed/autoscaler/compute/overview)
