...
Read about the fields in details from [elasticsearch concept](/docs/v2026.6.19/guides/elasticsearch/concepts/elasticsearch/).
...
<figure align="center">
<img alt="Deploy Elasticsearch with TLS/SSL" src="/docs/v2026.6.19/images/elasticsearch/es-tls.svg">
