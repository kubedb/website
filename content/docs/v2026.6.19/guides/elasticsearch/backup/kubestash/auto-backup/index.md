...
- If you are not familiar with how KubeStash backup and restore `Elasticsearch` databases, please check the following guide [here](/docs/v2026.6.19/guides/elasticsearch/backup/kubestash/overview/).
