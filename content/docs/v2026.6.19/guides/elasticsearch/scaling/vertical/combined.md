...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2026.6.19/guides/elasticsearch/clustering/combined-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.6.19/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Vertical Scaling Overview](/docs/v2026.6.19/guides/elasticsearch/scaling/vertical/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/elasticsearch](/docs/v2026.6.19/examples/elasticsearch) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Different Elasticsearch topology clustering modes [here](/docs/v2026.6.19/guides/elasticsearch/clustering/_index).
