...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology Cluster](/docs/v2026.6.19/guides/elasticsearch/clustering/topology-cluster/simple-dedicated-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.6.19/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Reconfigure Overview](/docs/v2026.6.19/guides/elasticsearch/reconfigure/overview)
...
- Different Elasticsearch topology clustering modes [here](/docs/v2026.6.19/guides/elasticsearch/clustering/topology-cluster/hot-warm-cold-cluster/).
