...
url: /docs/v2026.6.19/guides/zookeeper/
aliases:
- /docs/v2026.6.19/guides/zookeeper/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.19/images/zookeeper/zookeeper-lifecycle.png">
</p>

## User Guide

- [Quickstart ZooKeeper](/docs/v2026.6.19/guides/zookeeper/quickstart/quickstart) with KubeDB Operator.
- Detail Concept of [ZooKeeper Object](/docs/v2026.6.19/guides/zookeeper/concepts/zookeeper).
