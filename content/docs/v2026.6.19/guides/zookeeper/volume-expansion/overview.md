...
<figure align="center">
  <img alt="Volume Expansion process of ZooKeeper" src="/docs/v2026.6.19/images/day-2-operation/zookeeper/zk-volume-expansion.svg">
...
In the [next](/docs/v2026.6.19/guides/zookeeper/volume-expansion/volume-expansion) docs, we are going to show a step-by-step guide on Volume Expansion of various ZooKeeper database components using `ZooKeeperOpsRequest` CRD.
