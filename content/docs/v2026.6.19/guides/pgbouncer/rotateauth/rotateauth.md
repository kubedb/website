...
**If you just want to try out KubeDB, you can bypass some of the safety features following the tips [here](/docs/v2026.6.19/guides/pgbouncer/quickstart/quickstart#tips-for-testing).**

> Note: Before you begin, you have to create `PgBouncer` CRD with the help of [this](/docs/v2026.6.19/guides/pgbouncer/quickstart/quickstart).
