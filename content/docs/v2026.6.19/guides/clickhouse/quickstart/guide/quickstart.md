...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.19/guides/clickhouse/quickstart/images/clickhouse-lifecycle.png">
</p>
...
- Now, install KubeDB cli on your workstation and KubeDB operator in your cluster following the steps [here](/docs/v2026.6.19/setup/README) and make sure to include the flags `--set global.featureGates.ClickHouse=true` to ensure **ClickHouse CRD**  with helm command.
