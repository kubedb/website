...
url: /docs/v2026.6.19/guides/documentdb/
aliases:
- /docs/v2026.6.19/guides/documentdb/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
- [Custom Configuration](/docs/v2026.6.19/guides/documentdb/configuration/using-config-file) using a config file.
- [Reconfigure](/docs/v2026.6.19/guides/documentdb/reconfigure/reconfigure) a running DocumentDB database.
- [Failover & Disaster Recovery](/docs/v2026.6.19/guides/documentdb/failure-and-disaster-recovery/failover) of a DocumentDB cluster.
