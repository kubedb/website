...
- Install KubeDB following the steps [here](/docs/v2026.6.19/setup/README).
...
> [Custom Configuration](/docs/v2026.6.19/guides/documentdb/configuration/using-config-file/)) is
> unaffected.
...
finish bootstrapping (see the [Restart](/docs/v2026.6.19/guides/documentdb/restart/) guide), so the
...
- Provision a database with [Custom Configuration](/docs/v2026.6.19/guides/documentdb/configuration/using-config-file/).
- [Restart](/docs/v2026.6.19/guides/documentdb/restart/) a DocumentDB database.
