...
instances did not finish bootstrapping (see the [Restart](/docs/v2026.6.19/guides/documentdb/restart/)
...
- [Storage migration](/docs/v2026.6.19/guides/documentdb/storage-migration/) to a different StorageClass.
- [Storage autoscaling](/docs/v2026.6.19/guides/documentdb/autoscaler/storage/) of a DocumentDB cluster.
