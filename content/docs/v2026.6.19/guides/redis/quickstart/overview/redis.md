...
- Monitor your Redis server with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.6.19/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis server with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.6.19/guides/redis/monitoring/using-builtin-prometheus).
