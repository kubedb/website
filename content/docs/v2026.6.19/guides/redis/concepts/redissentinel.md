...
`spec.version` is a required field specifying the name of the [RedisVersion](/docs/v2026.6.19/guides/redis/concepts/catalog) crd where the docker images are specified. RedisSentinel is supported in following Redis Versions.
