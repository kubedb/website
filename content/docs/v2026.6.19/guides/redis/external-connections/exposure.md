...
Read about the fields in details in [redis concept](/docs/v2026.6.19/guides/redis/concepts/redis)
...
- [Backup and Restore](/docs/v2026.6.19/guides/redis/backup/kubestash/overview/) Redis databases using KubeStash.
- Initialize [Redis with Script](/docs/v2026.6.19/guides/redis/initialization/using-script).
- Monitor your Redis database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.6.19/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.6.19/guides/redis/monitoring/using-builtin-prometheus).
