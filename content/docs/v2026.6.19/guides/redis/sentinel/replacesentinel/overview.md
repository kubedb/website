...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2026.6.19/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2026.6.19/guides/redis/sentinel/replacesentinel/replace-sentinel)