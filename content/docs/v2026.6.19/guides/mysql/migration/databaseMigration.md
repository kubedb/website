...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [MySQL](/docs/v2026.6.19/guides/mysql/concepts/mysqldatabase)
    - [Migration](/docs/v2026.6.19/guides/mysql/concepts/migrator/)
...
Here we scope the migration to the `shop` database (`schema.database: [shop]`), enable both the bulk snapshot and CDC streaming phases, and cap connections at 100 on each side. For a full description of every field, see the [Migration CRD reference](/docs/v2026.6.19/guides/mysql/concepts/migrator/).
