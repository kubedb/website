...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.6.19/guides/milvus/volume-expansion/overview)
...
- Learn about [storage migration](/docs/v2026.6.19/guides/milvus/storage-migration/guide) of a Milvus database.
