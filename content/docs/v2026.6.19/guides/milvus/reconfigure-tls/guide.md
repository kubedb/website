...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure TLS Overview](/docs/v2026.6.19/guides/milvus/reconfigure-tls/overview)
...
- Deploy a [TLS-secured Milvus](/docs/v2026.6.19/guides/milvus/tls/configure/) from the start.
