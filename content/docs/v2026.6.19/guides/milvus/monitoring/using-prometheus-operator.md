...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Monitoring Overview](/docs/v2026.6.19/guides/milvus/monitoring/overview)
...
Monitoring is enabled through `spec.monitor`. The base [standalone](/docs/v2026.6.19/guides/milvus/quickstart/standalone) and [distributed](/docs/v2026.6.19/guides/milvus/quickstart/distributed) manifests already include it:
