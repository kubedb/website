...
> These base manifests already include **Prometheus Operator monitoring** and **TLS** — see the [monitoring](/docs/v2026.6.19/guides/milvus/monitoring/using-prometheus-operator) and [TLS](/docs/v2026.6.19/guides/milvus/tls/configure/) guides.
...
- [Monitor](/docs/v2026.6.19/guides/milvus/monitoring/using-prometheus-operator) your Milvus cluster.
- [Horizontally scale](/docs/v2026.6.19/guides/milvus/scaling/horizontal-scaling/guide) the distributed roles.
