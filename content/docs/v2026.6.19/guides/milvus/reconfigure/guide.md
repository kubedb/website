...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.6.19/guides/milvus/reconfigure/overview)

- An object-storage secret named `my-release-minio` must exist in the `demo` namespace (Milvus requires object storage). See the [quickstart](/docs/v2026.6.19/guides/milvus/quickstart/standalone) for details.
...
Deploy a standalone Milvus and wait for it to become `Ready` (see the [standalone quickstart](/docs/v2026.6.19/guides/milvus/quickstart/standalone)):
...
- Learn how to [restart](/docs/v2026.6.19/guides/milvus/restart/guide) a Milvus database.
