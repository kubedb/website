...
We wil use the [kubedb_plugin](/docs/v2026.6.19/setup/README) for generating configuration for remote replica. It will create the appbinding and necessary secrets to connect with source server
```bash
...
We have prepared another cluster in london region for replicating across cluster. follow the installation instruction [above](/docs/v2026.6.19/README).
