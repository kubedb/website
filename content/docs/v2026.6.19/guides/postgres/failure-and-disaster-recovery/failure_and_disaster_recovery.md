...
![img.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img.png)
...
![img_1.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_1.png)
...
![img_2.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_2.png)
...
![img_3.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_3.png)

After 10-30 second, the deleted pods will be back and will have its role.

![img_4.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_4.png)
...
![img_5.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_5.png)

Shortly both of the pods will be back with its role.

![img_6.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_6.png)
...
```
![img_7.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_7.png)

Within 20-30 second, all of the pod should be back.

![img_8.png](/docs/v2026.6.19/guides/postgres/failure-and-disaster-recovery/img_8.png)
...
[Backup and Restore](/docs/v2026.6.19/guides/postgres/backup)

Youtube video Links: [link](https://www.youtube.com/watch?v=j9y5MsB-guQ)


## A Guide to Postgres PITR
Documentaion Link: [PITR](/docs/v2026.6.19/guides/postgres/pitr)
...
For more details, please check the full section [here](/docs/v2026.6.19/guides/postgres/volume-expansion/Overview/overview).
