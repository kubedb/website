...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2026.6.19/setup/README)  and make sure install with helm command including `--set global.featureGates.Qdrant=true` to ensure MSSQLServer CRD installation.
