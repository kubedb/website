...
- Now, install `KubeDB` in your cluster following the steps [here](/docs/v2026.6.19/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [Qdrant](/docs/v2026.6.19/guides/qdrant/concepts/qdrant)
  - [QdrantOpsRequest](/docs/v2026.6.19/guides/qdrant/concepts/opsrequest)
  - [TLS Overview](/docs/v2026.6.19/guides/qdrant/tls/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/qdrant/reconfigure-tls](/docs/v2026.6.19/examples/qdrant/reconfigure-tls) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.timeout` specifies the timeout for the operation (learn more [here](/docs/v2026.6.19/guides/qdrant/concepts/opsrequest#spectimeout)).
- `spec.apply` specifies when to apply the operation (learn more [here](/docs/v2026.6.19/guides/qdrant/concepts/opsrequest#specapply)).
...
- Learn about [backup and restore](/docs/v2026.6.19/guides/qdrant/backup/overview/) Qdrant using KubeStash.
- Detail concepts of [Qdrant object](/docs/v2026.6.19/guides/qdrant/concepts/qdrant).
