...
- You should be familiar with the following `KubeDB` concepts:
    - [Solr](/docs/v2026.6.19/guides/solr/concepts/solr)
    - [SolrOpsRequest](/docs/v2026.6.19/guides/solr/concepts/solropsrequests)
    - [Updating Overview](/docs/v2026.6.19/guides/solr/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/Solr](/docs/v2026.6.19/examples/solr) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
> **Note:** If you want to update combined Solr, you just refer to the `Solr` combined object name in `spec.databaseRef.name`. To create a combined Solr, you can refer to the [Solr Combined](/docs/v2026.6.19/guides/solr/clustering/combined_cluster) guide.
