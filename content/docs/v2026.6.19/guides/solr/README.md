...
url: /docs/v2026.6.19/guides/solr/
aliases:
- /docs/v2026.6.19/guides/solr/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.19/guides/solr/quickstart/overview/images/Lifecycle-of-a-Solr-instance.png">
</p>

## User Guide

- [Quickstart Solr](/docs/v2026.6.19/guides/solr/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Solr Object](/docs/v2026.6.19/guides/solr/concepts/solr).
