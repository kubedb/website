...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [ProxySQL Cluster](/docs/v2026.6.19/guides/proxysql/clustering/overview/)
...
> You can find the load.sh file [here](/docs/v2026.6.19/guides/proxysql/clustering/proxysql-cluster/examples/load.sh)
