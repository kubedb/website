...
See the [Declarative Configuration](/docs/v2026.6.19/guides/proxysql/concepts/declarative-configuration/) concept page for the full field-by-field reference.
...
- Learn about [ProxySQL Declarative Configuration](/docs/v2026.6.19/guides/proxysql/concepts/declarative-configuration/) in detail.
- Learn about [ProxySQL clustering](/docs/v2026.6.19/guides/proxysql/clustering/overview/) with KubeDB.
