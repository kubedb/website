...
`spec.version` is a required field specifying the name of the [CassandraVersion](/docs/v2026.6.19/guides/cassandra/concepts/cassandraversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Cassandra` resources,
...
- [Monitor Apache Cassandra with Prometheus operator](/docs/v2026.6.19/guides/cassandra/monitoring/using-prometheus-operator)
- [Monitor Apache Cassandra with Built-in Prometheus](/docs/v2026.6.19/guides/cassandra/monitoring/using-builtin-prometheus)
...
- Learn how to use KubeDB to run Apache Cassandra cluster [here](/docs/v2026.6.19/guides/cassandra/README).
- Monitor your Cassandra cluster with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.6.19/guides/cassandra/monitoring/using-prometheus-operator).
- Detail concepts of [CassandraVersion object](/docs/v2026.6.19/guides/cassandra/concepts/cassandraversion).
