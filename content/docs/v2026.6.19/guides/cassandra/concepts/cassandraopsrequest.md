...
`spec.databaseRef` is a required field that point to the [Cassandra](/docs/v2026.6.19/guides/cassandra/concepts/cassandra) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Cassandra](/docs/v2026.6.19/guides/cassandra/concepts/cassandra) object.
...
- `spec.updateVersion.targetVersion` refers to a [CassandraVersion](/docs/v2026.6.19/guides/cassandra/concepts/cassandraversion) CR that contains the Cassandra version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.6.19/guides/cassandra/concepts/cassandra#spectls).
