...
url: /docs/v2026.6.19/guides/cassandra/
aliases:
- /docs/v2026.6.19/guides/cassandra/README/
info:
  autoscaler: v0.50.0
  cli: v0.65.0
  dashboard: v0.41.0
...
- [Quickstart Cassandra](/docs/v2026.6.19/guides/cassandra/quickstart/guide/quickstart) with KubeDB Operator.
