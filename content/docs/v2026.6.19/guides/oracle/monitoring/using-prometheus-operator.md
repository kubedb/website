...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.6.19/guides/oracle/monitoring/overview).
...
- Configure [TLS/SSL encryption](/docs/v2026.6.19/guides/oracle/tls/overview/) for your Oracle database.
