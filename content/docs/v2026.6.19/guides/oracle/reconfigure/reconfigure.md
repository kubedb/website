...
- Learn how to provision a database with a [custom configuration file](/docs/v2026.6.19/guides/oracle/configuration/using-config-file) at creation time.
