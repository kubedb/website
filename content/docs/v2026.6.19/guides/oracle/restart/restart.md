...
- Monitor your Oracle database with KubeDB using [Prometheus operator](/docs/v2026.6.19/guides/oracle/monitoring/using-prometheus-operator).
- Learn how to [reconfigure](/docs/v2026.6.19/guides/oracle/reconfigure/reconfigure) an Oracle database.
