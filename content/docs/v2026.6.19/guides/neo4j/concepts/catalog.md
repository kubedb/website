...
If the `DEPRECATED` column shows `true` for a version you are currently using, upgrade to a supported version via [UpdateVersion](/docs/v2026.6.19/guides/neo4j/update-version/versionupgrading/).
