...
- Install KubeDB operator following [the setup guide](/docs/v2026.6.19/setup/README).
...
- Learn `Neo4jOpsRequest` fields in detail from [Neo4j OpsRequest concept](/docs/v2026.6.19/guides/neo4j/concepts/opsrequest).
