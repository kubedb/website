...
- If you are not familiar with how KubeStash backup and restore Neo4j databases, please check the following guide [here](/docs/v2026.6.19/guides/neo4j/backup/kubestash/overview/).
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/neo4j/backup/kubestash/logical/examples](/docs/v2026.6.19/guides/neo4j/backup/kubestash/logical/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
Here, we have to use service `sample-neo4j` and secret `sample-neo4j-auth` to connect with the database. `KubeDB` creates an [AppBinding](/docs/v2026.6.19/guides/neo4j/concepts/appbinding) CR that holds the necessary information to connect with the database.
