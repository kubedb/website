...
- Install KubeDB following [the setup guide](/docs/v2026.6.19/setup/README).
...
- Learn Neo4j CR fields from [Neo4j concept doc](/docs/v2026.6.19/guides/neo4j/concepts/neo4j).
