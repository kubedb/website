...
- Read [concept of Memcached Version Catalog](/docs/v2026.6.19/guides/memcached/concepts/memcached-version) to learn detail concepts of `MemcachedVersion` object.
