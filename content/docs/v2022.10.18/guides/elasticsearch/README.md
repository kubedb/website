...
url: /docs/v2022.10.18/guides/elasticsearch/
aliases:
- /docs/v2022.10.18/guides/elasticsearch/README/
info:
  autoscaler: v0.14.0
  cli: v0.29.0
  dashboard: v0.5.0
...
> The listed ElasticsearchVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [ElasticsearchVersion](/docs/v2022.10.18/guides/elasticsearch/concepts/catalog/) object with your custom Elasticsearch image.

## User Guide

- [Quickstart Elasticsearch](/docs/v2022.10.18/guides/elasticsearch/quickstart/overview/) with KubeDB Operator.
- [Elasticsearch Clustering](/docs/v2022.10.18/guides/elasticsearch/clustering/combined-cluster/) supported by KubeDB
- [Backup & Restore Elasticsearch](/docs/v2022.10.18/guides/elasticsearch/backup/overview/) database using Stash.
...
- Use [kubedb cli](/docs/v2022.10.18/guides/elasticsearch/cli/cli) to manage databases like kubectl for Kubernetes.
