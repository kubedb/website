...
url: /docs/v2022.10.18/guides/pgbouncer/
aliases:
- /docs/v2022.10.18/guides/pgbouncer/README/
info:
  autoscaler: v0.14.0
  cli: v0.29.0
  dashboard: v0.5.0
...
- [Quickstart PgBouncer](/docs/v2022.10.18/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2022.10.18/guides/pgbouncer/monitoring/using-builtin-prometheus).
