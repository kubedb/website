...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2020.10.27-rc.1/setup/README).
- You have to be familiar with the [ProxySQL](/docs/v2020.10.27-rc.1/guides/proxysql/concepts/proxysql) CRD.
