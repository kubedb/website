...
- You also need to be familiar with WAL Archiving of PostgreSQL database with KubeDB. If you are not familiar with it, please read the guide from [here](/docs/v2020.10.27-rc.1/guides/postgres/backup/wal/continuous_archiving).
