...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/0.10.0/guides/elasticsearch/custom-config/overview).
