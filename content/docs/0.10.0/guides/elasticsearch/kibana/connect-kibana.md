...
![Search Guard Login UI](/docs/0.10.0/images/elasticsearch/kibana/search-guard-login-ui.png)
...
![Kibana Home](/docs/0.10.0/images/elasticsearch/kibana/kibana-home.png)
...
![Create Index_Pattern](/docs/0.10.0/images/elasticsearch/kibana/kibana-create-index.png)

Once we have created an index_pattern, we can use the Discovery UI.

![](/docs/0.10.0/images/elasticsearch/kibana/kibana-discovery-ui.png)
