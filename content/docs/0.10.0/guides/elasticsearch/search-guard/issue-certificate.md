...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/0.10.0/guides/elasticsearch/search-guard/use-tls).
- Learn how to generate [search-guard configuration](/docs/0.10.0/guides/elasticsearch/search-guard/configuration).
