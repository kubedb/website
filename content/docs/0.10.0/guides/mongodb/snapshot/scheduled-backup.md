...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/0.10.0/concepts/snapshot).  Now, create the `MongoDB` object with scheduled snapshot.
...
![snapshot-console](/docs/0.10.0/images/mongodb/mgo-scheduled.png)
