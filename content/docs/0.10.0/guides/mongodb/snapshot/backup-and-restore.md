...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/0.10.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/0.10.0/images/mongodb/mgo-xyz-snapshot.png)
