...
To lean how to configure other storage destinations for Snapshots, please visit [here](/docs/0.10.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/0.10.0/images/mysql/m1-xyz-snapshot.png)
...
You can customize pod template spec and volume claim spec for the backup and restore jobs. For details options read [this doc](/docs/0.10.0/concepts/snapshot).
