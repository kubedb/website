...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/0.10.0/setup/install).
...
- You also need to be familiar with WAL Archiving of PostgreSQL database with KubeDB. If you are not familiar with it, please read the guide from [here](/docs/0.10.0/guides/postgres/snapshot/continuous_archiving).
