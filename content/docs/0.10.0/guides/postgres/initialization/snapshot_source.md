...
> Don't know how backup works?  Check [tutorial](/docs/0.10.0/guides/postgres/snapshot/instant_backup) on Instant Backup.
...
We need a Snapshot to perform this initialization. If you don't have a Snapshot already, create one by following the tutorial [here](/docs/0.10.0/guides/postgres/snapshot/instant_backup).
...
Now, let's connect to our Postgres `recovered-postgres`  using pgAdmin we have installed in [quickstart](/docs/0.10.0/guides/postgres/quickstart/quickstart#before-you-begin) tutorial to verify that the database has been successfully initialized.
...
<p align="center">
  <kbd>
    <img alt="recovered-postgres"  src="/docs/0.10.0/images/postgres/recovered-postgres.gif">
  </kbd>
</p>
