...
- Learn how to use custom configuration specifying topology from [here](/docs/v2020.11.08/guides/elasticsearch/configuration/with-topology).
- Learn how to use custom configuration without specifying topology from [here](/docs/v2020.11.08/guides/elasticsearch/configuration/without-topology).