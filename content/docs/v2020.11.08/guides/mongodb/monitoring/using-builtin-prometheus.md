...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2020.11.08/guides/mongodb/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2020.11.08/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [backup and restore](/docs/v2020.11.08/guides/mongodb/backup/stash) MongoDB database using Stash.
- Learn how to configure [MongoDB Topology](/docs/v2020.11.08/guides/mongodb/clustering/sharding).
