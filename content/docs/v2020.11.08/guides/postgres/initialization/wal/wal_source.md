...
> Don't know how to take continuous backup?  Check this [tutorial](/docs/v2020.11.08/guides/postgres/backup/wal/continuous_archiving) on Continuous Archiving.
...
- Learn about restoring from [Amazon S3](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_s3).
- Learn about restoring from [S3 MinIO](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_minio).
- Learn about restoring from [Google Cloud Storage](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_gcs).
- Learn about restoring from [Azure Storage](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_azure).
- Learn about restoring from [OpenStack Object Storage (Swift)](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_swift).
- Learn about restoring from [Local Storage](/docs/v2020.11.08/guides/postgres/initialization/wal/replay_from_local).
