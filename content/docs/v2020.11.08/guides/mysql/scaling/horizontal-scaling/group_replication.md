...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Horizontal Scaling Overview](/docs/v2020.11.08/guides/mysql/scaling/horizontal-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mysql](/docs/v2020.11.08/examples/mysql) directory of [kubedb/doc](https://github.com/kubedb/docs) repository.
