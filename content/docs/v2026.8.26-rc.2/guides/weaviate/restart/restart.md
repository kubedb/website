...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Weaviate Quickstart](/docs/v2026.8.26-rc.2/guides/weaviate/quickstart/quickstart)
...
- Learn about [Reconfigure](/docs/v2026.8.26-rc.2/guides/weaviate/reconfigure/reconfigure) and other day-2 operations.
