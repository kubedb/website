...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure TLS Overview](/docs/v2026.8.26-rc.2/guides/weaviate/reconfigure-tls/overview)
...
- Provision a cluster with TLS from the start: [Weaviate TLS](/docs/v2026.8.26-rc.2/guides/weaviate/tls/overview).
