...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/weaviate/scaling/vertical-scaling/overview)
...
- Detail concepts of [Weaviate object](/docs/v2026.8.26-rc.2/guides/weaviate/concepts/weaviate).
- [Horizontal Scaling](/docs/v2026.8.26-rc.2/guides/weaviate/scaling/horizontal-scaling/horizontal-scaling) of a Weaviate cluster.
