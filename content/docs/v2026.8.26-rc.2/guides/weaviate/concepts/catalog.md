...
- Learn about the [Weaviate CRD](/docs/v2026.8.26-rc.2/guides/weaviate/concepts/weaviate).
- Deploy your first Weaviate database with the [Quickstart](/docs/v2026.8.26-rc.2/guides/weaviate/quickstart/quickstart).
