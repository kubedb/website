...
Install the KubeDB CLI on your workstation and the KubeDB operator in your cluster by following the [setup instructions](/docs/v2026.8.26-rc.2/setup/README).
...
- Learn about [ProxySQL Declarative Configuration](/docs/v2026.8.26-rc.2/guides/proxysql/concepts/declarative-configuration/) in detail.
- Learn about [ProxySQL clustering](/docs/v2026.8.26-rc.2/guides/proxysql/clustering/overview/) with KubeDB.
