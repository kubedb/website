...
- Now, install KubeDB in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README) and make sure install with helm command including `--set global.featureGates.Hazelcast=true` to ensure Hazelcast CRDs.
