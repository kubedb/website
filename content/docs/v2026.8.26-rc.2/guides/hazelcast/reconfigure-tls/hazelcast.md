...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.8.26-rc.2/guides/hazelcast/concepts/hazelcast#spectls).
