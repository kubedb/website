...
To know more about this configuration file, check [here](/docs/v2026.8.26-rc.2/guides/postgres/configuration/using-config-file)
```yaml
apiVersion: v1
stringData:
  user.conf: |
...
List postgres versions using `kubectl get postgresversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.8.26-rc.2/guides/postgres/update-version/versionupgrading/).
...
- Learn Postgres [GitOps](/docs/v2026.8.26-rc.2/guides/postgres/concepts/postgres-gitops)
- Learn Postgres Scaling 
  - [Horizontal Scaling](/docs/v2026.8.26-rc.2/guides/postgres/scaling/horizontal-scaling/overview/)
  - [Vertical Scaling](/docs/v2026.8.26-rc.2/guides/postgres/scaling/vertical-scaling/overview/)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.8.26-rc.2/guides/postgres/update-version/versionupgrading/)
