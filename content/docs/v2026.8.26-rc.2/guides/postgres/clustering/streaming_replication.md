...
[here](/docs/v2026.8.26-rc.2/setup/README).
...
- Learn about the [synchronous replication overview](/docs/v2026.8.26-rc.2/guides/postgres/synchronous/).
- Run PostgreSQL with a [custom configuration file](/docs/v2026.8.26-rc.2/guides/postgres/configuration/using-config-file).
