...
- Install `KubeDB` Community and Enterprise operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
    - [Postgres](/docs/v2026.8.26-rc.2/guides/postgres/concepts/postgres)
