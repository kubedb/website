...
We will use the [kubedb_plugin](/docs/v2026.8.26-rc.2/setup/README) for generating configuration for remote replica. It creates the AppBinding and the secrets the replica needs to connect to the source server:
...
existing database do it with a [ReconfigureTLS ops request](/docs/v2026.8.26-rc.2/guides/postgres/reconfigure-tls/reconfigure-tls)
...
We have prepared another cluster in london region for replicating across cluster. follow the installation instruction [above](/docs/v2026.8.26-rc.2/README).
