...
- **KubeDB operator** installed on both clusters — follow [setup instructions](/docs/v2026.8.26-rc.2/setup/README).
...
- Learn about [backup and restore](/docs/v2026.8.26-rc.2/guides/postgres/backup/stash/overview/) PostgreSQL with Stash.
...
- Configure a [Highly Available PostgreSQL Cluster](/docs/v2026.8.26-rc.2/guides/postgres/clustering/ha_cluster).
- Detail concepts of the [Postgres object](/docs/v2026.8.26-rc.2/guides/postgres/concepts/postgres).
