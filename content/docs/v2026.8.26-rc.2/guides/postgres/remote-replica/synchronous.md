...
- **KubeDB operator** on both — see [setup](/docs/v2026.8.26-rc.2/setup/README).
...
[Cross-Cluster DR with Bidirectional Failover](/docs/v2026.8.26-rc.2/guides/postgres/remote-replica/advanced-setup).
...
- [Cross-Cluster DR with Bidirectional Failover](/docs/v2026.8.26-rc.2/guides/postgres/remote-replica/advanced-setup)
- [Remote Replica overview](/docs/v2026.8.26-rc.2/guides/postgres/remote-replica/remotereplica)
- Configure a [Highly Available PostgreSQL Cluster](/docs/v2026.8.26-rc.2/guides/postgres/clustering/ha_cluster)
- Monitor with the [Prometheus operator](/docs/v2026.8.26-rc.2/guides/postgres/monitoring/using-prometheus-operator)
