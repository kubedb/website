...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Topology](/docs/v2026.8.26-rc.2/guides/elasticsearch/clustering/topology-cluster/simple-dedicated-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.8.26-rc.2/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Horizontal Scaling Overview](/docs/v2026.8.26-rc.2/guides/elasticsearch/scaling/horizontal/overview)
...
- Monitor your Elasticsearch with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.8.26-rc.2/guides/elasticsearch/monitoring/using-prometheus-operator).
