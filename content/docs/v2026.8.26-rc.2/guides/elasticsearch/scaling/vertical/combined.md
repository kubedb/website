...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2026.8.26-rc.2/guides/elasticsearch/clustering/combined-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.8.26-rc.2/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/elasticsearch/scaling/vertical/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/elasticsearch](/docs/v2026.8.26-rc.2/examples/elasticsearch) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
Now, we are going to deploy a `Elasticsearch` combined cluster database with version `xpack-9.2.3`.
...
- Different Elasticsearch topology clustering modes [here](/docs/v2026.8.26-rc.2/guides/elasticsearch/clustering/_index).
