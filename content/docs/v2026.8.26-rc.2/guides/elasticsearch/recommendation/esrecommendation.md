...
- [ElasticsearchOpsRequest](/docs/v2026.8.26-rc.2/guides/elasticsearch/concepts/elasticsearch-ops-request/)
- [ElasticsearchRotateAuth](/docs/v2026.8.26-rc.2/guides/elasticsearch/rotateauth/rotateauth)
- [ElasticsearchReconfigureTLS](/docs/v2026.8.26-rc.2/guides/elasticsearch/reconfigure_tls/elasticsearch)
- [ElasticsearchUpdateVersion](/docs/v2026.8.26-rc.2/guides/elasticsearch/update-version/elasticsearch)
...
| --------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Version Update**                | A newer major, minor, or patch version becomes available                          | [Version Update Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/version-update-recommendation)        |
| **Same-Version Update**           | The container image for your *current* version is refreshed (e.g. security patch) | [Version Update Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/version-update-recommendation)        |
| **TLS Certificate Rotation**      | An issued certificate is approaching its expiry threshold                         | [TLS Certificate Rotation Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/rotate-tls-recommendation)  |
| **Authentication Secret Rotation** | The auth secret is approaching its `rotateAfter` deadline                         | [Authentication Secret Rotation Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/rotate-auth-recommendation) |
...
For prerequisites, Helm configuration flags, and the full cross-database Recommendation lifecycle, see the [Recommendation Configuration](/docs/v2026.8.26-rc.2/operatormanual/recommendation/configuration) and [Recommendation Overview](/docs/v2026.8.26-rc.2/operatormanual/recommendation) in the operator manual.
