...
- Install `KubeDB` operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README).  Pass `--set kubedb-crd-manager.installGitOpsCRDs=true` in the kubedb installation 
...
To know more about this configuration file, check [here](/docs/v2026.8.26-rc.2/guides/elasticsearch/configuration/combined-cluster/)
```yaml
apiVersion: v1
kind: Secret
metadata:
...
List Elasticsearch versions using `kubectl get Elasticsearchversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.8.26-rc.2/guides/elasticsearch/update-version/elasticsearch).
...
- Learn Elasticsearch Scaling
    - [Horizontal Scaling](/docs/v2026.8.26-rc.2/guides/elasticsearch/scaling/horizontal/combined)
    - [Vertical Scaling](/docs/v2026.8.26-rc.2/guides/elasticsearch/scaling/vertical/combined)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.8.26-rc.2/guides/elasticsearch/update-version/elasticsearch)
- Monitor your ElasticsearchQL database with KubeDB using [built-in Prometheus](/docs/v2026.8.26-rc.2/guides/elasticsearch/monitoring/using-builtin-prometheus).
