...
When installing KubeDB operator, set the flags `--docker-registry` and `--image-pull-secret` to appropriate value. Follow the guide for customizing installer to see how to pass those flags from [here](/docs/v2026.8.26-rc.2/setup/README#customizing-installer).
...
- Learn about [backup & restore](/docs/v2026.8.26-rc.2/guides/elasticsearch/backup/stash/overview/) of Elasticsearch database using Stash.
