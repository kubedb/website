...
Read about the fields in details from [redis concept](/docs/v2026.8.26-rc.2/guides/redis/concepts/redis),
...
<figure align="center">
<img alt="Deploy Redis with TLS/SSL" src="/docs/v2026.8.26-rc.2/images/day-2-operation/redis/rd-tls.svg">
