...
- Read [redis sentinel concept](/docs/v2026.8.26-rc.2/guides/redis/sentinel/overview) to learn about Redis Sentinel.
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2026.8.26-rc.2/guides/redis/sentinel/replacesentinel/overview)
