...
- Learn how to [reconfigure](/docs/v2026.8.26-rc.2/guides/oracle/reconfigure/reconfigure) a running Oracle database with an `OracleOpsRequest`.
- Initialize [Oracle with Script](/docs/v2026.8.26-rc.2/guides/oracle/initialization/script_source).
