...
- Learn how to provision a database with a [custom configuration file](/docs/v2026.8.26-rc.2/guides/oracle/configuration/using-config-file) at creation time.
