...
- Learn how to monitor an Oracle database with KubeDB using the [Prometheus operator](/docs/v2026.8.26-rc.2/guides/oracle/monitoring/using-prometheus-operator).
- Detail concepts of the [Oracle object](/docs/v2026.8.26-rc.2/guides/oracle/concepts/oracle).
