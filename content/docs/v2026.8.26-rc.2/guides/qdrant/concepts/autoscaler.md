...
`spec.databaseRef` is a required field that points to the [Qdrant](/docs/v2026.8.26-rc.2/guides/qdrant/concepts/) object for which autoscaling will be performed. It contains:
...
- Read the [compute autoscaler overview](/docs/v2026.8.26-rc.2/guides/qdrant/autoscaler/compute/overview) and [storage autoscaler overview](/docs/v2026.8.26-rc.2/guides/qdrant/autoscaler/storage/overview).
- See the [compute autoscaler guide](/docs/v2026.8.26-rc.2/guides/qdrant/autoscaler/compute/compute-autoscale) and [storage autoscaler guide](/docs/v2026.8.26-rc.2/guides/qdrant/autoscaler/storage/storage-autoscale).