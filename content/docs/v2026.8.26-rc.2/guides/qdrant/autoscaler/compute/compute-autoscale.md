...
- You should be familiar with the following `KubeDB` concepts:
  - [Qdrant](/docs/v2026.8.26-rc.2/guides/qdrant/concepts/)
  - [QdrantAutoscaler](/docs/v2026.8.26-rc.2/guides/qdrant/concepts/autoscaler)
  - [QdrantOpsRequest](/docs/v2026.8.26-rc.2/guides/qdrant/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/qdrant/autoscaler/compute/overview)
