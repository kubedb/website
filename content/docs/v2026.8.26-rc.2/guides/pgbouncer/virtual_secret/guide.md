...
Luckily PostgreSQL is readily available in KubeDB as crd and can easily be deployed using this guide [here](/docs/v2026.8.26-rc.2/guides/postgres/virtual_secret/guide).
