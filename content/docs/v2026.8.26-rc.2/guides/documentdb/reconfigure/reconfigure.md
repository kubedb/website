...
- Install KubeDB following the steps [here](/docs/v2026.8.26-rc.2/setup/README).
...
> [Custom Configuration](/docs/v2026.8.26-rc.2/guides/documentdb/configuration/using-config-file)) is
> unaffected.
...
finish bootstrapping (see the [Restart](/docs/v2026.8.26-rc.2/guides/documentdb/restart/) guide), so the
...
- Provision a database with [Custom Configuration](/docs/v2026.8.26-rc.2/guides/documentdb/configuration/using-config-file).
- [Restart](/docs/v2026.8.26-rc.2/guides/documentdb/restart/) a DocumentDB database.
