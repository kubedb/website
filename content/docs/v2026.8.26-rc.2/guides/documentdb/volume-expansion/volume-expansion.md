...
instances did not finish bootstrapping (see the [Restart](/docs/v2026.8.26-rc.2/guides/documentdb/restart/)
...
- [Storage migration](/docs/v2026.8.26-rc.2/guides/documentdb/storage-migration/) to a different StorageClass.
- [Storage autoscaling](/docs/v2026.8.26-rc.2/guides/documentdb/autoscaler/storage/) of a DocumentDB cluster.
