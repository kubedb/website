...
- Learn how to autoscale the compute resources of a DocumentDB cluster in the [Compute Autoscaling](/docs/v2026.8.26-rc.2/guides/documentdb/autoscaler/compute/) guide.
