...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MongoDBAutoscaler](/docs/v2026.8.26-rc.2/guides/mongodb/concepts/autoscaler)
  - [MongoDBOpsRequest](/docs/v2026.8.26-rc.2/guides/mongodb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/mongodb/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mongodb](/docs/v2026.8.26-rc.2/examples/mongodb) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 3 fields. Know more about them here : [readinessCriteria](/docs/v2026.8.26-rc.2/guides/mongodb/concepts/opsrequest#specreadinesscriteria), [timeout](/docs/v2026.8.26-rc.2/guides/mongodb/concepts/opsrequest#spectimeout), [apply](/docs/v2026.8.26-rc.2/guides/mongodb/concepts/opsrequest#specapply).
