...
- Install the KubeDB **Provisioner** and **Ops-manager** operators in your cluster following the steps
  [here](/docs/v2026.8.26-rc.2/setup/README), with the HanaDB feature and catalog enabled.
...
- Apply [custom configuration](/docs/v2026.8.26-rc.2/guides/hanadb/configuration/using-config-file).
- Set up [monitoring](/docs/v2026.8.26-rc.2/guides/hanadb/monitoring/using-builtin-prometheus) and [TLS](/docs/v2026.8.26-rc.2/guides/hanadb/tls/overview).
