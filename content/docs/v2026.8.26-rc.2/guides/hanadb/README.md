...
url: /docs/v2026.8.26-rc.2/guides/hanadb/
aliases:
- /docs/v2026.8.26-rc.2/guides/hanadb/README/
info:
...
- [HanaDB Quickstart](/docs/v2026.8.26-rc.2/guides/hanadb/quickstart/quickstart) — deploy a standalone HanaDB and connect to it.
- [HanaDB System Replication](/docs/v2026.8.26-rc.2/guides/hanadb/clustering/system-replication) — run a multi-node HANA System Replication cluster.
- [Custom Configuration](/docs/v2026.8.26-rc.2/guides/hanadb/configuration/using-config-file) — supply a custom `global.ini`.
- [Monitoring with builtin Prometheus](/docs/v2026.8.26-rc.2/guides/hanadb/monitoring/using-builtin-prometheus).
- [Monitoring with Prometheus Operator](/docs/v2026.8.26-rc.2/guides/hanadb/monitoring/using-prometheus-operator).
- [TLS/SSL Encryption](/docs/v2026.8.26-rc.2/guides/hanadb/tls/overview).
- Day-2 operations: [Restart](/docs/v2026.8.26-rc.2/guides/hanadb/restart/restart.md), [Reconfigure](/docs/v2026.8.26-rc.2/guides/hanadb/reconfigure/reconfigure), [Vertical Scaling](/docs/v2026.8.26-rc.2/guides/hanadb/scaling/vertical-scaling/vertical-scaling), [Volume Expansion](/docs/v2026.8.26-rc.2/guides/hanadb/volume-expansion/volume-expansion), [Storage Migration](/docs/v2026.8.26-rc.2/guides/hanadb/storage-migration/storage-migration), [Rotate Authentication](/docs/v2026.8.26-rc.2/guides/hanadb/rotate-authentication/rotate-authentication).

## Concepts

- [HanaDB CRD](/docs/v2026.8.26-rc.2/guides/hanadb/concepts/hanadb)
- [HanaDBVersion CRD](/docs/v2026.8.26-rc.2/guides/hanadb/concepts/catalog)
- [HanaDBOpsRequest CRD](/docs/v2026.8.26-rc.2/guides/hanadb/concepts/opsrequest)
- [AppBinding](/docs/v2026.8.26-rc.2/guides/hanadb/concepts/appbinding)
