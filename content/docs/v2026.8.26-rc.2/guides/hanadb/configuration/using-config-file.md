...
see [Reconfigure](/docs/v2026.8.26-rc.2/guides/hanadb/reconfigure/reconfigure).
...
- Change configuration on a running database with [Reconfigure](/docs/v2026.8.26-rc.2/guides/hanadb/reconfigure/reconfigure).
