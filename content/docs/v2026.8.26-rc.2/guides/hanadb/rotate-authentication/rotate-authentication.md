...
- Create a namespace `demo` and deploy a standalone `hanadb-standalone` (see
  [Reconfigure](/docs/v2026.8.26-rc.2/guides/hanadb/reconfigure/reconfigure#deploy-a-hanadb)).
...
- Encrypt connections with [TLS/SSL](/docs/v2026.8.26-rc.2/guides/hanadb/tls/overview).
