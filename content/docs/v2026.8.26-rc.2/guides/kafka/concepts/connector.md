...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2026.8.26-rc.2/guides/kafka/quickstart/kafka/).
- Learn how to use KubeDB to run Apache Kafka Connect cluster [here](/docs/v2026.8.26-rc.2/guides/kafka/connectcluster/quickstart).
