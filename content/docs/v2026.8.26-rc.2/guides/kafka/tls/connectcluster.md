...
Read about the fields in details in [kafka concept](/docs/v2026.8.26-rc.2/guides/kafka/concepts/kafka),
...
> **Note:** Before creating Kafka ConnectCluster, make sure you have a Kafka cluster with/without TLS/SSL enabled. If you don't have a Kafka cluster, you can follow the steps [here](/docs/v2026.8.26-rc.2/guides/kafka/tls/topology).
...
- `spec.kafkaRef` refers to the Kafka cluster that we have created from [here](/docs/v2026.8.26-rc.2/guides/kafka/tls/topology).
...
- Monitor your Kafka cluster with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.8.26-rc.2/guides/kafka/monitoring/using-builtin-prometheus).
