...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  ...
  - [MySQLDatabase](/docs/v2026.8.26-rc.2/guides/mysql/concepts/mysqldatabase/)
  - [Schema Manager Overview](/docs/v2026.8.26-rc.2/guides/mysql/schema-manager/overview/)
...
- Detail concepts of [MySQLDatabase object](/docs/v2026.8.26-rc.2/guides/mysql/concepts/mysqldatabase/).
