...
> create one for the source. Learn more about [AppBinding](/docs/v2026.8.26-rc.2/guides/mysql/concepts/appbinding/).
...
- `database` — list of databases to include. An empty list means all databases except the MySQL
...
- Migrate a MySQL database step by step with the [MySQL Database Migration](/docs/v2026.8.26-rc.2/guides/mysql/migration/databasemigration) guide.
- Learn about the [AppBinding](/docs/v2026.8.26-rc.2/guides/mysql/concepts/appbinding/) concept.
- Learn about the MySQL CRD [here](/docs/v2026.8.26-rc.2/guides/mysql/concepts/database/).
