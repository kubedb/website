...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [MySQL](/docs/v2026.8.26-rc.2/guides/mysql/concepts/mysqldatabase)
    - [MySQLMigration](/docs/v2026.8.26-rc.2/guides/mysql/concepts/migrator/)
...
Here we scope the migration to the `shop` database (`schema.database: [shop]`), enable both the bulk snapshot and CDC streaming phases, and cap connections at 100 on each side. For a full description of every field, see the [MySQLMigration CRD reference](/docs/v2026.8.26-rc.2/guides/mysql/concepts/migrator/).
