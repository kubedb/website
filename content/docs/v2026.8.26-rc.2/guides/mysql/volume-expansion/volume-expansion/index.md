...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Volume Expansion Overview](/docs/v2026.8.26-rc.2/guides/mysql/volume-expansion/overview)
...
Now, we are going to deploy a `MySQL` database of 3 replicas with version `9.7.1`.
