...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/clickhouse/scaling/vertical-scaling/overview)
...
- Detail concepts of [ClickHouse object](/docs/v2026.8.26-rc.2/guides/clickhouse/concepts/clickhouse).
