...
<figure align="center">
  <img alt="updating Process of Ignite" src="/docs/v2026.8.26-rc.2/images/day-2-operation/ignite/ig-version-update.png">
...
In the [next](/docs/v2026.8.26-rc.2/guides/ignite/update-version/update-version) doc, we are going to show a step-by-step guide on updating of an Ignite database using updateVersion operation.
