...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.8.26-rc.2/guides/mssqlserver/monitoring/using-prometheus-operator).
