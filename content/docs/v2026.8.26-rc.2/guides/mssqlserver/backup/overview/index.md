...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/v2026.8.26-rc.2/guides/mssqlserver/backup/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="Microsoft SQL Server Backup Overview" src="/docs/v2026.8.26-rc.2/guides/mssqlserver/backup/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.8.26-rc.2/guides/mssqlserver/backup/overview/images/restore_overview.svg">
...
- Backup a `Microsoft SQL Server` database using KubeStash by the following guides from [here](/docs/v2026.8.26-rc.2/guides/mssqlserver/backup/logical/).