...
- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/singlestore)
  - [SingleStoreAutoscaler](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/autoscaler)
  - [SingleStoreOpsRequest](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/singlestore/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/singlestore](/docs/v2026.8.26-rc.2/examples/singlestore) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Detail concepts of [SingleStore object](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/singlestore).
- Different SingleStore clustering modes [here](/docs/v2026.8.26-rc.2/guides/singlestore/clustering/_index).
- Monitor your singlestore database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.8.26-rc.2/guides/singlestore/monitoring/prometheus-operator/).
- Monitor your singlestore database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.8.26-rc.2/guides/singlestore/monitoring/builtin-prometheus/).
