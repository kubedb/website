...
- Install `KubeDB` Community and Ops-manager operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/singlestore)
  - [Cluster](/docs/v2026.8.26-rc.2/guides/singlestore/clustering/overview/)
  - [SingleStoreOpsRequest](/docs/v2026.8.26-rc.2/guides/singlestore/concepts/opsrequest)
  - [Updating Overview](/docs/v2026.8.26-rc.2/guides/singlestore/update-version/overview/)
