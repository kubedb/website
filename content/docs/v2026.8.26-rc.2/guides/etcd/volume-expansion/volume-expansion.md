...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.8.26-rc.2/guides/etcd/volume-expansion/overview)
...
- `spec.volumeExpansion.mode` is **required**: `Online` or `Offline`. See
  [Volume Expansion Modes](/docs/v2026.8.26-rc.2/guides/etcd/volume-expansion/overview#volume-expansion-modes).
...
- Move the volumes to a different `StorageClass` with
  [Storage Migration](/docs/v2026.8.26-rc.2/guides/etcd/storage-migration/storage-migration).
