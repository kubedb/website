...
- Install the `KubeDB` Provisioner, Ops-manager and Autoscaler operators in your cluster
  following the steps [here](/docs/v2026.8.26-rc.2/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [EtcdAutoscaler](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdautoscaler)
  - [EtcdOpsRequest](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` holds the options that are copied onto the `EtcdOpsRequest` the
  ...
  [spec.timeout](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest#spectimeout) and
  [spec.apply](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest#specapply).
...
> [caveat in the overview](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/compute/overview#a-note-on-node-topology).
...
[Vertical Scaling](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/vertical-scaling).
...
- [Storage Autoscaling of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/storage/storage-autoscale).
