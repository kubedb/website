...
- The backend database file never shrinks on its own. Deleting keys, and even compacting the
  ...
  it is defragmented. See [Maintenance Overview](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/overview).
...
- [Autoscale the storage of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/storage/storage-autoscale).
- [Compute Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/compute/overview).
