...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Storage Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/storage/overview)
...
- [Compute Resource Autoscaling of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/compute/compute-autoscale).
- [Volume Expansion of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/volume-expansion/volume-expansion) — the same operation, applied by hand.
- Reclaim space inside the etcd backend with [Compact](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/compact)
  and [Defragment](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment).
