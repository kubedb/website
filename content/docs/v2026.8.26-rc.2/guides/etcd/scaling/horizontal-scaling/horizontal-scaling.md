...
[Horizontal Scaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview). Scaling an
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Horizontal Scaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview)
...
- `spec.horizontalScaling.replicas` is the desired **number of etcd members** after scaling. It must
  ...
  [Choosing a Member Count](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview#choosing-a-member-count)).
...
- Scale the cluster [vertically](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/vertical-scaling).
