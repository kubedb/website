...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/overview)
...
- `spec.verticalScaling.mode` specifies how the scaling is actuated — `Restart` (the default; the
  ...
  [Vertical Scaling Modes](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/overview#vertical-scaling-modes).
- Have a look [here](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest) to understand the `timeout` and
  `apply` fields.
...
> etcd (see the [note in the overview](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/overview#scalable-containers)).
