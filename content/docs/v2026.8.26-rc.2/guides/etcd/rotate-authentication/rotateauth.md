...
> authentication. See the [overview](/docs/v2026.8.26-rc.2/guides/etcd/rotate-authentication/overview#why-rotating-etcd-credentials-does-not-restart-anything)
> for the details.
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Rotate Authentication Overview](/docs/v2026.8.26-rc.2/guides/etcd/rotate-authentication/overview)

- At first, you need to have a Kubernetes cluster, and the kubectl command-line tool must be configured to communicate with your cluster. If you do not already have a cluster, you can create one by using [kind](https://kind.sigs.k8s.io/docs/user/quick-start/).

- Now, install KubeDB cli on your workstation and KubeDB operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README). Etcd support is behind an alpha feature gate, so make sure the Provisioner and Ops-manager operators are installed with `featureGates.Etcd=true`.
...
- Restart the members of a cluster with [Restart](/docs/v2026.8.26-rc.2/guides/etcd/restart/restart).
- Change the etcd tuning knobs of a running cluster with [Reconfigure](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure/reconfigure).
