...
- [Recommendation Configuration](/docs/v2026.8.26-rc.2/operatormanual/recommendation/configuration) — prerequisites, Supervisor CRD install, and all Helm flags.
- [Recommendation Overview](/docs/v2026.8.26-rc.2/operatormanual/recommendation) — architecture and lifecycle walkthrough.

<p align="center">
  <img alt="Recommendation Lifecycle" src="/docs/v2026.8.26-rc.2/operatormanual/recommendation/images/recommendation-generation.png">
</p>
...
- [Etcd](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd)
- [EtcdVersion](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdversion)
- [EtcdOpsRequest](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest)
- [Rotate Authentication](/docs/v2026.8.26-rc.2/guides/etcd/rotate-authentication/overview)
- [Reconfigure TLS](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure-tls/overview)
- [Update Version](/docs/v2026.8.26-rc.2/guides/etcd/update-version/overview)
...
| ---------------------------------- | ------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Version Update**                 | `UpdateVersion`                 | A newer major, minor, or patch `EtcdVersion` becomes available in the catalog      | [Version Update Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/version-update-recommendation)              |
| **Same-Version Update**            | `UpdateVersion`                 | The container image for your *current* `EtcdVersion` is refreshed                  | [Version Update Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/version-update-recommendation)              |
| **TLS Certificate Rotation**       | `ReconfigureTLS`                | An issued certificate is approaching its expiry threshold                          | [TLS Certificate Rotation Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/rotate-tls-recommendation)        |
| **Authentication Secret Rotation** | `RotateAuth`                    | The auth secret is approaching its `rotateAfter` deadline                          | [Authentication Secret Rotation Recommendation](/docs/v2026.8.26-rc.2/operatormanual/recommendation/rotate-auth-recommendation) |
...
See [Approval Policy](/docs/v2026.8.26-rc.2/operatormanual/recommendation/approval-policy) and
[Maintenance Window](/docs/v2026.8.26-rc.2/operatormanual/recommendation/maintenance-window).

---

For prerequisites, Helm configuration flags, and the full cross-database Recommendation lifecycle,
see the [Recommendation Configuration](/docs/v2026.8.26-rc.2/operatormanual/recommendation/configuration) and
[Recommendation Overview](/docs/v2026.8.26-rc.2/operatormanual/recommendation) in the operator manual.

## Next Steps

- [Autoscale the compute resources of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/autoscaler/compute/compute-autoscale).
- [Etcd Maintenance Operations](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/overview).
