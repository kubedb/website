...
[Maintenance Operations Overview](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/overview#compaction).
...
> [Defragment](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment) afterwards. Plan for the pair.
...
- Install the `KubeDB` Provisioner and Ops-manager operators in your cluster following the steps
  [here](/docs/v2026.8.26-rc.2/setup/README). etcd support is behind an alpha feature gate, so make sure the
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Maintenance Operations Overview](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/overview)
...
[Defragment the backends of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment) for the
full walkthrough.
...
existing cluster is a [Reconfigure](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure/reconfigure) operation.
...
- [Defragment the member backends of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment) —
  the follow-up that actually frees disk space.
- [Move the Raft leadership of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/move-leader).
