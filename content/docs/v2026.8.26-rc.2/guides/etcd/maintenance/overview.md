...
[Restart](/docs/v2026.8.26-rc.2/guides/etcd/restart/restart), a `VerticalScaling` in `Restart` mode and the
...
Read the guide: [Move the Raft leadership of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/move-leader).
...
Read the guide: [Compact the keyspace history of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/compact).
...
Read the guide: [Defragment the backends of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment).
...
- [Move the Raft leadership](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/move-leader).
- [Compact the keyspace history](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/compact).
- [Defragment the member backends](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/defragment).
