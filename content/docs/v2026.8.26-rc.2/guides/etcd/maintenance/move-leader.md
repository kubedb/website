...
[Maintenance Operations Overview](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/overview#raft-leadership-transfer).
...
- The meaning of `spec.timeout` and `spec.apply` is described
  [here](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest#spectimeout).
...
> [Etcd CRD](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd) for where KubeDB mounts those secrets.
...
- [Compact the keyspace history of an Etcd cluster](/docs/v2026.8.26-rc.2/guides/etcd/maintenance/compact).
