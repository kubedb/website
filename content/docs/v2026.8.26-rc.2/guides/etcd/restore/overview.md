...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Backup & Restore with KubeStash](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/)
  - [Horizontal Scaling Overview](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview) — the
...
| Guide | [Snapshot Backup & Restore](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/snapshot/#restore) | [In-place Restore walkthrough](/docs/v2026.8.26-rc.2/guides/etcd/restore/restore) |
...
- The cluster is degraded past the point of rescue — for example every member's volume is gone, so
  ...
  [`RecoverFromQuorumLoss`](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview) has nothing to
  work with.
...
[`RecoverFromQuorumLoss`](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview), which keeps the
...
[learners](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview#learners), streaming the restored
...
In the [next](/docs/v2026.8.26-rc.2/guides/etcd/restore/restore) doc, we are going to show a step-by-step guide on
