...
> [Snapshot Backup & Restore](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/snapshot/#restore). It is
> strictly safer, because there is no existing data to lose. See
> [Two Kinds of Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/overview#two-kinds-of-restore).
...
- Install `KubeDB` Provisioner and Ops-manager operator in your cluster following the steps
  [here](/docs/v2026.8.26-rc.2/setup/README). Etcd support is an **alpha** feature, so the operators must be
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [In-place Restore Overview](/docs/v2026.8.26-rc.2/guides/etcd/restore/overview)
...
[EtcdArchiver](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdarchiver), and therefore a KubeStash `Repository`
holding at least one successful **full** snapshot. If you do not, follow
[Snapshot Backup & Restore](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/snapshot/) first — the backup
...
[learner-add/promote path](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/overview#learners) an
...
- Set up scheduled snapshot [backups](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/) with an
  [EtcdArchiver](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdarchiver).
- Bootstrap a **new** cluster from a snapshot instead: see
  [Snapshot Backup & Restore](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/snapshot/#restore).
- [Recover from a permanent quorum loss](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview) when
  the data is fine but the cluster is not.
- Detail concepts of the [EtcdOpsRequest](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest) object.
