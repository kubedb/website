...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Update Version Overview](/docs/v2026.8.26-rc.2/guides/etcd/update-version/overview)
...
[The Upgrade Path Is Validated](/docs/v2026.8.26-rc.2/guides/etcd/update-version/overview#the-upgrade-path-is-validated--read-this-first).
...
- Scale the cluster [vertically](/docs/v2026.8.26-rc.2/guides/etcd/scaling/vertical-scaling/vertical-scaling) or
  [horizontally](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/horizontal-scaling).
- [Expand the volume](/docs/v2026.8.26-rc.2/guides/etcd/volume-expansion/volume-expansion) of an Etcd cluster.
- Detail concepts of the [EtcdVersion](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdversion) and
  [EtcdOpsRequest](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest) objects.
