...
- Read the [EtcdVersion](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdversion) concept to learn the details of
...
steps to [install the KubeDB operator](/docs/v2026.8.26-rc.2/setup/README).
...
- Run etcd with [custom RBAC resources](/docs/v2026.8.26-rc.2/guides/etcd/custom-rbac/using-custom-rbac).
- Back up and restore your etcd cluster with
  [KubeStash](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/).
- Detail concepts of the [Etcd](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd) object.
- Detail concepts of the [EtcdVersion](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdversion) object.
- Monitor your etcd cluster with KubeDB using the
  [out-of-the-box Prometheus operator](/docs/v2026.8.26-rc.2/guides/etcd/monitoring/using-prometheus-operator).
