...
steps [here](/docs/v2026.8.26-rc.2/setup/README). etcd support is an alpha feature gate, so it must be enabled
...
- Use a [private Docker registry](/docs/v2026.8.26-rc.2/guides/etcd/private-registry/using-private-registry) to
