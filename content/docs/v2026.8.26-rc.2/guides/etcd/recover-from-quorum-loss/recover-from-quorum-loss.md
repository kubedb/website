...
> [overview](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview) — especially
> [when *not* to use it](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview#when-to-use-it) —
> before you run it.
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Recover from Quorum Loss Overview](/docs/v2026.8.26-rc.2/guides/etcd/recover-from-quorum-loss/overview)
...
- **`no member of etcd demo/etcd-cluster answered; there is no surviving member to rebuild the
  ...
  [in-place Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/restore).
...
- [Restore a snapshot](/docs/v2026.8.26-rc.2/guides/etcd/restore/restore) into an existing Etcd cluster when the
  data itself is the problem.
- Take scheduled snapshot [backups](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/) so you
  always have something to fall back on.
- Scale the cluster [horizontally](/docs/v2026.8.26-rc.2/guides/etcd/scaling/horizontal-scaling/horizontal-scaling)
