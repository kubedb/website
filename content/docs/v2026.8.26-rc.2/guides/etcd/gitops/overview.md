...
- You should be familiar with the [Etcd](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd) and
...
<figure align="center">
  <img alt="GitOps Flow" src="/docs/v2026.8.26-rc.2/images/gitops/gitops.jpg">
...
- Follow the step-by-step guide in
  [GitOps Etcd using the KubeDB GitOps Operator](/docs/v2026.8.26-rc.2/guides/etcd/gitops/gitops).
