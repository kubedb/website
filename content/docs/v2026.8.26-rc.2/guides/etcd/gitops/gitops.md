...
- Install the `KubeDB` operator in your cluster following the steps
  [here](/docs/v2026.8.26-rc.2/setup/README). Two extra Helm values are needed for this guide:
...
- Read the [Etcd GitOps Overview](/docs/v2026.8.26-rc.2/guides/etcd/gitops/overview).
