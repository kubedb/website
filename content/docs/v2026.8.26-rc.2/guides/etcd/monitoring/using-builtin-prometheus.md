...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.8.26-rc.2/guides/etcd/monitoring/overview).
...
`prometheus.io/scheme` is `http` even if you have TLS enabled on the cluster, because the metrics listener is a separate socket from the mutually authenticated client API. See the [monitoring overview](/docs/v2026.8.26-rc.2/guides/etcd/monitoring/overview) for why.
...
- Monitor your etcd cluster with KubeDB using the [`out-of-the-box` Prometheus operator](/docs/v2026.8.26-rc.2/guides/etcd/monitoring/using-prometheus-operator).
- Run your etcd cluster with [TLS/SSL encryption](/docs/v2026.8.26-rc.2/guides/etcd/tls/configure-ssl).
- Tune the backend quota and compaction policy with [custom configuration](/docs/v2026.8.26-rc.2/guides/etcd/custom-configuration/using-config).
