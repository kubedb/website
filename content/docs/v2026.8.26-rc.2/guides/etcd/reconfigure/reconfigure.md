...
- Install `KubeDB` Provisioner and Ops-manager operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README). Etcd support is behind an alpha feature gate, so make sure both operators are installed with `featureGates.Etcd=true`.
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure/overview)
...
> [overview](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure/overview#what-configuration-means-for-etcd) for why.
...
sequence as the [Restart](/docs/v2026.8.26-rc.2/guides/etcd/restart/restart) ops request — followers first, one
...
- Restart the cluster without changing anything with [Restart](/docs/v2026.8.26-rc.2/guides/etcd/restart/restart).
- Rotate the etcd credentials with [Rotate Authentication](/docs/v2026.8.26-rc.2/guides/etcd/rotate-authentication/rotateauth).
