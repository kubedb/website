...
- Install `KubeDB` Provisioner and Ops-manager operators in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README). Etcd support is behind an alpha feature gate, so make sure the operators were installed with `--set featureGates.Etcd=true`.
...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Reconfigure TLS Overview](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure-tls/overview)
...
- Deploy an etcd cluster with TLS from the start: [Run Etcd with TLS/SSL](/docs/v2026.8.26-rc.2/guides/etcd/tls/configure-ssl).
