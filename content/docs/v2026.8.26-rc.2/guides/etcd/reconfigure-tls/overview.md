...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Etcd TLS/SSL overview](/docs/v2026.8.26-rc.2/guides/etcd/tls/overview)
...
In the [next](/docs/v2026.8.26-rc.2/guides/etcd/reconfigure-tls/reconfigure-tls) doc, we show a step-by-step guide for each of the four scenarios using the `EtcdOpsRequest` CRD.
