...
[EtcdOpsRequest](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdopsrequest#specrestore) is for. It obeys the same
...
live database**. See [In-place Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/overview).
...
- Walk through a complete backup and restore in
  [Snapshot Backup & Restore of Etcd using KubeStash](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/snapshot/).
