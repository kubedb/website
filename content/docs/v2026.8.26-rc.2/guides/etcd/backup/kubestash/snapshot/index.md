...
- Install `KubeDB` in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README). etcd support is
...
- Read the [Etcd Backup & Restore Overview](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/)
...
The [AppBinding](/docs/v2026.8.26-rc.2/guides/etcd/concepts/appbinding) is what the backup job reads to learn the client endpoint (`spec.clientConfig.service`
...
- **In-place restore** into an `Etcd` that already exists: an `EtcdOpsRequest` of type `Restore`,
  ...
  [In-place Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/overview).
...
- Restore a snapshot into an `Etcd` cluster that already exists with an
  [in-place Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/restore) ops request.
- Detail concepts of the [EtcdArchiver](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcdarchiver) object.
- Detail concepts of the [Etcd](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd) object.
- Detail concepts of the [AppBinding](/docs/v2026.8.26-rc.2/guides/etcd/concepts/appbinding) object.
