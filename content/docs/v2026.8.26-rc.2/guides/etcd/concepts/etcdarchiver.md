...
To restore a snapshot into an `Etcd` object that **already exists**, use an `EtcdOpsRequest` of type `Restore` instead — it replaces the whole keyspace of the live database. See [In-place Restore](/docs/v2026.8.26-rc.2/guides/etcd/restore/overview).

## Next Steps

- Learn about the [Etcd](/docs/v2026.8.26-rc.2/guides/etcd/concepts/etcd) crd.
- Follow the [etcd backup & restore guide](/docs/v2026.8.26-rc.2/guides/etcd/backup/kubestash/overview/) for an end-to-end walkthrough.
