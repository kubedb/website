...
`spec.version` is a required field specifying the name of the [RabbitMQVersion](/docs/v2026.8.26-rc.2/guides/rabbitmq/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `RabbitMQVersion` resources,
...
- [Monitor RabbitMQ with builtin Prometheus](/docs/v2026.8.26-rc.2/guides/rabbitmq/monitoring/using-builtin-prometheus)
- [Monitor RabbitMQ with Prometheus operator](/docs/v2026.8.26-rc.2/guides/rabbitmq/monitoring/using-prometheus-operator)
...
- Learn how to use KubeDB to run a RabbitMQ database [here](/docs/v2026.8.26-rc.2/guides/rabbitmq/README).
