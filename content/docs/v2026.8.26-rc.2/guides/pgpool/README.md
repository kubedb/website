...
url: /docs/v2026.8.26-rc.2/guides/pgpool/
aliases:
- /docs/v2026.8.26-rc.2/guides/pgpool/README/
info:
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/catalog) object with your custom pgpool image.
