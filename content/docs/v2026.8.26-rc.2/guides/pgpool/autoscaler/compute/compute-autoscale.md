...
- Install `KubeDB` Provisioner, Ops-manager and Autoscaler operator in your cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README).

- Install `Metrics Server` from [here](https://github.com/kubernetes-sigs/metrics-server#installation)

- You should be familiar with the following `KubeDB` concepts:
  - [Pgpool](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/pgpool)
  - [PgpoolAutoscaler](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/autoscaler)
  - [PgpoolOpsRequest](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/pgpool/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/pgpool](/docs/v2026.8.26-rc.2/examples/pgpool) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/opsrequest#spectimeout), [apply](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/opsrequest#specapply).
