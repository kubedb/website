...
### Prepare Postgres
Prepare a KubeDB Postgres cluster using this [tutorial](/docs/v2026.8.26-rc.2/guides/postgres/clustering/streaming_replication),but you have to set `password` as  `qrDy;GnX4QsKQ0UL`.
