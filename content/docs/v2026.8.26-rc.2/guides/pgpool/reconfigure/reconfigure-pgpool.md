...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.8.26-rc.2/guides/pgpool/reconfigure/overview)
...
- Have a look at the [Pgpool OpsRequest concept](/docs/v2026.8.26-rc.2/guides/pgpool/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
