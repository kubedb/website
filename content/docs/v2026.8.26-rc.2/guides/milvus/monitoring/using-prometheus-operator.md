...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Monitoring Overview](/docs/v2026.8.26-rc.2/guides/milvus/monitoring/overview)
...
Monitoring is enabled through `spec.monitor`. The base [standalone](/docs/v2026.8.26-rc.2/guides/milvus/quickstart/standalone) and [distributed](/docs/v2026.8.26-rc.2/guides/milvus/quickstart/distributed) quickstarts intentionally omit it so the first deployment only needs MinIO and etcd. Add the following block to your `Milvus` manifest:
...
- Secure your Milvus database with [TLS/SSL](/docs/v2026.8.26-rc.2/guides/milvus/tls/guide).
