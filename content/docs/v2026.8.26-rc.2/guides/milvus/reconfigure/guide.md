...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2026.8.26-rc.2/guides/milvus/reconfigure/overview)
...
Deploy a standalone Milvus and wait for it to become `Ready` (see the [standalone quickstart](/docs/v2026.8.26-rc.2/guides/milvus/quickstart/standalone)):
...
- Learn how to [restart](/docs/v2026.8.26-rc.2/guides/milvus/restart/guide) a Milvus database.
