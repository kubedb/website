...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Compute Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/milvus/autoscaler/compute/overview)
...
The Ops-manager then applies the vertical scaling exactly as in the [vertical scaling guide](/docs/v2026.8.26-rc.2/guides/milvus/scaling/vertical-scaling/guide), right-sizing the pod to the recommended resources.
...
- Learn about [storage autoscaling](/docs/v2026.8.26-rc.2/guides/milvus/autoscaler/storage/guide).
