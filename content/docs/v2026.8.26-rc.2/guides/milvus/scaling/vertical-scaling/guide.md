...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/milvus/scaling/vertical-scaling/overview)
...
- Learn about [horizontal scaling](/docs/v2026.8.26-rc.2/guides/milvus/scaling/horizontal-scaling/guide) of a distributed Milvus.
