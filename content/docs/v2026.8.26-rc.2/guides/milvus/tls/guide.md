...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [TLS Overview](/docs/v2026.8.26-rc.2/guides/milvus/tls/overview)
...
- Add, rotate or remove TLS on a running database with [Reconfigure TLS](/docs/v2026.8.26-rc.2/guides/milvus/reconfigure-tls/guide).
