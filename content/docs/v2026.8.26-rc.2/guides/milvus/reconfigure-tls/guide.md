...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure TLS Overview](/docs/v2026.8.26-rc.2/guides/milvus/reconfigure-tls/overview)
...
- Deploy a [TLS-secured Milvus](/docs/v2026.8.26-rc.2/guides/milvus/tls/guide) from the start.
