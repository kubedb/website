...
`spec.databaseRef` is required. It points to the [Milvus](/docs/v2026.8.26-rc.2/guides/milvus/concepts/milvus) object the operation will run against.
...
See [Reconfigure TLS Overview](/docs/v2026.8.26-rc.2/guides/milvus/reconfigure-tls/overview).
