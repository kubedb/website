...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [CassandraAutoscaler](/docs/v2026.8.26-rc.2/guides/cassandra/concepts/cassandraautoscaler)
  - [CassandraOpsRequest](/docs/v2026.8.26-rc.2/guides/cassandra/concepts/cassandraopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.8.26-rc.2/guides/cassandra/autoscaler/compute/overview)
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.8.26-rc.2/guides/cassandra/concepts/cassandraopsrequest#spectimeout), [apply](/docs/v2026.8.26-rc.2/guides/cassandra/concepts/cassandraopsrequest#specapply).
