...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.8.26-rc.2/guides/mariadb/volume-expansion/overview)
...
Now, we are going to deploy a `MariaDB` database of 3 replicas with version `12.3.2`.
...
sample-mariadb   12.3.2    Ready    5m4s
```
