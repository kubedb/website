...
> create one for the source. Learn more about [AppBinding](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/appbinding/).
...
- Migrate a MariaDB database step by step with the [MariaDB Database Migration](/docs/v2026.8.26-rc.2/guides/mariadb/migration/databasemigration) guide.
- Learn about the [AppBinding](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/appbinding/) concept.
- Learn about the MariaDB CRD [here](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/mariadb).
