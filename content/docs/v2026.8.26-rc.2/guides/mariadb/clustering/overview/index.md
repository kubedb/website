...
![MariaDB Cluster](/docs/v2026.8.26-rc.2/guides/mariadb/clustering/overview/images/galera_small.png)
...
![MariaDB Standard Replication Cluster](/docs/v2026.8.26-rc.2/guides/mariadb/clustering/overview/images/mariadb-standard-replication.png)
...
# Next Steps 
- [Deploy MariaDB Galera Cluster](/docs/v2026.8.26-rc.2/guides/mariadb/clustering/galera-cluster) using KubeDB.
