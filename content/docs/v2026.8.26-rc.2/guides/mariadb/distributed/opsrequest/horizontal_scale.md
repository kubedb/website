...
- At first, you need to have a multi-cluster Kubernetes setup with OCM and KubeSlice configured. Follow the [Distributed MariaDB Overview](/docs/v2026.8.26-rc.2/guides/mariadb/distributed/overview) guide to set up the required infrastructure.

- Install `KubeDB` Community and Enterprise operator in your hub cluster following the steps [here](/docs/v2026.8.26-rc.2/setup/README). Make sure to enable OCM support:
...
- You should be familiar with the following `KubeDB` concepts:
  - [MariaDB](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/mariadb/)
  - [Distributed MariaDB Overview](/docs/v2026.8.26-rc.2/guides/mariadb/distributed/overview/)
  - [MariaDBOpsRequest](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2026.8.26-rc.2/guides/mariadb/scaling/horizontal-scaling/overview/)
...
In this section, we are going to deploy a distributed MariaDB Galera cluster with version `12.3.2`. Note that `spec.distributed` is set to `true` and `spec.replicas` is `3`  which is less than the five indices defined in the `PlacementPolicy`. The operator will only create pods for indices `0`, `1`, and `2`.
