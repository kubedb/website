...
mariadb-backup-12.3.2    35s
mariadb-restore-12.3.2   35s
```
...
sample-mariadb-backup   mariadb-backup-12.3.2   */5 * * * *            Ready      11s
```
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2026.8.26-rc.2/guides/mariadb/backup/stash/logical/cluster/images/sample-mariadb-backup.png">
...
NAME                   TASK                    SCHEDULE      PAUSED   PHASE   AGE
sample-mariadb-backup  mariadb-backup-12.3.2   */5 * * * *   true     Ready   26m
```
...
$ kubectl get backupconfiguration -n demo sample-mariadb-backup
NAME                    TASK                    SCHEDULE      PAUSED   PHASE   AGE
sample-mariadb-backup   mariadb-backup-12.3.2   */5 * * * *   false    Ready   29m
```
