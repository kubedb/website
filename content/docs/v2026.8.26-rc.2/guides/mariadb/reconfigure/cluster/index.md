...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MariaDB Cluster](/docs/v2026.8.26-rc.2/guides/mariadb/clustering/galera-cluster)
  - [MariaDBOpsRequest](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/opsrequest)
  - [Reconfigure Overview](/docs/v2026.8.26-rc.2/guides/mariadb/reconfigure/overview)
...
Now, we are going to deploy a `MariaDB` Cluster database with version `12.3.2`.
...
sample-mariadb   12.3.2    Ready    71s
```
