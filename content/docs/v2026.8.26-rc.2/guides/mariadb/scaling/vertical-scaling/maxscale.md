...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [MariaDB Replication](/docs/v2026.8.26-rc.2/guides/mariadb/clustering/mariadb-replication)
    - [MariaDBOpsRequest](/docs/v2026.8.26-rc.2/guides/mariadb/concepts/opsrequest)
    - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/mariadb/scaling/vertical-scaling/overview)
