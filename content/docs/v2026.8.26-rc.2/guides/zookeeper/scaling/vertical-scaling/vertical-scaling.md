...
- You should be familiar with the following `KubeDB` concepts:
    - [ZooKeeper](/docs/v2026.8.26-rc.2/guides/zookeeper/concepts/zookeeper)
    - [ZooKeeperOpsRequest](/docs/v2026.8.26-rc.2/guides/zookeeper/concepts/opsrequest)
    - [Vertical Scaling Overview](/docs/v2026.8.26-rc.2/guides/zookeeper/scaling/vertical-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/zookeeper](/docs/v2026.8.26-rc.2/examples/zookeeper) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.verticalScaling.mode` specifies how the scaling is actuated — `Restart` (default, restarts the Pods) or `InPlace` (resizes the running Pods without a restart, falling back to restart if a Node can't fit the new resources). See [Vertical Scaling Modes](/docs/v2026.8.26-rc.2/guides/zookeeper/scaling/vertical-scaling/overview#vertical-scaling-modes).
- Have a look [here](/docs/v2026.8.26-rc.2/guides/zookeeper/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
