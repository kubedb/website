...
<figure align="center">
  <img alt="Reconfiguring TLS process of Neo4j" src="/docs/v2026.8.26-rc.2/images/neo4j/reconfigureTLS.png">
...
- Follow: [Reconfigure TLS in Neo4j](/docs/v2026.8.26-rc.2/guides/neo4j/reconfigure-tls/reconfigure-tls).
