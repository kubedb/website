...
- Monitor Neo4j using [Builtin Prometheus](/docs/v2026.8.26-rc.2/guides/neo4j/monitoring/using-builtin-prometheus).
- Monitor Neo4j using [Prometheus Operator](/docs/v2026.8.26-rc.2/guides/neo4j/monitoring/using-prometheus-operator).
