...
- Install KubeDB following [the setup guide](/docs/v2026.8.26-rc.2/setup/README).
...
- Learn Neo4j CR fields from [Neo4j concept doc](/docs/v2026.8.26-rc.2/guides/neo4j/concepts/neo4j).
