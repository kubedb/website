...
- You should be familiar with [Neo4j](/docs/v2026.8.26-rc.2/guides/neo4j/concepts/neo4j).
- You should be familiar with [Neo4jOpsRequest](/docs/v2026.8.26-rc.2/guides/neo4j/concepts/opsrequest).
...
<figure align="center">
  <img alt="Horizontal scaling process of Neo4j" src="/docs/v2026.8.26-rc.2/images/neo4j/HorizontalScalling.png">
...
Follow the detailed guide: [Scale Neo4j Horizontally](/docs/v2026.8.26-rc.2/guides/neo4j/scaling/horizontal-scaling/scale-horizontally/).
