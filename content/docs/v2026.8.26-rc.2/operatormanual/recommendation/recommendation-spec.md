...
This page is the complete field reference. If you are new to recommendations, read the [Overview](/docs/v2026.8.26-rc.2/operatormanual/recommendation) first, then come back here when you need to look up a specific field.
...
For auto-approval configuration, see [Approval Policy](/docs/v2026.8.26-rc.2/operatormanual/recommendation/approval-policy). For scheduling, see [Maintenance Window](/docs/v2026.8.26-rc.2/operatormanual/recommendation/maintenance-window) and [Cluster Maintenance Window](/docs/v2026.8.26-rc.2/operatormanual/recommendation/cluster-maintenance-window).
