...
url: /docs/v2026.8.26-rc.2/operatormanual/migration/
aliases:
- /docs/v2026.8.26-rc.2/operatormanual/migration/README/
info:
...
Add `--set kubedb-courier.enabled=true` to the standard [KubeDB helm install](/docs/v2026.8.26-rc.2/setup/install/kubedb/helm) guide.
...
Add `--set kubedb-courier.enabled=true` to the [Kubedb helm upgrade](/docs/v2026.8.26-rc.2/setup/upgrade/) 
...
[PostgreSQL](/docs/v2026.8.26-rc.2/guides/postgres/migration/databasemigration)

[MySQL](/docs/v2026.8.26-rc.2/guides/mysql/migration/databasemigration)

[MariaDB](/docs/v2026.8.26-rc.2/guides/mariadb/migration/databasemigration)

[MongoDB](/docs/v2026.8.26-rc.2/guides/mongodb/migration/databasemigration)

[MSSQL Server](/docs/v2026.8.26-rc.2/guides/mssqlserver/migration/databasemigration)
