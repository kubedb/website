...
* [kubectl-dba monitor check-connection](/docs/v2026.8.26-rc.2/reference/cli/kubectl-dba_monitor_check-connection)	 - Check connection status of prometheus targets with server
* [kubectl-dba monitor dashboard](/docs/v2026.8.26-rc.2/reference/cli/kubectl-dba_monitor_dashboard)	 - Check availability of a grafana dashboard
* [kubectl-dba monitor get-alerts](/docs/v2026.8.26-rc.2/reference/cli/kubectl-dba_monitor_get-alerts)	 - Alerts associated with a database
