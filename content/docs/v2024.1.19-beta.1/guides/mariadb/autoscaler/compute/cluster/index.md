...
- You should be familiar with the following `KubeDB` concepts:
  - [MariaDB](/docs/v2024.1.19-beta.1/guides/mariadb/concepts/mariadb)
  - [MariaDBAutoscaler](/docs/v2024.1.19-beta.1/guides/mariadb/concepts/autoscaler)
  - [MariaDBOpsRequest](/docs/v2024.1.19-beta.1/guides/mariadb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2024.1.19-beta.1/guides/mariadb/autoscaler/compute/overview)
