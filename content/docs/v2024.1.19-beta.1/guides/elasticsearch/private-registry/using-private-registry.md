...
When installing KubeDB operator, set the flags `--docker-registry` and `--image-pull-secret` to appropriate value. Follow the guide for customizing installer to see how to pass those flags from [here](/docs/v2024.1.19-beta.1/setup/README#customizing-installer).
...
- Learn about [backup & restore](/docs/v2024.1.19-beta.1/guides/elasticsearch/backup/overview/) of Elasticsearch database using Stash.
