...
url: /docs/v2024.1.19-beta.1/guides/pgbouncer/
aliases:
- /docs/v2024.1.19-beta.1/guides/pgbouncer/README/
info:
...
- [Quickstart PgBouncer](/docs/v2024.1.19-beta.1/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.1.19-beta.1/guides/pgbouncer/monitoring/using-builtin-prometheus).
