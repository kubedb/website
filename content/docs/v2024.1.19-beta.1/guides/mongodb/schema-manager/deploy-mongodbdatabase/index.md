...
- You should be familiar with the following concepts:
  ...
  - [Schema Manager Overview](/docs/v2024.1.19-beta.1/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2024.1.19-beta.1/guides/mongodb/concepts/mongodbdatabase).
