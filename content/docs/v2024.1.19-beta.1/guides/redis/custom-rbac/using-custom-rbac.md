...
- Monitor your Redis instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.1.19-beta.1/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.1.19-beta.1/guides/redis/monitoring/using-builtin-prometheus).
