...
- [AppBinding](/docs/v2024.1.19-beta.1/guides/redis/concepts/appbinding)
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2024.1.19-beta.1/guides/redis/backup/standalone/images/sample-redis-backup.png">
