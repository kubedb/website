...
* [kubectl-dba remote-config mysql](/docs/v2024.1.19-beta.1/reference/cli/kubectl-dba_remote-config_mysql)	 - generate appbinding , secrets for remote replica
* [kubectl-dba remote-config postgres](/docs/v2024.1.19-beta.1/reference/cli/kubectl-dba_remote-config_postgres)	 - generate appbinding , secrets for remote replica
