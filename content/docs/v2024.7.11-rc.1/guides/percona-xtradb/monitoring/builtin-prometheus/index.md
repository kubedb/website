...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2024.7.11-rc.1/guides/percona-xtradb/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.7.11-rc.1/guides/percona-xtradb/monitoring/builtin-prometheus/images/built-prom.png" style="padding:10px">
</p>
