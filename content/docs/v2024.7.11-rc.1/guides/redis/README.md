...
url: /docs/v2024.7.11-rc.1/guides/redis/
aliases:
- /docs/v2024.7.11-rc.1/guides/redis/README/
info:
...
- [Quickstart Redis](/docs/v2024.7.11-rc.1/guides/redis/quickstart/quickstart) with KubeDB Operator.
- [Deploy Redis Cluster](/docs/v2024.7.11-rc.1/guides/redis/clustering/redis-cluster) using KubeDB.
...
- Use [kubedb cli](/docs/v2024.7.11-rc.1/guides/redis/cli/cli) to manage databases like kubectl for Kubernetes.
