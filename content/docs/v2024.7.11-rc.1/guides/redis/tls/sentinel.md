...
Read about the fields in details in [redis concept](/docs/v2024.7.11-rc.1/guides/redis/concepts/redis) and [redissentinel concept](/docs/v2024.7.11-rc.1/guides/redis/concepts/redissentinel)
...
- [Backup and Restore](/docs/v2024.7.11-rc.1/guides/redis/backup/overview/) Redis databases using Stash. .
