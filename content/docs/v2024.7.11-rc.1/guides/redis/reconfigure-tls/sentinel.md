...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2024.7.11-rc.1/guides/redis/concepts/redis#spectls).
