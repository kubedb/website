...
url: /docs/v2024.7.11-rc.1/guides/mysql/
aliases:
- /docs/v2024.7.11-rc.1/guides/mysql/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.7.11-rc.1/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2024.7.11-rc.1/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.7.11-rc.1/guides/mysql/backup/overview/) MySQL databases using Stash.
