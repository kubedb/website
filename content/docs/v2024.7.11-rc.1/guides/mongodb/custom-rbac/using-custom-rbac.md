...
- [Backup and Restore](/docs/v2024.7.11-rc.1/guides/mongodb/backup/overview/) MongoDB instances using Stash.
- Initialize [MongoDB with Script](/docs/v2024.7.11-rc.1/guides/mongodb/initialization/using-script).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2024.7.11-rc.1/guides/mongodb/monitoring/using-prometheus-operator).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2024.7.11-rc.1/guides/mongodb/monitoring/using-builtin-prometheus).
