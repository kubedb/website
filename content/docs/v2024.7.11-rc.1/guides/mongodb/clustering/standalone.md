...
- `spec.podTemplate` specifies the resources and other specifications of the pod. Have a look [here](/docs/v2024.7.11-rc.1/guides/mongodb/concepts/mongodb#specpodtemplate) to know the other subfields of the podTemplate.
...
- Deploy MongoDB [ReplicaSet](/docs/v2024.7.11-rc.1/guides/mongodb/clustering/replication_concept)
