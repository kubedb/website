...
When you install KubeDB, an `ElasticsearchVersion` custom resource will be created automatically for every supported Elasticsearch versions. You have to specify the name of `ElasticsearchVersion` crd in `spec.version` field of [Elasticsearch](/docs/v2021.01.15/guides/elasticsearch/concepts/elasticsearch) crd. Then, KubeDB will use the docker images specified in the `ElasticsearchVersion` crd to create your expected database.
...
`metadata.name` is a required field that specifies the name of the `ElasticsearchVersion` crd. You have to specify this name in `spec.version` field of [Elasticsearch](/docs/v2021.01.15/guides/elasticsearch/concepts/elasticsearch) crd.
...
- Learn about Elasticsearch crd [here](/docs/v2021.01.15/guides/elasticsearch/concepts/elasticsearch).
- Deploy your first Elasticsearch database with KubeDB by following the guide [here](/docs/v2021.01.15/guides/elasticsearch/quickstart/quickstart).