...
url: /docs/v2021.11.18/guides/pgbouncer/
aliases:
- /docs/v2021.11.18/guides/pgbouncer/README/
info:
  autoscaler: v0.8.0
  cli: v0.23.0
  community: v0.23.0
...
- [Quickstart PgBouncer](/docs/v2021.11.18/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.11.18/guides/pgbouncer/monitoring/using-builtin-prometheus).
