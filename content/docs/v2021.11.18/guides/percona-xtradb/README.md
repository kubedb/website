...
url: /docs/v2021.11.18/guides/percona-xtradb/
aliases:
- /docs/v2021.11.18/guides/percona-xtradb/README/
info:
  autoscaler: v0.8.0
  cli: v0.23.0
  community: v0.23.0
...
- [Overview](/docs/v2021.11.18/guides/percona-xtradb/overview/overview) of PerconaXtraDB.
- [Quickstart PerconaXtraDB](/docs/v2021.11.18/guides/percona-xtradb/quickstart/quickstart) with KubeDB Operator.
