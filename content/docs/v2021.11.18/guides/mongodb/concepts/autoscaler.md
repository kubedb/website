...
`spec.databaseRef` is a required field that point to the [MongoDB](/docs/v2021.11.18/guides/mongodb/concepts/mongodb) object for which the autoscaling will be performed. This field consists of the following sub-field:
