...
![redis-sentinel](/docs/v2023.06.13-rc.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.06.13-rc.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
