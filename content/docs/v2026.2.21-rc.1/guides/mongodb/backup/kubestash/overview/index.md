...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/overview/images/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Backup a standalone MongoDB databases using KubeStash following the guide from [here](/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/logical/standalone/).
- Backup a MongoDB Replicaset cluster using KubeStash following the guide from [here](/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/logical/replicaset/).
- Backup a sharded MongoDB cluster using KubeStash following the guide from [here](/docs/v2026.2.21-rc.1/guides/mongodb/backup/kubestash/logical/sharding/).
