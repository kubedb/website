...
KubeDB creates an [AppBinding](/docs/v2026.2.21-rc.1/guides/mongodb/concepts/appbinding) crd that holds the necessary information to connect with the database.
