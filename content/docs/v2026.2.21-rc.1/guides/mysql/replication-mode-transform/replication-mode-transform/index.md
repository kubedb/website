...
- Read [mysql replication concept](/docs/v2026.2.21-rc.1/guides/mysql/clustering/overview/) to learn about MySQL Replication.
...
We will use the [KubeDB kubectl Plugin](/docs/v2026.2.21-rc.1/setup/README) for generating configuration for remote replica. It will create the appbinding and and necessary secrets to connect with source server
```bash
...
- Detail concepts of [MySQLDBVersion object](/docs/v2026.2.21-rc.1/guides/mysql/concepts/catalog/).
