...
- You should be familiar with the following `KubeDB` concepts:
  - [Memcached](/docs/v2026.2.21-rc.1/guides/memcached/concepts/memcached)
  - [MemcachedAutoscaler](/docs/v2026.2.21-rc.1/guides/memcached/concepts/memcached-autoscaler)
  - [MemcachedOpsRequest](/docs/v2026.2.21-rc.1/guides/memcached/concepts/memcached-opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/memcached/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/memcached](/docs/v2026.2.21-rc.1/examples/memcached) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2026.2.21-rc.1/guides/memcached/concepts/memcached-opsrequest#spectimeout), [apply](/docs/v2026.2.21-rc.1/guides/memcached/concepts/memcached-opsrequest#specapply).
