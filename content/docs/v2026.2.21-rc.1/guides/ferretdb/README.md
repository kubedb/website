...
url: /docs/v2026.2.21-rc.1/guides/ferretdb/
aliases:
- /docs/v2026.2.21-rc.1/guides/ferretdb/README/
info:
...
- [Quickstart FerretDB](/docs/v2026.2.21-rc.1/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
