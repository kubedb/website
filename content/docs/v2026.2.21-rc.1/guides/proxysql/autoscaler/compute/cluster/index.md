...
- You should be familiar with the following `KubeDB` concepts:
  - [ProxySQL](/docs/v2026.2.21-rc.1/guides/proxysql/concepts/proxysql)
  - [ProxySQLAutoscaler](/docs/v2026.2.21-rc.1/guides/proxysql/concepts/autoscaler)
  - [ProxySQLOpsRequest](/docs/v2026.2.21-rc.1/guides/proxysql/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/proxysql/autoscaler/compute/overview)
