...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.2.21-rc.1/guides/mssqlserver/monitoring/using-prometheus-operator).
