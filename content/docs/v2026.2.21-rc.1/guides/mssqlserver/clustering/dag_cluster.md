...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2026.2.21-rc.1/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
