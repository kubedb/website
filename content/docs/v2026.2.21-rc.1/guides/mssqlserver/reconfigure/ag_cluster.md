...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Availabilty Group](/docs/v2026.2.21-rc.1/guides/mssqlserver/clustering/ag_cluster)
  - [MSSQLServerOpsRequest](/docs/v2026.2.21-rc.1/guides/mssqlserver/concepts/opsrequest)
  - [Reconfigure Overview](/docs/v2026.2.21-rc.1/guides/mssqlserver/reconfigure/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mssqlserver](/docs/v2026.2.21-rc.1/examples/mssqlserver/reconfigure) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
