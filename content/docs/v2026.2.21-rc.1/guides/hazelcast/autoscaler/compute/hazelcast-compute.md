...
- You should be familiar with the following `KubeDB` concepts:
  - [Hazelcast](/docs/v2026.2.21-rc.1/guides/hazelcast/concepts/hazelcast)
  - [HazelcastAutoscaler](/docs/v2026.2.21-rc.1/guides/hazelcast/concepts/hazelcastautoscaler)
  - [HazelcastOpsRequest](/docs/v2026.2.21-rc.1/guides/hazelcast/concepts/hazelcast-opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/hazelcast/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/hazelcast](/docs/v2026.2.21-rc.1/examples/hazelcast) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Detail concepts of [Hazelcast object](/docs/v2026.2.21-rc.1/guides/hazelcast/concepts/hazelcast).
- Monitor your Hazelcast database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.21-rc.1/guides/hazelcast/monitoring/prometheus-operator).
