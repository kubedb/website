...
- You should be familiar with the following `KubeDB` concepts:
  - [Ignite](/docs/v2026.2.21-rc.1/guides/ignite/concepts/ignite)
  - [IgniteAutoscaler](/docs/v2026.2.21-rc.1/guides/ignite/concepts/autoscaler)
  - [IgniteOpsRequest](/docs/v2026.2.21-rc.1/guides/ignite/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/ignite/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/ignite](/docs/v2026.2.21-rc.1/examples/ignite) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.2.21-rc.1/guides/ignite/concepts/opsrequest#spectimeout), [apply](/docs/v2026.2.21-rc.1/guides/ignite/concepts/opsrequest#specapply).
