...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [KafkaAutoscaler](/docs/v2026.2.21-rc.1/guides/kafka/concepts/kafkaautoscaler)
  - [KafkaOpsRequest](/docs/v2026.2.21-rc.1/guides/kafka/concepts/kafkaopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/kafka/autoscaler/compute/overview)
