...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2026.2.21-rc.1/guides/kafka/quickstart/kafka/).
- Learn how to use KubeDB to run Apache Kafka Connect cluster [here](/docs/v2026.2.21-rc.1/guides/kafka/connectcluster/quickstart).
