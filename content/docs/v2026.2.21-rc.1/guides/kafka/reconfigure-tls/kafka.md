...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2026.2.21-rc.1/guides/kafka/concepts/kafka#spectls).
