...
- Monitor your Redis server with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.21-rc.1/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis server with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.2.21-rc.1/guides/redis/monitoring/using-builtin-prometheus).
