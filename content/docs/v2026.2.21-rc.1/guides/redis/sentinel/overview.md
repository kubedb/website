...
![redis-sentinel](/docs/v2026.2.21-rc.1/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2026.2.21-rc.1/guides/redis/sentinel/redis-sentinel) using KubeDB.
