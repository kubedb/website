...
- You should be familiar with the following `KubeDB` concepts:
    - [ZooKeeper](/docs/v2026.2.21-rc.1/guides/zookeeper/concepts/zookeeper)
    - [ZooKeeperOpsRequest](/docs/v2026.2.21-rc.1/guides/zookeeper/concepts/opsrequest)
    - [Vertical Scaling Overview](/docs/v2026.2.21-rc.1/guides/zookeeper/scaling/vertical-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/zookeeper](/docs/v2026.2.21-rc.1/examples/zookeeper) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Have a look [here](/docs/v2026.2.21-rc.1/guides/zookeeper/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
