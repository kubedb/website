...
<figure align="center">
  <img alt="Reconfiguring TLS process of ZooKeeper" src="/docs/v2026.2.21-rc.1/images/day-2-operation/zookeeper/zk-reconfigure-tls.svg">
...
In the [next](/docs/v2026.2.21-rc.1/guides/zookeeper/reconfigure-tls/reconfigure-tls) docs, we are going to show a step by step guide on reconfiguring TLS configuration of a ZooKeeper database using `ZooKeeperOpsRequest` CRD.