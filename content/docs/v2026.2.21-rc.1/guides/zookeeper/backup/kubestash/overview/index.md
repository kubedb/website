...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/v2026.2.21-rc.1/guides/zookeeper/backup/kubestash/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="ZooKeeper Backup Overview" src="/docs/v2026.2.21-rc.1/guides/zookeeper/backup/kubestash/overview/images/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.2.21-rc.1/guides/zookeeper/backup/kubestash/overview/images/restore_overview.svg">
...
- Backup a `ZooKeeper` database using KubeStash by the following guides from [here](/docs/v2026.2.21-rc.1/guides/zookeeper/backup/kubestash/logical/).