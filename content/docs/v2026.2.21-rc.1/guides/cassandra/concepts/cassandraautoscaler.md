...
`spec.databaseRef` is a required field that point to the [Cassandra](/docs/v2026.2.21-rc.1/guides/cassandra/concepts/cassandra) object for which the autoscaling will be performed. This field consists of the following sub-field:
