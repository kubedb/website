...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Horizontal Scaling Overview](/docs/v2026.2.21-rc.1/guides/cassandra/scaling/horizontal-scaling/overview)
...
- Monitor your Cassandra with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.2.21-rc.1/guides/cassandra/monitoring/using-prometheus-operator).
