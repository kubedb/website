...
url: /docs/v2026.2.21-rc.1/guides/pgbouncer/
aliases:
- /docs/v2026.2.21-rc.1/guides/pgbouncer/README/
info:
...
- [Quickstart PgBouncer](/docs/v2026.2.21-rc.1/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2026.2.21-rc.1/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2026.2.21-rc.1/guides/pgbouncer/monitoring/using-prometheus-operator).
