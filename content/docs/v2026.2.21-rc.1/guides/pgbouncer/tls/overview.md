...
- `spec:`
  ...
  - `connectionPool`
    - `authType`
Read about the fields in details from [pgbouncer concept](/docs/v2026.2.21-rc.1/guides/pgbouncer/concepts/pgbouncer),
...
<figure align="center">
<img alt="Deploy PgBouncer with TLS/SSL" src="/docs/v2026.2.21-rc.1/images/day-2-operation/pgbouncer/pb-tls.svg">
