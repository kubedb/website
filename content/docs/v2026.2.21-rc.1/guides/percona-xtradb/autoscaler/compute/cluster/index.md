...
- You should be familiar with the following `KubeDB` concepts:
  - [PerconaXtraDB](/docs/v2026.2.21-rc.1/guides/percona-xtradb/concepts/perconaxtradb)
  - [PerconaXtraDBAutoscaler](/docs/v2026.2.21-rc.1/guides/percona-xtradb/concepts/autoscaler)
  - [PerconaXtraDBOpsRequest](/docs/v2026.2.21-rc.1/guides/percona-xtradb/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.2.21-rc.1/guides/percona-xtradb/autoscaler/compute/overview)
