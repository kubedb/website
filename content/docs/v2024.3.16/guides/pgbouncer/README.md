...
url: /docs/v2024.3.16/guides/pgbouncer/
aliases:
- /docs/v2024.3.16/guides/pgbouncer/README/
info:
  autoscaler: v0.29.0
  cli: v0.44.0
  dashboard: v0.20.0
...
- [Quickstart PgBouncer](/docs/v2024.3.16/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.3.16/guides/pgbouncer/monitoring/using-builtin-prometheus).
