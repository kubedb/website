...
- Read [concept of PerconaXtraDB Version Catalog](/docs/v2024.3.16/guides/percona-xtradb/concepts/perconaxtradb-version) to learn detail concepts of `PerconaXtraDBVersion` object.
