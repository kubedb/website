...
url: /docs/v2024.8.21/guides/elasticsearch/
aliases:
- /docs/v2024.8.21/guides/elasticsearch/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
--->
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.8.21/guides/elasticsearch/images/Lifecycle-of-an-Elasticsearch-CRD-complete.png">
</p>
...
> The listed ElasticsearchVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [ElasticsearchVersion](/docs/v2024.8.21/guides/elasticsearch/concepts/catalog/) object with your custom Elasticsearch image.

## User Guide

- [Quickstart Elasticsearch](/docs/v2024.8.21/guides/elasticsearch/quickstart/overview/elasticsearch/) with KubeDB Operator.
- [Quickstart OpenSearch](/docs/v2024.8.21/guides/elasticsearch/quickstart/overview/opensearch/) with KubeDB Operator.
...
- [Elasticsearch Clustering](/docs/v2024.8.21/guides/elasticsearch/clustering/combined-cluster/) supported by KubeDB
- [Backup & Restore Elasticsearch](/docs/v2024.8.21/guides/elasticsearch/backup/overview/) database using Stash.
...
- Use [kubedb cli](/docs/v2024.8.21/guides/elasticsearch/cli/cli) to manage databases like kubectl for Kubernetes.
