...
`spec.databaseRef` is a required field that point to the [Pgpool](/docs/v2024.8.21/guides/pgpool/concepts/pgpool) object for which the autoscaling will be performed. This field consists of the following sub-field:
