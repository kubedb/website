...
Now, create a secret with structure defined [here](/docs/v2024.8.21/guides/pgpool/concepts/pgpool#specsyncusers). Below is the YAML of the `secret` that we are going to create,
