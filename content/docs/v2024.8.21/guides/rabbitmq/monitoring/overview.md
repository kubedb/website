...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2024.8.21/images/concepts/monitoring/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor RabbitMQ database with KubeDB using [builtin-Prometheus](/docs/v2024.8.21/guides/rabbitmq/monitoring/using-builtin-prometheus)
- Learn how to monitor RabbitMQ database with KubeDB using [Prometheus operator](/docs/v2024.8.21/guides/rabbitmq/monitoring/using-prometheus-operator).
