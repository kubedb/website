...
Read about the fields in details in [RabbitMQ concept](/docs/v2024.8.21/guides/rabbitmq/concepts/rabbitmq),
...
Below is the YAML for RabbitMQ Standalone. Here, [`spec.sslMode`](/docs/v2024.8.21/guides/rabbitmq/concepts/rabbitmq#spectls) specifies tls configurations required for operator to create corresponding resources.
...
(/docs/v2024.8.21/guides/RabbitMQ/monitoring/using-prometheus-operator).
