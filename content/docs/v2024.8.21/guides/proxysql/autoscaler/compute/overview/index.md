...
- You should be familiar with the following `KubeDB` concepts:
  - [ProxySQL](/docs/v2024.8.21/guides/proxysql/concepts/proxysql)
  - [ProxySQLAutoscaler](/docs/v2024.8.21/guides/proxysql/concepts/autoscaler)
  - [ProxySQLOpsRequest](/docs/v2024.8.21/guides/proxysql/concepts/opsrequest)
...
<figure align="center">
  <img alt="Auto Scaling process of ProxySQL" src="/docs/v2024.8.21/guides/proxysql/autoscaler/compute/overview/images/proxy-as-compute.png">
