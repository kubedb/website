...
url: /docs/v2024.8.21/guides/solr/
aliases:
- /docs/v2024.8.21/guides/solr/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.8.21/guides/solr/quickstart/overview/images/Lifecycle-of-a-solr-instance.png">
</p>

## User Guide

- [Quickstart Solr](/docs/v2024.8.21/guides/solr/quickstart/overview/) with KubeDB Operator.
- Detail Concept of [Solr Object](/docs/v2024.8.21/guides/solr/concepts/solr).
