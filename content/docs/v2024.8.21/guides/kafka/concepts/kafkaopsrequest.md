...
`spec.databaseRef` is a required field that point to the [Kafka](/docs/v2024.8.21/guides/kafka/concepts/kafka) object for which the administrative operations will be performed. This field consists of the following sub-field:
...
- `spec.updateVersion.targetVersion` refers to a [KafkaVersion](/docs/v2024.8.21/guides/kafka/concepts/kafkaversion) CR that contains the Kafka version information where you want to update.
