...
`spec.version` is a required field specifying the name of the [KafkaVersion](/docs/v2024.8.21/guides/kafka/concepts/kafkaversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `Kafka` resources,
...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2024.8.21/guides/kafka/README).
- Deploy [dedicated topology cluster](/docs/v2024.8.21/guides/kafka/clustering/topology-cluster/) for Apache Kafka
- Deploy [combined cluster](/docs/v2024.8.21/guides/kafka/clustering/combined-cluster/) for Apache Kafka
