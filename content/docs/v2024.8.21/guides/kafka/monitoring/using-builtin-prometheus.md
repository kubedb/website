...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.8.21/images/kafka/monitoring/kafka-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn how to configure [Kafka Topology](/docs/v2024.8.21/guides/kafka/clustering/topology-cluster/).
