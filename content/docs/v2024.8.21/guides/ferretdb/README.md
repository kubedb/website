...
url: /docs/v2024.8.21/guides/ferretdb/
aliases:
- /docs/v2024.8.21/guides/ferretdb/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
- [Quickstart FerretDB](/docs/v2024.8.21/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
