...
url: /docs/v2024.8.21/guides/mysql/
aliases:
- /docs/v2024.8.21/guides/mysql/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.8.21/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2024.8.21/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.8.21/guides/mysql/backup/overview/) MySQL databases using Stash.
