...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MySQLAutoscaler](/docs/v2024.8.21/guides/mysql/concepts/autoscaler)
...
<figure align="center">
  <img alt="Storage Autoscaling process of MySQL" src="/docs/v2024.8.21/guides/mysql/autoscaler/storage/overview/images/storage-autoscaling.jpg">
