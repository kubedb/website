...
url: /docs/v2024.8.21/guides/pgbouncer/
aliases:
- /docs/v2024.8.21/guides/pgbouncer/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
- [Quickstart PgBouncer](/docs/v2024.8.21/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.8.21/guides/pgbouncer/monitoring/using-builtin-prometheus).
