...
url: /docs/v2024.8.21/guides/singlestore/
aliases:
- /docs/v2024.8.21/guides/singlestore/README/
info:
  autoscaler: v0.32.0
  cli: v0.47.0
  dashboard: v0.23.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2024.8.21/guides/singlestore/images/singlestore-lifecycle.png" >
</p>

## User Guide

- [Quickstart SingleStore](/docs/v2024.8.21/guides/singlestore/quickstart/quickstart) with KubeDB Operator.
