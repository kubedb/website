...
Lets edit an existing running MongoDB object to setup [Scheduled Backup](/docs/0.8.0/guides/mongodb/snapshot/scheduled-backup). The following command will open MongoDB `mongodb-demo` in editor.
