...
`KubeDB` provides the flexibility of deploying Memcached database from a private Docker registry. To learn how to deploym Memcached from a private registry, please visit [here](/docs/0.8.0/guides/memcached/private-registry/using-private-registry).
...
- [Monitor Memcached with builtin Prometheus](/docs/0.8.0/guides/memcached/monitoring/using-builtin-prometheus)
- [Monitor Memcached with CoreOS Prometheus operator](/docs/0.8.0/guides/memcached/monitoring/using-coreos-prometheus-operator)
