...
- [Monitor Elasticsearch with builtin Prometheus](/docs/0.8.0/guides/elasticsearch/monitoring/using-builtin-prometheus)
- [Monitor Elasticsearch with CoreOS Prometheus operator](/docs/0.8.0/guides/elasticsearch/monitoring/using-coreos-prometheus-operator)
...
- Learn how to use KubeDB to run an Elasticsearch database [here](/docs/0.8.0/guides/elasticsearch/README).
