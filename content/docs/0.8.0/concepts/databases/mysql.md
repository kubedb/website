...
`KubeDB` provides the flexibility of deploying MySQL database from a private Docker registry. To learn how to deploym MySQL from a private registry, please visit [here](/docs/0.8.0/guides/mysql/private-registry/using-private-registry).
...
- [Monitor MySQL with builtin Prometheus](/docs/0.8.0/guides/mysql/monitoring/using-builtin-prometheus)
- [Monitor MySQL with CoreOS Prometheus Operator](/docs/0.8.0/guides/mysql/monitoring/using-coreos-prometheus-operator)
...
- Learn how to use KubeDB to run a MySQL database [here](/docs/0.8.0/guides/mysql/README).
