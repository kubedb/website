...
![redis-sentinel](/docs/v2023.02.28/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2023.02.28/guides/redis/sentinel/redis-sentinel) using KubeDB.
