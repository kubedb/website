...
`spec.databaseRef` is a required field that point to the [MariaDB](/docs/v2023.02.28/guides/mariadb/concepts/mariadb) object for which the autoscaling will be performed. This field consists of the following sub-field:
