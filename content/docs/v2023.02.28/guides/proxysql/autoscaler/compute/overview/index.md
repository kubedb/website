...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [ProxySQLAutoscaler](/docs/v2023.02.28/guides/proxysql/concepts/autoscaler)
...
<figure align="center">
  <img alt="Auto Scaling process of ProxySQL" src="/docs/v2023.02.28/guides/proxysql/autoscaler/compute/overview/images/proxy-as-compute.png">
