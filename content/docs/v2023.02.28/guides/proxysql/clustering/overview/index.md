...
![ProxySQL Cluster](/docs/v2023.02.28/guides/proxysql/clustering/overview/images/proxy-cluster.png)
...
- [Deploy ProxySQL Cluster](/docs/v2023.02.28/guides/proxysql/clustering/proxysql-cluster/) using KubeDB.