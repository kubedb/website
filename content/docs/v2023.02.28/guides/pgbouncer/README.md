...
url: /docs/v2023.02.28/guides/pgbouncer/
aliases:
- /docs/v2023.02.28/guides/pgbouncer/README/
info:
  autoscaler: v0.17.0
  cli: v0.32.0
  dashboard: v0.8.0
...
- [Quickstart PgBouncer](/docs/v2023.02.28/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.02.28/guides/pgbouncer/monitoring/using-builtin-prometheus).
