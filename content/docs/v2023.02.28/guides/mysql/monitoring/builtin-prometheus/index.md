...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2023.02.28/guides/mysql/monitoring/overview/).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2023.02.28/images/mysql/monitoring/mysql-builtin-prom-target.png" style="padding:10px">
</p>
