...
- You should be familiar with the following `KubeDB` concepts:
  - [MySQL](/docs/v2023.02.28/guides/mysql/concepts/mysqldatabase)
  - [MySQLAutoscaler](/docs/v2023.02.28/guides/mysql/concepts/autoscaler)
...
<figure align="center">
  <img alt="Storage Autoscaling process of MySQL" src="/docs/v2023.02.28/guides/mysql/autoscaler/storage/overview/images/storage-autoscaling.jpg">
