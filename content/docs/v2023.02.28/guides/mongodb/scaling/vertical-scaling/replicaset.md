...
- Install `KubeDB` Provisioner and Ops-manager operator in your cluster following the steps [here](/docs/v2023.02.28/setup/README).

- You should be familiar with the following `KubeDB` concepts:
  - [MongoDB](/docs/v2023.02.28/guides/mongodb/concepts/mongodb)
  - [Replicaset](/docs/v2023.02.28/guides/mongodb/clustering/replicaset) 
  - [MongoDBOpsRequest](/docs/v2023.02.28/guides/mongodb/concepts/opsrequest)
  - [Vertical Scaling Overview](/docs/v2023.02.28/guides/mongodb/scaling/vertical-scaling/overview)
...
- Have a look [here](/docs/v2023.02.28/guides/mongodb/concepts/opsrequest#specreadinesscriteria) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
