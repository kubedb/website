...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDB Cluster](/docs/v2025.12.9-rc.0/guides/percona-xtradb/clustering/galera-cluster/)
  - [PerconaXtraDBOpsRequest](/docs/v2025.12.9-rc.0/guides/percona-xtradb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2025.12.9-rc.0/guides/percona-xtradb/scaling/horizontal-scaling/overview/)
