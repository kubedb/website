...
- Install the KubeDB CLI on your workstation and the KubeDB operator in your cluster by following the [installation steps](/docs/v2025.12.9-rc.0/setup/README).
...
- Detail concepts of [PerconaXtraDBopsRequest object](/docs/v2025.12.9-rc.0/guides/percona-xtradb/concepts/opsrequest/).
