...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.12.9-rc.0/guides/druid/monitoring/images/druid-prometheus.png" style="padding:10px">
</p>
...
- Deploy [dedicated  cluster](/docs/v2025.12.9-rc.0/guides/druid/clustering/overview/) for Apache Druid
