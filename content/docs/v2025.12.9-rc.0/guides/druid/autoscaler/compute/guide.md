...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [DruidAutoscaler](/docs/v2025.12.9-rc.0/guides/druid/concepts/druidautoscaler)
    - [DruidOpsRequest](/docs/v2025.12.9-rc.0/guides/druid/concepts/druidopsrequest)
    - [Compute Resource Autoscaling Overview](/docs/v2025.12.9-rc.0/guides/druid/autoscaler/compute/overview)
