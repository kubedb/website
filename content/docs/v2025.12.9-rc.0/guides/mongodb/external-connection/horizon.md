...
Read about the fields in details in [mongodb concept](/docs/v2025.12.9-rc.0/guides/mongodb/concepts/mongodb),
...
Below is the YAML for MongoDB Replicaset Horizons. Here, [`spec.replicaSet.horizons`](/docs/v2025.12.9-rc.0/guides/mongodb/concepts/mongodb#specreplicaset) specifies `horizons` for `replicaset`.
...
If you would like to uninstall the KubeDB operator, please follow the steps [here](/docs/v2025.12.9-rc.0/setup/README).

## Next Steps

- [Quickstart MongoDB](/docs/v2025.12.9-rc.0/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
- [Backup and Restore](/docs/v2025.12.9-rc.0/guides/mongodb/backup/stash/overview/) MongoDB instances using Stash.
- Initialize [MongoDB with Script](/docs/v2025.12.9-rc.0/guides/mongodb/initialization/using-script).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.12.9-rc.0/guides/mongodb/monitoring/using-prometheus-operator).
- Monitor your MongoDB instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.12.9-rc.0/guides/mongodb/monitoring/using-builtin-prometheus).
