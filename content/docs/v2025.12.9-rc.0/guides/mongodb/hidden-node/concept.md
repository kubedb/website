...
<p align="center">
  <img alt="hidden-node"  src="/docs/v2025.12.9-rc.0/images/mongodb/hidden.png" width="500" height="408">
</p>
...
- [Deploy MongoDB ReplicaSet with Hidden-node](/docs/v2025.12.9-rc.0/guides/mongodb/hidden-node/replicaset) using KubeDB.
