...
- Install KubeDB in your cluster following the steps [here](/docs/v2025.12.9-rc.0/setup/README).
...
- [Backup and Restore](/docs/v2025.12.9-rc.0/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
