...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Reconfigure Overview](/docs/v2025.12.9-rc.0/guides/ignite/reconfigure/overview)
...
> **Note:** YAML files used in this tutorial are stored in [examples](/docs/v2025.12.9-rc.0/examples/ignite) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Have a look [here](/docs/v2025.12.9-rc.0/guides/ignite/concepts/opsrequest#specconfiguration) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
