...
url: /docs/v2025.12.9-rc.0/guides/ferretdb/
aliases:
- /docs/v2025.12.9-rc.0/guides/ferretdb/README/
info:
...
- [Quickstart FerretDB](/docs/v2025.12.9-rc.0/guides/ferretdb/quickstart/quickstart) with KubeDB Operator.
