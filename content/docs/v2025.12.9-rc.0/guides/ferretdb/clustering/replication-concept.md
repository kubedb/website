...
<figure align="center">
  <img alt="Compute Auto Scaling process of FerretDB" src="/docs/v2025.12.9-rc.0/images/ferretdb/fr-replication.png">
...
- [Deploy FerretDB ReplicaSet](/docs/v2025.12.9-rc.0/guides/ferretdb/clustering/replication) using KubeDB.
