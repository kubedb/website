...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.12.9-rc.0/guides/hazelcast/concepts/hazelcast#spectls).
