...
`spec.version` is a required field specifying the name of the [HazelcastVersion](/docs/v2025.12.9-rc.0/guides/hazelcast/concepts/hazelcastversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `HazelcastVersion` crds,
...
- Learn how to use KubeDB to run a Hazelcast server [here](/docs/v2025.12.9-rc.0/guides/hazelcast/README).
