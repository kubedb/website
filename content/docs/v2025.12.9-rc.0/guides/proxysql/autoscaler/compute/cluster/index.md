...
- You should be familiar with the following `KubeDB` concepts:
  - [ProxySQL](/docs/v2025.12.9-rc.0/guides/proxysql/concepts/proxysql)
  - [ProxySQLAutoscaler](/docs/v2025.12.9-rc.0/guides/proxysql/concepts/autoscaler)
  - [ProxySQLOpsRequest](/docs/v2025.12.9-rc.0/guides/proxysql/concepts/opsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2025.12.9-rc.0/guides/proxysql/autoscaler/compute/overview)
