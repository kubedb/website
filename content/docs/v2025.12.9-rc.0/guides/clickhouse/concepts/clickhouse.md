...
`spec.version` is a required field specifying the name of the [ClickHouseVersion](/docs/v2025.12.9-rc.0/guides/clickhouse/concepts/clickhouseversion) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `ClickHouse` resources,
...
- Learn how to use KubeDB to run Apache ClickHouse cluster [here](/docs/v2025.12.9-rc.0/guides/clickhouse/README).
- Detail concepts of [ClickHouseVersion object](/docs/v2025.12.9-rc.0/guides/clickhouse/concepts/clickhouseversion).
