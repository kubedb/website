...
`metadata.name` is a required field that specifies the name of the `ClickHouseVersion` CR. You have to specify this name in `spec.version` field of [ClickHouse](/docs/v2025.12.9-rc.0/guides/clickhouse/concepts/clickhouse) CR.
...
- Learn about ClickHouse CRD [here](/docs/v2025.12.9-rc.0/guides/clickhouse/concepts/clickhouse).
