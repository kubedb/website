...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2025.12.9-rc.0/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
