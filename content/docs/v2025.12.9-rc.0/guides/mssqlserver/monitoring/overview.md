...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.12.9-rc.0/guides/mssqlserver/monitoring/using-prometheus-operator).
