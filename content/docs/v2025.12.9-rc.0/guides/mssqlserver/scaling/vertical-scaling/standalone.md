...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2025.12.9-rc.0/guides/mssqlserver/scaling/vertical-scaling/overview)
...
- [Backup and Restore](/docs/v2025.12.9-rc.0/guides/mssqlserver/backup/overview/) MSSQLServer databases using KubeStash.
