...
Read about the fields in details from [kafka concept](/docs/v2025.12.9-rc.0/guides/kafka/concepts/kafka),
...
<figure align="center">
<img alt="Deploy Kafka with TLS/SSL" src="/docs/v2025.12.9-rc.0/images/kafka/kf-tls.svg">
