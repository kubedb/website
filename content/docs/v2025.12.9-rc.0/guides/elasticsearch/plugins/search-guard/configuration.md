...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/v2025.12.9-rc.0/images/elasticsearch/sg-flow.png">
  </kbd>
</p>
...
- Learn how to [create TLS certificates](/docs/v2025.12.9-rc.0/guides/elasticsearch/plugins/search-guard/issue-certificate).
- Learn how to [use TLS certificates](/docs/v2025.12.9-rc.0/guides/elasticsearch/plugins/search-guard/use-tls) to connect Elasticsearch.
