...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.12.9-rc.0/guides/elasticsearch/autoscaler/compute/topology/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
