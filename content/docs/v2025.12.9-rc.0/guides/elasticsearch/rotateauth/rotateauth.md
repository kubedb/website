...
- You should be familiar with the following `KubeDB` concepts:
    - [Elasticsearch](/docs/v2025.12.9-rc.0/guides/elasticsearch/concepts/elasticsearch/)
    - [ElasticsearchOpsRequest](/docs/v2025.12.9-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/)
