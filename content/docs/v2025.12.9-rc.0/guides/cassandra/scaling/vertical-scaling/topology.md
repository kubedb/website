...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2025.12.9-rc.0/guides/cassandra/scaling/vertical-scaling/overview)
...
- Detail concepts of [Cassandra object](/docs/v2025.12.9-rc.0/guides/cassandra/concepts/cassandra).
