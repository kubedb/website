...
`spec.databaseRef` is a required field that point to the [Cassandra](/docs/v2025.12.9-rc.0/guides/cassandra/concepts/cassandra) object for which the administrative operations will be performed. This field consists of the following sub-field:
...
- `spec.updateVersion.targetVersion` refers to a [CassandraVersion](/docs/v2025.12.9-rc.0/guides/cassandra/concepts/cassandraversion) CR that contains the Cassandra version information where you want to update.
...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.12.9-rc.0/guides/cassandra/concepts/cassandra#spectls).
