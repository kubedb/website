...
- Monitor your Solr cluster with KubeDB using [out-of-the-box Prometheus operator](/docs/v2025.12.9-rc.0/guides/solr/monitoring/prometheus-operator).
- Monitor your Solr cluster with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2025.12.9-rc.0/guides/solr/monitoring/prometheus-builtin).
