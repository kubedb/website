...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2022.08.02-rc.0/guides/elasticsearch/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2022.08.02-rc.0/guides/elasticsearch/x-pack/configuration).
