...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2022.08.02-rc.0/images/percona-xtradb/Lifecycle_of_a_PerconaXtraDB.svg">
</p>
...
- How to run [PerconaXtraDB Cluster](/docs/v2022.08.02-rc.0/guides/percona-xtradb/clustering/percona-xtradb-cluster).
- Initialize [PerconaXtraDB with Script](/docs/v2022.08.02-rc.0/guides/percona-xtradb/initialization/using-script).
