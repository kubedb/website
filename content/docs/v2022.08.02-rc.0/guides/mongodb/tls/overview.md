...
- `spec:`
  ...
  - `tls:`
    ...
    - `certificates`
  - `clusterAuthMode`
Read about the fields in details from [mongodb concept](/docs/v2022.08.02-rc.0/guides/mongodb/concepts/mongodb),
...
<figure align="center">
<img alt="Deploy MongoDB with TLS/SSL" src="/docs/v2022.08.02-rc.0/images/day-2-operation/mongodb/mongodb-tls.svg">
