...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2022.08.02-rc.0/images/memcached/memcached-lifecycle.png">
</p>
...
- Monitor your Memcached server with KubeDB using [out-of-the-box Prometheus operator](/docs/v2022.08.02-rc.0/guides/memcached/monitoring/using-prometheus-operator).
- Monitor your Memcached server with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2022.08.02-rc.0/guides/memcached/monitoring/using-builtin-prometheus).
- Use [private Docker registry](/docs/v2022.08.02-rc.0/guides/memcached/private-registry/using-private-registry) to deploy Memcached with KubeDB.
- Detail concepts of [Memcached object](/docs/v2022.08.02-rc.0/guides/memcached/concepts/memcached).
