...
Read about the fields in details from [mysql concept](/docs/v2022.08.02-rc.0/guides/mysql/concepts/database/#),
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2022.08.02-rc.0/guides/mysql/tls/overview/images/my-tls-ssl.png">
