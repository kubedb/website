...
![MySQL Replication](/docs/v2022.08.02-rc.0/guides/mysql/clustering/overview/images/replicationarchitecturexample.png)
...
![Primary-Secondary Replication](/docs/v2022.08.02-rc.0/guides/mysql/clustering/overview/images/async-replication-diagram.png)
...
![MySQL Semisynchronous Replication](/docs/v2022.08.02-rc.0/guides/mysql/clustering/overview/images/semisync-replication-diagram.png)
...
![MySQL Group Replication Protocol](/docs/v2022.08.02-rc.0/guides/mysql/clustering/overview/images/gr-replication-diagram.png)
...
![3 Server Group](/docs/v2022.08.02-rc.0/guides/mysql/clustering/overview/images/gr-3-server-group.png)
...
- [Deploy MySQL Group Replication](/docs/v2022.08.02-rc.0/guides/mysql/clustering/group-replication/) using KubeDB.
