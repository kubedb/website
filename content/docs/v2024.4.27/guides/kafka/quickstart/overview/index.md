...
> We have designed this tutorial to demonstrate a production setup of KubeDB managed Apache Kafka. If you just want to try out KubeDB, you can bypass some safety features following the tips [here](/docs/v2024.4.27/guides/kafka/quickstart/overview/#tips-for-testing).
...
When you install the KubeDB operator, it registers a CRD named [KafkaVersion](/docs/v2024.4.27/guides/kafka/concepts/catalog). The installation process comes with a set of tested KafkaVersion objects. Let's check available KafkaVersions by,
