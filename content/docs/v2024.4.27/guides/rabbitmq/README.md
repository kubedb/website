...
url: /docs/v2024.4.27/guides/rabbitmq/
aliases:
- /docs/v2024.4.27/guides/rabbitmq/README/
info:
  autoscaler: v0.30.0
  cli: v0.45.0
  dashboard: v0.21.0
...
<p text-align="center">
    <img alt="lifecycle"  src="/docs/v2024.4.27/guides/rabbitmq/images/rabbitmq-lifecycle.png" >
</p>

## User Guide

- [Quickstart RabbitMQ](/docs/v2024.4.27/guides/rabbitmq/quickstart/quickstart) with KubeDB Operator.
