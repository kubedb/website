...
`spec.version` is a required field specifying the name of the [RedisVersion](/docs/v2024.4.27/guides/redis/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `RedisVersion` crds,
