...
`spec.databaseRef` is a required field that point to the [Redis](/docs/v2024.4.27/guides/redis/concepts/redis) object for which the autoscaling will be performed. This field consists of the following sub-field:
...
- Deploy your first Redis database with Redis by following the guide [here](/docs/v2024.4.27/guides/redis/quickstart/quickstart).
