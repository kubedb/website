...
url: /docs/v2024.4.27/guides/pgpool/
aliases:
- /docs/v2024.4.27/guides/pgpool/README/
info:
  autoscaler: v0.30.0
  cli: v0.45.0
  dashboard: v0.21.0
...
> The listed PgpoolVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [PgpoolVersion](/docs/v2024.4.27/guides/pgpool/concepts/catalog) object with your custom pgpool image.
...
- [Quickstart Pgpool](/docs/v2024.4.27/guides/pgpool/quickstart/quickstart) with KubeDB Operator.
