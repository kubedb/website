...
Pair a `MaintenanceWindow` with an [ApprovalPolicy](/docs/v2026.8.14-rc.0/operatormanual/recommendation/approval-policy) to fully automate routine maintenance.
...
For a single cluster-wide default schedule, use a [Cluster Maintenance Window](/docs/v2026.8.14-rc.0/operatormanual/recommendation/cluster-maintenance-window) instead.
...
1. The Supervisor selects a MaintenanceWindow:
   ...
   * Otherwise falls back to a cluster-wide default ([ClusterMaintenanceWindow](/docs/v2026.8.14-rc.0/operatormanual/recommendation/cluster-maintenance-window)).
2. Time evaluation:
...
See [Approval Policy](/docs/v2026.8.14-rc.0/operatormanual/recommendation/approval-policy) for the full reference.
