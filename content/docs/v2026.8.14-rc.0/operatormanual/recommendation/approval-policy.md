...
See [Recommendation Spec](/docs/v2026.8.14-rc.0/operatormanual/recommendation/recommendation-spec) for the full Recommendation field reference, and [Maintenance Window](/docs/v2026.8.14-rc.0/operatormanual/recommendation/maintenance-window) for window scheduling details.
