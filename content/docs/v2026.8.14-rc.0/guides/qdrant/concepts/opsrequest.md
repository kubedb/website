...
`spec.databaseRef` is a required field that points to the [Qdrant](/docs/v2026.8.14-rc.0/guides/qdrant/concepts/qdrant) object where the administrative operations will be applied. It contains:
...
- Follow operation tutorials like [Restart](/docs/v2026.8.14-rc.0/guides/qdrant/restart/restart) and [Volume Expansion](/docs/v2026.8.14-rc.0/guides/qdrant/volume-expansion/volume-expansion).