...
`metadata.name` is a required field that specifies the name of the `QdrantVersion` CRD. You have to specify this name in `spec.version` field of the [Qdrant](/docs/v2026.8.14-rc.0/guides/qdrant/concepts/qdrant) CRD.
...
- Learn about the [Qdrant CRD](/docs/v2026.8.14-rc.0/guides/qdrant/concepts/qdrant).
- Deploy your first Qdrant database with KubeDB by following the guide [here](/docs/v2026.8.14-rc.0/guides/qdrant/quickstart/quickstart).