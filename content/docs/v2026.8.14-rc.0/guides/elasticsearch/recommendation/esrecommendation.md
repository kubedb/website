...
- [Recommendation Configuration](/docs/v2026.8.14-rc.0/operatormanual/recommendation/configuration) — prerequisites, Supervisor CRD install, and all Helm flags.
- [Recommendation Overview](/docs/v2026.8.14-rc.0/operatormanual/recommendation) — architecture and lifecycle walkthrough.

<p align="center">
  <img alt="Recommendation Lifecycle" src="/docs/v2026.8.14-rc.0/operatormanual/recommendation/images/recommendation-generation.png">
</p>
...
- [ElasticsearchOpsRequest](/docs/v2026.8.14-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/)
- [ElasticsearchRotateAuth](/docs/v2026.8.14-rc.0/guides/elasticsearch/rotateauth/rotateauth)
- [ElasticsearchReconfigureTLS](/docs/v2026.8.14-rc.0/guides/elasticsearch/reconfigure_tls/elasticsearch)
- [ElasticsearchUpdateVersion](/docs/v2026.8.14-rc.0/guides/elasticsearch/update-version/elasticsearch)
...
| --------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Version Update**                | A newer major, minor, or patch version becomes available                          | [Version Update Recommendation](/docs/v2026.8.14-rc.0/operatormanual/recommendation/version-update-recommendation)        |
| **Same-Version Update**           | The container image for your *current* version is refreshed (e.g. security patch) | [Version Update Recommendation](/docs/v2026.8.14-rc.0/operatormanual/recommendation/version-update-recommendation)        |
| **TLS Certificate Rotation**      | An issued certificate is approaching its expiry threshold                         | [TLS Certificate Rotation Recommendation](/docs/v2026.8.14-rc.0/operatormanual/recommendation/rotate-tls-recommendation)  |
| **Authentication Secret Rotation** | The auth secret is approaching its `rotateAfter` deadline                         | [Authentication Secret Rotation Recommendation](/docs/v2026.8.14-rc.0/operatormanual/recommendation/rotate-auth-recommendation) |
...
For prerequisites, Helm configuration flags, and the full cross-database Recommendation lifecycle, see the [Recommendation Configuration](/docs/v2026.8.14-rc.0/operatormanual/recommendation/configuration) and [Recommendation Overview](/docs/v2026.8.14-rc.0/operatormanual/recommendation) in the operator manual.
