...
sg-elasticsearch   searchguard-7.9.3    Running   1m
```
...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2026.8.14-rc.0/guides/elasticsearch/plugins/search-guard/use-tls).
- Learn how to generate [search-guard configuration](/docs/v2026.8.14-rc.0/guides/elasticsearch/plugins/search-guard/configuration).
