...
[here](/docs/v2026.8.14-rc.0/setup/README).
...
- Learn about the [synchronous replication overview](/docs/v2026.8.14-rc.0/guides/postgres/synchronous/).
- Run PostgreSQL with a [custom configuration file](/docs/v2026.8.14-rc.0/guides/postgres/configuration/using-config-file).
