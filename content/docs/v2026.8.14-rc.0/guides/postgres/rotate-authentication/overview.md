...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [PostgreSQLOpsRequest](/docs/v2026.8.14-rc.0/guides/postgres/concepts/opsrequest)
...
[//]: # (  <img alt="Rotate Authentication process of PostgreSQL" src="/docs/v2026.8.14-rc.0/images/day-2-operation/PostgreSQL/kf-rotate-auth.svg">)
