...
> New to KubeDB? Please start [the KubeDB documentation homepage](/docs/v2026.8.14-rc.0/README).
...
[the KubeDB installation guide](/docs/v2026.8.14-rc.0/setup/README).
...
[Using Custom Configuration File](/docs/v2026.8.14-rc.0/guides/postgres/configuration/using-config-file) for details).
...
- Learn how to [run PostgreSQL with a custom configuration file](/docs/v2026.8.14-rc.0/guides/postgres/configuration/using-config-file).
- Set up a [Highly Available PostgreSQL cluster](/docs/v2026.8.14-rc.0/guides/postgres/clustering/ha_cluster) — extensions created on the primary replicate to the standbys.
...
- Detail concepts of [PostgresVersion object](/docs/v2026.8.14-rc.0/guides/postgres/concepts/catalog).
