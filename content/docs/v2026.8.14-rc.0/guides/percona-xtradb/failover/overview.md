...
> New to KubeDB? Please start [here](/docs/v2026.8.14-rc.0/setup/README).
...
* Monitor your Percona XtraDB database with KubeDB using [built-in Prometheus](/docs/v2026.8.14-rc.0/guides/percona-xtradb/monitoring/builtin-prometheus/)
* Monitor with [Prometheus operator](/docs/v2026.8.14-rc.0/guides/percona-xtradb/monitoring/prometheus-operator/)
* Use [private Docker registry](/docs/v2026.8.14-rc.0/guides/percona-xtradb/private-registry/quickstart/) to deploy Percona XtraDB with KubeDB
