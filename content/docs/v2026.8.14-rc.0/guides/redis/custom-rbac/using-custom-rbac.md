...
- Monitor your Redis instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.8.14-rc.0/guides/redis/monitoring/using-prometheus-operator).
- Monitor your Redis instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.8.14-rc.0/guides/redis/monitoring/using-builtin-prometheus).
