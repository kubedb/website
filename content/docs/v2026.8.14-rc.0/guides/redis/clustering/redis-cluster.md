...
- Read [redis clustering concept](/docs/v2026.8.14-rc.0/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2026.8.14-rc.0/guides/redis/sentinel/overview)
