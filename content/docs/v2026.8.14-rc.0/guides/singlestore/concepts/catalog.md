...
spec:
  coordinator:
    image: ghcr.io/kubedb/singlestore-coordinator:v0.20.0
  db:
    image: ghcr.io/appscode-images/singlestore-node:alma-8.9.3-bfa36a984a
  gitSyncer:
  ...
  securityContext:
    ...
    runAsUser: 999
  standalone:
    image: docker.io/singlestore/cluster-in-a-box:alma-8.7.10-95e2357384-4.1.0-1.17.14
  updateConstraints:
    allowlist:
    - 8.9.3
  version: 8.9.3
...
`metadata.name` is a required field that specifies the name of the `SingleStoreVersion` crd. You have to specify this name in `spec.version` field of [SingleStore](/docs/v2026.8.14-rc.0/guides/singlestore/concepts/singlestore) crd.
...
- Learn about SingleStore crd [here](/docs/v2026.8.14-rc.0/guides/singlestore/concepts/singlestore).
- Deploy your first SingleStore database with KubeDB by following the guide [here](/docs/v2026.8.14-rc.0/guides/singlestore/quickstart/quickstart).