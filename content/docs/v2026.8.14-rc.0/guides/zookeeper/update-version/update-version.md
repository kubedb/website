...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2026.8.14-rc.0/guides/zookeeper/update-version/overview)
...
- Have a look [here](/docs/v2026.8.14-rc.0/guides/zookeeper/concepts/opsrequest#spectimeout) on the respective sections to understand the `readinessCriteria`, `timeout` & `apply` fields.
