...
<figure align="center">
  <img alt="Reconfiguring TLS process of Neo4j" src="/docs/v2026.8.14-rc.0/images/neo4j/reconfigureTLS.png">
...
- Follow: [Reconfigure TLS in Neo4j](/docs/v2026.8.14-rc.0/guides/neo4j/reconfigure-tls/reconfigure-tls).
