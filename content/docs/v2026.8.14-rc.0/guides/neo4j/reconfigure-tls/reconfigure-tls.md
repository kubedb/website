...
- Install KubeDB operator following [the setup guide](/docs/v2026.8.14-rc.0/setup/README).
...
- Learn `Neo4jOpsRequest` fields in detail from [Neo4j OpsRequest concept](/docs/v2026.8.14-rc.0/guides/neo4j/concepts/opsrequest).
