...
<p align="center">
  <img alt="lifecycle" src="/docs/v2026.8.14-rc.0/images/neo4j/lifecycle.png">
</p>
...
<p align="center">
  <kbd>
    <img alt="neo4j-browser-login" src="/docs/v2026.8.14-rc.0/images/neo4j/neo4j-browser-login.png">
  </kbd>
</p>
...
<p align="center">
  <kbd>
    <img alt="neo4j-browser-connected" src="/docs/v2026.8.14-rc.0/images/neo4j/neo4j-browser-connected.png">
  </kbd>
</p>
...
- Understand the cluster topology, Raft consensus, and failover behavior in the [Cluster Architecture Overview](/docs/v2026.8.14-rc.0/guides/neo4j/clustering/architecture-overview).
- If your cluster enforces RBAC, review required permissions in [RBAC for Neo4j](/docs/v2026.8.14-rc.0/guides/neo4j/quickstart/rbac).
- Learn how to perform day-2 operations such as version upgrades, scaling, volume expansion, TLS configuration, and more using the [Neo4j OpsRequest overview](/docs/v2026.8.14-rc.0/guides/neo4j/concepts/opsrequest).
- Detail concepts of the [Neo4j CRD](/docs/v2026.8.14-rc.0/guides/neo4j/concepts/neo4j).
