...
- Install KubeDB Community and Enterprise operators following [the setup guide](/docs/v2026.8.14-rc.0/setup/README).
- Review [Neo4j](/docs/v2026.8.14-rc.0/guides/neo4j/concepts/neo4j), [OpsRequest](/docs/v2026.8.14-rc.0/guides/neo4j/concepts/opsrequest), and [Reconfigure Overview](/docs/v2026.8.14-rc.0/guides/neo4j/reconfigure/overview).
