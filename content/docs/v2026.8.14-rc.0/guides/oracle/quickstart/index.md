...
<p align="center">   <img alt="lifecycle" src="/docs/v2026.8.14-rc.0/images/oracle/oracle_lifecycle.png"> </p>
...
<div style="text-align: center;">
  <img alt="registry-home" src="/docs/v2026.8.14-rc.0/guides/oracle/quickstart/registry-oracle-home.png">
</div>
...
<div style="text-align: center;">
  <img alt="database-images" src="/docs/v2026.8.14-rc.0/guides/oracle/quickstart/database-image-green-tick.png">
</div>

4\. Navigate to **My Profile** (top right corner) → **Generate Token** and copy the authentication token.

<div style="text-align: center;">
  <img alt="auth-token" src="/docs/v2026.8.14-rc.0/guides/oracle/quickstart/auth-token.png">
</div>
