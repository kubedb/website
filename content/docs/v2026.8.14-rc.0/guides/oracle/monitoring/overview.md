...
- Learn how to monitor an Oracle database with KubeDB using the [Prometheus operator](/docs/v2026.8.14-rc.0/guides/oracle/monitoring/using-prometheus-operator).
- Detail concepts of the [Oracle object](/docs/v2026.8.14-rc.0/guides/oracle/concepts/oracle).
