...
url: /docs/v2026.8.14-rc.0/guides/oracle/
aliases:
- /docs/v2026.8.14-rc.0/guides/oracle/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.8.14-rc.0/images/oracle/oracle_lifecycle.png">
</p>

## User Guide

- [Quickstart Oracle](/docs/v2026.8.14-rc.0/guides/oracle/quickstart/) with KubeDB Operator.
