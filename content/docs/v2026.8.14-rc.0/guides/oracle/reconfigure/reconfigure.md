...
- Learn how to provision a database with a [custom configuration file](/docs/v2026.8.14-rc.0/guides/oracle/configuration/using-config-file) at creation time.
