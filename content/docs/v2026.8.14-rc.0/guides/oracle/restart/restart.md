...
- Detail concepts of [Oracle object](/docs/v2026.8.14-rc.0/guides/oracle/concepts/oracle).
- Monitor your Oracle database with KubeDB using [Prometheus operator](/docs/v2026.8.14-rc.0/guides/oracle/monitoring/using-prometheus-operator).
- Learn how to [reconfigure](/docs/v2026.8.14-rc.0/guides/oracle/reconfigure/reconfigure) an Oracle database.
