...
- Learn how to [reconfigure](/docs/v2026.8.14-rc.0/guides/oracle/reconfigure/reconfigure) a running Oracle database with an `OracleOpsRequest`.
- Initialize [Oracle with Script](/docs/v2026.8.14-rc.0/guides/oracle/initialization/script_source).
