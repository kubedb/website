...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/clickhouse/scaling/vertical-scaling/overview)
...
- Detail concepts of [ClickHouse object](/docs/v2026.8.14-rc.0/guides/clickhouse/concepts/clickhouse).
