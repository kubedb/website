...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.8.14-rc.0/guides/milvus/volume-expansion/overview)
...
- Learn about [storage migration](/docs/v2026.8.14-rc.0/guides/milvus/storage-migration/guide) of a Milvus database.
