...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Horizontal Scaling Overview](/docs/v2026.8.14-rc.0/guides/milvus/scaling/horizontal-scaling/overview)
...
Deploy the distributed database (`milvus-cluster`) and wait until it is `Ready` (see the [distributed quickstart](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/distributed)). By default each role runs a single replica.
...
- Learn about [vertical scaling](/docs/v2026.8.14-rc.0/guides/milvus/scaling/vertical-scaling/guide) of a Milvus database.
