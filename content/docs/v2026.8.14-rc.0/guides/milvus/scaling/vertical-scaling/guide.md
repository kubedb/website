...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/milvus/scaling/vertical-scaling/overview)
...
- Learn about [horizontal scaling](/docs/v2026.8.14-rc.0/guides/milvus/scaling/horizontal-scaling/guide) of a distributed Milvus.
