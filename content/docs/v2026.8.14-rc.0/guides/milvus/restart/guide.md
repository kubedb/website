...
Deploy a standalone Milvus and wait until it is `Ready` (see the [quickstart](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/standalone)).
...
- Learn how to [reconfigure](/docs/v2026.8.14-rc.0/guides/milvus/reconfigure/guide) a Milvus database.
