...
url: /docs/v2026.8.14-rc.0/guides/milvus/
aliases:
- /docs/v2026.8.14-rc.0/guides/milvus/README/
info:
...
- [Prepare Dependencies](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/prerequisites) before running any Milvus example.
- [Standalone Quickstart](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/standalone) with KubeDB Operator.
- [Distributed Quickstart](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/distributed) with KubeDB Operator.
