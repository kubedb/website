...
For the [standalone](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/standalone) and [distributed](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/distributed) quickstarts, this is the default and recommended path.
...
- Install [Prometheus Operator](https://github.com/prometheus-operator/prometheus-operator) only if you want to follow the [monitoring guide](/docs/v2026.8.14-rc.0/guides/milvus/monitoring/using-prometheus-operator).
- Install [cert-manager](https://cert-manager.io/docs/installation/) only if you want to follow the [TLS guide](/docs/v2026.8.14-rc.0/guides/milvus/tls/guide) or the [TLS reconfiguration guide](/docs/v2026.8.14-rc.0/guides/milvus/reconfigure-tls/guide).
...
- [Deploy standalone Milvus](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/standalone)
- [Deploy distributed Milvus](/docs/v2026.8.14-rc.0/guides/milvus/quickstart/distributed)
