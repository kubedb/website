...
Only `streamingnode` carries persistent Milvus storage in distributed mode. That is why storage operations such as [volume expansion](/docs/v2026.8.14-rc.0/guides/milvus/volume-expansion/guide), [storage migration](/docs/v2026.8.14-rc.0/guides/milvus/storage-migration/guide), and [storage autoscaling](/docs/v2026.8.14-rc.0/guides/milvus/autoscaler/storage/guide) target `streamingnode`.
...
- `spec.authSecret.rotateAfter` and `spec.authSecret.activeFrom` are used by the Recommendation Engine to decide when a [RotateAuth](/docs/v2026.8.14-rc.0/guides/milvus/rotate-auth/guide) recommendation should be emitted.
...
See [Configure TLS for Milvus](/docs/v2026.8.14-rc.0/guides/milvus/tls/guide) for the end-to-end flow.
...
See [Monitoring Milvus](/docs/v2026.8.14-rc.0/guides/milvus/monitoring/using-prometheus-operator).
...
- [MilvusAutoscaler](/docs/v2026.8.14-rc.0/guides/milvus/concepts/milvusautoscaler)
