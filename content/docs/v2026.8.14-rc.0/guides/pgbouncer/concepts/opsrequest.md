...
`spec.databaseRef` is a required field that point to the [PgBouncer](/docs/v2026.8.14-rc.0/guides/pgbouncer/concepts/pgbouncer) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [PgBouncer](/docs/v2026.8.14-rc.0/guides/pgbouncer/concepts/pgbouncer) object.
...
- `spec.updateVersion.targetVersion` refers to a [PgBouncerVersion](/docs/v2026.8.14-rc.0/guides/pgbouncer/concepts/catalog) CR that contains the PgBouncer version information where you want to update.
