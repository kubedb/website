...
PgBouncer is a connection pooler for PostgreSQL and requires a running PostgreSQL instance as its backend. Prepare a KubeDB Postgres cluster using this [tutorial](/docs/v2026.8.14-rc.0/guides/postgres/clustering/streaming_replication).
