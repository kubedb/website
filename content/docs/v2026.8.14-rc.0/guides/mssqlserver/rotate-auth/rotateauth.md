...
- You should be familiar with the following `KubeDB` concepts:
  - [MSSQLServer](/docs/v2026.8.14-rc.0/guides/mssqlserver/concepts/mssqlserver)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mssqlserver](/docs/v2026.8.14-rc.0/examples/mssqlserver/rotate-auth) directory of [kubedb/docs](https://github.com/kube/docs) repository.
