...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2026.8.14-rc.0/guides/mssqlserver/monitoring/using-prometheus-operator).
