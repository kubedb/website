...
> create one for the source. Learn more about [AppBinding](/docs/v2026.8.14-rc.0/guides/mssqlserver/concepts/appbinding).
...
- Migrate an MSSQL Server database step by step with the [MSSQL Server Database Migration](/docs/v2026.8.14-rc.0/guides/mssqlserver/migration/databasemigration) guide.
- Learn about the [AppBinding](/docs/v2026.8.14-rc.0/guides/mssqlserver/concepts/appbinding) concept.
- Learn about the MSSQLServer CRD [here](/docs/v2026.8.14-rc.0/guides/mssqlserver/concepts/mssqlserver).
