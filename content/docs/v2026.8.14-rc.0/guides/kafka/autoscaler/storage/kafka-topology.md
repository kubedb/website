...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [KafkaAutoscaler](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaautoscaler)
    - [KafkaOpsRequest](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaopsrequest)
    - [Storage Autoscaling Overview](/docs/v2026.8.14-rc.0/guides/kafka/autoscaler/storage/overview)
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/kafka/autoscaler/storage/kafka-storage-autoscaler-topology.yaml
...
- Different Kafka topology clustering modes [here](/docs/v2026.8.14-rc.0/guides/kafka/clustering/_index).
