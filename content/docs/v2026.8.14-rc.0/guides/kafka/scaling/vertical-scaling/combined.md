...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2026.8.14-rc.0/guides/kafka/clustering/combined-cluster/)
    - [KafkaOpsRequest](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaopsrequest)
    - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/kafka/scaling/vertical-scaling/overview)
