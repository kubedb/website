...
`spec.databaseRef` is a required field that point to the [Kafka](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafka) object for which the autoscaling will be performed. This field consists of the following sub-field:
