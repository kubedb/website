...
Read about the fields in details from [kafka concept](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafka),
...
<figure align="center">
<img alt="Deploy Kafka with TLS/SSL" src="/docs/v2026.8.14-rc.0/images/kafka/kf-tls.svg">
