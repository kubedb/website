...
To know more about this configuration file, check [here](/docs/v2026.8.14-rc.0/guides/kafka/configuration/kafka-topology)
```yaml
apiVersion: v1
kind: Secret
metadata:
...
List Kafka versions using `kubectl get kafkaversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.8.14-rc.0/guides/kafka/update-version/update-version).
...
- Learn Kafka Scaling
    - [Horizontal Scaling](/docs/v2026.8.14-rc.0/guides/kafka/scaling/horizontal-scaling/topology)
    - [Vertical Scaling](/docs/v2026.8.14-rc.0/guides/kafka/scaling/vertical-scaling/topology)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.8.14-rc.0/guides/kafka/update-version/overview)
- Monitor your KafkaQL database with KubeDB using [built-in Prometheus](/docs/v2026.8.14-rc.0/guides/kafka/monitoring/using-builtin-prometheus).
