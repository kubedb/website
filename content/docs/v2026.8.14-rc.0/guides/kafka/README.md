...
url: /docs/v2026.8.14-rc.0/guides/kafka/
aliases:
- /docs/v2026.8.14-rc.0/guides/kafka/README/
info:
...
<p align="center">
<img alt="lifecycle"  src="/docs/v2026.8.14-rc.0/images/kafka/kafka-crd-lifecycle.png">
</p>
...
> The listed KafkaVersions are tested and provided as a part of the installation process (ie. catalog chart), but you are open to create your own [KafkaVersion](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaversion) object with your custom Kafka image.
...
- Kafka Clustering supported by KubeDB
  - [Combined Clustering](/docs/v2026.8.14-rc.0/guides/kafka/clustering/combined-cluster/)
  - [Topology Clustering](/docs/v2026.8.14-rc.0/guides/kafka/clustering/topology-cluster/)
- Monitor your Kafka database with KubeDB using [out-of-the-box Prometheus and Grafana](/docs/v2026.8.14-rc.0/guides/kafka/monitoring/using-prometheus-operator).
- Use [kubedb cli](/docs/v2026.8.14-rc.0/guides/kafka/cli/cli) to manage databases like kubectl for Kubernetes.
- Detail concepts of [Kafka object](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafka).
- Detail concepts of [ConnectCluster object](/docs/v2026.8.14-rc.0/guides/kafka/concepts/connectcluster).
- Detail concepts of [Connector object](/docs/v2026.8.14-rc.0/guides/kafka/concepts/connector).
- Detail concepts of [KafkaVersion object](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaversion).
- Detail concepts of [KafkaConnectorVersion object](/docs/v2026.8.14-rc.0/guides/kafka/concepts/kafkaconnectorversion).
