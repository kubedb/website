...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/solr/scaling/vertical-scaling/overview)
...
- Different Solr Combined clustering modes [here](/docs/v2026.8.14-rc.0/guides/solr/clustering/combined_cluster).
