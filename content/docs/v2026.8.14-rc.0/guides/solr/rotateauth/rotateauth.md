...
> This tutorial demonstrates how to rotate authentication credentials for Solr managed by KubeDB. Before you begin, ensure that the Solr CRD is installed and running. If not, follow [this guide](/docs/v2026.8.14-rc.0/guides/solr/quickstart/overview/) to set it up.
...
- Detail concepts of [Solr object](/docs/v2026.8.14-rc.0/guides/solr/concepts/solr).
- Different Solr topology clustering modes [here](/docs/v2026.8.14-rc.0/guides/solr/clustering/topology_cluster).
- Monitor your Solr database with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.8.14-rc.0/guides/solr/monitoring/prometheus-operator).
- Monitor your Solr database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.8.14-rc.0/guides/solr/monitoring/prometheus-builtin)
