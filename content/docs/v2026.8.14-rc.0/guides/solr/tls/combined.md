...
- Now, install KubeDB cli on your workstation and KubeDB operator in your combined following the steps [here](/docs/v2026.8.14-rc.0/setup/README).
...
Read about the fields in details in [Solr Concept](/docs/v2026.8.14-rc.0/guides/solr/concepts/solr),
...
- Monitor your Solr combined with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.8.14-rc.0/guides/solr/monitoring/prometheus-operator).
- Monitor your Solr combined with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.8.14-rc.0/guides/solr/monitoring/prometheus-builtin).
