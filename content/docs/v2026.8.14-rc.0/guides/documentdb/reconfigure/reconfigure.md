...
- Install KubeDB following the steps [here](/docs/v2026.8.14-rc.0/setup/README).
...
> [Custom Configuration](/docs/v2026.8.14-rc.0/guides/documentdb/configuration/using-config-file/)) is
> unaffected.
...
finish bootstrapping (see the [Restart](/docs/v2026.8.14-rc.0/guides/documentdb/restart/) guide), so the
...
- Provision a database with [Custom Configuration](/docs/v2026.8.14-rc.0/guides/documentdb/configuration/using-config-file/).
- [Restart](/docs/v2026.8.14-rc.0/guides/documentdb/restart/) a DocumentDB database.
