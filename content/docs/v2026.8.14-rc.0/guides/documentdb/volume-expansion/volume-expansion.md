...
instances did not finish bootstrapping (see the [Restart](/docs/v2026.8.14-rc.0/guides/documentdb/restart/)
...
- [Storage migration](/docs/v2026.8.14-rc.0/guides/documentdb/storage-migration/) to a different StorageClass.
- [Storage autoscaling](/docs/v2026.8.14-rc.0/guides/documentdb/autoscaler/storage/) of a DocumentDB cluster.
