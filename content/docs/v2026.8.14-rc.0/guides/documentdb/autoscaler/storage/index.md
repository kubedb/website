...
- Learn how to autoscale the compute resources of a DocumentDB cluster in the [Compute Autoscaling](/docs/v2026.8.14-rc.0/guides/documentdb/autoscaler/compute/) guide.
