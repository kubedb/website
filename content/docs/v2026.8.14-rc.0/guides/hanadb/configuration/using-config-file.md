...
see [Reconfigure](/docs/v2026.8.14-rc.0/guides/hanadb/reconfigure/reconfigure).
...
- Change configuration on a running database with [Reconfigure](/docs/v2026.8.14-rc.0/guides/hanadb/reconfigure/reconfigure).
