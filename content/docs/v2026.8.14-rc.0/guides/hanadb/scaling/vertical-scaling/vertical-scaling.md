...
- Deploy a `hanadb-cluster` System Replication database (see [Restart](/docs/v2026.8.14-rc.0/guides/hanadb/restart/restart#deploy-a-hanadb-system-replication-cluster)) in namespace `demo`.
...
- [Expand the volume](/docs/v2026.8.14-rc.0/guides/hanadb/volume-expansion/volume-expansion) of a HanaDB.
