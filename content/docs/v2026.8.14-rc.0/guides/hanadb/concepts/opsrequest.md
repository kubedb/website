...
|----------------------|-------------------------------------------------------------------------|-------|
| `Restart`            | Rolling restart of the database pods.                                   | [Restart](/docs/v2026.8.14-rc.0/guides/hanadb/restart/restart) |
| `Reconfigure`        | Apply / change / remove custom `global.ini` configuration.              | [Reconfigure](/docs/v2026.8.14-rc.0/guides/hanadb/reconfigure/reconfigure) |
| `ReconfigureTLS`     | Add, rotate, or remove TLS certificates.                                | [Reconfigure TLS](/docs/v2026.8.14-rc.0/guides/hanadb/tls/overview) |
| `VerticalScaling`    | Change CPU/memory of the database (and sidecar) containers.             | [Vertical Scaling](/docs/v2026.8.14-rc.0/guides/hanadb/scaling/vertical-scaling/vertical-scaling) |
| `VolumeExpansion`    | Grow the data PVCs (requires an expandable StorageClass).               | [Volume Expansion](/docs/v2026.8.14-rc.0/guides/hanadb/volume-expansion/volume-expansion) |
| `HorizontalScaling`  | Add/remove nodes of a System Replication cluster.                       | — |
| `StorageMigration`   | Move the data volumes to a different StorageClass.                      | [Storage Migration](/docs/v2026.8.14-rc.0/guides/hanadb/storage-migration/storage-migration) |
| `RotateAuth`         | Rotate the `SYSTEM` password (auto-generated or user-provided).         | [Rotate Authentication](/docs/v2026.8.14-rc.0/guides/hanadb/rotate-authentication/rotate-authentication) |
...
- Run a [Restart](/docs/v2026.8.14-rc.0/guides/hanadb/restart/restart) or [Reconfigure](/docs/v2026.8.14-rc.0/guides/hanadb/reconfigure/reconfigure).
- Review the [HanaDB CRD](/docs/v2026.8.14-rc.0/guides/hanadb/concepts/hanadb).
