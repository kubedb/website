...
- Set initial configuration at creation time with [Custom Configuration](/docs/v2026.8.14-rc.0/guides/hanadb/configuration/using-config-file).
- [Vertically scale](/docs/v2026.8.14-rc.0/guides/hanadb/scaling/vertical-scaling/vertical-scaling) a HanaDB.
