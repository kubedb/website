...
- Create a namespace `demo` and deploy a standalone `hanadb-standalone` (see
  [Reconfigure](/docs/v2026.8.14-rc.0/guides/hanadb/reconfigure/reconfigure#deploy-a-hanadb)).
...
- Encrypt connections with [TLS/SSL](/docs/v2026.8.14-rc.0/guides/hanadb/tls/overview).
