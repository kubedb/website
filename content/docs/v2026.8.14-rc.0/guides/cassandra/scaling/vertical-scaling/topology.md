...
- You should be familiar with the following `KubeDB` concepts:
    - [Cassandra](/docs/v2026.8.14-rc.0/guides/cassandra/concepts/cassandra)
    - [CassandraOpsRequest](/docs/v2026.8.14-rc.0/guides/cassandra/concepts/cassandraopsrequest)
    - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/cassandra/scaling/vertical-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/cassandra](/docs/v2026.8.14-rc.0/examples/cassandra) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- Detail concepts of [Cassandra object](/docs/v2026.8.14-rc.0/guides/cassandra/concepts/cassandra).
