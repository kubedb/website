...
- At first, you need to have a multi-cluster Kubernetes setup with OCM and KubeSlice configured. Follow the [Distributed MariaDB Overview](/docs/v2026.8.14-rc.0/guides/mariadb/distributed/overview) guide to set up the required infrastructure.

- Install `KubeDB` Community and Enterprise operator in your hub cluster following the steps [here](/docs/v2026.8.14-rc.0/setup/README). Make sure to enable OCM support:
...
- You should be familiar with the following `KubeDB` concepts:
  - [MariaDB](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/mariadb/)
  - [Distributed MariaDB Overview](/docs/v2026.8.14-rc.0/guides/mariadb/distributed/overview/)
  - [MariaDBOpsRequest](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2026.8.14-rc.0/guides/mariadb/scaling/horizontal-scaling/overview/)
