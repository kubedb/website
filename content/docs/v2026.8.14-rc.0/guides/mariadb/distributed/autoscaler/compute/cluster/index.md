...
- Install `KubeDB` Community, Ops-Manager and Autoscaler operator in your hub cluster following the steps [here](/docs/v2026.8.14-rc.0/setup/README). Make sure to enable OCM support:
  ```bash
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Distributed MariaDB Compute Autoscaling Overview](/docs/v2026.8.14-rc.0/guides/mariadb/distributed/autoscaler/compute/overview)
...
In this section, we are going to deploy a distributed MariaDB Galera cluster with version `12.3.2`. Then, in the next section we will set up autoscaling for this database using `MariaDBAutoscaler` CRD.
