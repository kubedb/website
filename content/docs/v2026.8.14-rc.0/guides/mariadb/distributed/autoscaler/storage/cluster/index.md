...
- Install `KubeDB` Community, Enterprise and Autoscaler operator in your hub cluster following the steps [here](/docs/v2026.8.14-rc.0/setup/README). Make sure to enable OCM support:
  ```bash
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MariaDBAutoscaler](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/autoscaler)
  - [MariaDBOpsRequest](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/opsrequest)
  - [Distributed MariaDB Storage Autoscaling Overview](/docs/v2026.8.14-rc.0/guides/mariadb/distributed/autoscaler/storage/overview)
...
In this section, we are going to deploy a distributed MariaDB replicaset database with version `12.3.2`. Then, in the next section we will set up autoscaling for this database using `MariaDBAutoscaler` CRD.
