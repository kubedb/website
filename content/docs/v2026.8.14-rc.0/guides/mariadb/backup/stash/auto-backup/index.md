...
- If you are not familiar with how Stash backup and restore MariaDB databases, please check the following guide [here](/docs/v2026.8.14-rc.0/guides/mariadb/backup/stash/overview/).
...
mariadb-backup-12.3.2    62m
mariadb-restore-12.3.2   62m
```
...
app-sample-mariadb   mariadb-backup-12.3.2   */5 * * * *            Ready   7m28s
```
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2026.8.14-rc.0/guides/mariadb/backup/stash/auto-backup/images/sample-mariadb.png">
...
NAME                   TASK                    SCHEDULE      PAUSED   PHASE   AGE
app-sample-mariadb-2   mariadb-backup-12.3.2   */3 * * * *            Ready   3m24s
```
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2026.8.14-rc.0/guides/mariadb/backup/stash/auto-backup/images/sample-mariadb-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
NAME                   TASK                    SCHEDULE      PAUSED   PHASE   AGE
app-sample-mariadb-3   mariadb-backup-12.3.2   */5 * * * *            Ready   106s
```
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2026.8.14-rc.0/guides/mariadb/backup/stash/auto-backup/images/sample-mariadb-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
