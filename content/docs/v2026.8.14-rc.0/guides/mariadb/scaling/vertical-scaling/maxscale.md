...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [MariaDB Replication](/docs/v2026.8.14-rc.0/guides/mariadb/clustering/mariadb-replication)
    - [MariaDBOpsRequest](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/opsrequest)
    - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/mariadb/scaling/vertical-scaling/overview)
