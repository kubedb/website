...
- Now, install KubeDB operator in your cluster by following the steps [here](/docs/v2026.8.14-rc.0/setup/README).
...
sample-mariadb   12.3.2   Ready    5m
```
...
Server version: 10.5.23-MariaDB-1:12.3.2+maria~ubu2004 mariadb.org binary distribution
