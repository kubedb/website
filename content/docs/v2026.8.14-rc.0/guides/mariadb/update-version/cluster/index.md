...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2026.8.14-rc.0/guides/mariadb/clustering/overview)
  - [MariaDBOpsRequest](/docs/v2026.8.14-rc.0/guides/mariadb/concepts/opsrequest)
  - [Updating Overview](/docs/v2026.8.14-rc.0/guides/mariadb/update-version/overview)
...
Here, we are going to update `MariaDB` cluster from `11.8.5` to `12.3.2`.
...
- `spec.updateVersion.targetVersion` specifies the expected version of the database `12.3.2`.
