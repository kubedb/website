...
This guide will show you how to use `KubeDB` Migration to migrate an existing `MongoDB` database — such as one running on DigitalOcean Managed MongoDB or any external instance — entirely into a KubeDB-managed `MongoDB` with minimal downtime.

## Before You Begin

- At first, you need to have a Kubernetes cluster, and the `kubectl` command-line tool must be configured to communicate with your cluster.

- Install `KubeDB` operator with the kubedb-courier operator enabled in your cluster following the steps [here](/docs/v2026.8.14-rc.0/operatormanual/migration/).
...
- You should be familiar with the following `KubeDB` concepts:
    - [AppBinding](/docs/v2026.8.14-rc.0/guides/mongodb/concepts/appbinding)
    - [MongoDB](/docs/v2026.8.14-rc.0/guides/mongodb/concepts/mongodb)
    - [MongoDBMigration](/docs/v2026.8.14-rc.0/guides/mongodb/concepts/migrator)
    - [Migration](/docs/v2026.8.14-rc.0/operatormanual/migration/)
...
For a full description of every field, see the [MongoDBMigration CRD reference](/docs/v2026.8.14-rc.0/guides/mongodb/concepts/migrator).
