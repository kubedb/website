...
List MongoDB versions using `kubectl get mgversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.8.14-rc.0/guides/mongodb/update-version/replicaset).
...
- Learn MongoDB Scaling
    - [Horizontal Scaling](/docs/v2026.8.14-rc.0/guides/mongodb/scaling/horizontal-scaling/replicaset)
    - [Vertical Scaling](/docs/v2026.8.14-rc.0/guides/mongodb/scaling/vertical-scaling/replicaset)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.8.14-rc.0/guides/mongodb/update-version/replicaset)
- Monitor your ElasticsearchQL database with KubeDB using [built-in Prometheus](/docs/v2026.8.14-rc.0/guides/mongodb/monitoring/using-builtin-prometheus).
