...
> create one for the source. Learn more about [AppBinding](/docs/v2026.8.14-rc.0/guides/mysql/concepts/appbinding/).
...
- Migrate a MySQL database step by step with the [MySQL Database Migration](/docs/v2026.8.14-rc.0/guides/mysql/migration/databasemigration) guide.
- Learn about the [AppBinding](/docs/v2026.8.14-rc.0/guides/mysql/concepts/appbinding/) concept.
- Learn about the MySQL CRD [here](/docs/v2026.8.14-rc.0/guides/mysql/concepts/database/).
