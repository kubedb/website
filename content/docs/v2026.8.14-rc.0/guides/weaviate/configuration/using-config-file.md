...
> **Tip:** You can change the configuration of a running Weaviate cluster (and even reference a replacement config Secret) without recreating it using a `Reconfigure` ops request. See [Reconfigure Weaviate](/docs/v2026.8.14-rc.0/guides/weaviate/reconfigure/reconfigure).
