...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Storage Migration Overview](/docs/v2026.8.14-rc.0/guides/weaviate/storage-migration/overview)
...
- Expand the volume of a cluster: [Volume Expansion](/docs/v2026.8.14-rc.0/guides/weaviate/volume-expansion/volume-expansion).
