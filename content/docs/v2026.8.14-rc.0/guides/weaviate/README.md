...
url: /docs/v2026.8.14-rc.0/guides/weaviate/
aliases:
- /docs/v2026.8.14-rc.0/guides/weaviate/README/
info:
...
- [Quickstart Weaviate](/docs/v2026.8.14-rc.0/guides/weaviate/quickstart/quickstart) with KubeDB operator.
- Use [custom configuration](/docs/v2026.8.14-rc.0/guides/weaviate/configuration/using-config-file) for Weaviate.
- Secure your cluster with [TLS](/docs/v2026.8.14-rc.0/guides/weaviate/tls/overview).
- Run day-2 operations with [Ops Requests](/docs/v2026.8.14-rc.0/guides/weaviate/restart/restart) and [Autoscaler](/docs/v2026.8.14-rc.0/guides/weaviate/autoscaler/compute/compute-autoscale).
