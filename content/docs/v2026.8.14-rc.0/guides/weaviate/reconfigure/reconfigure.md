...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Custom Configuration](/docs/v2026.8.14-rc.0/guides/weaviate/configuration/using-config-file)
  - [Reconfigure Overview](/docs/v2026.8.14-rc.0/guides/weaviate/reconfigure/overview)
...
- Learn how to supply a [custom configuration](/docs/v2026.8.14-rc.0/guides/weaviate/configuration/using-config-file) at provisioning time.
