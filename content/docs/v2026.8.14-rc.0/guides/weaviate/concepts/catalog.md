...
- Learn about the [Weaviate CRD](/docs/v2026.8.14-rc.0/guides/weaviate/concepts/weaviate).
- Deploy your first Weaviate database with the [Quickstart](/docs/v2026.8.14-rc.0/guides/weaviate/quickstart/quickstart).
