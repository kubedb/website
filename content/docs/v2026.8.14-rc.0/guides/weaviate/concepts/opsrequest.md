...
`spec.databaseRef` is a required field that points to the [Weaviate](/docs/v2026.8.14-rc.0/guides/weaviate/concepts/weaviate) object where the administrative operations will be applied. It contains:
...
- Learn about the [Weaviate](/docs/v2026.8.14-rc.0/guides/weaviate/concepts/weaviate) CRD.
- Deploy your first Weaviate database by following the guide [here](/docs/v2026.8.14-rc.0/guides/weaviate/quickstart/quickstart).
