...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2026.8.14-rc.0/guides/weaviate/scaling/vertical-scaling/overview)
...
- Detail concepts of [Weaviate object](/docs/v2026.8.14-rc.0/guides/weaviate/concepts/weaviate).
- [Horizontal Scaling](/docs/v2026.8.14-rc.0/guides/weaviate/scaling/horizontal-scaling/horizontal-scaling) of a Weaviate cluster.
