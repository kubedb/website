...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Horizontal Scaling Overview](/docs/v2026.8.14-rc.0/guides/weaviate/scaling/horizontal-scaling/overview)
...
- [Vertical Scaling](/docs/v2026.8.14-rc.0/guides/weaviate/scaling/vertical-scaling/vertical-scaling) of a Weaviate cluster.
