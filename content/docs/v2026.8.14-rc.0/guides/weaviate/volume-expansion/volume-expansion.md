...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Volume Expansion Overview](/docs/v2026.8.14-rc.0/guides/weaviate/volume-expansion/overview)
...
- Automatically scale the storage with the [Storage Autoscaler](/docs/v2026.8.14-rc.0/guides/weaviate/autoscaler/storage/storage-autoscale).
