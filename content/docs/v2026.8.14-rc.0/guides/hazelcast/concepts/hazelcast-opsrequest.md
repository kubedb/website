...
`spec.databaseRef` is a required field that point to the [Hazelcast](/docs/v2026.8.14-rc.0/guides/hazelcast/concepts/hazelcast) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Hazelcast](/docs/v2026.8.14-rc.0/guides/hazelcast/concepts/hazelcast) object.
...
- `spec.updateVersion.targetVersion` refers to a [HazelcastVersion](/docs/v2026.8.14-rc.0/guides/hazelcast/concepts/hazelcastversion) CR that contains the Hazelcast version information where you want to update.
...
- Learn about [Hazelcast CRD](/docs/v2026.8.14-rc.0/guides/hazelcast/concepts/hazelcast).
- Deploy your first Hazelcast database with KubeDB by following the guide [here](/docs/v2026.8.14-rc.0/guides/hazelcast/quickstart/overview/).
