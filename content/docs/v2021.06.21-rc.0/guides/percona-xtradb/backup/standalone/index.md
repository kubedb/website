...
- If you are not familiar with how Stash takes backup and restores Percona XtraDB databases, please check the following guide [here](/docs/v2021.06.21-rc.0/guides/percona-xtradb/backup/overview/).
...
Here, we have to use service `sample-xtradb` and secret `sample-xtradb-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2021.06.21-rc.0/guides/percona-xtradb/concepts/appbinding) CRD that holds the necessary information to connect with the database.
...
<figure align="center">
  <img alt="Backed up data in GCS Bucket" src="/docs/v2021.06.21-rc.0/guides/percona-xtradb/backup/standalone/images/sample-xtradb-backup.png">
