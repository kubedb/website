...
![Kibana Monitoring Home](/docs/0.9.0-rc.2/images/elasticsearch/x-pack/monitoring-home.png)

![Kibana Monitoring Node](/docs/0.9.0-rc.2/images/elasticsearch/x-pack/monitoring-node.png)

![Kibana Monitoring Overview](/docs/0.9.0-rc.2/images/elasticsearch/x-pack/monitoring-overview.png)
