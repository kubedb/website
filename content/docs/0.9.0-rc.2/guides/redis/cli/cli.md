...
KubeDB comes with its own cli. It is called `kubedb` cli. `kubedb` can be used to manage any KubeDB object. `kubedb` cli also performs various validations to improve ux. To install KubeDB cli on your workstation, follow the steps [here](/docs/0.9.0-rc.2/setup/install).
...
To learn about various options of `create` command, please visit [here](/docs/0.9.0-rc.2/reference/kubedb_create).
...
To learn about various options of `get` command, please visit [here](/docs/0.9.0-rc.2/reference/kubedb_get).
...
To learn about various options of `describe` command, please visit [here](/docs/0.9.0-rc.2/reference/kubedb_describe).
...
Lets edit an existing running Redis object to setup [Monitoring](/docs/0.9.0-rc.2/guides/redis/monitoring/using-builtin-prometheus). The following command will open Redis `redis-demo` in editor.
...
To learn about various options of `edit` command, please visit [here](/docs/0.9.0-rc.2/reference/kubedb_edit).
...
To learn about various options of `delete` command, please visit [here](/docs/0.9.0-rc.2/reference/kubedb_delete).
...
- Learn how to use KubeDB to run a Redis database [here](/docs/0.9.0-rc.2/guides/redis/README).
- Learn how to use custom configuration in Redis with KubeDB [here](/docs/0.9.0-rc.2/guides/redis/custom-config/using-custom-config)
