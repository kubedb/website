...
Lets edit an existing running Memcached object to setup [Monitoring](/docs/0.9.0-rc.2/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
...
- Learn how to use KubeDB to run a Memcached database [here](/docs/0.9.0-rc.2/guides/memcached/README).
