...
> Don't know how to take continuous backup?  Check [tutorial](/docs/0.9.0-rc.2/guides/postgres/snapshot/continuous_archiving) on Continuous Archiving.
...
We need a WAL archive to perform initialization. If you already don't have a WAL archive ready, create one by following the tutorial [here](/docs/0.9.0-rc.2/guides/postgres/snapshot/continuous_archiving).
...
Also cleanup the resources created for `wal-postgres` following the guide [here](/docs/0.9.0-rc.2/guides/postgres/snapshot/continuous_archiving#cleaning-up).
