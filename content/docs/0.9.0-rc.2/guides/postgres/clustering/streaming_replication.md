...
Now connect to this *primary* server Pod `ha-postgres-0` using pgAdmin installed in [quickstart](/docs/0.9.0-rc.2/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
...
<p align="center">
  <kbd>
    <img alt="recovered-postgres"  src="/docs/0.9.0-rc.2/images/postgres/ha-postgres.gif">
  </kbd>
</p>
...
Now connect to one of our *hot standby* servers Pod `hot-postgres-2` using pgAdmin installed in [quickstart](/docs/0.9.0-rc.2/guides/postgres/quickstart/quickstart#before-you-begin) tutorial.
