...
Lets edit an existing running Postgres object to setup [Scheduled Backup](/docs/0.9.0-rc.2/guides/postgres/snapshot/scheduled_backup). The following command will open Postgres `postgres-demo` in editor.
