...
Lets edit an existing running Memcached object to setup [Monitoring](/docs/0.9.0-rc.0/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
