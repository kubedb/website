...
KubeDB supports providing custom configuration for MongoDB via [PodTemplate](/docs/0.9.0-rc.0/concepts/databases/mongodb#specpodtemplate). This tutorial will show you how to use KubeDB to run a MongoDB database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/0.9.0-rc.0/concepts/databases/mongodb#specpodtemplate),

## CRD Configuration

Below is the YAML for the MongoDB created in this example. Here, [`spec.podTemplate.spec.env`](/docs/0.9.0-rc.0/concepts/databases/mongodb#specpodtemplatespecenv) specifies environment variables and [`spec.podTemplate.spec.args`](/docs/0.9.0-rc.0/concepts/databases/mongodb#specpodtemplatespecargs) provides extra arguments for [MongoDB Docker Image](https://hub.docker.com/_/mongodb/). 
...
Below is the Snapshot CRD that is deployed in this tutorial. Create a secret `mg-snap-secret` from [here](/docs/0.9.0-rc.0/guides/mongodb/snapshot/backup-and-restore#instant-backups) for snapshot. 
...
- [Quickstart MongoDB](/docs/0.9.0-rc.0/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
...
- Use [kubedb cli](/docs/0.9.0-rc.0/guides/mongodb/cli/cli) to manage databases like kubectl for Kubernetes.
