...
<p align="center">
  <img alt="lifecycle"  src="/docs/0.9.0-rc.0/images/elasticsearch/lifecycle.png">
</p>
...
>We have designed this tutorial to demonstrate a production setup of KubeDB managed Elasticsearch. If you just want to try out KubeDB, you can bypass some of the safety features following the tips [here](/docs/0.9.0-rc.0/guides/elasticsearch/quickstart/quickstart#tips-for-testing).
...
In this tutorial, we will use `6.3-v1` ElasticsearchVersion crd to create Elasticsearch database. To know more about what is `ElasticsearchVersion` crd and why there is `6.3` and `6.3-v1` variation, please visit [here](/docs/0.9.0-rc.0/concepts/catalog/elasticsearch). You can also see supported ElasticsearchVersion in KubeDB 0.9.0-rc.0 from [here](/docs/0.9.0-rc.0/guides/elasticsearch/README#supported-elasticsearchversion-crd).
...
To learn about how to configure an Elasticsearch cluster, please visit [here](/docs/0.9.0-rc.0/guides/elasticsearch/clustering/topology).
...
To know more about search-guard configuration, please visit [here](/docs/0.9.0-rc.0/guides/elasticsearch/search-guard/configuration).
...
To know more about how to create TLS secure Elasticsearch database with KubeDB, please visit [here](/docs/0.9.0-rc.0/guides/elasticsearch/search-guard/use-tls).
...
- Detail concepts of [Elasticsearch object](/docs/0.9.0-rc.0/concepts/databases/elasticsearch).
