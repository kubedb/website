...
- Learn how to use custom configuration specifying topology from [here](/docs/0.9.0-rc.0/guides/elasticsearch/custom-config/with-topology).
- Learn how to use custom configuration without specifying topology from [here](/docs/0.9.0-rc.0/guides/elasticsearch/custom-config/without-topology).