...
- [Quickstart Elasticsearch](/docs/0.9.0-rc.0/guides/elasticsearch/quickstart/quickstart) with KubeDB Operator.
- [Take instant backup](/docs/0.9.0-rc.0/guides/elasticsearch/snapshot/instant_backup) of Elasticsearch database using KubeDB.
- [Schedule backup](/docs/0.9.0-rc.0/guides/elasticsearch/snapshot/scheduled_backup)  of Elasticsearch database.
- Initialize [Elasticsearch with Snapshot](/docs/0.9.0-rc.0/guides/elasticsearch/initialization/snapshot_source).
- [Elasticsearch Topology](/docs/0.9.0-rc.0/guides/elasticsearch/clustering/topology) supported by KubeDB
...
- Use [kubedb cli](/docs/0.9.0-rc.0/guides/elasticsearch/cli/cli) to manage databases like kubectl for Kubernetes.
