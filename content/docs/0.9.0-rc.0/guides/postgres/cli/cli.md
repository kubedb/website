...
Lets edit an existing running Postgres object to setup [Scheduled Backup](/docs/0.9.0-rc.0/backup). The following command will open Postgres `postgres-demo` in editor.
...
- Learn how to use KubeDB to run a PostgreSQL database [here](/docs/0.9.0-rc.0/guides/postgres/overview).
- Learn how to use KubeDB to run an Elasticsearch database [here](/docs/0.9.0-rc.0/guides/elasticsearch/overview).
