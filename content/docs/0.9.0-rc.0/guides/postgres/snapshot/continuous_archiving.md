...
<p align="center">
  <kbd>
    <img alt="continuous-archiving"  src="/docs/0.9.0-rc.0/images/postgres/wal-postgres.png">
  </kbd>
</p>
...
- Learn about initializing [PostgreSQL from WAL](/docs/0.9.0-rc.0/guides/postgres/initialization/script_source) files stored in cloud.
