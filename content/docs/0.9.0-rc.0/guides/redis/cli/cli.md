...
To learn about various options of `get` command, please visit [here](/docs/0.9.0-rc.0/reference/kubedb_get).
...
Lets edit an existing running Redis object to setup [Monitoring](/docs/0.9.0-rc.0/guides/redis/monitoring/using-builtin-prometheus). The following command will open Redis `redis-demo` in editor.
...
- Learn how to use custom configuration in Redis with KubeDB [here](/docs/0.9.0-rc.0/guides/redis/custom-config/using-custom-config)
