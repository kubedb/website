...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Sharding](/docs/v2024.3.9-rc.0/guides/mongodb/clustering/sharding) 
  - [MongoDBOpsRequest](/docs/v2024.3.9-rc.0/guides/mongodb/concepts/opsrequest)
  - [Horizontal Scaling Overview](/docs/v2024.3.9-rc.0/guides/mongodb/scaling/horizontal-scaling/overview)
