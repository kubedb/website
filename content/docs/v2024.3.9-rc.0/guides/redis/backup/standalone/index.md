...
- [AppBinding](/docs/v2024.3.9-rc.0/guides/redis/concepts/appbinding)
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2024.3.9-rc.0/guides/redis/backup/standalone/images/sample-redis-backup.png">
