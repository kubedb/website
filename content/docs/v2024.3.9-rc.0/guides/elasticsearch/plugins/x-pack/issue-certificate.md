...
- Learn how to use TLS certificates to connect Elasticsearch from [here](/docs/v2024.3.9-rc.0/guides/elasticsearch/plugins/x-pack/use-tls).
- Learn how to generate [x-pack configuration](/docs/v2024.3.9-rc.0/guides/elasticsearch/plugins/x-pack/configuration).
