...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2024.3.9-rc.0/guides/mysql/concepts/database/#spectls).
