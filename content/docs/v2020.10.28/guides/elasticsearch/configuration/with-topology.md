...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2020.10.28/guides/elasticsearch/configuration/overview).
