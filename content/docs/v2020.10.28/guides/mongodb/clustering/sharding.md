...
- Read [mongodb sharding concept](/docs/v2020.10.28/guides/mongodb/clustering/sharding_concept) to learn about MongoDB Sharding clustering.
...
- [Backup and Restore](/docs/v2020.10.28/guides/mongodb/backup/stash) process of MongoDB databases using Stash.
