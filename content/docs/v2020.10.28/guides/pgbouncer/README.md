...
url: /docs/v2020.10.28/guides/pgbouncer/
aliases:
- /docs/v2020.10.28/guides/pgbouncer/README/
info:
  cli: v0.14.0
  community: v0.14.0
  enterprise: v0.1.0
...
- [Quickstart PgBouncer](/docs/v2020.10.28/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2020.10.28/guides/pgbouncer/monitoring/using-builtin-prometheus).
