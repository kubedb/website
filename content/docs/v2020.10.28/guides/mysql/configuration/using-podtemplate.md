...
KubeDB supports providing custom configuration for MySQL via [PodTemplate](/docs/v2020.10.28/guides/mysql/concepts/mysql#specpodtemplate). This tutorial will show you how to use KubeDB to run a MySQL database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2020.10.28/guides/mysql/concepts/mysql#specpodtemplate),

## CRD Configuration

Below is the YAML for the MySQL created in this example. Here, [`spec.podTemplate.spec.env`](/docs/v2020.10.28/guides/mysql/concepts/mysql#specpodtemplatespecenv) specifies environment variables and [`spec.podTemplate.spec.args`](/docs/v2020.10.28/guides/mysql/concepts/mysql#specpodtemplatespecargs) provides extra arguments for [MySQL Docker Image](https://hub.docker.com/_/mysql/).
...
![mysql_all_databases](/docs/v2020.10.28/images/mysql/mysql-all-databases.png)

![mysql_charset](/docs/v2020.10.28/images/mysql/mysql-charset.png)
