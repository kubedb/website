...
Lets edit an existing running MySQL object to setup database [Halted](/docs/v2020.10.28/guides/mysql/concepts/mysql#spechalted). The following command will open MySQL `mysql-demo` in editor.
