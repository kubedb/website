...
Just create [snapshot object](/docs/0.8.0-beta.2/guides/mongodb/snapshot/backup-and-restore) and KubeDB operator will reuse the `ImagePullSecret` from `MongoDB` object.
