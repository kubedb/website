...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/0.8.0-beta.2/concepts/snapshot).  Now, create the `MongoDB` object with scheduled snapshot.
...
![snapshot-console](/docs/0.8.0-beta.2/images/mongodb/mgo-scheduled.png)
