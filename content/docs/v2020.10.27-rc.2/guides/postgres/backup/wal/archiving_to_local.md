...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/v2020.10.27-rc.2/guides/postgres/backup/wal/continuous_archiving) to learn more.
