...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/v2020.10.27-rc.2/guides/postgres/backup/wal/continuous_archiving) to learn more about it.
...
<p align="center">
  <kbd>
    <img alt="continuous-archiving"  src="/docs/v2020.10.27-rc.2/images/postgres/wal-postgres-swift.png">
  </kbd>
</p>
...
- Learn about initializing [PostgreSQL from WAL](/docs/v2020.10.27-rc.2/guides/postgres/initialization/wal/wal_source) files stored in cloud.
