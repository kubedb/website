...
- [Backup & Restore](/docs/v2020.10.27-rc.2/guides/elasticsearch/backup/stash) Elasticsearch instances using Stash.
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box Prometheus operator](/docs/v2020.10.27-rc.2/guides/elasticsearch/monitoring/using-prometheus-operator).
- Monitor your Elasticsearch instance with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2020.10.27-rc.2/guides/elasticsearch/monitoring/using-builtin-prometheus).
