...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2020.10.27-rc.2/guides/elasticsearch/configuration/overview).
