...
url: /docs/v2020.10.27-rc.2/guides/pgbouncer/
aliases:
- /docs/v2020.10.27-rc.2/guides/pgbouncer/README/
info:
  cli: v0.14.0-rc.2
...
- [Quickstart PgBouncer](/docs/v2020.10.27-rc.2/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2020.10.27-rc.2/guides/pgbouncer/monitoring/using-builtin-prometheus).
