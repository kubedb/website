...
menu:
  docs_v2020.10.27-rc.2:
    ...
    weight: 10
menu_name: docs_v2020.10.27-rc.2s
...
PgBouncerVersions are KubeDB crds that define the docker images KubeDB will use when deploying a pgbouncer server. For more details about PgBouncerVersion crd, please visit [here](/docs/v2020.10.27-rc.2/guides/pgbouncer/concepts/catalog).
