...
- Read [redis clustering concept](/docs/v2024.2.14/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2024.2.14/guides/redis/sentinel/overview)
