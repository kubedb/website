...
url: /docs/v2024.2.14/guides/pgbouncer/
aliases:
- /docs/v2024.2.14/guides/pgbouncer/README/
info:
  autoscaler: v0.27.0
  cli: v0.42.0
  dashboard: v0.18.0
...
- [Quickstart PgBouncer](/docs/v2024.2.14/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2024.2.14/guides/pgbouncer/monitoring/using-builtin-prometheus).
