...
Now that the config secret is created, it needs to be mention in the [Elasticsearch](/docs/v2024.2.14/guides/elasticsearch/concepts/elasticsearch/) object's yaml:
