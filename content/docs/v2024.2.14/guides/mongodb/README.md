...
url: /docs/v2024.2.14/guides/mongodb/
aliases:
- /docs/v2024.2.14/guides/mongodb/README/
info:
  autoscaler: v0.27.0
  cli: v0.42.0
  dashboard: v0.18.0
...
- [MongoDB Replicaset](/docs/v2024.2.14/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2024.2.14/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2024.2.14/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2024.2.14/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2024.2.14/guides/mongodb/configuration/using-config-file).
