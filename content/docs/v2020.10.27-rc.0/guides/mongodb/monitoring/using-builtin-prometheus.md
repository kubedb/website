...
- Install KubeDB operator in your cluster following the steps [here](/docs/v2020.10.27-rc.0/setup/README).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2020.10.27-rc.0/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [backup and restore](/docs/v2020.10.27-rc.0/guides/mongodb/backup/stash) MongoDB database using Stash.
- Learn how to configure [MongoDB Topology](/docs/v2020.10.27-rc.0/guides/mongodb/clustering/sharding).
