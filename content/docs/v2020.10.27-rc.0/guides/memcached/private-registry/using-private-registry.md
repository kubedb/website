...
- Read [concept of Memcached Version Catalog](/docs/v2020.10.27-rc.0/guides/memcached/concepts/catalog) to learn detail concepts of `MemcachedVersion` object.
...
- Monitor your Memcached server with KubeDB using [out-of-the-box Prometheus operator](/docs/v2020.10.27-rc.0/guides/memcached/monitoring/using-prometheus-operator).
