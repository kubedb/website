...
url: /docs/v2022.08.04-rc.1/guides/mongodb/
aliases:
- /docs/v2022.08.04-rc.1/guides/mongodb/README/
info:
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2022.08.04-rc.1/images/mongodb/quick-start.png">
</p>

## User Guide

- [Quickstart MongoDB](/docs/v2022.08.04-rc.1/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
- [MongoDB Replicaset](/docs/v2022.08.04-rc.1/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2022.08.04-rc.1/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2022.08.04-rc.1/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2022.08.04-rc.1/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2022.08.04-rc.1/guides/mongodb/configuration/using-config-file).
