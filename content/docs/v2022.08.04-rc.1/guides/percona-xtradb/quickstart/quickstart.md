...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2022.08.04-rc.1/images/percona-xtradb/Lifecycle_of_a_PerconaXtraDB.svg">
</p>
...
- How to use [custom configuration](/docs/v2022.08.04-rc.1/guides/percona-xtradb/configuration/using-config-file).
