...
- Install KubeDB operator following [the setup guide](/docs/v2026.6.18-rc.2/setup/README).
...
- Learn `Neo4jOpsRequest` fields in detail from [Neo4j OpsRequest concept](/docs/v2026.6.18-rc.2/guides/neo4j/concepts/opsrequest).
