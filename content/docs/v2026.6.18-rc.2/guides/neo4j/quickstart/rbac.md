...
> If you want to provide your own ServiceAccount and Role instead of the auto-generated ones, see [Custom RBAC for Neo4j](/docs/v2026.6.18-rc.2/guides/neo4j/custom-rbac/using-custom-rbac).

> Prerequisites: A running `neo4j-test` database in the `demo` namespace. If you haven't deployed one yet, follow the [quickstart guide](/docs/v2026.6.18-rc.2/guides/neo4j/quickstart/quickstart) first.
...
- To use your own ServiceAccount and Role rather than the auto-generated ones, see [Custom RBAC for Neo4j](/docs/v2026.6.18-rc.2/guides/neo4j/custom-rbac/using-custom-rbac).
- To clean up, delete the database and namespace from the [quickstart cleanup step](/docs/v2026.6.18-rc.2/guides/neo4j/quickstart/quickstart#cleaning-up).
