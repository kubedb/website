...
<p align="center">
  <kbd>
    <img alt="operational-view" src="/docs/v2026.6.18-rc.2/images/neo4j/operational-view.png">
  </kbd>
</p>
...
- Follow the [Neo4j quickstart](/docs/v2026.6.18-rc.2/guides/neo4j/quickstart/quickstart) to provision your first cluster.
- Learn about [horizontal scaling](/docs/v2026.6.18-rc.2/guides/neo4j/scaling/horizontal-scaling/overview) to add or remove cluster members.
- Learn about [vertical scaling](/docs/v2026.6.18-rc.2/guides/neo4j/scaling/vertical-scaling/overview) to adjust pod resources.
- Learn about [TLS configuration](/docs/v2026.6.18-rc.2/guides/neo4j/tls/overview/) for securing cluster communication.
