...
Follow the steps to [install KubeDB operator](/docs/v2026.6.18-rc.2/setup/README) properly in cluster so that it points to the `DOCKER_REGISTRY` you wish to pull images from.
