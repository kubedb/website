...
Update your KubeDB operator to get the latest catalog, or check the [supported versions list](/docs/v2026.6.18-rc.2/guides/neo4j/README).
...
- [Neo4j Vertical Scaling](/docs/v2026.6.18-rc.2/guides/neo4j/scaling/vertical-scaling/) — adjust CPU and memory
