...
<figure align="center">
  <img alt="Vertical scaling process of ZooKeeper" src="/docs/v2026.6.18-rc.2/images/day-2-operation/zookeeper/zk-vertical-scaling.svg">
...
In the [next](/docs/v2026.6.18-rc.2/guides/zookeeper/scaling/vertical-scaling/vertical-scaling) docs, we are going to show a step by step guide on updating resources of ZooKeeper database using `ZooKeeperOpsRequest` CRD.