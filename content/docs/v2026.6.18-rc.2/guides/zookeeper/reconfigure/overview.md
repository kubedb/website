...
<figure align="center">
  <img alt="Reconfiguring process of ZooKeeper" src="/docs/v2026.6.18-rc.2/images/day-2-operation/zookeeper/zk-reconfigure.svg">
...
In the [next](/docs/v2026.6.18-rc.2/guides/zookeeper/reconfigure/reconfigure) docs, we are going to show a step by step guide on reconfiguring ZooKeeper database components using `ZooKeeperOpsRequest` CRD.