...
Read about the fields in details from [zookeeper concept](/docs/v2026.6.18-rc.2/guides/zookeeper/concepts/zookeeper),
...
<figure align="center">
<img alt="Deploy ZooKeeper with TLS/SSL" src="/docs/v2026.6.18-rc.2/images/zookeeper/zk-tls.svg">
...
In the [next](/docs/v2026.6.18-rc.2/guides/zookeeper/tls/configure-ssl) doc, we are going to show a step-by-step guide on how to configure a `ZooKeeper` cluster with TLS/SSL.