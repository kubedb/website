...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [updating Overview](/docs/v2026.6.18-rc.2/guides/memcached/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/memcached](/docs/v2026.6.18-rc.2/examples/memcached) directory of [kubedb/docs](https://github.com/kube/docs) repository.
