...
Read about the fields in details from [kafka concept](/docs/v2026.6.18-rc.2/guides/kafka/concepts/kafka),
...
<figure align="center">
<img alt="Deploy Kafka with TLS/SSL" src="/docs/v2026.6.18-rc.2/images/kafka/kf-tls.svg">
