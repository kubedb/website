...
- Learn about ConnectCluster CRD [here](/docs/v2026.6.18-rc.2/guides/kafka/concepts/connectcluster).
- Deploy your first ConnectCluster with KubeDB by following the guide [here](/docs/v2026.6.18-rc.2/guides/kafka/connectcluster/quickstart).
