...
`metadata.name` is a required field that specifies the name of the `SingleStoreVersion` crd. You have to specify this name in `spec.version` field of [SingleStore](/docs/v2026.6.18-rc.2/guides/singlestore/concepts/singlestore) crd.
...
- Learn about SingleStore crd [here](/docs/v2026.6.18-rc.2/guides/singlestore/concepts/singlestore).
- Deploy your first SingleStore database with KubeDB by following the guide [here](/docs/v2026.6.18-rc.2/guides/singlestore/quickstart/quickstart).