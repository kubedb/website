...
KubeDB supports providing custom configuration for SingleStore via [PodTemplate](/docs/v2026.6.18-rc.2/guides/singlestore/concepts/singlestore#spec.topology). This tutorial will show you how to use KubeDB to run a SingleStore database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2026.6.18-rc.2/guides/singlestore/concepts/singlestore#spectopology),
...
Below is the YAML for the SingleStore created in this example. Here, [`spec.topology.aggregator/leaf.podTemplate.spec.args`](/docs/v2026.6.18-rc.2/guides/mysql/concepts/database/#specpodtemplatespecargs) provides extra arguments.
...
- [Quickstart SingleStore](/docs/v2026.6.18-rc.2/guides/singlestore/quickstart/quickstart) with KubeDB Operator.
- Initialize [SingleStore with Script](/docs/v2026.6.18-rc.2/guides/singlestore/initialization).
