...
`spec.databaseRef` is a required field that point to the [Pgpool](/docs/v2026.6.18-rc.2/guides/pgpool/concepts/pgpool) object for which the autoscaling will be performed. This field consists of the following sub-field:
