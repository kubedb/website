...
`spec.version` is a required field specifying the name of the [PgpoolVersion](/docs/v2026.6.18-rc.2/guides/pgpool/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `PgpoolVersion` resources,
...
- [Monitor Pgpool with builtin Prometheus](/docs/v2026.6.18-rc.2/guides/pgpool/monitoring/using-builtin-prometheus)
- [Monitor Pgpool with Prometheus operator](/docs/v2026.6.18-rc.2/guides/pgpool/monitoring/using-prometheus-operator)
...
To learn more about how to use a custom configuration file see [here](/docs/v2026.6.18-rc.2/guides/pgpool/configuration/using-config-file).
### spec.deletionPolicy
