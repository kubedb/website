...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [PostgreSQLOpsRequest](/docs/v2026.6.18-rc.2/guides/postgres/concepts/opsrequest)
...
[//]: # (  <img alt="Rotate Authentication process of PostgreSQL" src="/docs/v2026.6.18-rc.2/images/day-2-operation/PostgreSQL/kf-rotate-auth.svg">)
