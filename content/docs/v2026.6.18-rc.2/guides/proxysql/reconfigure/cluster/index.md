...
- You should be familiar with the following `KubeDB` concepts:
  - [ProxySQL](/docs/v2026.6.18-rc.2/guides/proxysql/concepts/proxysql)
  - [ProxySQL Cluster](/docs/v2026.6.18-rc.2/guides/proxysql/clustering/proxysql-cluster)
  - [ProxySQLOpsRequest](/docs/v2026.6.18-rc.2/guides/proxysql/concepts/opsrequest)
  - [Reconfigure Overview](/docs/v2026.6.18-rc.2/guides/proxysql/reconfigure/overview)
