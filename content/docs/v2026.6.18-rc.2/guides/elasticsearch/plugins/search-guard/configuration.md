...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/v2026.6.18-rc.2/images/elasticsearch/sg-flow.png">
  </kbd>
</p>
...
- Learn how to [create TLS certificates](/docs/v2026.6.18-rc.2/guides/elasticsearch/plugins/search-guard/issue-certificate).
- Learn how to [use TLS certificates](/docs/v2026.6.18-rc.2/guides/elasticsearch/plugins/search-guard/use-tls) to connect Elasticsearch.
