...
- Install KubeDB in your cluster following the steps [here](/docs/v2026.6.18-rc.2/setup/README).
...
- [Backup and Restore](/docs/v2026.6.18-rc.2/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
