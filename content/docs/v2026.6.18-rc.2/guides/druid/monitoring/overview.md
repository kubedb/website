...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2026.6.18-rc.2/guides/druid/monitoring/images/druid-monitoring.png">
</p>
...
- Learn how to use KubeDB to run a Apache Druid cluster [here](/docs/v2026.6.18-rc.2/guides/druid/README).
- Deploy [dedicated topology cluster](/docs/v2026.6.18-rc.2/guides/druid/clustering/overview/) for Apache Druid
