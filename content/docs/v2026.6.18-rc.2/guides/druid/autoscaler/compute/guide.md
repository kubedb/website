...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [DruidAutoscaler](/docs/v2026.6.18-rc.2/guides/druid/concepts/druidautoscaler)
    - [DruidOpsRequest](/docs/v2026.6.18-rc.2/guides/druid/concepts/druidopsrequest)
    - [Compute Resource Autoscaling Overview](/docs/v2026.6.18-rc.2/guides/druid/autoscaler/compute/overview)
