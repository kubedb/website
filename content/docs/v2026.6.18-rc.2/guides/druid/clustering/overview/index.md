...
![Druid Architecture](/docs/v2026.6.18-rc.2/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2026.6.18-rc.2/guides/druid/clustering/overview/) using KubeDB.
