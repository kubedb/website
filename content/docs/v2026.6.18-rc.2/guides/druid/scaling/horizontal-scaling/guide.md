...
- You should be familiar with the following `KubeDB` concepts:
    - [Druid](/docs/v2026.6.18-rc.2/guides/druid/concepts/druid)
    - [Topology](/docs/v2026.6.18-rc.2/guides/druid/clustering/overview/)
    - [DruidOpsRequest](/docs/v2026.6.18-rc.2/guides/druid/concepts/druidopsrequest)
    - [Horizontal Scaling Overview](/docs/v2026.6.18-rc.2/guides/druid/scaling/horizontal-scaling/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/druid](/docs/v2026.6.18-rc.2/examples/druid) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.18-rc.2/guides/druid/scaling/horizontal-scaling/images/druid-ui.png">
</p>
...
Verify the scaled replica count of nodes from the druid ui. To access the UI follow the steps described in the first part of this guide. [(Check Replica Count from Druid UI)](/docs/v2026.6.18-rc.2/guides/druid/scaling/horizontal-scaling/#Check-Replica-Count-from-Druid-UI)
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.6.18-rc.2/guides/druid/scaling/horizontal-scaling/images/druid-ui-scaled-up.png">
</p>
...
- Detail concepts of [Druid object](/docs/v2026.6.18-rc.2/guides/druid/concepts/druid).
- Different Druid topology clustering modes [here](/docs/v2026.6.18-rc.2/guides/druid/clustering/_index).
- Monitor your Druid with KubeDB using [out-of-the-box Prometheus operator](/docs/v2026.6.18-rc.2/guides/druid/monitoring/using-prometheus-operator).
