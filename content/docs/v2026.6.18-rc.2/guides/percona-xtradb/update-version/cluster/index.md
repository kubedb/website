...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2026.6.18-rc.2/guides/percona-xtradb/clustering/overview)
  - [PerconaXtraDBOpsRequest](/docs/v2026.6.18-rc.2/guides/percona-xtradb/concepts/opsrequest)
  - [updating Overview](/docs/v2026.6.18-rc.2/guides/percona-xtradb/update-version/overview)
