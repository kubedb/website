...
- At first, you need to have a multi-cluster Kubernetes setup with OCM and KubeSlice configured. Follow the [Distributed MariaDB Overview](/docs/v2026.6.18-rc.2/guides/mariadb/distributed/overview) guide to set up the required infrastructure.

- Install `KubeDB` Community, Ops-Manager and Autoscaler operator in your hub cluster following the steps [here](/docs/v2026.6.18-rc.2/setup/README). Make sure to enable OCM support:
  ```bash
...
- You should be familiar with the following `KubeDB` concepts:
  - [MariaDB](/docs/v2026.6.18-rc.2/guides/mariadb/concepts/mariadb)
  - [MariaDBAutoscaler](/docs/v2026.6.18-rc.2/guides/mariadb/concepts/autoscaler)
  - [MariaDBOpsRequest](/docs/v2026.6.18-rc.2/guides/mariadb/concepts/opsrequest)
  - [Distributed MariaDB Compute Autoscaling Overview](/docs/v2026.6.18-rc.2/guides/mariadb/distributed/autoscaler/compute/overview)
