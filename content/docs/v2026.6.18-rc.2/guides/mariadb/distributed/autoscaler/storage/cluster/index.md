...
- Install `KubeDB` Community, Enterprise and Autoscaler operator in your hub cluster following the steps [here](/docs/v2026.6.18-rc.2/setup/README). Make sure to enable OCM support:
  ```bash
...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Distributed MariaDB Storage Autoscaling Overview](/docs/v2026.6.18-rc.2/guides/mariadb/distributed/autoscaler/storage/overview)
