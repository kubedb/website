...
To know more about this configuration file, check [here](/docs/v2026.6.18-rc.2/guides/mariadb/reconfigure/overview/)
```yaml
apiVersion: v1
stringData:
  user.cnf: |
...
List MariaDB versions using `kubectl get MariaDBversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.6.18-rc.2/guides/mariadb/update-version/overview/).
...
- Learn MariaDB Scaling
    - [Horizontal Scaling](/docs/v2026.6.18-rc.2/guides/mariadb/scaling/horizontal-scaling/overview/)
    - [Vertical Scaling](/docs/v2026.6.18-rc.2/guides/mariadb/scaling/vertical-scaling/overview/)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.6.18-rc.2/guides/mariadb/update-version/overview/)
- Monitor your MariaDBQL database with KubeDB using [built-in Prometheus](/docs/v2026.6.18-rc.2/guides/mariadb/monitoring/prometheus-operator/).
