...
![redis-sentinel](/docs/v2026.6.18-rc.2/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2026.6.18-rc.2/guides/redis/sentinel/redis-sentinel) using KubeDB.
