...
- You need to install GitOps tools like `ArgoCD` or `FluxCD` and configure with your Git Repository to monitor the Git repository and synchronize the state of the Kubernetes cluster with the desired state defined in Git.
  ...
  ```
> Note: YAML files used in this tutorial are stored in [docs/examples/Redis](/docs/v2026.6.18-rc.2/examples/redis) folder in GitHub repository [kubedb/docs](https://github.com/kubedb/docs).
...
List Redis versions using `kubectl get Redisversion` and choose desired version that is compatible for upgrade from current version. Check the version constraints and ops request [here](/docs/v2026.6.18-rc.2/guides/redis/update-version/cluster).
...
- Learn Redis Scaling
    - [Horizontal Scaling](/docs/v2026.6.18-rc.2/guides/redis/scaling/horizontal-scaling/cluster)
    - [Vertical Scaling](/docs/v2026.6.18-rc.2/guides/redis/scaling/horizontal-scaling/cluster)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.6.18-rc.2/guides/redis/update-version/cluster)
- Monitor your RedisQL database with KubeDB using [built-in Prometheus](/docs/v2026.6.18-rc.2/guides/redis/monitoring/using-builtin-prometheus).
