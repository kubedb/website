...
- You should be familiar with the following `KubeDB` concepts:
  - [RedisSentinel](/docs/v2026.6.18-rc.2/guides/redis/concepts/redissentinel)
  - [RedisAutoscaler](/docs/v2026.6.18-rc.2/guides/redis/concepts/autoscaler)
  - [RedisOpsRequest](/docs/v2026.6.18-rc.2/guides/redis/concepts/redisopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.6.18-rc.2/guides/redis/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/redis](/docs/v2026.6.18-rc.2/examples/redis) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.6.18-rc.2/guides/redis/concepts/redisopsrequest#spectimeout), [apply](/docs/v2026.6.18-rc.2/guides/redis/concepts/redisopsrequest#specapply).
