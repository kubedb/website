...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [updating Overview](/docs/v2026.6.18-rc.2/guides/redis/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/redis](/docs/v2026.6.18-rc.2/examples/redis) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
> If you are a current `Redis` user and want to switch to `Valkey`, make sure to update `Redis` 7.\*.\* to `Valkey` 7.\*.\* and RedisSentinel [Distribution](/docs/v2026.6.18-rc.2/guides/redis/concepts/catalog) and Redis [Distribution](/docs/v2026.6.18-rc.2/guides/redis/concepts/catalog) are same.
