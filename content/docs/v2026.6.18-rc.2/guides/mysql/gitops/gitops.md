...
To know more about this configuration file, check [here](/docs/v2026.6.18-rc.2/guides/mysql/configuration/using-config-file)
```yaml
apiVersion: v1
stringData:
  user.cnf: |
...
List MySQL versions using `kubectl get MySQLversion` and choose desired version that is compatible for umyrade from current version. Check the version constraints and ops request [here](/docs/v2026.6.18-rc.2/guides/mysql/update-version/versionumyrading/).
...
- Learn MySQL [GitOps](/docs/v2026.6.18-rc.2/guides/mysql/concepts/MySQL-gitops)
- Learn MySQL Scaling 
  - [Horizontal Scaling](/docs/v2026.6.18-rc.2/guides/mysql/scaling/horizontal-scaling/overview/)
  - [Vertical Scaling](/docs/v2026.6.18-rc.2/guides/mysql/scaling/vertical-scaling/overview/)
- Learn Version Update Ops Request and Constraints [here](/docs/v2026.6.18-rc.2/guides/mysql/update-version/versionumyrading/)
- Monitor your MySQL database with KubeDB using [built-in Prometheus](/docs/v2026.6.18-rc.2/guides/mysql/monitoring/using-builtin-prometheus).
