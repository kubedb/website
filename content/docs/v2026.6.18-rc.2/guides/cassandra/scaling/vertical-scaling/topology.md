...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Vertical Scaling Overview](/docs/v2026.6.18-rc.2/guides/cassandra/scaling/vertical-scaling/overview)
...
- Detail concepts of [Cassandra object](/docs/v2026.6.18-rc.2/guides/cassandra/concepts/cassandra).
