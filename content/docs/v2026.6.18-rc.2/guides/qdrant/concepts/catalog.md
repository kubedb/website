...
When you install KubeDB, a `QdrantVersion` custom resource will be created automatically for every supported Qdrant version. You have to specify the name of the `QdrantVersion` CRD in `spec.version` field of the [Qdrant](/docs/v2026.6.18-rc.2/guides/qdrant/concepts/qdrant) CRD. Then, KubeDB will use the Docker images specified in the `QdrantVersion` CRD to create your expected database.
...
`metadata.name` is a required field that specifies the name of the `QdrantVersion` CRD. You have to specify this name in `spec.version` field of the [Qdrant](/docs/v2026.6.18-rc.2/guides/qdrant/concepts/qdrant) CRD.
...
- Learn about the [Qdrant CRD](/docs/v2026.6.18-rc.2/guides/qdrant/concepts/qdrant).
- Deploy your first Qdrant database with KubeDB by following the guide [here](/docs/v2026.6.18-rc.2/guides/qdrant/quickstart/quickstart).