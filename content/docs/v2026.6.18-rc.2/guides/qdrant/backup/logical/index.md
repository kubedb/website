...
- If you are not familiar with how KubeStash backup and restore Qdrant databases, please check the following guide [here](/docs/v2026.6.18-rc.2/guides/qdrant/backup/overview/).
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/qdrant/backup/logical/backup-configuration.yaml
