...
KubeDB supports providing custom configuration for RabbitMQ via [PodTemplate](/docs/v2026.6.18-rc.2/guides/rabbitmq/concepts/rabbitmq#specpodtemplate). This tutorial will show you how to use KubeDB to run a RabbitMQ database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2026.6.18-rc.2/guides/rabbitmq/concepts/rabbitmq#specpodtemplate),
...
- [Quickstart rabbitmq](/docs/v2026.6.18-rc.2/guides/rabbitmq/quickstart/quickstart) with KubeDB Operator.
...
- Monitor your rabbitmq database with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.6.18-rc.2/guides/rabbitmq/monitoring/using-builtin-prometheus).
- Detail concepts of [rabbitmq object](/docs/v2026.6.18-rc.2/guides/rabbitmq/concepts/rabbitmq).
