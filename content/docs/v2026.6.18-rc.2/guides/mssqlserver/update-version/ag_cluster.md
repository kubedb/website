...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Availability Group Cluster](/docs/v2026.6.18-rc.2/guides/mssqlserver/clustering/ag_cluster)
  - [MSSQLServerOpsRequest](/docs/v2026.6.18-rc.2/guides/mssqlserver/concepts/opsrequest)
  - [Updating Overview](/docs/v2026.6.18-rc.2/guides/mssqlserver/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mssqlserver](/docs/v2026.6.18-rc.2/examples/mssqlserver/update-version) directory of [kubedb/docs](https://github.com/kube/docs) repository.
...
- Have a look [here](/docs/v2026.6.18-rc.2/guides/mssqlserver/concepts/opsrequest#spectimeout) on the respective sections to understand the `timeout` & `apply` fields.
