...
- `spec:`
  ...
  - `connectionPool`
    - `authType`
Read about the fields in details from [pgbouncer concept](/docs/v2026.6.18-rc.2/guides/pgbouncer/concepts/pgbouncer),
...
<figure align="center">
<img alt="Deploy PgBouncer with TLS/SSL" src="/docs/v2026.6.18-rc.2/images/day-2-operation/pgbouncer/pb-tls.svg">
