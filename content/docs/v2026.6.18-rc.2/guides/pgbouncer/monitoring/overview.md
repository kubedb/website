...
- Learn how to monitor PgBouncer database with KubeDB using [builtin-Prometheus](/docs/v2026.6.18-rc.2/guides/pgbouncer/monitoring/using-builtin-prometheus)
- Learn how to monitor PgBouncer database with KubeDB using [Prometheus operator](/docs/v2026.6.18-rc.2/guides/pgbouncer/monitoring/using-prometheus-operator).
