...
`spec.version` is a required field that specifies the name of the [PgBouncerVersion](/docs/v2026.6.18-rc.2/guides/pgbouncer/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `PgBouncerVersion` resources,
...
- [Monitor PgBouncer with builtin Prometheus](/docs/v2026.6.18-rc.2/guides/pgbouncer/monitoring/using-builtin-prometheus)
- [Monitor PgBouncer with Prometheus operator](/docs/v2026.6.18-rc.2/guides/pgbouncer/monitoring/using-prometheus-operator)
...
- Learn how to how to get started with PgBouncer [here](/docs/v2026.6.18-rc.2/guides/pgbouncer/quickstart/quickstart).
