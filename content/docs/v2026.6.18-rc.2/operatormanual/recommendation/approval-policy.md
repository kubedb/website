...
See [Recommendation Spec](/docs/v2026.6.18-rc.2/operatormanual/recommendation/recommendation-spec) for the full Recommendation field reference, and [Maintenance Window](/docs/v2026.6.18-rc.2/operatormanual/recommendation/maintenance-window) for window scheduling details.
