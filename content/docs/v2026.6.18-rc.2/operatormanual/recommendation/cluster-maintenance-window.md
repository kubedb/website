...
> **Use this only when you want a single cluster-wide default.** For per-namespace control, prefer a namespace-scoped [Maintenance Window](/docs/v2026.6.18-rc.2/operatormanual/recommendation/maintenance-window) — it always takes priority over the cluster default.
