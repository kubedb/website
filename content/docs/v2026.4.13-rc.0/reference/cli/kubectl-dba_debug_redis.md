---
title: Kubectl-Dba Debug Redis
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-debug-redis
    name: Kubectl-Dba Debug Redis
...
```
kubectl dba debug redis -n demo sample-redis --operator-namespace kubedb
```
