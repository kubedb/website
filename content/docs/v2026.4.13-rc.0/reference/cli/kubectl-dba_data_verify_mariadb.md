---
title: Kubectl-Dba Data Verify Mariadb
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-data-verify-mariadb
    name: Kubectl-Dba Data Verify Mariadb
...
```
kubectl-dba data verify mariadb [flags]
```
