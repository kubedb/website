---
title: Kubectl-Dba Debug Mysql
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-debug-mysql
    name: Kubectl-Dba Debug Mysql
...
```
kubectl dba debug mysql -n demo sample-mysql --operator-namespace kubedb
```
