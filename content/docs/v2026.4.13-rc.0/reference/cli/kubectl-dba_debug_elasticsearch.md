---
title: Kubectl-Dba Debug Elasticsearch
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-debug-elasticsearch
    name: Kubectl-Dba Debug Elasticsearch
...
```
kubectl dba debug elasticsearch -n demo sample-elasticsearch --operator-namespace kubedb
```
