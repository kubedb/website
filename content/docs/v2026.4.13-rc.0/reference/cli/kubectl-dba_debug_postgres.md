---
title: Kubectl-Dba Debug Postgres
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-debug-postgres
    name: Kubectl-Dba Debug Postgres
...
```
kubectl dba debug postgres -n demo sample-postgres --operator-namespace kubedb
```
