---
title: Kubectl-Dba Remote-Config Postgres
menu:
  docs_v2026.4.13-rc.0:
    identifier: kubectl-dba-remote-config-postgres
    name: Kubectl-Dba Remote-Config Postgres
...
## kubectl-dba remote-config postgres
...
```
kubectl-dba remote-config postgres [flags]
```
