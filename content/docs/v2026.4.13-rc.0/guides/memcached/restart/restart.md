...
- The meaning of `spec.timeout` & `spec.apply` fields can be found [here](/docs/v2026.4.13-rc.0/guides/memcached/concepts/memcached-opsrequest)
...
- Monitor your Memcached database with KubeDB using [Built-in Prometheus](/docs/v2026.4.13-rc.0/guides/memcached/monitoring/using-builtin-prometheus).
- Monitor your Memcached database with KubeDB using [Prometheus Operator](/docs/v2026.4.13-rc.0/guides/memcached/monitoring/using-prometheus-operator).
- Detail concepts of [Memcached](/docs/v2026.4.13-rc.0/guides/memcached/concepts/memcached).
