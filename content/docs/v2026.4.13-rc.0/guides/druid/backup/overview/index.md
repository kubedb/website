...
<figure align="center">
  <img alt="KubeDB + KubeStash" src="/docs/v2026.4.13-rc.0/guides/druid/backup/overview/images/kubedb_plus_kubestash.svg">
...
<figure align="center">
  <img alt="Druid Backup Overview" src="/docs/v2026.4.13-rc.0/guides/druid/backup/overview/images/backup_overview.svg">
...
2. Then, user creates a `BackupStorage` custom resource that specifies the backend information, along with the `Secret` containing the credentials needed to access the backend.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2026.4.13-rc.0/guides/druid/backup/overview/images/restore_overview.svg">
...
- Backup a `Druid` database using KubeStash by following the guides from [here](/docs/v2026.4.13-rc.0/guides/druid/backup/logical/).
