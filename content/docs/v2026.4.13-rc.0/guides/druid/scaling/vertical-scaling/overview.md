...
- You should be familiar with the following `KubeDB` concepts:
    - [Druid](/docs/v2026.4.13-rc.0/guides/kafka/concepts/kafka)
    - [DruidOpsRequest](/docs/v2026.4.13-rc.0/guides/kafka/concepts/kafkaopsrequest)
...
<figure align="center">
  <img alt="Vertical scaling process of Druid" src="/docs/v2026.4.13-rc.0/guides/druid/scaling/horizontal-scaling/images/dr-horizontal-scaling.png">
