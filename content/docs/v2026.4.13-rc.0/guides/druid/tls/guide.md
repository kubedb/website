...
Read about the fields in details in [druid concept](/docs/v2026.4.13-rc.0/guides/druid/concepts/druid),
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2026.4.13-rc.0/guides/druid/tls/images/druid-ui.png">
</p>
...
- Monitor your Druid cluster with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2026.4.13-rc.0/guides/druid/monitoring/using-builtin-prometheus).
