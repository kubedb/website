...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2026.4.13-rc.0/guides/druid/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2026.4.13-rc.0/guides/druid/monitoring/images/druid-prometheus.png" style="padding:10px">
</p>
...
- Learn how to configure [Druid Topology](/docs/v2026.4.13-rc.0/guides/druid/clustering/overview/).
