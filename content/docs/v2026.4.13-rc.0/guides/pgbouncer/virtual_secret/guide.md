---
title: Virtual Secret PgBouncer
menu:
  docs_v2026.4.13-rc.0:
    identifier: pb-virtualsecret
    name: Virtual Secret Pgbouncer
    parent: pb-vs
    weight: 10
...
Luckily PostgreSQL is readily available in KubeDB as crd and can easily be deployed using this guide [here](/docs/v2026.4.13-rc.0/guides/postgres/virtual_secret/guide).
