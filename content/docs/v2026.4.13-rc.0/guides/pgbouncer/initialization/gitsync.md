...
### Prepare Postgres
Prepare a KubeDB Postgres cluster using this [tutorial](/docs/v2026.4.13-rc.0/guides/postgres/clustering/streaming_replication),but you have to set `password` as  `qrDy;GnX4QsKQ0UL`.
