...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [SolrAutoscaler](/docs/v2026.4.13-rc.0/guides/solr/concepts/autoscaler)
    - [SolrOpsRequest](/docs/v2026.4.13-rc.0/guides/solr/concepts/solropsrequests)
    - [Compute Resource Autoscaling Overview](/docs/v2026.4.13-rc.0/guides/solr/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2026.4.13-rc.0/examples/solr/autoscaler) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2026.4.13-rc.0/guides/solr/concepts/solropsrequests#spectimeout), [apply](/docs/v2026.4.13-rc.0/guides/solr/concepts/solropsrequests#specapply).
