---
title: Virtual Secret Postgres
menu:
  docs_v2026.4.13-rc.0:
    identifier: guides-postgres-virtual-secret
    name: Virtual Secret Postgres
    parent: guides-postgres-vs
    weight: 10
...
- Install `KubeDB` Community and Enterprise operator in your cluster following the steps [here](/docs/v2026.4.13-rc.0/setup/README).
...
- You should be familiar with the following `KubeDB` concepts:
    - [Postgres](/docs/v2026.4.13-rc.0/guides/postgres/concepts/postgres)
