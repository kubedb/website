...
- If you are not familiar with how Stash backup and restore MySQL databases, please check the following guide [here](/docs/v2026.4.13-rc.0/guides/mysql/backup/stash/overview/).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2026.4.13-rc.0/guides/mysql/concepts/appbinding/)
...
sample-mysql   9.1.0    Ready   4m22s
```
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2026.4.13-rc.0/guides/mysql/concepts/appbinding/) CRD that holds the necessary information to connect with the database.
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"kubedb.com/v1","kind":"MySQL","metadata":{"annotations":{},"name":"sample-mysql","namespace":"demo"},"spec":{"replicas":1,"storage":{"accessModes":["ReadWriteOnce"],"resources":{"requests":{"storage":"50Mi"}}},"storageType":"Durable","deletionPolicy":"WipeOut","version":"9.1.0"}}
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2026.4.13-rc.0/guides/mysql/backup/stash/standalone/images/sample-mysql-backup.png">
...
NAME             VERSION   STATUS         AGE
restored-mysql   9.1.0    Provisioning   61s
```
