...
- Learn how to use KubeDB to run Apache Kafka cluster [here](/docs/v2026.4.13-rc.0/guides/kafka/quickstart/kafka/).
- Learn how to use KubeDB to run Apache Kafka Connect cluster [here](/docs/v2026.4.13-rc.0/guides/kafka/connectcluster/quickstart).
