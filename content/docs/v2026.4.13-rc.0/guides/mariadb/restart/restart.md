...
- Learn about [backup and restore](/docs/v2026.4.13-rc.0/guides/mariadb/backup/kubestash/overview/) MariaDBQL database using Stash.
- Learn about initializing [MariaDBQL with Script](/docs/v2026.4.13-rc.0/guides/mariadb/initialization/using-script/)
