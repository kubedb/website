...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Updating Overview](/docs/v2026.4.13-rc.0/guides/clickhouse/update-version/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/clickhouse](/docs/v2026.4.13-rc.0/examples/clickhouse) directory of [kubedb/docs](https://github.com/kube/docs) repository.
