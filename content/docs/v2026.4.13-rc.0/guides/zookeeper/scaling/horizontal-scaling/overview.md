...
<figure align="center">
  <img alt="Horizontal scaling process of ZooKeeper" src="/docs/v2026.4.13-rc.0/images/day-2-operation/zookeeper/zk-horizontal-scaling.svg">
...
In the [next](/docs/v2026.4.13-rc.0/guides/zookeeper/scaling/horizontal-scaling/horizontal-scaling) docs, we are going to show a step by step guide on horizontal scaling of ZooKeeper database using `ZooKeeperOpsRequest` CRD.