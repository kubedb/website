...
- Learn how to use custom configuration in combined cluster from [here](/docs/v2026.4.13-rc.0/guides/elasticsearch/configuration/combined-cluster/).
- Learn how to use custom configuration in topology cluster from [here](/docs/v2026.4.13-rc.0/guides/elasticsearch/configuration/topology-cluster/).
