...
xpack-8.19.9    7.14.0    KubeDB         kubedb/elasticsearch:7.14.0-xpack-v2021.08.23                  4h44m
...
- Snapshot and restore Elasticsearch cluster data using [S3 Repository Plugin](/docs/v2026.4.13-rc.0/guides/elasticsearch/plugins-backup/s3-repository/).