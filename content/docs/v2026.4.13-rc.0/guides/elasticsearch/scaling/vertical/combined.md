...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2026.4.13-rc.0/guides/elasticsearch/clustering/combined-cluster/)
    - [ElasticsearchOpsRequest](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/)
    - [Vertical Scaling Overview](/docs/v2026.4.13-rc.0/guides/elasticsearch/scaling/vertical/overview)
