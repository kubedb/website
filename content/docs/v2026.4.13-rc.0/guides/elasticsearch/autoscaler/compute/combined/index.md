...
- Install `KubeDB` Community, Enterprise and Autoscaler operator in your cluster following the steps [here](/docs/v2026.4.13-rc.0/setup/README).

- Install `Metrics Server` from [here](https://github.com/kubernetes-sigs/metrics-server#installation)

- You should be familiar with the following `KubeDB` concepts:
  - [Elasticsearch](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/elasticsearch/)
  - [ElasticsearchAutoscaler](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/autoscaler/)
  - [ElasticsearchOpsRequest](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/)
  - [Compute Resource Autoscaling Overview](/docs/v2026.4.13-rc.0/guides/elasticsearch/autoscaler/compute/overview/)
...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2026.4.13-rc.0/guides/elasticsearch/autoscaler/compute/combined/yamls) of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- - `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here : [timeout](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#spectimeout), [apply](/docs/v2026.4.13-rc.0/guides/elasticsearch/concepts/elasticsearch-ops-request/#specapply).
