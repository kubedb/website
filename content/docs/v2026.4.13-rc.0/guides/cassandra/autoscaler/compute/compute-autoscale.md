...
- You should be familiar with the following `KubeDB` concepts:
  - [Cassandra](/docs/v2026.4.13-rc.0/guides/cassandra/concepts/cassandra)
  - [CassandraAutoscaler](/docs/v2026.4.13-rc.0/guides/cassandra/concepts/cassandraautoscaler)
  - [CassandraOpsRequest](/docs/v2026.4.13-rc.0/guides/cassandra/concepts/cassandraopsrequest)
  - [Compute Resource Autoscaling Overview](/docs/v2026.4.13-rc.0/guides/cassandra/autoscaler/compute/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/cassandra](/docs/v2026.4.13-rc.0/examples/cassandra) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
- `spec.opsRequestOptions` contains the options to pass to the created OpsRequest. It has 2 fields. Know more about them here :  [timeout](/docs/v2026.4.13-rc.0/guides/cassandra/concepts/cassandraopsrequest#spectimeout), [apply](/docs/v2026.4.13-rc.0/guides/cassandra/concepts/cassandraopsrequest#specapply).
