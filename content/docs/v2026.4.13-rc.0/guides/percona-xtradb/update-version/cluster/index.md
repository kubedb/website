...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Cluster](/docs/v2026.4.13-rc.0/guides/percona-xtradb/clustering/overview)
  - [PerconaXtraDBOpsRequest](/docs/v2026.4.13-rc.0/guides/percona-xtradb/concepts/opsrequest)
  - [updating Overview](/docs/v2026.4.13-rc.0/guides/percona-xtradb/update-version/overview)
