...
description: RabbitMQ Monitoring Overview
menu:
  docs_v2026.4.13-rc.0:
    identifier: rm-monitoring-overview
    name: Overview
...
# Monitoring RabbitMQ with KubeDB
...
A sample YAML for RabbitMQ crd with `spec.monitor` section configured to enable monitoring with [Prometheus operator](https://github.com/prometheus-operator/prometheus-operator) is shown below.
...
- Learn how to monitor RabbitMQ database with KubeDB using [builtin-Prometheus](/docs/v2026.4.13-rc.0/guides/rabbitmq/monitoring/using-builtin-prometheus)
- Learn how to monitor RabbitMQ database with KubeDB using [Prometheus operator](/docs/v2026.4.13-rc.0/guides/rabbitmq/monitoring/using-prometheus-operator).
