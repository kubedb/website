...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/v2021.09.09/images/elasticsearch/sg-flow.png">
  </kbd>
</p>
...
- Learn how to [use TLS certificates](/docs/v2021.09.09/guides/elasticsearch/search-guard/use-tls) to connect Elasticsearch.
