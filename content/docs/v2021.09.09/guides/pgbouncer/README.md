...
url: /docs/v2021.09.09/guides/pgbouncer/
aliases:
- /docs/v2021.09.09/guides/pgbouncer/README/
info:
  autoscaler: v0.6.0
  cli: v0.21.0
  community: v0.21.0
...
- [Quickstart PgBouncer](/docs/v2021.09.09/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.09.09/guides/pgbouncer/monitoring/using-builtin-prometheus).
