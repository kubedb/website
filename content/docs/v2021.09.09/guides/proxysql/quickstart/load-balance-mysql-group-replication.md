...
- Now, install KubeDB operator in your cluster following the steps [here](/docs/v2021.09.09/setup/README).
- You have to be familiar with the [ProxySQL](/docs/v2021.09.09/guides/proxysql/concepts/proxysql) CRD.
