...
Lets edit an existing running MySQL object to setup [Scheduled Backup](/docs/0.9.0/guides/mysql/snapshot/scheduled-backup). The following command will open MySQL `mysql-demo` in editor.
