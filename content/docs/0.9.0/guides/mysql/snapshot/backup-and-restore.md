...
To lean how to configure other storage destinations for Snapshots, please visit [here](/docs/0.9.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/0.9.0/images/mysql/m1-xyz-snapshot.png)
