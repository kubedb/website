...
KubeDB supports providing custom configuration for MySQL via [PodTemplate](/docs/0.9.0/concepts/databases/mysql#specpodtemplate). This tutorial will show you how to use KubeDB to run a MySQL database with custom configuration using PodTemplate.
...
> Note: Yaml files used in this tutorial are stored in [docs/examples/mysql](https://github.com/kubedb/cli/tree/0.9.0/docs/examples/mysql) folder in GitHub repository [kubedb/cli](https://github.com/kubedb/cli).
...
Read about the fields in details in [PodTemplate concept](/docs/0.9.0/concepts/databases/mysql#specpodtemplate),

## CRD Configuration

Below is the YAML for the MySQL created in this example. Here, [`spec.podTemplate.spec.env`](/docs/0.9.0/concepts/databases/mysql#specpodtemplatespecenv) specifies environment variables and [`spec.podTemplate.spec.args`](/docs/0.9.0/concepts/databases/mysql#specpodtemplatespecargs) provides extra arguments for [MySQL Docker Image](https://hub.docker.com/_/mysql/). 
...
![mysql_all_databases](/docs/0.9.0/images/mysql/mysql-all-databases.png)

![mysql_charset](/docs/0.9.0/images/mysql/mysql-charset.png)
...
Below is the Snapshot CRD that is deployed in this tutorial. Create a secret `my-snap-secret` from [here](/docs/0.9.0/guides/mysql/snapshot/backup-and-restore#instant-backups) for snapshot. 
...
- [Quickstart MySQL](/docs/0.9.0/guides/mysql/quickstart/quickstart) with KubeDB Operator.
...
- Use [kubedb cli](/docs/0.9.0/guides/mysql/cli/cli) to manage databases like kubectl for Kubernetes.
