...
Let's insert some data so that we can verify that the snapshot contains those data. Check how to connect with the database from [here](/docs/0.9.0/guides/elasticsearch/quickstart/quickstart#connect-with-elasticsearch-database).
...
<p align="center">
  <kbd>
    <img alt="snapshot-console"  src="/docs/0.9.0/images/elasticsearch/instant-backup.png">
  </kbd>
</p>
