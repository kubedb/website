...
KubeDB can be installed via [Helm](https://helm.sh/) using the [chart](https://github.com/kubedb/cli/tree/0.9.0/chart/kubedb) from [AppsCode Charts Repository](https://github.com/appscode/charts). To install the chart with the release name `my-release`:
...
To see the detailed configuration options, visit [here](https://github.com/kubedb/cli/tree/0.9.0/chart/kubedb).
...
Now, you are ready to [create your first database](/docs/0.9.0/guides/README) using KubeDB.
