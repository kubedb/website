...
url: /docs/v2025.7.31/guides/memcached/
aliases:
- /docs/v2025.7.31/guides/memcached/README/
info:
  autoscaler: v0.42.0
  cli: v0.57.0
  dashboard: v0.33.0
...
- Use [kubedb cli](/docs/v2025.7.31/guides/memcached/cli/cli) to manage databases like kubectl for Kubernetes.
