...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.7.31/guides/mssqlserver/monitoring/using-prometheus-operator).
