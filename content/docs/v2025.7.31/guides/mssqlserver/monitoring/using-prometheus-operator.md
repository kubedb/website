...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.7.31/guides/mssqlserver/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.7.31/images/mssqlserver/monitoring/mssql-monitoring-targets.png" style="padding:10px">
</p>
