...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.7.31/guides/mssqlserver/concepts/mssqlserver#spectls).
