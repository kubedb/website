...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.7.31/guides/druid/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.7.31/guides/druid/monitoring/images/druid-prometheus.png" style="padding:10px">
</p>
...
- Deploy [dedicated  cluster](/docs/v2025.7.31/guides/druid/clustering/overview/) for Apache Druid
