...
![Druid Architecture](/docs/v2025.7.31/guides/druid/clustering/overview/images/druid-architecture.svg)
...
- [Deploy Druid Cluster](/docs/v2025.7.31/guides/druid/clustering/overview/) using KubeDB.
