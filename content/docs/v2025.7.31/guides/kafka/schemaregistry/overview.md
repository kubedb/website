...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.7.31/images/kafka/schemaregistry/schemaregistry-crd-lifecycle.png">
</p>
...
> We have designed this tutorial to demonstrate a production setup of KubeDB managed Schema Registry. If you just want to try out KubeDB, you can bypass some safety features following the tips [here](/docs/v2025.7.31/guides/kafka/schemaregistry/overview#tips-for-testing).

## Find Available SchemaRegistry Versions

When you install the KubeDB operator, it registers a CRD named [SchemaRegistryVersion](/docs/v2025.7.31/guides/kafka/concepts/schemaregistryversion). The installation process comes with a set of tested SchemaRegistryVersion objects. Let's check available SchemaRegistryVersions by,
...
Before create SchemaRegistry, you have to deploy a `Kafka` cluster first. To deploy kafka cluster, follow the [Kafka Quickstart](/docs/v2025.7.31/guides/kafka/quickstart/kafka/) guide. Let's assume `kafka-quickstart` is already deployed using KubeDB.
...
<p align="center"> <img src="/docs/v2025.7.31/images/kafka/schemaregistry/schemaregistry-ui-apicurio.png"> </p>
