...
> **Note:** For combined kafka, you just need to refer kafka combined object in `databaseRef` field. To learn more about combined kafka, please visit [here](/docs/v2025.7.31/guides/kafka/clustering/combined-cluster/).
...
- Kafka ConnectCluster with KubeDB [here](/docs/v2025.7.31/guides/kafka/connectcluster/quickstart).
- Kafka Schema Registry with KubeDB [here](/docs/v2025.7.31/guides/kafka/schemaregistry/overview).
- Kafka RestProxy with KubeDB [here](/docs/v2025.7.31/guides/kafka/restproxy/overview).
- Kafka Migration with KubeDB [here](/docs/v2025.7.31/guides/kafka/migration/overview).
