...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/v0.13.0-rc.0/concepts/snapshot).  Now, create the `MySQL` object with scheduled snapshot.
...
![snapshot-console](/docs/v0.13.0-rc.0/images/mysql/mysql-scheduled.png)
