...
KubeDB supports providing custom configuration for MySQL via [PodTemplate](/docs/v0.13.0-rc.0/concepts/databases/mysql#specpodtemplate). This tutorial will show you how to use KubeDB to run a MySQL database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v0.13.0-rc.0/concepts/databases/mysql#specpodtemplate),

## CRD Configuration

Below is the YAML for the MySQL created in this example. Here, [`spec.podTemplate.spec.env`](/docs/v0.13.0-rc.0/concepts/databases/mysql#specpodtemplatespecenv) specifies environment variables and [`spec.podTemplate.spec.args`](/docs/v0.13.0-rc.0/concepts/databases/mysql#specpodtemplatespecargs) provides extra arguments for [MySQL Docker Image](https://hub.docker.com/_/mysql/).
...
![mysql_all_databases](/docs/v0.13.0-rc.0/images/mysql/mysql-all-databases.png)

![mysql_charset](/docs/v0.13.0-rc.0/images/mysql/mysql-charset.png)
...
Below is the Snapshot CRD that is deployed in this tutorial. Create a secret `my-snap-secret` from [here](/docs/v0.13.0-rc.0/guides/mysql/snapshot/backup-and-restore#instant-backups) for snapshot.
...
If you would like to uninstall KubeDB operator, please follow the steps [here](/docs/v0.13.0-rc.0/setup/uninstall).
