...
- This tutorial assumes that you have created a namespace `demo` and a snapshot `snapshot-instant`. Follow the steps [here](/docs/v0.13.0-rc.0/guides/mysql/snapshot/backup-and-restore) to create a database and take [instant snapshot](/docs/v0.13.0-rc.0/guides/mysql/snapshot/backup-and-restore#instant-backups), if you have not done so already. If you have changed the name of either namespace or snapshot object, please modify the YAMLs used in this tutorial accordingly.
