...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v0.13.0-rc.0/images/postgres/monitoring/pg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [taking instant backup](/docs/v0.13.0-rc.0/guides/postgres/snapshot/instant_backup) of PostgreSQL database using KubeDB.
- Learn how to [schedule backup](/docs/v0.13.0-rc.0/guides/postgres/snapshot/scheduled_backup)  of PostgreSQL database.
- Learn about initializing [PostgreSQL with Snapshot](/docs/v0.13.0-rc.0/guides/postgres/initialization/snapshot_source).
