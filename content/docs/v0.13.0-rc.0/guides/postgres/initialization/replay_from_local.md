...
Also cleanup the resources created for `wal-postgres` following the guide [here](/docs/v0.13.0-rc.0/guides/postgres/snapshot/archiving_to_local#cleaning-up).
