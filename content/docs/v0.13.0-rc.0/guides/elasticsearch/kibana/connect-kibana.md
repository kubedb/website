...
![Search Guard Login UI](/docs/v0.13.0-rc.0/images/elasticsearch/kibana/search-guard-login-ui.png)
...
![Kibana Home](/docs/v0.13.0-rc.0/images/elasticsearch/kibana/kibana-home.png)
...
![Create Index_Pattern](/docs/v0.13.0-rc.0/images/elasticsearch/kibana/kibana-create-index.png)

Once we have created an index_pattern, we can use the Discovery UI.

![](/docs/v0.13.0-rc.0/images/elasticsearch/kibana/kibana-discovery-ui.png)
