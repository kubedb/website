...
![Kibana Monitoring Home](/docs/v0.13.0-rc.0/images/elasticsearch/x-pack/monitoring-home.png)

![Kibana Monitoring Node](/docs/v0.13.0-rc.0/images/elasticsearch/x-pack/monitoring-node.png)

![Kibana Monitoring Overview](/docs/v0.13.0-rc.0/images/elasticsearch/x-pack/monitoring-overview.png)
