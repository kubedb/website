...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v0.13.0-rc.0/guides/elasticsearch/custom-config/overview).
