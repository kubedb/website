...
![redis-cluster](/docs/v0.13.0-rc.0/images/redis/redis-cluster.png)
...
- [Deploy Redis Cluster](/docs/v0.13.0-rc.0/guides/redis/clustering/redis-cluster) using KubeDB.
