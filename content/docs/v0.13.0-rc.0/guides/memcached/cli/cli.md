...
Lets edit an existing running Memcached object to setup [Monitoring](/docs/v0.13.0-rc.0/guides/memcached/monitoring/using-builtin-prometheus). The following command will open Memcached `memcached-demo` in editor.
...
- Learn how to use KubeDB to run a Memcached server [here](/docs/v0.13.0-rc.0/guides/memcached/README).
