...
`.spec.version` is a required field specifying the name of the [ProxySQLVersion](/docs/v2023.01.31/guides/proxysql/concepts/proxysql-version/) CRD where the docker images are specified. Currently, when you install KubeDB, it creates the following `ProxySQLVersion` resources,
...
Checkout this [link](/docs/v2023.01.31/guides/proxysql/concepts/declarative-configuration/) for detailed overview on declarative configuration. 
...
- Learn how to use KubeDB ProxySQL to load balance MySQL Group Replication [here](/docs/v2023.01.31/guides/proxysql/quickstart/mysqlgrp/)