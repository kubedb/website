...
- Read [mysql group replication concept](/docs/v2023.01.31/guides/mysql/clustering/overview/) to learn about MySQL Group Replication.
...
- Detail concepts of [MySQLDBVersion object](/docs/v2023.01.31/guides/mysql/concepts/catalog/).
