...
- Read [mongodb hidden-node concept](/docs/v2023.01.31/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Hidden node.
...
- Deploy MongoDB shard [with Hidden-node](/docs/v2023.01.31/guides/mongodb/hidden-node/sharding).
