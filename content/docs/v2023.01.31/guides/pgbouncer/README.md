...
url: /docs/v2023.01.31/guides/pgbouncer/
aliases:
- /docs/v2023.01.31/guides/pgbouncer/README/
info:
  autoscaler: v0.16.0
  cli: v0.31.0
  dashboard: v0.7.0
...
- [Quickstart PgBouncer](/docs/v2023.01.31/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2023.01.31/guides/pgbouncer/monitoring/using-builtin-prometheus).
