...
- If you are not familiar with how Stash takes backup and restores Percona XtraDB, please check the following guide [here](/docs/v2021.03.17/guides/percona-xtradb/backup/overview/).

You have to be familiar with the following custom resources:

- [AppBinding](/docs/v2021.03.17/guides/percona-xtradb/concepts/appbinding)
...
Here, we have to use service `sample-xtradb-cluster` and secret `sample-xtradb-cluster-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2021.03.17/guides/percona-xtradb/concepts/appbinding) CRD that holds the necessary information to connect with the database.
...
<figure align="center">
  <img alt="Backed up data in GCS Bucket" src="/docs/v2021.03.17/guides/percona-xtradb/backup/cluster/images/sample-xtradb-cluster-backup.png">
