...
url: /docs/v2021.03.17/guides/pgbouncer/
aliases:
- /docs/v2021.03.17/guides/pgbouncer/README/
info:
  autoscaler: v0.2.1
  cli: v0.17.1
  community: v0.17.1
...
- [Quickstart PgBouncer](/docs/v2021.03.17/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.03.17/guides/pgbouncer/monitoring/using-builtin-prometheus).
