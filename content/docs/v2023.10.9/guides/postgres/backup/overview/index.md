...
<figure align="center">
  <img alt="PostgreSQL Backup Overview" src="/docs/v2023.10.9/guides/postgres/backup/overview/images/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2023.10.9/guides/postgres/concepts/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2023.10.9/guides/postgres/backup/overview/images/restore_overview.svg">
...
- Backup a standalone PostgreSQL database using Stash following the guide from [here](/docs/v2023.10.9/guides/postgres/backup/standalone/).
- Configure a generic backup template for all the PostgreSQL databases of your cluster using Stash Auto-backup by following the guide from [here](/docs/v2023.10.9/guides/postgres/backup/auto-backup/).
