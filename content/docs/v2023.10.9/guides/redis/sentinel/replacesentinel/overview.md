...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2023.10.9/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2023.10.9/guides/redis/sentinel/replacesentinel/replace-sentinel)