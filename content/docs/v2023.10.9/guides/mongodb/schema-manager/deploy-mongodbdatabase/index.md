...
- You should be familiar with the following concepts:
  ...
  - [MongoDBDatabase](/docs/v2023.10.9/guides/mongodb/concepts/mongodbdatabase)
  - [Schema Manager Overview](/docs/v2023.10.9/guides/mongodb/schema-manager/overview/)
...
- Detail concepts of [MongoDBDatabase object](/docs/v2023.10.9/guides/mongodb/concepts/mongodbdatabase).
