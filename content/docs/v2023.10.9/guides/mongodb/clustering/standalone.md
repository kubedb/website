...
- `spec.podTemplate` specifies the resources and other specifications of the pod. Have a look [here](/docs/v2023.10.9/guides/mongodb/concepts/mongodb#specpodtemplate) to know the other subfields of the podTemplate.
...
- Deploy MongoDB [ReplicaSet](/docs/v2023.10.9/guides/mongodb/clustering/replication_concept)
