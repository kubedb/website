...
url: /docs/v2023.10.9/guides/mongodb/
aliases:
- /docs/v2023.10.9/guides/mongodb/README/
info:
  autoscaler: v0.21.0
  cli: v0.36.0
  dashboard: v0.12.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2023.10.9/images/mongodb/quick-start.png">
</p>

## User Guide

- [Quickstart MongoDB](/docs/v2023.10.9/guides/mongodb/quickstart/quickstart) with KubeDB Operator.
- [MongoDB Replicaset](/docs/v2023.10.9/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2023.10.9/guides/mongodb/clustering/sharding) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.10.9/guides/mongodb/backup/overview/) MongoDB databases using Stash.
- Initialize [MongoDB with Script](/docs/v2023.10.9/guides/mongodb/initialization/using-script).
- Start [MongoDB with Custom Config](/docs/v2023.10.9/guides/mongodb/configuration/using-config-file).
