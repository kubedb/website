...
url: /docs/v2023.10.9/guides/mysql/
aliases:
- /docs/v2023.10.9/guides/mysql/README/
info:
  autoscaler: v0.21.0
  cli: v0.36.0
  dashboard: v0.12.0
...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2023.10.9/images/mysql/mysql-lifecycle.png" >
</p>

## User Guide

- [Quickstart MySQL](/docs/v2023.10.9/guides/mysql/quickstart/) with KubeDB Operator.
- [Backup & Restore](/docs/v2023.10.9/guides/mysql/backup/overview/) MySQL databases using Stash.
