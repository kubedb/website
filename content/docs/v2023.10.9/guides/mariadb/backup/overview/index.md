...
<figure align="center">
  <img alt="MariaDB Backup Overview" src="/docs/v2023.10.9/guides/mariadb/backup/overview/images/mariadb-logical-backup.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2023.10.9/guides/mariadb/concepts/appbinding/) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2023.10.9/guides/mariadb/backup/overview/images/mariadb-logical-restore.svg">
...
- Backup a standalone MariaDB databases using Stash following the guide from [here](/docs/v2023.10.9/guides/mariadb/backup/logical/standalone/).
- Backup a MariaDB cluster using Stash following the guide from [here](/docs/v2023.10.9/guides/mariadb/backup/logical/cluster/).
- Configure a generic backup template for all the MariaDB databases of your cluster using Stash Auto-backup by following the guide from [here](/docs/v2023.10.9/guides/mariadb/backup/auto-backup/).
- Customize the backup & restore process for your cluster by following the guides from [here](/docs/v2023.10.9/guides/mariadb/backup/customization/).
