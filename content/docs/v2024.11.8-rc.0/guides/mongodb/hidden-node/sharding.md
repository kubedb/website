...
- Read [mongodb hidden-node concept](/docs/v2024.11.8-rc.0/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Replica Set Hidden-node.
...
- [Backup and Restore](/docs/v2024.11.8-rc.0/guides/mongodb/backup/stash/overview/) process of MongoDB databases using Stash.
