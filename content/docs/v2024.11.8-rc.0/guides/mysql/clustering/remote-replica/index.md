...
- Read [mysql replication concept](/docs/v2024.11.8-rc.0/guides/mysql/clustering/overview/) to learn about MySQL Replication.
...
We wil use the [kubedb_plugin](/docs/v2024.11.8-rc.0/setup/README) for generating configuration for remote replica. It will create the appbinding and and necessary secrets to connect with source server
```bash
...
We have prepared another cluster in london region for replicating across cluster. follow the installation instruction [above](/docs/v2024.11.8-rc.0/README).
...
- Detail concepts of [MySQLDBVersion object](/docs/v2024.11.8-rc.0/guides/mysql/concepts/catalog/).
