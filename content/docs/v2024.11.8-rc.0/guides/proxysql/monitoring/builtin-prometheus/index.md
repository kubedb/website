...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2024.11.8-rc.0/guides/proxysql/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2024.11.8-rc.0/guides/proxysql/monitoring/builtin-prometheus/images/built-prom.png" style="padding:10px">
</p>
