...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2024.11.8-rc.0/guides/mssqlserver/monitoring/using-prometheus-operator).
