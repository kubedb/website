...
Read about the fields in details in [mssqlserver concept](/docs/v2024.11.8-rc.0/guides/mssqlserver/concepts/mssqlserver).
...
- [Backup and Restore](/docs/v2024.11.8-rc.0/guides/mssqlserver/backup/overview/) MSSQLServer databases using KubeStash. .
