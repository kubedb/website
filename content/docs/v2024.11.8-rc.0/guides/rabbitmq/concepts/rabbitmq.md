...
`spec.version` is a required field specifying the name of the [RabbitMQVersion](/docs/v2024.11.8-rc.0/guides/rabbitmq/concepts/catalog) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `RabbitMQVersion` resources,
...
- [Monitor RabbitMQ with builtin Prometheus](/docs/v2024.11.8-rc.0/guides/rabbitmq/monitoring/using-builtin-prometheus)
- [Monitor RabbitMQ with Prometheus operator](/docs/v2024.11.8-rc.0/guides/rabbitmq/monitoring/using-prometheus-operator)
...
To learn more about how to use a custom configuration file see [here](/docs/v2024.11.8-rc.0/guides/rabbitmq/configuration/using-config-file).
...
- Learn how to use KubeDB to run a RabbitMQ database [here](/docs/v2024.11.8-rc.0/guides/rabbitmq/README).
