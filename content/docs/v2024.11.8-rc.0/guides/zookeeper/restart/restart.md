...
- The meaning of `spec.timeout` & `spec.apply` fields will be found [here](/docs/v2024.11.8-rc.0/guides/zookeeper/concepts/opsrequest#spectimeout)
...
- Detail concepts of [ZooKeeper object](/docs/v2024.11.8-rc.0/guides/zookeeper/concepts/zookeeper).
- Detail concepts of [ZooKeeper object](/docs/v2024.11.8-rc.0/guides/zookeeper/concepts/zookeeper).
