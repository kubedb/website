...
- You should be familiar with the following `KubeDB` concepts:
  - [SingleStore](/docs/v2024.11.8-rc.0/guides/singlestore/concepts/)
...
<figure align="center">
  <img alt="Reconfiguring process of SingleStore" src="/docs/v2024.11.8-rc.0/guides/singlestore/reconfigure/overview/images/sdb-reconfigure.svg">
