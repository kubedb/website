...
![redis-sentinel](/docs/v2024.11.8-rc.0/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2024.11.8-rc.0/guides/redis/sentinel/redis-sentinel) using KubeDB.
