...
aliases:
- /docs/v2020.07.10-beta.0/setup/developer-guide/
info:
...
For unified operator or db specific operators, we support building Docker images. To build and push your custom Docker image, follow the steps below. To release a new version of KubeDB, please follow the [release guide](/docs/v2020.07.10-beta.0/setup/developer-guide/release).
...
![Debug using atom](/docs/v2020.07.10-beta.0/images/debug-using-atom.gif)
