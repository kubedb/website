...
Lets edit an existing running MySQL object to setup [Scheduled Backup](/docs/v2020.07.10-beta.0/guides/mysql/snapshot/scheduled-backup). The following command will open MySQL `mysql-demo` in editor.
