...
{{< notice type="warning" message="This doc has been deprecated and will be removed in a future release. We recommend using [Stash](/docs/v2020.07.10-beta.0/guides/mysql/snapshot/stash) to backup & restore MySQL database." >}}
...
To lean how to configure other storage destinations for Snapshots, please visit [here](/docs/v2020.07.10-beta.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/v2020.07.10-beta.0/images/mysql/m1-xyz-snapshot.png)
