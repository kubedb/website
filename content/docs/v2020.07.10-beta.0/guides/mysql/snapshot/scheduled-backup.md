...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/v2020.07.10-beta.0/concepts/snapshot).  Now, create the `MySQL` object with scheduled snapshot.
...
![snapshot-console](/docs/v2020.07.10-beta.0/images/mysql/mysql-scheduled.png)
