...
Read about the fields in details in [mongodb concept](/docs/v2020.07.10-beta.0/concepts/databases/mongodb),
...
Below is the YAML for MongoDB Standalone. Here, [`spec.sslMode`](/docs/v2020.07.10-beta.0/concepts/databases/mongodb#specsslMode) specifies `sslMode` for `standalone` (which is `requireSSL`).
...
Below is the YAML for MongoDB Replicaset. Here, [`spec.sslMode`](/docs/v2020.07.10-beta.0/concepts/databases/mongodb#specsslMode) specifies `sslMode` for `replicaset` (which is `requireSSL`) and [`spec.clusterAuthMode`](/docs/v2020.07.10-beta.0/concepts/databases/mongodb#specclusterAuthMode) provides `clusterAuthMode` for mongodb replicaset nodes (which is `x509`).
...
Below is the YAML for MongoDB Sharding. Here, [`spec.sslMode`](/docs/v2020.07.10-beta.0/concepts/databases/mongodb#specsslMode) specifies `sslMode` for `sharding` and [`spec.clusterAuthMode`](/docs/v2020.07.10-beta.0/concepts/databases/mongodb#specclusterAuthMode) provides `clusterAuthMode` for sharding servers.
