...
If you would like to uninstall the KubeDB operator, please follow the steps [here](/docs/v2020.07.10-beta.0/setup/operator/uninstall).

## Next Steps

- Learn about [taking instant backup](/docs/v2020.07.10-beta.0/guides/postgres/snapshot/instant_backup) of PostgreSQL instance using KubeDB Snapshot.
- Learn how to [schedule backup](/docs/v2020.07.10-beta.0/guides/postgres/snapshot/scheduled_backup) of PostgreSQL instance.
...
- Monitor your PostgreSQL instance with KubeDB using [built-in Prometheus](/docs/v2020.07.10-beta.0/guides/postgres/monitoring/using-builtin-prometheus).
- Monitor your PostgreSQL instance with KubeDB using [CoreOS Prometheus Operator](/docs/v2020.07.10-beta.0/guides/postgres/monitoring/using-coreos-prometheus-operator).
