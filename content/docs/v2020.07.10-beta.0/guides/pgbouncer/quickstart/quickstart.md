...
> We have designed this tutorial to demonstrate a production setup of KubeDB managed PgBouncer. If you just want to try out KubeDB, you can bypass some of the safety features following the tips [here](/docs/v2020.07.10-beta.0/guides/pgbouncer/quickstart/quickstart#tips-for-testing).
...
In this tutorial, we will use `1.11.0` PgBouncerVersion crd to create PgBouncer. To know more about what `PgBouncerVersion` crd is, please visit [here](/docs/v2020.07.10-beta.0/concepts/catalog/pgbouncer). You can also see supported PgBouncerVersion [here](/docs/v2020.07.10-beta.0/guides/pgbouncer/README#supported-pgbouncerversion-crd).
...
Luckily PostgreSQL is readily available in KubeDB as crd and can easily be deployed using this guide [here](/docs/v2020.07.10-beta.0/guides/postgres/quickstart/quickstart).
...
Should you choose not to use KubeDB to deploy Postgres, create AppBinding(s) to point PgBouncer to your PostgreSQL server(s) where your target databases are located. Click [here](/docs/v2020.07.10-beta.0/concepts/appbinding) for detailed instructions on how to manually create AppBindings for Postgres.
...
- Monitor your PgBouncer with KubeDB using [built-in Prometheus](/docs/v2020.07.10-beta.0/guides/pgbouncer/monitoring/using-builtin-prometheus).
- Monitor your PgBouncer with KubeDB using [CoreOS Prometheus Operator](/docs/v2020.07.10-beta.0/guides/pgbouncer/monitoring/using-coreos-prometheus-operator).
