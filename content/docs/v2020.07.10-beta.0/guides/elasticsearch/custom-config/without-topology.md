...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2020.07.10-beta.0/guides/elasticsearch/custom-config/overview).
