...
Lets edit an existing running Elasticsearch object to setup [Scheduled Backup](/docs/v2020.07.10-beta.0/guides/elasticsearch/snapshot/scheduled_backup). The following command will open Elasticsearch `elasticsearch-demo` in editor.
