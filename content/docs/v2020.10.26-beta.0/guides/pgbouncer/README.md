...
url: /docs/v2020.10.26-beta.0/guides/pgbouncer/
aliases:
- /docs/v2020.10.26-beta.0/guides/pgbouncer/README/
info:
  cli: v0.14.0-beta.5
...
- [Quickstart PgBouncer](/docs/v2020.10.26-beta.0/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2020.10.26-beta.0/guides/pgbouncer/monitoring/using-builtin-prometheus).
