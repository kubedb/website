...
- Learn about archiving to [Amazon S3](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_s3).
- Learn about archiving to [S3 MinIO](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_minio).
- Learn about archiving to [Google Cloud Storage](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_gcs).
- Learn about archiving to [Azure Storage](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_azure).
- Learn about archiving to [OpenStack Object Storage (Swift)](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_swift).
- Learn about archiving to [Local Storage](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_local).
