...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/continuous_archiving) to learn more about it.
...
<p align="center">
  <kbd>
    <img alt="continuous-archiving"  src="/docs/v2020.10.26-beta.0/images/postgres/wal-postgres-swift.png">
  </kbd>
</p>
