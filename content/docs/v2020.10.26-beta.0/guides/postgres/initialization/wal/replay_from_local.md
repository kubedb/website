...
Also cleanup the resources created for `wal-postgres` following the guide [here](/docs/v2020.10.26-beta.0/guides/postgres/backup/wal/archiving_to_local#cleaning-up).
