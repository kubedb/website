...
`metadata.name` is a required field that specifies the name of the `MySQLVersion` crd. You have to specify this name in `spec.version` field of [MySQL](/docs/v2020.10.26-beta.0/guides/mysql/concepts/mysql) crd.
...
- Learn about MySQL crd [here](/docs/v2020.10.26-beta.0/guides/mysql/concepts/mysql).
- Deploy your first MySQL database with KubeDB by following the guide [here](/docs/v2020.10.26-beta.0/guides/mysql/quickstart/quickstart).
