...
- You should be familiar with the following `KubeDB` concepts:
  - [MySQL](/docs/v2020.10.26-beta.0/guides/mysql/concepts/mysql)
  - [MySQLOpsRequest](/docs/v2020.10.26-beta.0/guides/mysql/concepts/opsrequest)
  - [Upgrading Overview](/docs/v2020.10.26-beta.0/guides/mysql/upgrading/overview)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/mysql](/docs/v2020.10.26-beta.0/examples/mysql) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/mysql/upgrading/majorversion/group_replication.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/mysql/upgrading/majorversion/upgrade_major_version_group.yaml
