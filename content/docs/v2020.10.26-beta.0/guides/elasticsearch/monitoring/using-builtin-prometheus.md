...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2020.10.26-beta.0/guides/elasticsearch/monitoring/overview).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2020.10.26-beta.0/images/elasticsearch/monitoring/es-builtin-prom-target.png" style="padding:10px">
</p>
