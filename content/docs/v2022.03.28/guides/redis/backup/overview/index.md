...
<figure align="center">
  <img alt="Redis Backup Overview" src="/docs/v2022.03.28/guides/redis/backup/overview/images/redis-logical-backup.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2022.03.28/guides/redis/concepts/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2022.03.28/guides/redis/backup/overview/images/redis-logical-restore.svg">
...
- Backup your Redis database using Stash following the guide from [here](/docs/v2022.03.28/guides/redis/backup/standalone/).
