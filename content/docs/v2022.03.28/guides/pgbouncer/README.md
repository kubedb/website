...
url: /docs/v2022.03.28/guides/pgbouncer/
aliases:
- /docs/v2022.03.28/guides/pgbouncer/README/
info:
  autoscaler: v0.11.0
  cli: v0.26.0
  community: v0.26.0
...
- [Quickstart PgBouncer](/docs/v2022.03.28/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2022.03.28/guides/pgbouncer/monitoring/using-builtin-prometheus).
