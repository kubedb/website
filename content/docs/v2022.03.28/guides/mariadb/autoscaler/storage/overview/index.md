...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [MariaDBAutoscaler](/docs/v2022.03.28/guides/mariadb/concepts/autoscaler)
...
<figure align="center">
  <img alt="Storage Autoscaling process of MariaDB" src="/docs/v2022.03.28/guides/mariadb/autoscaler/storage/overview/images/mdas-storage.jpeg">
