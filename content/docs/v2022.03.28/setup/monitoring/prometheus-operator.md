...
aliases:
- /docs/v2022.03.28/setup/operator-monitoring/
info:
  autoscaler: v0.11.0
  cli: v0.26.0
  community: v0.26.0
...
Enable Prometheus monitoring using `prometheus.io/operator` agent while installing KubeDB operator. To know details about how to enable monitoring see [here](/docs/v2022.03.28/setup/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2022.03.28/images/monitoring/operator/coreos-prom-target.png" style="padding:10px">
</p>
...
To uninstall KubeDB operator follow this [guide](/docs/v2022.03.28/setup/README).

## Next Steps

- Learn what metrics KubeDB operator exports from [here](/docs/v2022.03.28/setup/monitoring/overview).
- Learn how to monitor KubeDB operator using builtin Prometheus operator from [here](/docs/v2022.03.28/setup/monitoring/builtin-prometheus).
