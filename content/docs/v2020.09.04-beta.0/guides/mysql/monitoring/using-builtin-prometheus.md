...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2020.09.04-beta.0/images/mysql/monitoring/mysql-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [taking instant backup](/docs/v2020.09.04-beta.0/guides/mysql/snapshot/backup-and-restore) of MySQL database using KubeDB.
- Learn how to [schedule backup](/docs/v2020.09.04-beta.0/guides/mysql/snapshot/scheduled-backup)  of MySQL database.
- Learn about initializing [MySQL with Snapshot](/docs/v2020.09.04-beta.0/guides/mysql/initialization/using-snapshot).
