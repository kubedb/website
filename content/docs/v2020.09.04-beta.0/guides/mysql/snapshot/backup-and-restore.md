...
To lean how to configure other storage destinations for Snapshots, please visit [here](/docs/v2020.09.04-beta.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/v2020.09.04-beta.0/images/mysql/m1-xyz-snapshot.png)
