...
Also cleanup the resources created for `wal-postgres` following the guide [here](/docs/v2020.09.04-beta.0/guides/postgres/snapshot/wal/archiving_to_local#cleaning-up).
