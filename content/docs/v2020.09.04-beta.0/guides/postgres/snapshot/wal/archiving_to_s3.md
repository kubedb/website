...
**WAL-G** is used to continuously archive PostgreSQL WAL files. Please refer to [continuous archiving in KubeDB](/docs/v2020.09.04-beta.0/guides/postgres/snapshot/wal/continuous_archiving) to learn more about it.
...
```console
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/postgres/snapshot/wal-postgres-s3.yaml
...
<p align="center">
  <kbd>
    <img alt="continuous-archiving"  src="/docs/v2020.09.04-beta.0/images/postgres/wal-postgres.png">
  </kbd>
</p>
...
- Learn about initializing [PostgreSQL from WAL](/docs/v2020.09.04-beta.0/guides/postgres/initialization/wal/wal_source) files stored in cloud.
