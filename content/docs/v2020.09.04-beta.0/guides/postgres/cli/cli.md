...
Lets edit an existing running Postgres object to setup [Scheduled Backup](/docs/v2020.09.04-beta.0/guides/postgres/snapshot/scheduled_backup). The following command will open Postgres `postgres-demo` in editor.
