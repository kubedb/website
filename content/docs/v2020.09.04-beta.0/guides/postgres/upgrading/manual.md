...
Note that, Once the DB version is updated, kubedb-operator will update the statefulsets too. This update strategy can be modified by `spec.updateStrategy`. Read [here](/docs/v2020.09.04-beta.0/concepts/databases/postgres#specupdatestrategy) for details about updateStrategy.
