...
- Read [mysql group replication concept](/docs/v2020.09.04-beta.0/guides/mysql/clustering/overview) to learn about MySQL Group Replication.
...
- You have to be familiar with the [ProxySQL](/docs/v2020.09.04-beta.0/concepts/database-proxy/proxysql) CRD.
...
- Monitor ProxySQL with KubeDB using [out-of-the-box builtin-Prometheus](/docs/v2020.09.04-beta.0/guides/proxysql/monitoring/using-builtin-prometheus).
- Monitor ProxySQL with KubeDB using [out-of-the-box CoreOS Prometheus Operator](/docs/v2020.09.04-beta.0/guides/proxysql/monitoring/using-coreos-prometheus-operator).
