...
url: /docs/v2020.09.04-beta.0/guides/mongodb/
aliases:
- /docs/v2020.09.04-beta.0/guides/mongodb/README/
info:
...
- [MongoDB Replicaset](/docs/v2020.09.04-beta.0/guides/mongodb/clustering/replicaset) with KubeDB Operator.
- [MongoDB Sharding](/docs/v2020.09.04-beta.0/guides/mongodb/clustering/sharding) with KubeDB Operator.
...
- Start [MongoDB with Custom Config](/docs/v2020.09.04-beta.0/guides/mongodb/configuration/using-custom-config).
