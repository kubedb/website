...
{{< notice type="warning" message="This doc has been deprecated and will be removed in a future release. We recommend using [Stash](/docs/v2020.09.04-beta.0/guides/mongodb/snapshot/stash) to backup & restore MongoDB database." >}}
...
To learn how to configure other storage destinations for Snapshots, please visit [here](/docs/v2020.09.04-beta.0/concepts/snapshot). Now, create the Snapshot object.
...
![snapshot-console](/docs/v2020.09.04-beta.0/images/mongodb/mgo-xyz-snapshot.png)
...
You can customize pod template spec and volume claim spec for the backup and restore jobs. For details options read [this doc](/docs/v2020.09.04-beta.0/concepts/snapshot).
