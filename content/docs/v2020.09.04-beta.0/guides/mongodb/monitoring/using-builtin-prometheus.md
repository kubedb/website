...
- Install KubeDB operator in your cluster following the steps [here](/docs/v2020.09.04-beta.0/setup/README).
...
<p align="center">
  <img alt="Prometheus Target" height="100%" src="/docs/v2020.09.04-beta.0/images/mongodb/monitoring/mg-builtin-prom-target.png" style="padding:10px">
</p>
...
- Learn about [taking instant backup and restore from snapshot](/docs/v2020.09.04-beta.0/guides/mongodb/snapshot/backup-and-restore) of MongoDB database using KubeDB.
- Learn how to [schedule backup](/docs/v2020.09.04-beta.0/guides/mongodb/snapshot/scheduled-backup)  of MongoDB database.
- Learn about initializing [MongoDB with Snapshot](/docs/v2020.09.04-beta.0/guides/mongodb/initialization/using-snapshot).
- Learn how to configure [MongoDB Topology](/docs/v2020.09.04-beta.0/guides/mongodb/clustering/sharding).
