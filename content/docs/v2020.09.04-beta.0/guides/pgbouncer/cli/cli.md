...
Lets edit an existing running PgBouncer object to setup [Monitoring](/docs/v2020.09.04-beta.0/guides/pgbouncer/monitoring/using-coreos-prometheus-operator). The following command will open PgBouncer `pgbouncer-demo` in editor.
...
- Learn how to use KubeDB to run a PgBouncer [here](/docs/v2020.09.04-beta.0/guides/pgbouncer/README).
