...
We will need a PgBouncer with monitoring enabled. This PgBouncer needs to be connected to PostgreSQL database(s). You can get a PgBouncer setup with active connection(s) to PostgreSQL by following the [quickstart](/docs/v2020.09.04-beta.0/guides/pgbouncer/quickstart/quickstart) guide. PgBouncer object in that guide didn't come with monitoring. So we are going to enable monitoring in it. Below is the PgBouncer object that contains CoreOS prometheus operator based monitoring:
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2020.09.04-beta.0/images/pgbouncer/monitoring/pb-coreos-prom-target.png" style="padding:10px">
</p>
