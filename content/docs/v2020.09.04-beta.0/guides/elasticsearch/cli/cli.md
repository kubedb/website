...
Lets edit an existing running Elasticsearch object to setup [Scheduled Backup](/docs/v2020.09.04-beta.0/guides/elasticsearch/snapshot/scheduled_backup). The following command will open Elasticsearch `elasticsearch-demo` in editor.
