...
If you don't know how KubeDB handles custom configuration for an Elasticsearch cluster, please visit [here](/docs/v2020.09.04-beta.0/guides/elasticsearch/custom-config/overview).
