...
url: /docs/v2020.09.04-beta.0/welcome/contributing/
aliases:
- /docs/v2020.09.04-beta.0/CONTRIBUTING/
info:
...
We have a [Developer Guide](/docs/v2020.09.04-beta.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your dev environment to how to build and test KubeDB. If you find something undocumented or incorrect along the way, please feel free to send a Pull Request.
