...
`spec.version` is a required field that specifies the name of the [PgBouncerVersion](/docs/v2020.09.04-beta.0/concepts/catalog/pgbouncer) crd where the docker images are specified. Currently, when you install KubeDB, it creates the following `PgBouncerVersion` resources,
...
- [Monitor PgBouncer with builtin Prometheus](/docs/v2020.09.04-beta.0/guides/pgbouncer/monitoring/using-builtin-prometheus)
- [Monitor PgBouncer with CoreOS Prometheus operator](/docs/v2020.09.04-beta.0/guides/pgbouncer/monitoring/using-coreos-prometheus-operator)
...
- Learn how to how to get started with PgBouncer [here](/docs/v2020.09.04-beta.0/guides/pgbouncer/quickstart/quickstart).
