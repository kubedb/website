...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [Combined](/docs/v2025.12.31-rc.1/guides/kafka/clustering/combined-cluster/)
    - [KafkaOpsRequest](/docs/v2025.12.31-rc.1/guides/kafka/concepts/kafkaopsrequest)
    - [Vertical Scaling Overview](/docs/v2025.12.31-rc.1/guides/kafka/scaling/vertical-scaling/overview)
