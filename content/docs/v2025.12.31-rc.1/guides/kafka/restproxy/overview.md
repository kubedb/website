...
<p align="center">
  <img alt="lifecycle"  src="/docs/v2025.12.31-rc.1/images/kafka/restproxy/restproxy-crd-lifecycle.png">
</p>
...
> We have designed this tutorial to demonstrate a production setup of KubeDB managed RestProxy. If you just want to try out KubeDB, you can bypass some safety features following the tips [here](/docs/v2025.12.31-rc.1/guides/kafka/restproxy/overview#tips-for-testing).
