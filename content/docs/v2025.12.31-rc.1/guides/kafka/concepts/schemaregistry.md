...
`spec.version` is a required field specifying the name of the [SchemaRegistryVersion](/docs/v2025.12.31-rc.1/guides/kafka/concepts/schemaregistryversion) CR where the docker images are specified. Currently, when you install KubeDB, it creates the following `SchemaRegistryVersion` resources,
- `2.5.11.final`
- `3.15.0`
...
- Monitor your SchemaRegistry with KubeDB using [`out-of-the-box` Prometheus operator](/docs/v2025.12.31-rc.1/guides/kafka/monitoring/using-prometheus-operator).
