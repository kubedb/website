...
> **Note:** For combined kafka, you just need to refer kafka combined object in `databaseRef` field. To learn more about combined kafka, please visit [here](/docs/v2025.12.31-rc.1/guides/kafka/clustering/combined-cluster/).
...
- Different Kafka topology clustering modes [here](/docs/v2025.12.31-rc.1/guides/kafka/clustering/_index).
...
- Kafka ConnectCluster with KubeDB [here](/docs/v2025.12.31-rc.1/guides/kafka/connectcluster/quickstart).
- Kafka Schema Registry with KubeDB [here](/docs/v2025.12.31-rc.1/guides/kafka/schemaregistry/overview).
- Kafka RestProxy with KubeDB [here](/docs/v2025.12.31-rc.1/guides/kafka/restproxy/overview).
- Kafka Migration with KubeDB [here](/docs/v2025.12.31-rc.1/guides/kafka/migration/overview).
