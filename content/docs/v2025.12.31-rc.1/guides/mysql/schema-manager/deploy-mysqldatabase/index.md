...
- You should be familiar with the following `KubeDB` and `KubeVault` concepts:
  - [MySQL](/docs/v2025.12.31-rc.1/guides/mysql/concepts/database/)
  - [MySQLDatabase](/docs/v2025.12.31-rc.1/guides/mysql/concepts/mysqldatabase/)
  - [Schema Manager Overview](/docs/v2025.12.31-rc.1/guides/mysql/schema-manager/overview/)
...
- Detail concepts of [MySQLDatabase object](/docs/v2025.12.31-rc.1/guides/mysql/concepts/mysqldatabase/).
