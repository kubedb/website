...
Now that the config secret is created, it needs to be mentioned in the [Druid](/docs/v2025.12.31-rc.1/guides/druid/concepts/druid) object's yaml:
...
<p align="center">
  <img alt="druid-ui"  src="/docs/v2025.12.31-rc.1/guides/druid/configuration/config-file/images/druid-updated-ui.png">
</p>
