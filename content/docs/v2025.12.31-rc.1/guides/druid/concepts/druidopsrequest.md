...
`spec.databaseRef` is a required field that point to the [Druid](/docs/v2025.12.31-rc.1/guides/druid/concepts/druid) object for which the administrative operations will be performed. This field consists of the following sub-field:

- **spec.databaseRef.name :** specifies the name of the [Druid](/docs/v2025.12.31-rc.1/guides/druid/concepts/druid) object.
...
- `spec.updateVersion.targetVersion` refers to a [DruidVersion](/docs/v2025.12.31-rc.1/guides/druid/concepts/druidversion) CR that contains the Druid version information where you want to update.
