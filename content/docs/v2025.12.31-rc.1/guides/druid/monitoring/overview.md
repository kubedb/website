...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2025.12.31-rc.1/guides/druid/monitoring/images/druid-monitoring.png">
</p>
...
- Learn how to use KubeDB to run a Apache Druid cluster [here](/docs/v2025.12.31-rc.1/guides/druid/README).
- Deploy [dedicated topology cluster](/docs/v2025.12.31-rc.1/guides/druid/clustering/overview/) for Apache Druid
