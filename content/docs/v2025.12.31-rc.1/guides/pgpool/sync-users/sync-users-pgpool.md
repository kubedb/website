...
Now, create a secret with structure defined [here](/docs/v2025.12.31-rc.1/guides/pgpool/concepts/pgpool#specsyncusers). Below is the YAML of the `secret` that we are going to create,
