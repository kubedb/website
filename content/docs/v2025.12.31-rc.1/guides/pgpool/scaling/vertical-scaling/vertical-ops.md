...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [Vertical Scaling Overview](/docs/v2025.12.31-rc.1/guides/pgpool/scaling/vertical-scaling/overview)
...
- Have a look [here](/docs/v2025.12.31-rc.1/guides/pgpool/concepts/opsrequest) on the respective sections to understand the `timeout` & `apply` fields.
