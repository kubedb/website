...
> New to KubeDB? Please start [here](/docs/v2025.12.31-rc.1/setup/README).
...
* Monitor your Percona XtraDB database with KubeDB using [built-in Prometheus](/docs/v2025.12.31-rc.1/guides/percona-xtradb/monitoring/builtin-prometheus/)
* Monitor with [Prometheus operator](/docs/v2025.12.31-rc.1/guides/percona-xtradb/monitoring/prometheus-operator/)
* Use [private Docker registry](/docs/v2025.12.31-rc.1/guides/percona-xtradb/private-registry/quickstart/) to deploy Percona XtraDB with KubeDB
