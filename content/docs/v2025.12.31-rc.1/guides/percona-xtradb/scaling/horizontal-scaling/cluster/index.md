...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PerconaXtraDB Cluster](/docs/v2025.12.31-rc.1/guides/percona-xtradb/clustering/galera-cluster/)
  - [PerconaXtraDBOpsRequest](/docs/v2025.12.31-rc.1/guides/percona-xtradb/concepts/opsrequest/)
  - [Horizontal Scaling Overview](/docs/v2025.12.31-rc.1/guides/percona-xtradb/scaling/horizontal-scaling/overview/)
