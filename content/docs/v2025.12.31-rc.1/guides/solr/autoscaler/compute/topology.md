...
> **Note:** YAML files used in this tutorial are stored in this [directory](/docs/v2025.12.31-rc.1/examples/solr/autoscaler/compute) of [kubedb/docs](https://github.com/kubedb/docs) repository.
