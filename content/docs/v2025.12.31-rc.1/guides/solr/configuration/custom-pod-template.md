...
KubeDB supports providing custom configuration for Solr via [PodTemplate](/docs/v2025.12.31-rc.1/guides/solr/concepts/solr#spectopology). This tutorial will show you how to use KubeDB to run a Solr database with custom configuration using PodTemplate.
...
Read about the fields in details in [PodTemplate concept](/docs/v2025.12.31-rc.1/guides/solr/concepts/solr#spectopology),
