...
<p align="center">
  <img alt="Database Monitoring Flow"  src="/docs/v2025.12.31-rc.1/guides/proxysql/monitoring/overview/images/database-monitoring-overview.svg">
</p>
...
- Learn how to monitor `ProxySQL` server with KubeDB using [builtin-Prometheus](/docs/v2025.12.31-rc.1/guides/proxysql/monitoring/builtin-prometheus) and using [Prometheus operator](/docs/v2025.12.31-rc.1/guides/proxysql/monitoring/prometheus-operator).
- Learn how to monitor `ElasticSearch` database with KubeDB using [builtin-Prometheus](/docs/v2025.12.31-rc.1/guides/elasticsearch/monitoring/using-builtin-prometheus) and using [Prometheus operator](/docs/v2025.12.31-rc.1/guides/elasticsearch/monitoring/using-prometheus-operator).
