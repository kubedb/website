...
- Learn how to monitor FerretDB database with KubeDB using [builtin-Prometheus](/docs/v2025.12.31-rc.1/guides/ferretdb/monitoring/using-builtin-prometheus)
- Learn how to monitor FerretDB database with KubeDB using [Prometheus operator](/docs/v2025.12.31-rc.1/guides/ferretdb/monitoring/using-prometheus-operator).
