...
- To learn how Prometheus monitoring works with KubeDB in general, please visit [here](/docs/v2025.12.31-rc.1/guides/ferretdb/monitoring/overview).
...
To look at the more details of KubeDB managed Postgres monitoring, you can look at [this documentation](/docs/v2025.12.31-rc.1/guides/postgres/monitoring/using-prometheus-operator). 
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2025.12.31-rc.1/images/ferretdb/fr-coreos-prom-target.png" style="padding:10px">
</p>
...
- Detail concepts of [FerretDBVersion object](/docs/v2025.12.31-rc.1/guides/ferretdb/concepts/catalog).
