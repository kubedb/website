...
<figure align="center">
  <img alt="Compute Auto Scaling process of FerretDB" src="/docs/v2025.12.31-rc.1/images/ferretdb/fr-replication.png">
...
- [Deploy FerretDB ReplicaSet](/docs/v2025.12.31-rc.1/guides/ferretdb/clustering/replication) using KubeDB.
