...
- Each cluster must have KubeDB installed. Follow the steps [here](/docs/v2025.12.31-rc.1/setup/README), ensuring you enable the MSSQLServer feature gate: `--set global.featureGates.MSSQLServer=true`.
