...
- Learn how to monitor Microsoft SQL Server with KubeDB using  [Prometheus operator](/docs/v2025.12.31-rc.1/guides/mssqlserver/monitoring/using-prometheus-operator).
