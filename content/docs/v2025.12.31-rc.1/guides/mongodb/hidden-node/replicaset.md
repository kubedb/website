...
- Read [mongodb hidden-node concept](/docs/v2025.12.31-rc.1/guides/mongodb/hidden-node/concept) to get the concept about MongoDB Hidden node.
...
- Deploy MongoDB shard [with Hidden-node](/docs/v2025.12.31-rc.1/guides/mongodb/hidden-node/sharding).
