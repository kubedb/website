...
- Install KubeDB in your cluster following the steps [here](/docs/v2025.12.31-rc.1/setup/README).
...
- [Backup and Restore](/docs/v2025.12.31-rc.1/guides/mongodb/backup/kubestash/overview/) MongoDB databases using KubeStash.
