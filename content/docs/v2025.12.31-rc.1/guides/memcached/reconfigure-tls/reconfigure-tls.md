...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.12.31-rc.1/guides/memcached/concepts/memcached#spectls).
...
- Detail concepts of [Memcached](/docs/v2025.12.31-rc.1/guides/memcached/concepts/memcached).
