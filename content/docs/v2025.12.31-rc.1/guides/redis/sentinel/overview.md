...
![redis-sentinel](/docs/v2025.12.31-rc.1/images/redis/redis-sentinel.png)
...
- [Deploy Redis Sentinel](/docs/v2025.12.31-rc.1/guides/redis/sentinel/redis-sentinel) using KubeDB.
