...
<figure align="center">
  <img alt="updating Process of MongoDB" src="/docs/v2025.12.31-rc.1/images/day-2-operation/redis/replace-sentinel.svg">
...
- Replace Sentinel of your database with a new [Sentinel](/docs/v2025.12.31-rc.1/guides/redis/sentinel/replacesentinel/replace-sentinel)