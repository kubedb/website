...
- Read [redis clustering concept](/docs/v2025.12.31-rc.1/guides/redis/clustering/overview) to learn about Redis clustering.
...
- Deploy [Redis Sentinel](/docs/v2025.12.31-rc.1/guides/redis/sentinel/overview)
