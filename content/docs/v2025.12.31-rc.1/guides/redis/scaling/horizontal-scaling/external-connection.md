...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [External Client Connection](/docs/v2025.12.31-rc.1/guides/redis/external-connections/exposure)
...
Deploy `Redis/Valkey` cluster as shown in [External Connection Exposer](/docs/v2025.12.31-rc.1/guides/redis/external-connections/exposure).
