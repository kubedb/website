...
- `spec.tls.certificates` specifies the certificates. You can learn more about this field from [here](/docs/v2025.12.31-rc.1/guides/elasticsearch/concepts/elasticsearch/).

Let's create the `ElasticsearchOpsRequest` CR we have shown above,

> **Note:** For combined Elasticsearch, you just need to refer Elasticsearch combined object in `databaseRef` field. To learn more about combined Elasticsearch, please visit [here](/docs/v2025.12.31-rc.1/guides/elasticsearch/clustering/combined-cluster/).
