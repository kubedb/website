...
- Different Elasticsearch topology clustering modes [here](/docs/v2025.12.31-rc.1/guides/elasticsearch/clustering/topology-cluster/simple-dedicated-cluster/).
