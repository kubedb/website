...
- You should be familiar with the following `KubeDB` concepts:
    ...
    - [PostgreSQLOpsRequest](/docs/v2025.12.31-rc.1/guides/postgres/concepts/opsrequest)
...
[//]: # (  <img alt="Rotate Authentication process of PostgreSQL" src="/docs/v2025.12.31-rc.1/images/day-2-operation/PostgreSQL/kf-rotate-auth.svg">)
