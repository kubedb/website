...
url: /docs/v2021.11.24/guides/pgbouncer/
aliases:
- /docs/v2021.11.24/guides/pgbouncer/README/
info:
  autoscaler: v0.9.0
  cli: v0.24.0
  community: v0.24.0
...
- [Quickstart PgBouncer](/docs/v2021.11.24/guides/pgbouncer/quickstart/quickstart) with KubeDB Operator.
- Monitor your PgBouncer with KubeDB using [`out-of-the-box` builtin-Prometheus](/docs/v2021.11.24/guides/pgbouncer/monitoring/using-builtin-prometheus).
